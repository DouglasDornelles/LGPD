...
namespace GeneXus.Programs {
   public class parametroview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public parametroview( IGxContext context )
      {
      ...
      public void execute( string aP0_ParametroCod ,
                           string aP1_TabCode )
      {
         this.AV10ParametroCod = aP0_ParametroCod;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "parametroview.aspx"+UrlEncode(StringUtil.RTrim(AV10ParametroCod)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("parametroview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vPARAMETROCOD", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV10ParametroCod, "")), context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPARAMETROCOD", StringUtil.RTrim( AV10ParametroCod));
         GxWebStd.gx_hidden_field( context, "gxhash_vPARAMETROCOD", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV10ParametroCod, "")), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "parametroview.aspx"+UrlEncode(StringUtil.RTrim(AV10ParametroCod)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("parametroview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      protected void WB810( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Parametro", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_ParametroView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divParametrogeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
      ...
      protected void START812( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Parametro View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA812( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "parametroview.aspx")), "parametroview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "parametroview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10ParametroCod = gxfirstwebparm;
                     AssignAttri("", false, "AV10ParametroCod", AV10ParametroCod);
                     GxWebStd.gx_hidden_field( context, "gxhash_vPARAMETROCOD", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV10ParametroCod, "")), context));
      ...
      protected void E11812( )
      {
         ...
         lblWorkwithlink_Link = formatLink("parametroww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H00812 */
         pr_default.execute(0, new Object[] {AV10ParametroCod});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A124ParametroCod = H00812_A124ParametroCod[0];
            A125ParametroDescricao = H00812_A125ParametroDescricao[0];
            AV16GXLvl9 = 1;
            Form.Caption = A125ParametroDescricao;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "ParametroGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "parametrogeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "ParametroGeneral";
            WebComp_Webcomponent_general_Component = "ParametroGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(string)AV10ParametroCod});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10ParametroCod = (string)getParm(obj,0);
         AssignAttri("", false, "AV10ParametroCod", AV10ParametroCod);
         GxWebStd.gx_hidden_field( context, "gxhash_vPARAMETROCOD", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV10ParametroCod, "")), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910512321", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("parametroview.js", "?202311910512321", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divParametrogeneral_cell_Internalname = "PARAMETROGENERAL_CELL";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10ParametroCod',fld:'vPARAMETROCOD',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00812_A124ParametroCod = new string[] {""} ;
         H00812_A125ParametroDescricao = new string[] {""} ;
         A124ParametroCod = "";
         A125ParametroDescricao = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.parametroview__default(),
            new Object[][] {
                new Object[] {
               H00812_A124ParametroCod, H00812_A125ParametroDescricao
               }
            }
         );
      ...
      private int idxLst ;
      private string AV10ParametroCod ;
      private string AV8TabCode ;
      private string wcpOAV10ParametroCod ;
      ...
      private string divParametrogeneral_cell_Internalname ;
      ...
      private string[] H00812_A124ParametroCod ;
      private string[] H00812_A125ParametroDescricao ;
   ...
   public class parametroview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10ParametroCod",GXType.NChar,10,0)
          };
          def= new CursorDef[] {
              new CursorDef("H00812", "SELECT [ParametroCod], [ParametroDescricao] FROM [Parametro] WHERE [ParametroCod] = @AV10ParametroCod ORDER BY [ParametroCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00812,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

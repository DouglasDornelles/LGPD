...
namespace GeneXus.Programs {
   public class fonteretencaoprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public fonteretencaoprompt( )
      {
      ...
      public fonteretencaoprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutFonteRetencaoId ,
                           ref string aP1_InOutFonteRetencaoNome )
      {
         this.AV8InOutFonteRetencaoId = aP0_InOutFonteRetencaoId;
         this.AV9InOutFonteRetencaoNome = aP1_InOutFonteRetencaoNome;
         executePrivate();
         aP0_InOutFonteRetencaoId=this.AV8InOutFonteRetencaoId;
         aP1_InOutFonteRetencaoNome=this.AV9InOutFonteRetencaoNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutFonteRetencaoId");
            ...
            {
               AV8InOutFonteRetencaoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutFonteRetencaoId", StringUtil.LTrimStr( (decimal)(AV8InOutFonteRetencaoId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutFonteRetencaoNome = GetPar( "InOutFonteRetencaoNome");
                  AssignAttri("", false, "AV9InOutFonteRetencaoNome", AV9InOutFonteRetencaoNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      {
         get {
            return "fonteretencaoprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("fonteretencaoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutFonteRetencaoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutFonteRetencaoNome))}, new string[] {"InOutFonteRetencaoId","InOutFonteRetencaoNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTFONTERETENCAOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutFonteRetencaoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTFONTERETENCAONOME", AV9InOutFonteRetencaoNome);
      ...
      {
         return formatLink("fonteretencaoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutFonteRetencaoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutFonteRetencaoNome))}, new string[] {"InOutFonteRetencaoId","InOutFonteRetencaoNome"})  ;
      }

      public override string GetPgmname( )
      {
         return "FonteRetencaoPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Fonte Retencao" ;
      }
      ...
      protected void WB5N0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_5N2( true) ;
         }
         else
         {
            wb_table1_14_5N2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_5N2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START5N2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Fonte Retencao", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_FONTERETENCAONOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A64FonteRetencaoNome, "")), context));
         GxWebStd.gx_hidden_field( context, "FONTERETENCAONOME", A64FonteRetencaoNome);
      }
      ...
      {
         /* GeneXus formulas. */
         AV22Pgmname = "FonteRetencaoPrompt";
         context.Gx_err = 0;
      ...
      protected void RF5N2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A65FonteRetencaoAtivo = H005N2_A65FonteRetencaoAtivo[0];
               A64FonteRetencaoNome = H005N2_A64FonteRetencaoNome[0];
               A63FonteRetencaoId = H005N2_A63FonteRetencaoId[0];
               E175N2 ();
      ...
      protected void send_integrity_lvl_hashes5N2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_FONTERETENCAOID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A63FonteRetencaoId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_FONTERETENCAONOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A64FonteRetencaoNome, "")), context));
      }
      ...
      protected void E155N2( )
      {
         ...
         Form.Caption = "Consulta de Fonte Retencao";
      ...
      protected void E185N2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutFonteRetencaoId = A63FonteRetencaoId;
         AssignAttri("", false, "AV8InOutFonteRetencaoId", StringUtil.LTrimStr( (decimal)(AV8InOutFonteRetencaoId), 8, 0));
         AV9InOutFonteRetencaoNome = A64FonteRetencaoNome;
         AssignAttri("", false, "AV9InOutFonteRetencaoNome", AV9InOutFonteRetencaoNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutFonteRetencaoId,(string)AV9InOutFonteRetencaoNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutFonteRetencaoId","AV9InOutFonteRetencaoNome"});
      ...
      protected void wb_table1_14_5N2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_FonteRetencaoPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutFonteRetencaoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutFonteRetencaoId", StringUtil.LTrimStr( (decimal)(AV8InOutFonteRetencaoId), 8, 0));
         AV9InOutFonteRetencaoNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutFonteRetencaoNome", AV9InOutFonteRetencaoNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231191051394", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("fonteretencaoprompt.js", "?20231191051394", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtFonteRetencaoId_Internalname = "FONTERETENCAOID_"+sGXsfl_26_idx;
         edtFonteRetencaoNome_Internalname = "FONTERETENCAONOME_"+sGXsfl_26_idx;
         cmbFonteRetencaoAtivo_Internalname = "FONTERETENCAOATIVO_"+sGXsfl_26_idx;
      }

      protected void SubsflControlProps_fel_262( )
      {
         edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx;
         edtFonteRetencaoId_Internalname = "FONTERETENCAOID_"+sGXsfl_26_fel_idx;
         edtFonteRetencaoNome_Internalname = "FONTERETENCAONOME_"+sGXsfl_26_fel_idx;
         cmbFonteRetencaoAtivo_Internalname = "FONTERETENCAOATIVO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "FONTERETENCAOATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbFonteRetencaoAtivo_Internalname, "Values", (string)(cmbFonteRetencaoAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:FonteRetencaoId|2:FonteRetencaoNome|3:FonteRetencaoAtivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E175N2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E185N2',iparms:[{av:'A63FonteRetencaoId',fld:'FONTERETENCAOID',pic:'ZZZZZZZ9',hsh:true},{av:'A64FonteRetencaoNome',fld:'FONTERETENCAONOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutFonteRetencaoId',fld:'vINOUTFONTERETENCAOID',pic:'ZZZZZZZ9'},{av:'AV9InOutFonteRetencaoNome',fld:'vINOUTFONTERETENCAONOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E145N2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H005N2_A65FonteRetencaoAtivo = new bool[] {false} ;
         H005N2_A64FonteRetencaoNome = new string[] {""} ;
         H005N2_A63FonteRetencaoId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.fonteretencaoprompt__default(),
            new Object[][] {
                new Object[] {
               H005N2_A65FonteRetencaoAtivo, H005N2_A64FonteRetencaoNome, H005N2_A63FonteRetencaoId
               }
               , new Object[] {
      ...
      private int AV8InOutFonteRetencaoId ;
      private int wcpOAV8InOutFonteRetencaoId ;
      ...
      private string AV9InOutFonteRetencaoNome ;
      private string wcpOAV9InOutFonteRetencaoNome ;
      ...
      private int aP0_InOutFonteRetencaoId ;
      private string aP1_InOutFonteRetencaoNome ;
      private GXCombobox cmbFonteRetencaoAtivo ;
      private IDataStoreProvider pr_default ;
      private bool[] H005N2_A65FonteRetencaoAtivo ;
      private string[] H005N2_A64FonteRetencaoNome ;
      private int[] H005N2_A63FonteRetencaoId ;
   ...
   public class fonteretencaoprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([FonteRetencaoId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [FonteRetencaoNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and [FonteRetencaoAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and [FonteRetencaoAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H005N2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
               case 1 :
                     return conditional_H005N3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
         }

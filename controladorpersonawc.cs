...
namespace GeneXus.Programs {
   public class controladorpersonawc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public controladorpersonawc( )
      {
      ...
      public controladorpersonawc( IGxContext context )
      {
      ...
      public void execute( int aP0_ControladorId )
      {
         this.AV8ControladorId = aP0_ControladorId;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "ControladorId");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8ControladorId = (int)(NumberUtil.Val( GetPar( "ControladorId"), "."));
                  AssignAttri(sPrefix, false, "AV8ControladorId", StringUtil.LTrimStr( (decimal)(AV8ControladorId), 8, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(int)AV8ControladorId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV33ControladorId_In = (int)(NumberUtil.Val( GetPar( "ControladorId_In"), "."));
         AV34IsPersona = StringUtil.StrToBool( GetPar( "IsPersona"));
         AV35PersonaId_Out = (int)(NumberUtil.Val( GetPar( "PersonaId_Out"), "."));
         AV36ControladorId_Out = (int)(NumberUtil.Val( GetPar( "ControladorId_Out"), "."));
         AV30IsAuthorized_Delete = StringUtil.StrToBool( GetPar( "IsAuthorized_Delete"));
         AV31IsAuthorized_PersonaNome = StringUtil.StrToBool( GetPar( "IsAuthorized_PersonaNome"));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV16FilterFullText, AV20ManageFiltersExecutionStep, AV39Pgmname, AV14OrderedBy, AV15OrderedDsc, AV28IsAuthorized_Update, AV33ControladorId_In, AV34IsPersona, AV35PersonaId_Out, AV36ControladorId_Out, AV30IsAuthorized_Delete, AV31IsAuthorized_PersonaNome, AV32IsAuthorized_Insert, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV39Pgmname = "ControladorPersonaWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Controlador Persona WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "controladorpersonawc.aspx"+UrlEncode(StringUtil.LTrimStr(AV8ControladorId,8,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("controladorpersonawc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_PERSONANOME", GetSecureSignedToken( sPrefix, AV31IsAuthorized_PersonaNome, context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8ControladorId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV8ControladorId), 8, 0, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_UPDATE", GetSecureSignedToken( sPrefix, AV28IsAuthorized_Update, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vCONTROLADORID_IN", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV33ControladorId_In), 8, 0, ",", "")));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISPERSONA", AV34IsPersona);
         GxWebStd.gx_hidden_field( context, sPrefix+"vPERSONAID_OUT", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV35PersonaId_Out), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vCONTROLADORID_OUT", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV36ControladorId_Out), 8, 0, ",", "")));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_DELETE", AV30IsAuthorized_Delete);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( sPrefix, AV30IsAuthorized_Delete, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_PERSONANOME", AV31IsAuthorized_PersonaNome);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_PERSONANOME", GetSecureSignedToken( sPrefix, AV31IsAuthorized_PersonaNome, context));
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV32IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vCONTROLADORID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8ControladorId), 8, 0, ",", "")));
      ...
      {
         return "ControladorPersonaWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Controlador Persona WC" ;
      }
      ...
      protected void WB3F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "controladorpersonawc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "Inserir", bttBtninsert_Jsonclick, 5, "Inserir", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_ControladorPersonaWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
            wb_table1_24_3F2( true) ;
         }
         else
         {
            wb_table1_24_3F2( false) ;
         }
         return  ;
      }

      protected void wb_table1_24_3F2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         if ( wbEnd == 39 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtControladorId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A10ControladorId), 8, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A10ControladorId), "ZZZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtControladorId_Jsonclick, 0, "Attribute", "", "", "", "", edtControladorId_Visible, 0, 0, "text", "1", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "Id", "right", false, "", "HLP_ControladorPersonaWC.htm");
            /* User Defined Control */
      ...
      protected void START3F2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Controlador Persona WC", 0) ;
            }
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "controladorpersonawc.aspx")), "controladorpersonawc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "controladorpersonawc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       int AV33ControladorId_In ,
                                       bool AV34IsPersona ,
                                       int AV35PersonaId_Out ,
                                       int AV36ControladorId_Out ,
                                       bool AV30IsAuthorized_Delete ,
                                       bool AV31IsAuthorized_PersonaNome ,
      ...
      protected void RF3F2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            /* Using cursor H003F2 */
            pr_default.execute(0, new Object[] {lV16FilterFullText, lV16FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_39_idx = 1;
            sGXsfl_39_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_39_idx), 4, 0), 4, "0");
            SubsflControlProps_392( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A15PersonaAtivo = H003F2_A15PersonaAtivo[0];
               A14PersonaNome = H003F2_A14PersonaNome[0];
               A13PersonaId = H003F2_A13PersonaId[0];
               E183F2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
         /* Using cursor H003F3 */
         pr_default.execute(1, new Object[] {lV16FilterFullText, lV16FilterFullText});
      ...
      protected void STRUP3F0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8ControladorId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8ControladorId"), ",", "."));
      ...
      protected void E163F2( )
      {
         ...
         GXt_boolean1 = AV31IsAuthorized_PersonaNome;
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "personaview_Execute", out  GXt_boolean1) ;
         AV31IsAuthorized_PersonaNome = GXt_boolean1;
         AssignAttri(sPrefix, false, "AV31IsAuthorized_PersonaNome", AV31IsAuthorized_PersonaNome);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_PERSONANOME", GetSecureSignedToken( sPrefix, AV31IsAuthorized_PersonaNome, context));
         Ddo_grid_Gridinternalname = subGrid_Internalname;
         ucDdo_grid.SendProperty(context, sPrefix, false, Ddo_grid_Internalname, "GridInternalName", Ddo_grid_Gridinternalname);
         edtControladorId_Visible = 0;
         AssignProp(sPrefix, false, edtControladorId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtControladorId_Visible), 5, 0), true);
      ...
      private void E183F2( )
      {
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "persona.aspx"+UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode(StringUtil.LTrimStr(A13PersonaId,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV33ControladorId_In,8,0)) + "," + UrlEncode(StringUtil.BoolToStr(AV34IsPersona)) + "," + UrlEncode(StringUtil.LTrimStr(AV35PersonaId_Out,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV36ControladorId_Out,8,0));
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "persona.aspx"+UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode(StringUtil.LTrimStr(A13PersonaId,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV33ControladorId_In,8,0)) + "," + UrlEncode(StringUtil.BoolToStr(AV34IsPersona)) + "," + UrlEncode(StringUtil.LTrimStr(AV35PersonaId_Out,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV36ControladorId_Out,8,0));
            edtavDelete_Link = formatLink("persona.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
         }
         if ( AV31IsAuthorized_PersonaNome )
         {
            GXKey = Crypto.GetSiteKey( );
      ...
      protected void E113F2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("ControladorPersonaWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV39Pgmname+"GridState"));
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("ControladorPersonaWCFilters"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "ControladorPersonaWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void E153F2( )
      {
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "persona.aspx"+UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode(StringUtil.LTrimStr(0,1,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV33ControladorId_In,8,0)) + "," + UrlEncode(StringUtil.BoolToStr(AV34IsPersona)) + "," + UrlEncode(StringUtil.LTrimStr(AV35PersonaId_Out,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV36ControladorId_Out,8,0));
      ...
      protected void S152( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "persona_Delete", out  GXt_boolean1) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "ControladorPersonaWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "Persona";
         AV11TrnContextAtt = new GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute(context);
         AV11TrnContextAtt.gxTpr_Attributename = "ControladorId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8ControladorId), 8, 0);
         AV10TrnContext.gxTpr_Attributes.Add(AV11TrnContextAtt, 0);
         AV17Session.Set("TrnContext", AV10TrnContext.ToXml(false, true, "", ""));
      }

      protected void wb_table1_24_3F2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table2_29_3F2( true) ;
         }
         else
         {
            wb_table2_29_3F2( false) ;
         }
         return  ;
      }

      protected void wb_table2_29_3F2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_24_3F2e( true) ;
         }
         else
         {
            wb_table1_24_3F2e( false) ;
         }
      }

      protected void wb_table2_29_3F2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8ControladorId = Convert.ToInt32(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8ControladorId", StringUtil.LTrimStr( (decimal)(AV8ControladorId), 8, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8ControladorId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "controladorpersonawc", GetJustCreated( ));
         ...
         {
            AV8ControladorId = Convert.ToInt32(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8ControladorId", StringUtil.LTrimStr( (decimal)(AV8ControladorId), 8, 0));
         }
         wcpOAV8ControladorId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8ControladorId"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( AV8ControladorId != wcpOAV8ControladorId ) ) )
         {
            setjustcreated();
         }
         wcpOAV8ControladorId = AV8ControladorId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8ControladorId = cgiGet( sPrefix+"AV8ControladorId_CTRL");
         if ( StringUtil.Len( sCtrlAV8ControladorId) > 0 )
         {
            AV8ControladorId = (int)(context.localUtil.CToN( cgiGet( sCtrlAV8ControladorId), ",", "."));
            AssignAttri(sPrefix, false, "AV8ControladorId", StringUtil.LTrimStr( (decimal)(AV8ControladorId), 8, 0));
         }
         else
         {
            AV8ControladorId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"AV8ControladorId_PARM"), ",", "."));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8ControladorId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8ControladorId), 8, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8ControladorId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8ControladorId_CTRL", StringUtil.RTrim( sCtrlAV8ControladorId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910454086", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("controladorpersonawc.js", "?202311910454086", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_392( )
      {
         ...
         edtPersonaNome_Internalname = sPrefix+"PERSONANOME_"+sGXsfl_39_idx;
         cmbPersonaAtivo_Internalname = sPrefix+"PERSONAATIVO_"+sGXsfl_39_idx;
      }
      ...
      protected void SubsflControlProps_fel_392( )
      {
         ...
         edtPersonaNome_Internalname = sPrefix+"PERSONANOME_"+sGXsfl_39_fel_idx;
         cmbPersonaAtivo_Internalname = sPrefix+"PERSONAATIVO_"+sGXsfl_39_fel_idx;
      }
      ...
      protected void sendrow_392( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_39_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "PERSONAATIVO_" + sGXsfl_39_idx;
            ...
            AssignProp(sPrefix, false, cmbPersonaAtivo_Internalname, "Values", (string)(cmbPersonaAtivo.ToJavascriptSource()), !bGXsfl_39_Refreshing);
      ...
      protected void init_default_properties( )
      {
         ...
         edtPersonaNome_Internalname = sPrefix+"PERSONANOME";
         cmbPersonaAtivo_Internalname = sPrefix+"PERSONAATIVO";
      ...
      public override void initialize_properties( )
      {
         ...
         edtControladorId_Visible = 1;
         bttBtninsert_Visible = 1;
         Grid_empowerer_Hastitlesettings = Convert.ToBoolean( -1);
         Ddo_grid_Includesortasc = "T";
         Ddo_grid_Columnssortvalues = "2|1|3";
         Ddo_grid_Columnids = "2:PersonaId|3:PersonaNome|4:PersonaAtivo";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV33ControladorId_In',fld:'vCONTROLADORID_IN',pic:'ZZZZZZZ9'},{av:'AV34IsPersona',fld:'vISPERSONA',pic:''},{av:'AV35PersonaId_Out',fld:'vPERSONAID_OUT',pic:'ZZZZZZZ9'},{av:'AV36ControladorId_Out',fld:'vCONTROLADORID_OUT',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_PersonaNome',fld:'vISAUTHORIZED_PERSONANOME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV25GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV26GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{av:'AV18ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E123F2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV33ControladorId_In',fld:'vCONTROLADORID_IN',pic:'ZZZZZZZ9'},{av:'AV34IsPersona',fld:'vISPERSONA',pic:''},{av:'AV35PersonaId_Out',fld:'vPERSONAID_OUT',pic:'ZZZZZZZ9'},{av:'AV36ControladorId_Out',fld:'vCONTROLADORID_OUT',pic:'ZZZZZZZ9'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_PersonaNome',fld:'vISAUTHORIZED_PERSONANOME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E133F2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV33ControladorId_In',fld:'vCONTROLADORID_IN',pic:'ZZZZZZZ9'},{av:'AV34IsPersona',fld:'vISPERSONA',pic:''},{av:'AV35PersonaId_Out',fld:'vPERSONAID_OUT',pic:'ZZZZZZZ9'},{av:'AV36ControladorId_Out',fld:'vCONTROLADORID_OUT',pic:'ZZZZZZZ9'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_PersonaNome',fld:'vISAUTHORIZED_PERSONANOME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E143F2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV33ControladorId_In',fld:'vCONTROLADORID_IN',pic:'ZZZZZZZ9'},{av:'AV34IsPersona',fld:'vISPERSONA',pic:''},{av:'AV35PersonaId_Out',fld:'vPERSONAID_OUT',pic:'ZZZZZZZ9'},{av:'AV36ControladorId_Out',fld:'vCONTROLADORID_OUT',pic:'ZZZZZZZ9'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_PersonaNome',fld:'vISAUTHORIZED_PERSONANOME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E183F2',iparms:[{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A13PersonaId',fld:'PERSONAID',pic:'ZZZZZZZ9'},{av:'AV33ControladorId_In',fld:'vCONTROLADORID_IN',pic:'ZZZZZZZ9'},{av:'AV34IsPersona',fld:'vISPERSONA',pic:''},{av:'AV35PersonaId_Out',fld:'vPERSONAID_OUT',pic:'ZZZZZZZ9'},{av:'AV36ControladorId_Out',fld:'vCONTROLADORID_OUT',pic:'ZZZZZZZ9'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_PersonaNome',fld:'vISAUTHORIZED_PERSONANOME',pic:'',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV27Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV29Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtPersonaNome_Link',ctrl:'PERSONANOME',prop:'Link'}]}");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'E113F2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV33ControladorId_In',fld:'vCONTROLADORID_IN',pic:'ZZZZZZZ9'},{av:'AV34IsPersona',fld:'vISPERSONA',pic:''},{av:'AV35PersonaId_Out',fld:'vPERSONAID_OUT',pic:'ZZZZZZZ9'},{av:'AV36ControladorId_Out',fld:'vCONTROLADORID_OUT',pic:'ZZZZZZZ9'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_PersonaNome',fld:'vISAUTHORIZED_PERSONANOME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",",oparms:[{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'},{av:'AV24GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV25GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV26GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{av:'AV18ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''}]}");
         setEventMetadata("'DOINSERT'","{handler:'E153F2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV33ControladorId_In',fld:'vCONTROLADORID_IN',pic:'ZZZZZZZ9'},{av:'AV34IsPersona',fld:'vISPERSONA',pic:''},{av:'AV35PersonaId_Out',fld:'vPERSONAID_OUT',pic:'ZZZZZZZ9'},{av:'AV36ControladorId_Out',fld:'vCONTROLADORID_OUT',pic:'ZZZZZZZ9'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_PersonaNome',fld:'vISAUTHORIZED_PERSONANOME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'A13PersonaId',fld:'PERSONAID',pic:'ZZZZZZZ9'}]");
         setEventMetadata("'DOINSERT'",",oparms:[{av:'AV36ControladorId_Out',fld:'vCONTROLADORID_OUT',pic:'ZZZZZZZ9'},{av:'AV35PersonaId_Out',fld:'vPERSONAID_OUT',pic:'ZZZZZZZ9'},{av:'AV34IsPersona',fld:'vISPERSONA',pic:''},{av:'AV33ControladorId_In',fld:'vCONTROLADORID_IN',pic:'ZZZZZZZ9'},{av:'A13PersonaId',fld:'PERSONAID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV25GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV26GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{av:'AV18ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]}");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV16FilterFullText = "";
         H003F2_A15PersonaAtivo = new bool[] {false} ;
         H003F2_A14PersonaNome = new string[] {""} ;
         H003F2_A13PersonaId = new int[1] ;
         ...
         sCtrlAV8ControladorId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         GXCCtl = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.controladorpersonawc__default(),
            new Object[][] {
                new Object[] {
               H003F2_A15PersonaAtivo, H003F2_A14PersonaNome, H003F2_A13PersonaId
               }
               , new Object[] {
      ...
      private int AV8ControladorId ;
      private int wcpOAV8ControladorId ;
      private int subGrid_Rows ;
      private int Gridpaginationbar_Rowsperpageselectedvalue ;
      private int nRC_GXsfl_39 ;
      private int nGXsfl_39_idx=1 ;
      private int AV33ControladorId_In ;
      private int AV35PersonaId_Out ;
      private int AV36ControladorId_Out ;
      private int edtavUpdate_Enabled ;
      private int edtavDelete_Enabled ;
      private int Gridpaginationbar_Pagestoshow ;
      private int bttBtninsert_Visible ;
      private int A10ControladorId ;
      private int edtControladorId_Visible ;
      ...
      private string sCtrlAV8ControladorId ;
      ...
      private bool AV34IsPersona ;
      private bool AV30IsAuthorized_Delete ;
      private bool AV31IsAuthorized_PersonaNome ;
      ...
      private bool[] H003F2_A15PersonaAtivo ;
      private string[] H003F2_A14PersonaNome ;
      private int[] H003F2_A13PersonaId ;
   ...
   public class controladorpersonawc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV15OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([PersonaId] AS decimal(8,0))) like '%' + @lV16FilterFullText) or ( [PersonaNome] like '%' + @lV16FilterFullText))");
         }
         else
         {
            GXv_int5[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H003F2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] );
               case 1 :
                     return conditional_H003F3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] );
         }

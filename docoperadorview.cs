...
namespace GeneXus.Programs {
   public class docoperadorview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public docoperadorview( )
      {
      ...
      public docoperadorview( IGxContext context )
      {
      ...
      public void execute( int aP0_DocOperadorId ,
                           string aP1_TabCode )
      {
         this.AV10DocOperadorId = aP0_DocOperadorId;
      ...
      {
         get {
            return "docoperadorview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "docoperadorview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10DocOperadorId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("docoperadorview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vDOCOPERADORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10DocOperadorId), "ZZZZZZZ9"), context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vDOCOPERADORID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10DocOperadorId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vDOCOPERADORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10DocOperadorId), "ZZZZZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "docoperadorview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10DocOperadorId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("docoperadorview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "DocOperadorView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Doc Operador View" ;
      }
      ...
      protected void WB6R0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Doc Operador", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_DocOperadorView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divDocoperadorgeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
      ...
      protected void START6R2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Doc Operador View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA6R2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "docoperadorview.aspx")), "docoperadorview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "docoperadorview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10DocOperadorId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10DocOperadorId", StringUtil.LTrimStr( (decimal)(AV10DocOperadorId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vDOCOPERADORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10DocOperadorId), "ZZZZZZZ9"), context));
      ...
      protected void E116R2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("docoperadorww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H006R2 */
         pr_default.execute(0, new Object[] {AV10DocOperadorId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A86DocOperadorId = H006R2_A86DocOperadorId[0];
            A87DocOperadorColeta = H006R2_A87DocOperadorColeta[0];
            AV16GXLvl9 = 1;
            Form.Caption = StringUtil.BoolToStr( A87DocOperadorColeta);
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "DocOperadorGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "docoperadorgeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "DocOperadorGeneral";
            WebComp_Webcomponent_general_Component = "DocOperadorGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10DocOperadorId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10DocOperadorId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10DocOperadorId", StringUtil.LTrimStr( (decimal)(AV10DocOperadorId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vDOCOPERADORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10DocOperadorId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910512133", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("docoperadorview.js", "?202311910512133", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divDocoperadorgeneral_cell_Internalname = "DOCOPERADORGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Doc Operador View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10DocOperadorId',fld:'vDOCOPERADORID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H006R2_A86DocOperadorId = new int[1] ;
         H006R2_A87DocOperadorColeta = new bool[] {false} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.docoperadorview__default(),
            new Object[][] {
                new Object[] {
               H006R2_A86DocOperadorId, H006R2_A87DocOperadorColeta
               }
            }
         );
      ...
      private int AV10DocOperadorId ;
      private int wcpOAV10DocOperadorId ;
      ...
      private string divDocoperadorgeneral_cell_Internalname ;
      ...
      private int[] H006R2_A86DocOperadorId ;
      private bool[] H006R2_A87DocOperadorColeta ;
   ...
   public class docoperadorview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10DocOperadorId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H006R2", "SELECT [DocOperadorId], [DocOperadorColeta] FROM [DocOperador] WHERE [DocOperadorId] = @AV10DocOperadorId ORDER BY [DocOperadorId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006R2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

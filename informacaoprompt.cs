...
namespace GeneXus.Programs {
   public class informacaoprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public informacaoprompt( )
      {
      ...
      public informacaoprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutInformacaoId ,
                           ref string aP1_InOutInformacaoNome )
      {
         this.AV8InOutInformacaoId = aP0_InOutInformacaoId;
         this.AV9InOutInformacaoNome = aP1_InOutInformacaoNome;
         executePrivate();
         aP0_InOutInformacaoId=this.AV8InOutInformacaoId;
         aP1_InOutInformacaoNome=this.AV9InOutInformacaoNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutInformacaoId");
            ...
            {
               AV8InOutInformacaoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutInformacaoId", StringUtil.LTrimStr( (decimal)(AV8InOutInformacaoId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutInformacaoNome = GetPar( "InOutInformacaoNome");
                  AssignAttri("", false, "AV9InOutInformacaoNome", AV9InOutInformacaoNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      {
         get {
            return "informacaoprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("informacaoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutInformacaoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutInformacaoNome))}, new string[] {"InOutInformacaoId","InOutInformacaoNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTINFORMACAOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutInformacaoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTINFORMACAONOME", AV9InOutInformacaoNome);
      ...
      {
         return formatLink("informacaoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutInformacaoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutInformacaoNome))}, new string[] {"InOutInformacaoId","InOutInformacaoNome"})  ;
      }

      public override string GetPgmname( )
      {
         return "InformacaoPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Informacao" ;
      }
      ...
      protected void WB2K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_2K2( true) ;
         }
         else
         {
            wb_table1_14_2K2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_2K2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START2K2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Informacao", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_INFORMACAONOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A70InformacaoNome, "")), context));
         GxWebStd.gx_hidden_field( context, "INFORMACAONOME", A70InformacaoNome);
      }
      ...
      protected void RF2K2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A71InformacaoAtivo = H002K2_A71InformacaoAtivo[0];
               A70InformacaoNome = H002K2_A70InformacaoNome[0];
               A69InformacaoId = H002K2_A69InformacaoId[0];
               E172K2 ();
      ...
      protected void send_integrity_lvl_hashes2K2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_INFORMACAOID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A69InformacaoId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_INFORMACAONOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A70InformacaoNome, "")), context));
      }
      ...
      protected void E152K2( )
      {
         ...
         Form.Caption = "Consulta de Informacao";
      ...
      protected void E182K2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutInformacaoId = A69InformacaoId;
         AssignAttri("", false, "AV8InOutInformacaoId", StringUtil.LTrimStr( (decimal)(AV8InOutInformacaoId), 8, 0));
         AV9InOutInformacaoNome = A70InformacaoNome;
         AssignAttri("", false, "AV9InOutInformacaoNome", AV9InOutInformacaoNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutInformacaoId,(string)AV9InOutInformacaoNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutInformacaoId","AV9InOutInformacaoNome"});
      ...
      protected void wb_table1_14_2K2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_InformacaoPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutInformacaoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutInformacaoId", StringUtil.LTrimStr( (decimal)(AV8InOutInformacaoId), 8, 0));
         AV9InOutInformacaoNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutInformacaoNome", AV9InOutInformacaoNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910494776", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("informacaoprompt.js", "?202311910494776", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         cmbInformacaoAtivo_Internalname = "INFORMACAOATIVO_"+sGXsfl_26_idx;
      }
      ...
      protected void SubsflControlProps_fel_262( )
      {
         ...
         cmbInformacaoAtivo_Internalname = "INFORMACAOATIVO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "INFORMACAOATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbInformacaoAtivo_Internalname, "Values", (string)(cmbInformacaoAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:InformacaoId|2:InformacaoNome|3:InformacaoAtivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E172K2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E182K2',iparms:[{av:'A69InformacaoId',fld:'INFORMACAOID',pic:'ZZZZZZZ9',hsh:true},{av:'A70InformacaoNome',fld:'INFORMACAONOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutInformacaoId',fld:'vINOUTINFORMACAOID',pic:'ZZZZZZZ9'},{av:'AV9InOutInformacaoNome',fld:'vINOUTINFORMACAONOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E142K2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H002K2_A71InformacaoAtivo = new bool[] {false} ;
         H002K2_A70InformacaoNome = new string[] {""} ;
         H002K2_A69InformacaoId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.informacaoprompt__default(),
            new Object[][] {
                new Object[] {
               H002K2_A71InformacaoAtivo, H002K2_A70InformacaoNome, H002K2_A69InformacaoId
               }
               , new Object[] {
      ...
      private int AV8InOutInformacaoId ;
      private int wcpOAV8InOutInformacaoId ;
      ...
      private string AV9InOutInformacaoNome ;
      private string wcpOAV9InOutInformacaoNome ;
      ...
      private int aP0_InOutInformacaoId ;
      private string aP1_InOutInformacaoNome ;
      private GXCombobox cmbInformacaoAtivo ;
      private IDataStoreProvider pr_default ;
      private bool[] H002K2_A71InformacaoAtivo ;
      private string[] H002K2_A70InformacaoNome ;
      private int[] H002K2_A69InformacaoId ;
   ...
   public class informacaoprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([InformacaoId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [InformacaoNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and [InformacaoAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and [InformacaoAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
         ...
         {
            sOrderString += " ORDER BY [InformacaoId] DESC";
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002K2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
               case 1 :
                     return conditional_H002K3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
         }

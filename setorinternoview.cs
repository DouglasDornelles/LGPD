...
namespace GeneXus.Programs {
   public class setorinternoview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public setorinternoview( )
      {
      ...
      public setorinternoview( IGxContext context )
      {
      ...
      public void execute( int aP0_SetorInternoId ,
                           string aP1_TabCode )
      {
         this.AV10SetorInternoId = aP0_SetorInternoId;
      ...
      {
         get {
            return "setorinternoview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "setorinternoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10SetorInternoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("setorinternoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vSETORINTERNOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10SetorInternoId), "ZZZZZZZ9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vSETORINTERNOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10SetorInternoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vSETORINTERNOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10SetorInternoId), "ZZZZZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "setorinternoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10SetorInternoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("setorinternoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "SetorInternoView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Setor Interno View" ;
      }
      ...
      protected void WB5G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Setor Interno", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_SetorInternoView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divSetorinternogeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDocsetorinterno_title_Internalname, "Doc Setor Interno", "", "", lblDocsetorinterno_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_SetorInternoView.htm");
            /* Div Control */
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0033"+"", StringUtil.RTrim( WebComp_Docsetorinternowc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
      ...
      protected void START5G2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Setor Interno View", 0) ;
         }
         context.wjLoc = "";
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldDocsetorinternowc = cgiGet( "W0033");
                           ...
                           if ( StringUtil.Len( WebComp_Docsetorinternowc_Component) != 0 )
                           {
                              WebComp_Docsetorinternowc.componentprocess("W0033", "", sEvt);
                           }
                           WebComp_Docsetorinternowc_Component = OldDocsetorinternowc;
                        }
                     }
      ...
      protected void PA5G2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "setorinternoview.aspx")), "setorinternoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "setorinternoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10SetorInternoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10SetorInternoId", StringUtil.LTrimStr( (decimal)(AV10SetorInternoId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vSETORINTERNOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10SetorInternoId), "ZZZZZZZ9"), context));
      ...
      protected void E125G2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("setorinternoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H005G2 */
         pr_default.execute(0, new Object[] {AV10SetorInternoId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A60SetorInternoId = H005G2_A60SetorInternoId[0];
            A61SetorInternoNome = H005G2_A61SetorInternoNome[0];
            AV16GXLvl9 = 1;
            Form.Caption = A61SetorInternoNome;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "SetorInternoGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "setorinternogeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "SetorInternoGeneral";
            WebComp_Webcomponent_general_Component = "SetorInternoGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10SetorInternoId});
      ...
      protected void S122( )
      {
         /* 'LOADTABS' Routine */
         returnInSub = false;
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "DocSetorInterno") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Docsetorinternowc_Component), StringUtil.Lower( "SetorInternoDocSetorInternoWC")) != 0 )
            {
               WebComp_Docsetorinternowc = getWebComponent(GetType(), "GeneXus.Programs", "setorinternodocsetorinternowc", new Object[] {context} );
               WebComp_Docsetorinternowc.ComponentInit();
               WebComp_Docsetorinternowc.Name = "SetorInternoDocSetorInternoWC";
               WebComp_Docsetorinternowc_Component = "SetorInternoDocSetorInternoWC";
            }
            if ( StringUtil.Len( WebComp_Docsetorinternowc_Component) != 0 )
            {
               WebComp_Docsetorinternowc.setjustcreated();
               WebComp_Docsetorinternowc.componentprepare(new Object[] {(string)"W0033",(string)"",(int)AV10SetorInternoId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10SetorInternoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10SetorInternoId", StringUtil.LTrimStr( (decimal)(AV10SetorInternoId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vSETORINTERNOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10SetorInternoId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910505612", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("setorinternoview.js", "?202311910505612", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divSetorinternogeneral_cell_Internalname = "SETORINTERNOGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Setor Interno View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10SetorInternoId',fld:'vSETORINTERNOID',pic:'ZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E115G2',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10SetorInternoId',fld:'vSETORINTERNOID',pic:'ZZZZZZZ9',hsh:true}]");
         setEventMetadata("TABS.TABCHANGED",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{ctrl:'DOCSETORINTERNOWC'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H005G2_A60SetorInternoId = new int[1] ;
         H005G2_A61SetorInternoNome = new string[] {""} ;
         A61SetorInternoNome = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.setorinternoview__default(),
            new Object[][] {
                new Object[] {
               H005G2_A60SetorInternoId, H005G2_A61SetorInternoNome
               }
            }
         );
      ...
      private int AV10SetorInternoId ;
      private int wcpOAV10SetorInternoId ;
      ...
      private string divSetorinternogeneral_cell_Internalname ;
      ...
      private int[] H005G2_A60SetorInternoId ;
      private string[] H005G2_A61SetorInternoNome ;
   ...
   public class setorinternoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10SetorInternoId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H005G2", "SELECT [SetorInternoId], [SetorInternoNome] FROM [SetorInterno] WHERE [SetorInternoId] = @AV10SetorInternoId ORDER BY [SetorInternoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005G2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

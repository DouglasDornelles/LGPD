...
namespace GeneXus.Programs {
   public class fonteretencaowwexportreport : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public fonteretencaowwexportreport( )
      {
      ...
      public fonteretencaowwexportreport( IGxContext context )
      {
      ...
      {
         fonteretencaowwexportreport objfonteretencaowwexportreport;
         objfonteretencaowwexportreport = new fonteretencaowwexportreport();
         objfonteretencaowwexportreport.context.SetSubmitInitialConfig(context);
         objfonteretencaowwexportreport.initialize();
         Submit( executePrivateCatch,objfonteretencaowwexportreport);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((fonteretencaowwexportreport)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "fonteretencaoww_Execute", out  GXt_boolean1) ;
            ...
            if ( AV8IsAuthorized )
            {
               ...
               AV33Title = "Lista de Fonte Retencao";
      ...
      protected void S111( )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV19TFFonteRetencaoNome_Sel)) )
         {
            AV22TempBoolean = (bool)(((StringUtil.StrCmp(AV19TFFonteRetencaoNome_Sel, "<#Empty#>")==0)));
            AV19TFFonteRetencaoNome_Sel = (AV22TempBoolean ? "(Vazio)" : AV19TFFonteRetencaoNome_Sel);
            H4M0( false, 20) ;
            getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 169, 169, 169, 0, 255, 255, 255) ;
            getPrinter().GxDrawText("Nome", 25, Gx_line+0, 99, Gx_line+15, 0, 0, 0, 0) ;
            getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
            getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV19TFFonteRetencaoNome_Sel, "")), 99, Gx_line+0, 789, Gx_line+15, 0, 0, 0, 0) ;
            Gx_OldLine = Gx_line;
            Gx_line = (int)(Gx_line+20);
            AV19TFFonteRetencaoNome_Sel = (AV22TempBoolean ? "<#Empty#>" : AV19TFFonteRetencaoNome_Sel);
         }
         else
         {
            if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV18TFFonteRetencaoNome)) )
            {
               H4M0( false, 20) ;
               getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 169, 169, 169, 0, 255, 255, 255) ;
               getPrinter().GxDrawText("Nome", 25, Gx_line+0, 99, Gx_line+15, 0, 0, 0, 0) ;
               getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV18TFFonteRetencaoNome, "")), 99, Gx_line+0, 789, Gx_line+15, 0, 0, 0, 0) ;
               Gx_OldLine = Gx_line;
               Gx_line = (int)(Gx_line+20);
            }
         }
         if ( ! (0==AV20TFFonteRetencaoAtivo_Sel) )
         {
            if ( AV20TFFonteRetencaoAtivo_Sel == 1 )
            {
               AV21FilterTFFonteRetencaoAtivo_SelValueDescription = "Marcado";
            }
            else if ( AV20TFFonteRetencaoAtivo_Sel == 2 )
            {
               AV21FilterTFFonteRetencaoAtivo_SelValueDescription = "Desmarcado";
            }
            H4M0( false, 20) ;
            getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 169, 169, 169, 0, 255, 255, 255) ;
            getPrinter().GxDrawText("Ativo?", 25, Gx_line+0, 99, Gx_line+15, 0, 0, 0, 0) ;
            getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
            getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV21FilterTFFonteRetencaoAtivo_SelValueDescription, "")), 99, Gx_line+0, 789, Gx_line+15, 0, 0, 0, 0) ;
            Gx_OldLine = Gx_line;
            Gx_line = (int)(Gx_line+20);
         }
      }
      ...
      protected void S131( )
      {
         /* 'PRINTDATA' Routine */
         returnInSub = false;
         AV41Fonteretencaowwds_1_filterfulltext = AV13FilterFullText;
         AV42Fonteretencaowwds_2_tffonteretencaonome = AV18TFFonteRetencaoNome;
         AV43Fonteretencaowwds_3_tffonteretencaonome_sel = AV19TFFonteRetencaoNome_Sel;
         AV44Fonteretencaowwds_4_tffonteretencaoativo_sel = AV20TFFonteRetencaoAtivo_Sel;
         ...
         {
            A65FonteRetencaoAtivo = P004M2_A65FonteRetencaoAtivo[0];
            A64FonteRetencaoNome = P004M2_A64FonteRetencaoNome[0];
            A63FonteRetencaoId = P004M2_A63FonteRetencaoId[0];
            AV35FonteRetencaoAtivoDescription = "";
            if ( StringUtil.StrCmp(StringUtil.Trim( StringUtil.BoolToStr( A65FonteRetencaoAtivo)), "true") == 0 )
            {
               AV35FonteRetencaoAtivoDescription = "SIM";
            }
            else if ( StringUtil.StrCmp(StringUtil.Trim( StringUtil.BoolToStr( A65FonteRetencaoAtivo)), "false") == 0 )
            {
               AV35FonteRetencaoAtivoDescription = "NÃO";
            }
            ...
            if ( A65FonteRetencaoAtivo )
            {
               ...
               getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( A64FonteRetencaoNome, "")), 30, Gx_line+10, 406, Gx_line+25, 0, 0, 0, 0) ;
               getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV35FonteRetencaoAtivoDescription, "")), 410, Gx_line+10, 787, Gx_line+25, 0, 0, 0, 0) ;
      ...
      protected void S161( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV14Session.Get("FonteRetencaoWWGridState"), "") == 0 )
         {
            AV16GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "FonteRetencaoWWGridState"), null, "", "");
         }
         else
         {
            AV16GridState.FromXml(AV14Session.Get("FonteRetencaoWWGridState"), null, "", "");
         }
         ...
         while ( AV45GXV1 <= AV16GridState.gxTpr_Filtervalues.Count )
         {
            ...
            else if ( StringUtil.StrCmp(AV17GridStateFilterValue.gxTpr_Name, "TFFONTERETENCAONOME") == 0 )
            {
               AV18TFFonteRetencaoNome = AV17GridStateFilterValue.gxTpr_Value;
            }
            else if ( StringUtil.StrCmp(AV17GridStateFilterValue.gxTpr_Name, "TFFONTERETENCAONOME_SEL") == 0 )
            {
               AV19TFFonteRetencaoNome_Sel = AV17GridStateFilterValue.gxTpr_Value;
            }
            else if ( StringUtil.StrCmp(AV17GridStateFilterValue.gxTpr_Name, "TFFONTERETENCAOATIVO_SEL") == 0 )
            {
               AV20TFFonteRetencaoAtivo_Sel = (short)(NumberUtil.Val( AV17GridStateFilterValue.gxTpr_Value, "."));
            }
      ...
      public override void initialize( )
      {
         ...
         AV33Title = "";
         AV13FilterFullText = "";
         AV19TFFonteRetencaoNome_Sel = "";
         AV18TFFonteRetencaoNome = "";
         AV21FilterTFFonteRetencaoAtivo_SelValueDescription = "";
         AV41Fonteretencaowwds_1_filterfulltext = "";
         AV42Fonteretencaowwds_2_tffonteretencaonome = "";
         AV43Fonteretencaowwds_3_tffonteretencaonome_sel = "";
         scmdbuf = "";
         ...
         A64FonteRetencaoNome = "";
         P004M2_A65FonteRetencaoAtivo = new bool[] {false} ;
         P004M2_A64FonteRetencaoNome = new string[] {""} ;
         P004M2_A63FonteRetencaoId = new int[1] ;
         AV35FonteRetencaoAtivoDescription = "";
         ...
         AV24AddressLine2 = "";
         AV25AddressLine3 = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.fonteretencaowwexportreport__default(),
            new Object[][] {
                new Object[] {
               P004M2_A65FonteRetencaoAtivo, P004M2_A64FonteRetencaoNome, P004M2_A63FonteRetencaoId
               }
            }
         );
      ...
      private short AV20TFFonteRetencaoAtivo_Sel ;
      ...
      private string AV19TFFonteRetencaoNome_Sel ;
      private string AV18TFFonteRetencaoNome ;
      private string AV21FilterTFFonteRetencaoAtivo_SelValueDescription ;
      ...
      private string AV35FonteRetencaoAtivoDescription ;
      ...
      private bool[] P004M2_A65FonteRetencaoAtivo ;
      private string[] P004M2_A64FonteRetencaoNome ;
      private int[] P004M2_A63FonteRetencaoId ;
   ...
   public class fonteretencaowwexportreport__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P004M2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (string)dynConstraints[4] , (bool)dynConstraints[5] , (short)dynConstraints[6] , (bool)dynConstraints[7] );
         }

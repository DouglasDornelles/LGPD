...
namespace GeneXus.Programs {
   public class temporetencaodocumentowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public temporetencaodocumentowc( )
      {
      ...
      public temporetencaodocumentowc( IGxContext context )
      {
      ...
      public void execute( int aP0_TempoRetencaoId )
      {
         this.AV8TempoRetencaoId = aP0_TempoRetencaoId;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "TempoRetencaoId");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8TempoRetencaoId = (int)(NumberUtil.Val( GetPar( "TempoRetencaoId"), "."));
                  AssignAttri(sPrefix, false, "AV8TempoRetencaoId", StringUtil.LTrimStr( (decimal)(AV8TempoRetencaoId), 8, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(int)AV8TempoRetencaoId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV8TempoRetencaoId, AV20ManageFiltersExecutionStep, AV36Pgmname, AV14OrderedBy, AV15OrderedDsc, AV16FilterFullText, AV28IsAuthorized_Update, AV33Aba, AV30IsAuthorized_Delete, AV31IsAuthorized_Insert, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV36Pgmname = "TempoRetencaoDocumentoWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Tempo Retencao Documento WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "temporetencaodocumentowc.aspx"+UrlEncode(StringUtil.LTrimStr(AV8TempoRetencaoId,8,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("temporetencaodocumentowc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8TempoRetencaoId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV8TempoRetencaoId), 8, 0, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV31IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTEMPORETENCAOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8TempoRetencaoId), 8, 0, ",", "")));
      ...
      {
         return "TempoRetencaoDocumentoWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Tempo Retencao Documento WC" ;
      }
      ...
      protected void WB500( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "temporetencaodocumentowc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "Inserir", bttBtninsert_Jsonclick, 5, "Inserir", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_TempoRetencaoDocumentoWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void wb_table1_24_502e( bool wbgen )
      {
         ...
         if ( wbEnd == 39 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtTempoRetencaoId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A48TempoRetencaoId), 8, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A48TempoRetencaoId), "ZZZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTempoRetencaoId_Jsonclick, 0, "Attribute", "", "", "", "", edtTempoRetencaoId_Visible, 0, 0, "text", "1", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "Id", "right", false, "", "HLP_TempoRetencaoDocumentoWC.htm");
            /* User Defined Control */
      ...
      protected void START502( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Tempo Retencao Documento WC", 0) ;
            }
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "temporetencaodocumentowc.aspx")), "temporetencaodocumentowc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "temporetencaodocumentowc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void RF502( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00502 */
            pr_default.execute(0, new Object[] {AV8TempoRetencaoId, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_39_idx = 1;
            sGXsfl_39_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_39_idx), 4, 0), 4, "0");
            SubsflControlProps_392( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A48TempoRetencaoId = H00502_A48TempoRetencaoId[0];
               n48TempoRetencaoId = H00502_n48TempoRetencaoId[0];
               AssignAttri(sPrefix, false, "A48TempoRetencaoId", StringUtil.LTrimStr( (decimal)(A48TempoRetencaoId), 8, 0));
               A105DocumentoOperador = H00502_A105DocumentoOperador[0];
               n105DocumentoOperador = H00502_n105DocumentoOperador[0];
               A85DocumentoAtivo = H00502_A85DocumentoAtivo[0];
               n85DocumentoAtivo = H00502_n85DocumentoAtivo[0];
               A84DocumentoFluxoTratDadosDesc = H00502_A84DocumentoFluxoTratDadosDesc[0];
               n84DocumentoFluxoTratDadosDesc = H00502_n84DocumentoFluxoTratDadosDesc[0];
               A83DocumentoMedidaSegurancaDesc = H00502_A83DocumentoMedidaSegurancaDesc[0];
               n83DocumentoMedidaSegurancaDesc = H00502_n83DocumentoMedidaSegurancaDesc[0];
               A82DocumentoDadosGrupoVul = H00502_A82DocumentoDadosGrupoVul[0];
               n82DocumentoDadosGrupoVul = H00502_n82DocumentoDadosGrupoVul[0];
               A81DocumentoDadosCriancaAdolesc = H00502_A81DocumentoDadosCriancaAdolesc[0];
               n81DocumentoDadosCriancaAdolesc = H00502_n81DocumentoDadosCriancaAdolesc[0];
               A80DocumentoBaseLegalNormIntExt = H00502_A80DocumentoBaseLegalNormIntExt[0];
               n80DocumentoBaseLegalNormIntExt = H00502_n80DocumentoBaseLegalNormIntExt[0];
               A79DocumentoBaseLegalNorm = H00502_A79DocumentoBaseLegalNorm[0];
               n79DocumentoBaseLegalNorm = H00502_n79DocumentoBaseLegalNorm[0];
               A78DocumentoPrevColetaDados = H00502_A78DocumentoPrevColetaDados[0];
               n78DocumentoPrevColetaDados = H00502_n78DocumentoPrevColetaDados[0];
               A45TipoDescarteId = H00502_A45TipoDescarteId[0];
               n45TipoDescarteId = H00502_n45TipoDescarteId[0];
               A39FrequenciaTratamentoId = H00502_A39FrequenciaTratamentoId[0];
               n39FrequenciaTratamentoId = H00502_n39FrequenciaTratamentoId[0];
               A36AbrangenciaGeograficaId = H00502_A36AbrangenciaGeograficaId[0];
               n36AbrangenciaGeograficaId = H00502_n36AbrangenciaGeograficaId[0];
               A33FerramentaColetaId = H00502_A33FerramentaColetaId[0];
               n33FerramentaColetaId = H00502_n33FerramentaColetaId[0];
               A30TipoDadoId = H00502_A30TipoDadoId[0];
               n30TipoDadoId = H00502_n30TipoDadoId[0];
               A27CategoriaId = H00502_A27CategoriaId[0];
               n27CategoriaId = H00502_n27CategoriaId[0];
               A77DocumentoFinalidadeTratamento = H00502_A77DocumentoFinalidadeTratamento[0];
               n77DocumentoFinalidadeTratamento = H00502_n77DocumentoFinalidadeTratamento[0];
               A13PersonaId = H00502_A13PersonaId[0];
               n13PersonaId = H00502_n13PersonaId[0];
               A7EncarregadoId = H00502_A7EncarregadoId[0];
               n7EncarregadoId = H00502_n7EncarregadoId[0];
               A20SubprocessoId = H00502_A20SubprocessoId[0];
               n20SubprocessoId = H00502_n20SubprocessoId[0];
               A76DocumentoNome = H00502_A76DocumentoNome[0];
               n76DocumentoNome = H00502_n76DocumentoNome[0];
               A75DocumentoId = H00502_A75DocumentoId[0];
               E18502 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         /* Using cursor H00503 */
         pr_default.execute(1, new Object[] {AV8TempoRetencaoId});
      ...
      protected void STRUP500( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8TempoRetencaoId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8TempoRetencaoId"), ",", "."));
      ...
      protected void E16502( )
      {
         ...
         AssignProp(sPrefix, false, edtTempoRetencaoId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtTempoRetencaoId_Visible), 5, 0), true);
      ...
      protected void E11502( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("TempoRetencaoDocumentoWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV36Pgmname+"GridState"));
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("TempoRetencaoDocumentoWCFilters"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "TempoRetencaoDocumentoWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "TempoRetencaoDocumentoWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "TempoRetencaoId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8TempoRetencaoId), 8, 0);
      ...
      protected void wb_table1_24_502( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table2_29_502( true) ;
         }
         else
         {
            wb_table2_29_502( false) ;
         }
         return  ;
      }

      protected void wb_table2_29_502e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table2_29_502( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8TempoRetencaoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8TempoRetencaoId", StringUtil.LTrimStr( (decimal)(AV8TempoRetencaoId), 8, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8TempoRetencaoId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "temporetencaodocumentowc", GetJustCreated( ));
         ...
         {
            AV8TempoRetencaoId = Convert.ToInt32(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8TempoRetencaoId", StringUtil.LTrimStr( (decimal)(AV8TempoRetencaoId), 8, 0));
         }
         wcpOAV8TempoRetencaoId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8TempoRetencaoId"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( AV8TempoRetencaoId != wcpOAV8TempoRetencaoId ) ) )
         {
            setjustcreated();
         }
         wcpOAV8TempoRetencaoId = AV8TempoRetencaoId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8TempoRetencaoId = cgiGet( sPrefix+"AV8TempoRetencaoId_CTRL");
         if ( StringUtil.Len( sCtrlAV8TempoRetencaoId) > 0 )
         {
            AV8TempoRetencaoId = (int)(context.localUtil.CToN( cgiGet( sCtrlAV8TempoRetencaoId), ",", "."));
            AssignAttri(sPrefix, false, "AV8TempoRetencaoId", StringUtil.LTrimStr( (decimal)(AV8TempoRetencaoId), 8, 0));
         }
         else
         {
            AV8TempoRetencaoId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"AV8TempoRetencaoId_PARM"), ",", "."));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8TempoRetencaoId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8TempoRetencaoId), 8, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8TempoRetencaoId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8TempoRetencaoId_CTRL", StringUtil.RTrim( sCtrlAV8TempoRetencaoId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202312417261393", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("temporetencaodocumentowc.js", "?202312417261393", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void StartGridControl39( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Id da Abrangência Geográgica") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E18502',iparms:[{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A75DocumentoId',fld:'DOCUMENTOID',pic:'ZZZZZZZ9',hsh:true},{av:'AV33Aba',fld:'vABA',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         scmdbuf = "";
         H00502_A48TempoRetencaoId = new int[1] ;
         H00502_n48TempoRetencaoId = new bool[] {false} ;
         H00502_A105DocumentoOperador = new bool[] {false} ;
         H00502_n105DocumentoOperador = new bool[] {false} ;
         H00502_A85DocumentoAtivo = new bool[] {false} ;
         H00502_n85DocumentoAtivo = new bool[] {false} ;
         H00502_A84DocumentoFluxoTratDadosDesc = new string[] {""} ;
         H00502_n84DocumentoFluxoTratDadosDesc = new bool[] {false} ;
         H00502_A83DocumentoMedidaSegurancaDesc = new string[] {""} ;
         H00502_n83DocumentoMedidaSegurancaDesc = new bool[] {false} ;
         H00502_A82DocumentoDadosGrupoVul = new bool[] {false} ;
         H00502_n82DocumentoDadosGrupoVul = new bool[] {false} ;
         H00502_A81DocumentoDadosCriancaAdolesc = new bool[] {false} ;
         H00502_n81DocumentoDadosCriancaAdolesc = new bool[] {false} ;
         H00502_A80DocumentoBaseLegalNormIntExt = new string[] {""} ;
         H00502_n80DocumentoBaseLegalNormIntExt = new bool[] {false} ;
         H00502_A79DocumentoBaseLegalNorm = new string[] {""} ;
         H00502_n79DocumentoBaseLegalNorm = new bool[] {false} ;
         H00502_A78DocumentoPrevColetaDados = new bool[] {false} ;
         H00502_n78DocumentoPrevColetaDados = new bool[] {false} ;
         H00502_A45TipoDescarteId = new int[1] ;
         H00502_n45TipoDescarteId = new bool[] {false} ;
         H00502_A39FrequenciaTratamentoId = new int[1] ;
         H00502_n39FrequenciaTratamentoId = new bool[] {false} ;
         H00502_A36AbrangenciaGeograficaId = new int[1] ;
         H00502_n36AbrangenciaGeograficaId = new bool[] {false} ;
         H00502_A33FerramentaColetaId = new int[1] ;
         H00502_n33FerramentaColetaId = new bool[] {false} ;
         H00502_A30TipoDadoId = new int[1] ;
         H00502_n30TipoDadoId = new bool[] {false} ;
         H00502_A27CategoriaId = new int[1] ;
         H00502_n27CategoriaId = new bool[] {false} ;
         H00502_A77DocumentoFinalidadeTratamento = new string[] {""} ;
         H00502_n77DocumentoFinalidadeTratamento = new bool[] {false} ;
         H00502_A13PersonaId = new int[1] ;
         H00502_n13PersonaId = new bool[] {false} ;
         H00502_A7EncarregadoId = new int[1] ;
         H00502_n7EncarregadoId = new bool[] {false} ;
         H00502_A20SubprocessoId = new int[1] ;
         H00502_n20SubprocessoId = new bool[] {false} ;
         H00502_A76DocumentoNome = new string[] {""} ;
         H00502_n76DocumentoNome = new bool[] {false} ;
         H00502_A75DocumentoId = new int[1] ;
         ...
         sCtrlAV8TempoRetencaoId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         GXCCtl = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.temporetencaodocumentowc__default(),
            new Object[][] {
                new Object[] {
               H00502_A48TempoRetencaoId, H00502_n48TempoRetencaoId, H00502_A105DocumentoOperador, H00502_n105DocumentoOperador, H00502_A85DocumentoAtivo, H00502_n85DocumentoAtivo, H00502_A84DocumentoFluxoTratDadosDesc, H00502_n84DocumentoFluxoTratDadosDesc, H00502_A83DocumentoMedidaSegurancaDesc, H00502_n83DocumentoMedidaSegurancaDesc,
               H00502_A82DocumentoDadosGrupoVul, H00502_n82DocumentoDadosGrupoVul, H00502_A81DocumentoDadosCriancaAdolesc, H00502_n81DocumentoDadosCriancaAdolesc, H00502_A80DocumentoBaseLegalNormIntExt, H00502_n80DocumentoBaseLegalNormIntExt, H00502_A79DocumentoBaseLegalNorm, H00502_n79DocumentoBaseLegalNorm, H00502_A78DocumentoPrevColetaDados, H00502_n78DocumentoPrevColetaDados,
               H00502_A45TipoDescarteId, H00502_n45TipoDescarteId, H00502_A39FrequenciaTratamentoId, H00502_n39FrequenciaTratamentoId, H00502_A36AbrangenciaGeograficaId, H00502_n36AbrangenciaGeograficaId, H00502_A33FerramentaColetaId, H00502_n33FerramentaColetaId, H00502_A30TipoDadoId, H00502_n30TipoDadoId,
               H00502_A27CategoriaId, H00502_n27CategoriaId, H00502_A77DocumentoFinalidadeTratamento, H00502_n77DocumentoFinalidadeTratamento, H00502_A13PersonaId, H00502_n13PersonaId, H00502_A7EncarregadoId, H00502_n7EncarregadoId, H00502_A20SubprocessoId, H00502_n20SubprocessoId,
               H00502_A76DocumentoNome, H00502_n76DocumentoNome, H00502_A75DocumentoId
               }
               , new Object[] {
      ...
      private int AV8TempoRetencaoId ;
      private int wcpOAV8TempoRetencaoId ;
      ...
      private string sCtrlAV8TempoRetencaoId ;
      ...
      private int[] H00502_A48TempoRetencaoId ;
      private bool[] H00502_n48TempoRetencaoId ;
      private bool[] H00502_A105DocumentoOperador ;
      private bool[] H00502_n105DocumentoOperador ;
      private bool[] H00502_A85DocumentoAtivo ;
      private bool[] H00502_n85DocumentoAtivo ;
      private string[] H00502_A84DocumentoFluxoTratDadosDesc ;
      private bool[] H00502_n84DocumentoFluxoTratDadosDesc ;
      private string[] H00502_A83DocumentoMedidaSegurancaDesc ;
      private bool[] H00502_n83DocumentoMedidaSegurancaDesc ;
      private bool[] H00502_A82DocumentoDadosGrupoVul ;
      private bool[] H00502_n82DocumentoDadosGrupoVul ;
      private bool[] H00502_A81DocumentoDadosCriancaAdolesc ;
      private bool[] H00502_n81DocumentoDadosCriancaAdolesc ;
      private string[] H00502_A80DocumentoBaseLegalNormIntExt ;
      private bool[] H00502_n80DocumentoBaseLegalNormIntExt ;
      private string[] H00502_A79DocumentoBaseLegalNorm ;
      private bool[] H00502_n79DocumentoBaseLegalNorm ;
      private bool[] H00502_A78DocumentoPrevColetaDados ;
      private bool[] H00502_n78DocumentoPrevColetaDados ;
      private int[] H00502_A45TipoDescarteId ;
      private bool[] H00502_n45TipoDescarteId ;
      private int[] H00502_A39FrequenciaTratamentoId ;
      private bool[] H00502_n39FrequenciaTratamentoId ;
      private int[] H00502_A36AbrangenciaGeograficaId ;
      private bool[] H00502_n36AbrangenciaGeograficaId ;
      private int[] H00502_A33FerramentaColetaId ;
      private bool[] H00502_n33FerramentaColetaId ;
      private int[] H00502_A30TipoDadoId ;
      private bool[] H00502_n30TipoDadoId ;
      private int[] H00502_A27CategoriaId ;
      private bool[] H00502_n27CategoriaId ;
      private string[] H00502_A77DocumentoFinalidadeTratamento ;
      private bool[] H00502_n77DocumentoFinalidadeTratamento ;
      private int[] H00502_A13PersonaId ;
      private bool[] H00502_n13PersonaId ;
      private int[] H00502_A7EncarregadoId ;
      private bool[] H00502_n7EncarregadoId ;
      private int[] H00502_A20SubprocessoId ;
      private bool[] H00502_n20SubprocessoId ;
      private string[] H00502_A76DocumentoNome ;
      private bool[] H00502_n76DocumentoNome ;
      private int[] H00502_A75DocumentoId ;
   ...
   public class temporetencaodocumentowc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int A48TempoRetencaoId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [TempoRetencaoId], [DocumentoOperador], [DocumentoAtivo], [DocumentoFluxoTratDadosDesc], [DocumentoMedidaSegurancaDesc], [DocumentoDadosGrupoVul], [DocumentoDadosCriancaAdolesc], [DocumentoBaseLegalNormIntExt], [DocumentoBaseLegalNorm], [DocumentoPrevColetaDados], [TipoDescarteId], [FrequenciaTratamentoId], [AbrangenciaGeograficaId], [FerramentaColetaId], [TipoDadoId], [CategoriaId], [DocumentoFinalidadeTratamento], [PersonaId], [EncarregadoId], [SubprocessoId], [DocumentoNome], [DocumentoId]";
         sFromString = " FROM [Documento]";
         sOrderString = "";
         AddWhere(sWhereString, "([TempoRetencaoId] = @AV8TempoRetencaoId)");
         if ( ( AV14OrderedBy == 1 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [TempoRetencaoId], [DocumentoNome]";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TempoRetencaoId] DESC, [DocumentoNome] DESC";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [TempoRetencaoId], [DocumentoId]";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TempoRetencaoId] DESC, [DocumentoId] DESC";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [TempoRetencaoId], [SubprocessoId]";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TempoRetencaoId] DESC, [SubprocessoId] DESC";
         }
         ...
         {
            sOrderString += " ORDER BY [TempoRetencaoId] DESC";
         }
         else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [TempoRetencaoId], [EncarregadoId]";
         }
         else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TempoRetencaoId] DESC, [EncarregadoId] DESC";
         }
         else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [TempoRetencaoId], [PersonaId]";
         }
         else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TempoRetencaoId] DESC, [PersonaId] DESC";
         }
         else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [TempoRetencaoId], [DocumentoFinalidadeTratamento]";
         }
         else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TempoRetencaoId] DESC, [DocumentoFinalidadeTratamento] DESC";
         }
         else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [TempoRetencaoId], [CategoriaId]";
         }
         else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TempoRetencaoId] DESC, [CategoriaId] DESC";
         }
         else if ( ( AV14OrderedBy == 9 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [TempoRetencaoId], [TipoDadoId]";
         }
         else if ( ( AV14OrderedBy == 9 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TempoRetencaoId] DESC, [TipoDadoId] DESC";
         }
         else if ( ( AV14OrderedBy == 10 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [TempoRetencaoId], [FerramentaColetaId]";
         }
         else if ( ( AV14OrderedBy == 10 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TempoRetencaoId] DESC, [FerramentaColetaId] DESC";
         }
         else if ( ( AV14OrderedBy == 11 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [TempoRetencaoId], [AbrangenciaGeograficaId]";
         }
         else if ( ( AV14OrderedBy == 11 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TempoRetencaoId] DESC, [AbrangenciaGeograficaId] DESC";
         }
         else if ( ( AV14OrderedBy == 12 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [TempoRetencaoId], [FrequenciaTratamentoId]";
         }
         else if ( ( AV14OrderedBy == 12 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TempoRetencaoId] DESC, [FrequenciaTratamentoId] DESC";
         }
         else if ( ( AV14OrderedBy == 13 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [TempoRetencaoId], [TipoDescarteId]";
         }
         else if ( ( AV14OrderedBy == 13 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TempoRetencaoId] DESC, [TipoDescarteId] DESC";
         }
         else if ( ( AV14OrderedBy == 14 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [TempoRetencaoId], [DocumentoPrevColetaDados]";
         }
         else if ( ( AV14OrderedBy == 14 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TempoRetencaoId] DESC, [DocumentoPrevColetaDados] DESC";
         }
         else if ( ( AV14OrderedBy == 15 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [TempoRetencaoId], [DocumentoBaseLegalNorm]";
         }
         else if ( ( AV14OrderedBy == 15 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TempoRetencaoId] DESC, [DocumentoBaseLegalNorm] DESC";
         }
         else if ( ( AV14OrderedBy == 16 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [TempoRetencaoId], [DocumentoBaseLegalNormIntExt]";
         }
         else if ( ( AV14OrderedBy == 16 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TempoRetencaoId] DESC, [DocumentoBaseLegalNormIntExt] DESC";
         }
         else if ( ( AV14OrderedBy == 17 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [TempoRetencaoId], [DocumentoDadosCriancaAdolesc]";
         }
         else if ( ( AV14OrderedBy == 17 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TempoRetencaoId] DESC, [DocumentoDadosCriancaAdolesc] DESC";
         }
         else if ( ( AV14OrderedBy == 18 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [TempoRetencaoId], [DocumentoDadosGrupoVul]";
         }
         else if ( ( AV14OrderedBy == 18 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TempoRetencaoId] DESC, [DocumentoDadosGrupoVul] DESC";
         }
         ...
         {
            sOrderString += " ORDER BY [TempoRetencaoId], [DocumentoMedidaSegurancaDesc]";
         }
         else if ( ( AV14OrderedBy == 20 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TempoRetencaoId] DESC, [DocumentoMedidaSegurancaDesc] DESC";
         }
         else if ( ( AV14OrderedBy == 21 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [TempoRetencaoId], [DocumentoFluxoTratDadosDesc]";
         }
         else if ( ( AV14OrderedBy == 21 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TempoRetencaoId] DESC, [DocumentoFluxoTratDadosDesc] DESC";
         }
         else if ( ( AV14OrderedBy == 22 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [TempoRetencaoId], [DocumentoAtivo]";
         }
         else if ( ( AV14OrderedBy == 22 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TempoRetencaoId] DESC, [DocumentoAtivo] DESC";
         }
         else if ( ( AV14OrderedBy == 23 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [TempoRetencaoId], [DocumentoOperador]";
         }
         else if ( ( AV14OrderedBy == 23 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TempoRetencaoId] DESC, [DocumentoOperador] DESC";
         }
         else if ( true )
         {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00502(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (int)dynConstraints[2] , (int)dynConstraints[3] );
               case 1 :
                     return conditional_H00503(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (int)dynConstraints[2] , (int)dynConstraints[3] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV8TempoRetencaoId",GXType.Int32,8,0) ,

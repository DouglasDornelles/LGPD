...
namespace GeneXus.Programs {
   public class subprocessoview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public subprocessoview( )
      {
      ...
      public subprocessoview( IGxContext context )
      {
      ...
      public void execute( int aP0_SubprocessoId ,
                           string aP1_TabCode )
      {
         this.AV10SubprocessoId = aP0_SubprocessoId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "SubprocessoId");
      ...
      {
         get {
            return "subprocessoview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "subprocessoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10SubprocessoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("subprocessoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vSUBPROCESSOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10SubprocessoId), "ZZZZZZZ9"), context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vSUBPROCESSOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10SubprocessoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vSUBPROCESSOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10SubprocessoId), "ZZZZZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "subprocessoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10SubprocessoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("subprocessoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "SubProcessoView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Sub Processo View" ;
      }
      ...
      protected void WB720( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Sub Processo", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_SubProcessoView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divSubprocessogeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
      ...
      protected void START722( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Sub Processo View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA722( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "subprocessoview.aspx")), "subprocessoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "subprocessoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10SubprocessoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10SubprocessoId", StringUtil.LTrimStr( (decimal)(AV10SubprocessoId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vSUBPROCESSOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10SubprocessoId), "ZZZZZZZ9"), context));
      ...
      protected void E11722( )
      {
         ...
         lblWorkwithlink_Link = formatLink("subprocessoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H00722 */
         pr_default.execute(0, new Object[] {AV10SubprocessoId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A20SubprocessoId = H00722_A20SubprocessoId[0];
            A21SubprocessoNome = H00722_A21SubprocessoNome[0];
            AV16GXLvl9 = 1;
            Form.Caption = A21SubprocessoNome;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "SubProcessoGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "subprocessogeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "SubProcessoGeneral";
            WebComp_Webcomponent_general_Component = "SubProcessoGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10SubprocessoId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10SubprocessoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10SubprocessoId", StringUtil.LTrimStr( (decimal)(AV10SubprocessoId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vSUBPROCESSOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10SubprocessoId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910512191", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("subprocessoview.js", "?202311910512191", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divSubprocessogeneral_cell_Internalname = "SUBPROCESSOGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Sub Processo View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10SubprocessoId',fld:'vSUBPROCESSOID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00722_A20SubprocessoId = new int[1] ;
         H00722_A21SubprocessoNome = new string[] {""} ;
         A21SubprocessoNome = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.subprocessoview__default(),
            new Object[][] {
                new Object[] {
               H00722_A20SubprocessoId, H00722_A21SubprocessoNome
               }
            }
         );
      ...
      private int AV10SubprocessoId ;
      private int wcpOAV10SubprocessoId ;
      ...
      private string divSubprocessogeneral_cell_Internalname ;
      ...
      private int[] H00722_A20SubprocessoId ;
      private string[] H00722_A21SubprocessoNome ;
   ...
   public class subprocessoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10SubprocessoId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H00722", "SELECT [SubprocessoId], [SubprocessoNome] FROM [SubProcesso] WHERE [SubprocessoId] = @AV10SubprocessoId ORDER BY [SubprocessoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00722,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

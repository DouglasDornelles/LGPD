...
namespace GeneXus.Programs {
   public class arearesponsavelview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public arearesponsavelview( )
      {
      ...
      public arearesponsavelview( IGxContext context )
      {
      ...
      public void execute( int aP0_AreaResponsavelId ,
                           string aP1_TabCode )
      {
         this.AV10AreaResponsavelId = aP0_AreaResponsavelId;
      ...
      {
         get {
            return "arearesponsavelview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "arearesponsavelview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10AreaResponsavelId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("arearesponsavelview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vAREARESPONSAVELID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10AreaResponsavelId), "ZZZZZZZ9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vAREARESPONSAVELID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10AreaResponsavelId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vAREARESPONSAVELID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10AreaResponsavelId), "ZZZZZZZ9"), context));
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Subprocessowc == null ) )
         {
            WebComp_Subprocessowc.componentjscripts();
         }
      }
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "arearesponsavelview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10AreaResponsavelId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("arearesponsavelview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "AreaResponsavelView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Area Responsavel View" ;
      }
      ...
      protected void WB7R0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Area Responsavel", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_AreaResponsavelView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divArearesponsavelgeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSubprocesso_title_Internalname, "Sub Processo", "", "", lblSubprocesso_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_AreaResponsavelView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            context.WriteHtmlText( "SubProcesso") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel1"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtablesubprocesso_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0033"+"", StringUtil.RTrim( WebComp_Subprocessowc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0033"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Subprocessowc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldSubprocessowc), StringUtil.Lower( WebComp_Subprocessowc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0033"+"");
                  }
                  WebComp_Subprocessowc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldSubprocessowc), StringUtil.Lower( WebComp_Subprocessowc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
      ...
      protected void START7R2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Area Responsavel View", 0) ;
         }
         context.wjLoc = "";
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldSubprocessowc = cgiGet( "W0033");
                           if ( ( StringUtil.Len( OldSubprocessowc) == 0 ) || ( StringUtil.StrCmp(OldSubprocessowc, WebComp_Subprocessowc_Component) != 0 ) )
                           {
                              WebComp_Subprocessowc = getWebComponent(GetType(), "GeneXus.Programs", OldSubprocessowc, new Object[] {context} );
                              WebComp_Subprocessowc.ComponentInit();
                              WebComp_Subprocessowc.Name = "OldSubprocessowc";
                              WebComp_Subprocessowc_Component = OldSubprocessowc;
                           }
                           if ( StringUtil.Len( WebComp_Subprocessowc_Component) != 0 )
                           {
                              WebComp_Subprocessowc.componentprocess("W0033", "", sEvt);
                           }
                           WebComp_Subprocessowc_Component = OldSubprocessowc;
                        }
                     }
      ...
      protected void PA7R2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "arearesponsavelview.aspx")), "arearesponsavelview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "arearesponsavelview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10AreaResponsavelId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10AreaResponsavelId", StringUtil.LTrimStr( (decimal)(AV10AreaResponsavelId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vAREARESPONSAVELID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10AreaResponsavelId), "ZZZZZZZ9"), context));
      ...
      protected void RF7R2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Subprocessowc_Component) != 0 )
               {
                  WebComp_Subprocessowc.componentstart();
               }
            }
         }
      ...
      protected void E127R2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("arearesponsavelww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H007R2 */
         pr_default.execute(0, new Object[] {AV10AreaResponsavelId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A24AreaResponsavelId = H007R2_A24AreaResponsavelId[0];
            A25AreaResponsavelNome = H007R2_A25AreaResponsavelNome[0];
            AV16GXLvl9 = 1;
            Form.Caption = A25AreaResponsavelNome;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "AreaResponsavelGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "arearesponsavelgeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "AreaResponsavelGeneral";
            WebComp_Webcomponent_general_Component = "AreaResponsavelGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10AreaResponsavelId});
      ...
      protected void S122( )
      {
         /* 'LOADTABS' Routine */
         returnInSub = false;
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "SubProcesso") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Subprocessowc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Subprocessowc_Component), StringUtil.Lower( "AreaResponsavelSubProcessoWC")) != 0 )
            {
               WebComp_Subprocessowc = getWebComponent(GetType(), "GeneXus.Programs", "arearesponsavelsubprocessowc", new Object[] {context} );
               WebComp_Subprocessowc.ComponentInit();
               WebComp_Subprocessowc.Name = "AreaResponsavelSubProcessoWC";
               WebComp_Subprocessowc_Component = "AreaResponsavelSubProcessoWC";
            }
            if ( StringUtil.Len( WebComp_Subprocessowc_Component) != 0 )
            {
               WebComp_Subprocessowc.setjustcreated();
               WebComp_Subprocessowc.componentprepare(new Object[] {(string)"W0033",(string)"",(int)AV10AreaResponsavelId});
               WebComp_Subprocessowc.componentbind(new Object[] {(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Subprocessowc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0033"+"");
               WebComp_Subprocessowc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10AreaResponsavelId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10AreaResponsavelId", StringUtil.LTrimStr( (decimal)(AV10AreaResponsavelId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vAREARESPONSAVELID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10AreaResponsavelId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Subprocessowc == null ) )
         {
            if ( StringUtil.Len( WebComp_Subprocessowc_Component) != 0 )
            {
               WebComp_Subprocessowc.componentthemes();
            }
         }
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910512293", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("arearesponsavelview.js", "?202311910512293", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divArearesponsavelgeneral_cell_Internalname = "AREARESPONSAVELGENERAL_CELL";
         lblSubprocesso_title_Internalname = "SUBPROCESSO_TITLE";
         divUnnamedtablesubprocesso_Internalname = "UNNAMEDTABLESUBPROCESSO";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Area Responsavel View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10AreaResponsavelId',fld:'vAREARESPONSAVELID',pic:'ZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E117R2',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10AreaResponsavelId',fld:'vAREARESPONSAVELID',pic:'ZZZZZZZ9',hsh:true}]");
         setEventMetadata("TABS.TABCHANGED",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{ctrl:'SUBPROCESSOWC'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         lblSubprocesso_title_Jsonclick = "";
         WebComp_Subprocessowc_Component = "";
         OldSubprocessowc = "";
         sEvt = "";
         EvtGridId = "";
         EvtRowId = "";
         ...
         scmdbuf = "";
         H007R2_A24AreaResponsavelId = new int[1] ;
         H007R2_A25AreaResponsavelNome = new string[] {""} ;
         A25AreaResponsavelNome = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.arearesponsavelview__default(),
            new Object[][] {
                new Object[] {
               H007R2_A24AreaResponsavelId, H007R2_A25AreaResponsavelNome
               }
            }
         );
         WebComp_Webcomponent_general = new GeneXus.Http.GXNullWebComponent();
         WebComp_Subprocessowc = new GeneXus.Http.GXNullWebComponent();
         /* GeneXus formulas. */
         context.Gx_err = 0;
      }
      ...
      private int AV10AreaResponsavelId ;
      private int wcpOAV10AreaResponsavelId ;
      ...
      private string divArearesponsavelgeneral_cell_Internalname ;
      ...
      private string lblSubprocesso_title_Internalname ;
      private string lblSubprocesso_title_Jsonclick ;
      private string divUnnamedtablesubprocesso_Internalname ;
      private string WebComp_Subprocessowc_Component ;
      private string OldSubprocessowc ;
      private string sEvt ;
   ...
   public class arearesponsavelview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10AreaResponsavelId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H007R2", "SELECT [AreaResponsavelId], [AreaResponsavelNome] FROM [AreaResponsavel] WHERE [AreaResponsavelId] = @AV10AreaResponsavelId ORDER BY [AreaResponsavelId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007R2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

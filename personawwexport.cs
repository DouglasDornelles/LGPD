...
namespace GeneXus.Programs {
   ...
   public class personawwexport__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV18OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( [PersonaNome] like '%' + @lV50Personawwds_1_filterfulltext) or ( 'sim' like '%' + LOWER(@lV50Personawwds_1_filterfulltext) and [PersonaAtivo] = 1) or ( 'não' like '%' + LOWER(@lV50Personawwds_1_filterfulltext) and [PersonaAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;

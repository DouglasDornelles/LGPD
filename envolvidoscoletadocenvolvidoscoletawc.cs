...
namespace GeneXus.Programs {
   public class envolvidoscoletadocenvolvidoscoletawc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public envolvidoscoletadocenvolvidoscoletawc( )
      {
      ...
      public envolvidoscoletadocenvolvidoscoletawc( IGxContext context )
      {
      ...
      public void execute( int aP0_EnvolvidosColetaId )
      {
         this.AV8EnvolvidosColetaId = aP0_EnvolvidosColetaId;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "EnvolvidosColetaId");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8EnvolvidosColetaId = (int)(NumberUtil.Val( GetPar( "EnvolvidosColetaId"), "."));
                  AssignAttri(sPrefix, false, "AV8EnvolvidosColetaId", StringUtil.LTrimStr( (decimal)(AV8EnvolvidosColetaId), 8, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(int)AV8EnvolvidosColetaId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV15FilterFullText, AV8EnvolvidosColetaId, AV19ManageFiltersExecutionStep, AV33Pgmname, AV14OrderedDsc, AV27IsAuthorized_Update, AV29IsAuthorized_Delete, AV30IsAuthorized_Insert, A54EnvolvidosColetaId, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV33Pgmname = "EnvolvidosColetaDocEnvolvidosColetaWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Envolvidos Coleta Doc Envolvidos Coleta WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "envolvidoscoletadocenvolvidoscoletawc.aspx"+UrlEncode(StringUtil.LTrimStr(AV8EnvolvidosColetaId,8,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("envolvidoscoletadocenvolvidoscoletawc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", sPrefix+"hsh"+"EnvolvidosColetaDocEnvolvidosColetaWC");
         ...
         GXUtil.WriteLogInfo("envolvidoscoletadocenvolvidoscoletawc:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8EnvolvidosColetaId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV8EnvolvidosColetaId), 8, 0, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV30IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vENVOLVIDOSCOLETAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8EnvolvidosColetaId), 8, 0, ",", "")));
      ...
      {
         return "EnvolvidosColetaDocEnvolvidosColetaWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Envolvidos Coleta Doc Envolvidos Coleta WC" ;
      }
      ...
      protected void WB5A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "envolvidoscoletadocenvolvidoscoletawc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "Inserir", bttBtninsert_Jsonclick, 5, "Inserir", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EnvolvidosColetaDocEnvolvidosColetaWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
            wb_table1_24_5A2( true) ;
         }
         else
         {
            wb_table1_24_5A2( false) ;
         }
         return  ;
      }

      protected void wb_table1_24_5A2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         if ( wbEnd == 39 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtEnvolvidosColetaId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A54EnvolvidosColetaId), 8, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A54EnvolvidosColetaId), "ZZZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEnvolvidosColetaId_Jsonclick, 0, "Attribute", "", "", "", "", edtEnvolvidosColetaId_Visible, 0, 0, "text", "1", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "Id", "right", false, "", "HLP_EnvolvidosColetaDocEnvolvidosColetaWC.htm");
            /* User Defined Control */
      ...
      protected void START5A2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Envolvidos Coleta Doc Envolvidos Coleta WC", 0) ;
            }
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "envolvidoscoletadocenvolvidoscoletawc.aspx")), "envolvidoscoletadocenvolvidoscoletawc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "envolvidoscoletadocenvolvidoscoletawc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void RF5A2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H005A2 */
            pr_default.execute(0, new Object[] {AV8EnvolvidosColetaId, lV15FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_39_idx = 1;
            sGXsfl_39_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_39_idx), 4, 0), 4, "0");
            SubsflControlProps_392( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A54EnvolvidosColetaId = H005A2_A54EnvolvidosColetaId[0];
               AssignAttri(sPrefix, false, "A54EnvolvidosColetaId", StringUtil.LTrimStr( (decimal)(A54EnvolvidosColetaId), 8, 0));
               A75DocumentoId = H005A2_A75DocumentoId[0];
               E185A2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV15FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV15FilterFullText), "%", "");
         /* Using cursor H005A3 */
         pr_default.execute(1, new Object[] {AV8EnvolvidosColetaId, lV15FilterFullText});
      ...
      protected void STRUP5A0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8EnvolvidosColetaId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8EnvolvidosColetaId"), ",", "."));
            ...
            {
               GXUtil.WriteLogError("envolvidoscoletadocenvolvidoscoletawc:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
               context.HttpContext.Response.StatusDescription = 403.ToString();
               context.HttpContext.Response.StatusCode = 403;
               context.WriteHtmlText( "<title>403 Forbidden</title>") ;
      ...
      protected void E165A2( )
      {
         ...
         AssignProp(sPrefix, false, edtEnvolvidosColetaId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtEnvolvidosColetaId_Visible), 5, 0), true);
      ...
      protected void E115A2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("EnvolvidosColetaDocEnvolvidosColetaWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV33Pgmname+"GridState"));
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("EnvolvidosColetaDocEnvolvidosColetaWCFilters"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "EnvolvidosColetaDocEnvolvidosColetaWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
      ...
      protected void E155A2( )
      {
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "docenvolvidoscoleta.aspx"+UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode(StringUtil.LTrimStr(AV8EnvolvidosColetaId,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(0,1,0));
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "EnvolvidosColetaDocEnvolvidosColetaWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "DocEnvolvidosColeta";
         AV11TrnContextAtt = new GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute(context);
         AV11TrnContextAtt.gxTpr_Attributename = "EnvolvidosColetaId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8EnvolvidosColetaId), 8, 0);
         AV10TrnContext.gxTpr_Attributes.Add(AV11TrnContextAtt, 0);
         AV16Session.Set("TrnContext", AV10TrnContext.ToXml(false, true, "", ""));
      }

      protected void wb_table1_24_5A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table2_29_5A2( true) ;
         }
         else
         {
            wb_table2_29_5A2( false) ;
         }
         return  ;
      }

      protected void wb_table2_29_5A2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_24_5A2e( true) ;
         }
         else
         {
            wb_table1_24_5A2e( false) ;
         }
      }

      protected void wb_table2_29_5A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8EnvolvidosColetaId = Convert.ToInt32(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8EnvolvidosColetaId", StringUtil.LTrimStr( (decimal)(AV8EnvolvidosColetaId), 8, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8EnvolvidosColetaId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "envolvidoscoletadocenvolvidoscoletawc", GetJustCreated( ));
         ...
         {
            AV8EnvolvidosColetaId = Convert.ToInt32(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8EnvolvidosColetaId", StringUtil.LTrimStr( (decimal)(AV8EnvolvidosColetaId), 8, 0));
         }
         wcpOAV8EnvolvidosColetaId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8EnvolvidosColetaId"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( AV8EnvolvidosColetaId != wcpOAV8EnvolvidosColetaId ) ) )
         {
            setjustcreated();
         }
         wcpOAV8EnvolvidosColetaId = AV8EnvolvidosColetaId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8EnvolvidosColetaId = cgiGet( sPrefix+"AV8EnvolvidosColetaId_CTRL");
         if ( StringUtil.Len( sCtrlAV8EnvolvidosColetaId) > 0 )
         {
            AV8EnvolvidosColetaId = (int)(context.localUtil.CToN( cgiGet( sCtrlAV8EnvolvidosColetaId), ",", "."));
            AssignAttri(sPrefix, false, "AV8EnvolvidosColetaId", StringUtil.LTrimStr( (decimal)(AV8EnvolvidosColetaId), 8, 0));
         }
         else
         {
            AV8EnvolvidosColetaId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"AV8EnvolvidosColetaId_PARM"), ",", "."));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8EnvolvidosColetaId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8EnvolvidosColetaId), 8, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8EnvolvidosColetaId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8EnvolvidosColetaId_CTRL", StringUtil.RTrim( sCtrlAV8EnvolvidosColetaId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910462419", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("envolvidoscoletadocenvolvidoscoletawc.js", "?202311910462419", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         edtEnvolvidosColetaId_Internalname = sPrefix+"ENVOLVIDOSCOLETAID";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8EnvolvidosColetaId',fld:'vENVOLVIDOSCOLETAID',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'AV19ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A54EnvolvidosColetaId',fld:'ENVOLVIDOSCOLETAID',pic:'ZZZZZZZ9'}]");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E125A2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8EnvolvidosColetaId',fld:'vENVOLVIDOSCOLETAID',pic:'ZZZZZZZ9'},{av:'AV19ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A54EnvolvidosColetaId',fld:'ENVOLVIDOSCOLETAID',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E135A2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8EnvolvidosColetaId',fld:'vENVOLVIDOSCOLETAID',pic:'ZZZZZZZ9'},{av:'AV19ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A54EnvolvidosColetaId',fld:'ENVOLVIDOSCOLETAID',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E145A2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8EnvolvidosColetaId',fld:'vENVOLVIDOSCOLETAID',pic:'ZZZZZZZ9'},{av:'AV19ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A54EnvolvidosColetaId',fld:'ENVOLVIDOSCOLETAID',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E185A2',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A54EnvolvidosColetaId',fld:'ENVOLVIDOSCOLETAID',pic:'ZZZZZZZ9'},{av:'A75DocumentoId',fld:'DOCUMENTOID',pic:'ZZZZZZZ9',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E155A2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8EnvolvidosColetaId',fld:'vENVOLVIDOSCOLETAID',pic:'ZZZZZZZ9'},{av:'AV19ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A54EnvolvidosColetaId',fld:'ENVOLVIDOSCOLETAID',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'A75DocumentoId',fld:'DOCUMENTOID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV15FilterFullText = "";
         H005A2_A54EnvolvidosColetaId = new int[1] ;
         H005A2_A75DocumentoId = new int[1] ;
         ...
         sCtrlAV8EnvolvidosColetaId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.envolvidoscoletadocenvolvidoscoletawc__default(),
            new Object[][] {
                new Object[] {
               H005A2_A54EnvolvidosColetaId, H005A2_A75DocumentoId
               }
               , new Object[] {
      ...
      private int AV8EnvolvidosColetaId ;
      private int wcpOAV8EnvolvidosColetaId ;
      ...
      private string sCtrlAV8EnvolvidosColetaId ;
      ...
      private int[] H005A2_A54EnvolvidosColetaId ;
      private int[] H005A2_A75DocumentoId ;
   ...
   public class envolvidoscoletadocenvolvidoscoletawc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int A54EnvolvidosColetaId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [EnvolvidosColetaId], [DocumentoId]";
         sFromString = " FROM [DocEnvolvidosColeta]";
         sOrderString = "";
         AddWhere(sWhereString, "([EnvolvidosColetaId] = @AV8EnvolvidosColetaId)");
         ...
         {
            sOrderString += " ORDER BY [EnvolvidosColetaId] DESC, [DocumentoId] DESC";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY [EnvolvidosColetaId], [DocumentoId]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H005A2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (bool)dynConstraints[2] , (int)dynConstraints[3] , (int)dynConstraints[4] );
               case 1 :
                     return conditional_H005A3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (bool)dynConstraints[2] , (int)dynConstraints[3] , (int)dynConstraints[4] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV8EnvolvidosColetaId",GXType.Int32,8,0) ,

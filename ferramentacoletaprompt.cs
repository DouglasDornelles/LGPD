...
namespace GeneXus.Programs {
   public class ferramentacoletaprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public ferramentacoletaprompt( )
      {
      ...
      public ferramentacoletaprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutFerramentaColetaId ,
                           ref string aP1_InOutFerramentaColetaNome )
      {
         this.AV8InOutFerramentaColetaId = aP0_InOutFerramentaColetaId;
         this.AV9InOutFerramentaColetaNome = aP1_InOutFerramentaColetaNome;
         executePrivate();
         aP0_InOutFerramentaColetaId=this.AV8InOutFerramentaColetaId;
         aP1_InOutFerramentaColetaNome=this.AV9InOutFerramentaColetaNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutFerramentaColetaId");
            ...
            {
               AV8InOutFerramentaColetaId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutFerramentaColetaId", StringUtil.LTrimStr( (decimal)(AV8InOutFerramentaColetaId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutFerramentaColetaNome = GetPar( "InOutFerramentaColetaNome");
                  AssignAttri("", false, "AV9InOutFerramentaColetaNome", AV9InOutFerramentaColetaNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      {
         get {
            return "ferramentacoletaprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("ferramentacoletaprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutFerramentaColetaId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutFerramentaColetaNome))}, new string[] {"InOutFerramentaColetaId","InOutFerramentaColetaNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTFERRAMENTACOLETAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutFerramentaColetaId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTFERRAMENTACOLETANOME", AV9InOutFerramentaColetaNome);
      ...
      {
         return formatLink("ferramentacoletaprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutFerramentaColetaId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutFerramentaColetaNome))}, new string[] {"InOutFerramentaColetaId","InOutFerramentaColetaNome"})  ;
      }

      public override string GetPgmname( )
      {
         return "FerramentaColetaPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Ferramenta Coleta" ;
      }
      ...
      protected void WB490( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_492( true) ;
         }
         else
         {
            wb_table1_14_492( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_492e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START492( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Ferramenta Coleta", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_FERRAMENTACOLETANOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A34FerramentaColetaNome, "")), context));
         GxWebStd.gx_hidden_field( context, "FERRAMENTACOLETANOME", A34FerramentaColetaNome);
      }
      ...
      {
         /* GeneXus formulas. */
         AV22Pgmname = "FerramentaColetaPrompt";
         context.Gx_err = 0;
      ...
      protected void RF492( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A35FerramentaColetaAtivo = H00492_A35FerramentaColetaAtivo[0];
               A34FerramentaColetaNome = H00492_A34FerramentaColetaNome[0];
               A33FerramentaColetaId = H00492_A33FerramentaColetaId[0];
               E17492 ();
      ...
      protected void send_integrity_lvl_hashes492( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_FERRAMENTACOLETAID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A33FerramentaColetaId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_FERRAMENTACOLETANOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A34FerramentaColetaNome, "")), context));
      }
      ...
      protected void E15492( )
      {
         ...
         Form.Caption = "Consulta de Ferramenta Coleta";
      ...
      protected void E18492( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutFerramentaColetaId = A33FerramentaColetaId;
         AssignAttri("", false, "AV8InOutFerramentaColetaId", StringUtil.LTrimStr( (decimal)(AV8InOutFerramentaColetaId), 8, 0));
         AV9InOutFerramentaColetaNome = A34FerramentaColetaNome;
         AssignAttri("", false, "AV9InOutFerramentaColetaNome", AV9InOutFerramentaColetaNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutFerramentaColetaId,(string)AV9InOutFerramentaColetaNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutFerramentaColetaId","AV9InOutFerramentaColetaNome"});
      ...
      protected void wb_table1_14_492( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_FerramentaColetaPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutFerramentaColetaId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutFerramentaColetaId", StringUtil.LTrimStr( (decimal)(AV8InOutFerramentaColetaId), 8, 0));
         AV9InOutFerramentaColetaNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutFerramentaColetaNome", AV9InOutFerramentaColetaNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910502468", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("ferramentacoletaprompt.js", "?202311910502469", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtFerramentaColetaId_Internalname = "FERRAMENTACOLETAID_"+sGXsfl_26_idx;
         edtFerramentaColetaNome_Internalname = "FERRAMENTACOLETANOME_"+sGXsfl_26_idx;
         cmbFerramentaColetaAtivo_Internalname = "FERRAMENTACOLETAATIVO_"+sGXsfl_26_idx;
      }

      protected void SubsflControlProps_fel_262( )
      {
         edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx;
         edtFerramentaColetaId_Internalname = "FERRAMENTACOLETAID_"+sGXsfl_26_fel_idx;
         edtFerramentaColetaNome_Internalname = "FERRAMENTACOLETANOME_"+sGXsfl_26_fel_idx;
         cmbFerramentaColetaAtivo_Internalname = "FERRAMENTACOLETAATIVO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "FERRAMENTACOLETAATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbFerramentaColetaAtivo_Internalname, "Values", (string)(cmbFerramentaColetaAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:FerramentaColetaId|2:FerramentaColetaNome|3:FerramentaColetaAtivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E17492',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E18492',iparms:[{av:'A33FerramentaColetaId',fld:'FERRAMENTACOLETAID',pic:'ZZZZZZZ9',hsh:true},{av:'A34FerramentaColetaNome',fld:'FERRAMENTACOLETANOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutFerramentaColetaId',fld:'vINOUTFERRAMENTACOLETAID',pic:'ZZZZZZZ9'},{av:'AV9InOutFerramentaColetaNome',fld:'vINOUTFERRAMENTACOLETANOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E14492',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      {
         wcpOAV9InOutFerramentaColetaNome = "";
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H00492_A35FerramentaColetaAtivo = new bool[] {false} ;
         H00492_A34FerramentaColetaNome = new string[] {""} ;
         H00492_A33FerramentaColetaId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.ferramentacoletaprompt__default(),
            new Object[][] {
                new Object[] {
               H00492_A35FerramentaColetaAtivo, H00492_A34FerramentaColetaNome, H00492_A33FerramentaColetaId
               }
               , new Object[] {
      ...
      private int AV8InOutFerramentaColetaId ;
      private int wcpOAV8InOutFerramentaColetaId ;
      ...
      private string AV9InOutFerramentaColetaNome ;
      private string wcpOAV9InOutFerramentaColetaNome ;
      ...
      private int aP0_InOutFerramentaColetaId ;
      private string aP1_InOutFerramentaColetaNome ;
      private GXCombobox cmbFerramentaColetaAtivo ;
      private IDataStoreProvider pr_default ;
      private bool[] H00492_A35FerramentaColetaAtivo ;
      private string[] H00492_A34FerramentaColetaNome ;
      private int[] H00492_A33FerramentaColetaId ;
   ...
   public class ferramentacoletaprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([FerramentaColetaId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [FerramentaColetaNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and [FerramentaColetaAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and [FerramentaColetaAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00492(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
               case 1 :
                     return conditional_H00493(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("H00493", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00493,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }

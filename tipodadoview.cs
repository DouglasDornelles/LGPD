...
namespace GeneXus.Programs {
   public class tipodadoview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public tipodadoview( )
      {
      ...
      public tipodadoview( IGxContext context )
      {
      ...
      public void execute( int aP0_TipoDadoId ,
                           string aP1_TabCode )
      {
         this.AV10TipoDadoId = aP0_TipoDadoId;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "tipodadoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10TipoDadoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("tipodadoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vTIPODADOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10TipoDadoId), "ZZZZZZZ9"), context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vTIPODADOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10TipoDadoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vTIPODADOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10TipoDadoId), "ZZZZZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "tipodadoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10TipoDadoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("tipodadoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      protected void WB420( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Tipo Dado", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_TipoDadoView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTipodadogeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
      ...
      protected void START422( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Tipo Dado View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA422( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "tipodadoview.aspx")), "tipodadoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "tipodadoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10TipoDadoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10TipoDadoId", StringUtil.LTrimStr( (decimal)(AV10TipoDadoId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vTIPODADOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10TipoDadoId), "ZZZZZZZ9"), context));
      ...
      protected void E11422( )
      {
         ...
         lblWorkwithlink_Link = formatLink("tipodadoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H00422 */
         pr_default.execute(0, new Object[] {AV10TipoDadoId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A30TipoDadoId = H00422_A30TipoDadoId[0];
            A31TipoDadoNome = H00422_A31TipoDadoNome[0];
            AV16GXLvl9 = 1;
            Form.Caption = A31TipoDadoNome;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "TipoDadoGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "tipodadogeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "TipoDadoGeneral";
            WebComp_Webcomponent_general_Component = "TipoDadoGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10TipoDadoId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10TipoDadoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10TipoDadoId", StringUtil.LTrimStr( (decimal)(AV10TipoDadoId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vTIPODADOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10TipoDadoId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910502358", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("tipodadoview.js", "?202311910502359", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTipodadogeneral_cell_Internalname = "TIPODADOGENERAL_CELL";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10TipoDadoId',fld:'vTIPODADOID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00422_A30TipoDadoId = new int[1] ;
         H00422_A31TipoDadoNome = new string[] {""} ;
         A31TipoDadoNome = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tipodadoview__default(),
            new Object[][] {
                new Object[] {
               H00422_A30TipoDadoId, H00422_A31TipoDadoNome
               }
            }
         );
      ...
      private int AV10TipoDadoId ;
      private int wcpOAV10TipoDadoId ;
      ...
      private string divTipodadogeneral_cell_Internalname ;
      ...
      private int[] H00422_A30TipoDadoId ;
      private string[] H00422_A31TipoDadoNome ;
   ...
   public class tipodadoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10TipoDadoId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H00422", "SELECT [TipoDadoId], [TipoDadoNome] FROM [TipoDado] WHERE [TipoDadoId] = @AV10TipoDadoId ORDER BY [TipoDadoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00422,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

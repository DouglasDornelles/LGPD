...
namespace GeneXus.Programs {
   public class docanexogeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public docanexogeneral( )
      {
      ...
      public docanexogeneral( IGxContext context )
      {
      ...
      {
         this.A93DocAnexoId = aP0_DocAnexoId;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(int)A93DocAnexoId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Doc Anexo General") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "docanexogeneral.aspx"+UrlEncode(StringUtil.LTrimStr(A93DocAnexoId,8,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("docanexogeneral.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA93DocAnexoId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOA93DocAnexoId), 8, 0, ",", "")));
      ...
      {
         return "DocAnexoGeneral" ;
      }

      public override string GetPgmdesc( )
      {
         return "Doc Anexo General" ;
      }
      ...
      protected void WB6E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "docanexogeneral.aspx");
            }
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtDocAnexoDescricao_Internalname, A94DocAnexoDescricao, StringUtil.RTrim( context.localUtil.Format( A94DocAnexoDescricao, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtDocAnexoDescricao_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtDocAnexoDescricao_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "left", true, "", "HLP_DocAnexoGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            ClassString = "AttributeFL";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtDocAnexoArquivo_Internalname, A95DocAnexoArquivo, "", "", 0, 1, edtDocAnexoArquivo_Enabled, 0, 80, "chr", 3, "row", 0, StyleString, ClassString, "", "", "200", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_DocAnexoGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtDocAnexoDataInclusao_Internalname, context.localUtil.Format(A96DocAnexoDataInclusao, "99/99/99"), context.localUtil.Format( A96DocAnexoDataInclusao, "99/99/99"), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtDocAnexoDataInclusao_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtDocAnexoDataInclusao_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "right", false, "", "HLP_DocAnexoGeneral.htm");
            GxWebStd.gx_bitmap( context, edtDocAnexoDataInclusao_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtDocAnexoDataInclusao_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_DocAnexoGeneral.htm");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Modifica", bttBtnupdate_Jsonclick, 5, "Modifica", "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOUPDATE\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_DocAnexoGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Eliminar", bttBtndelete_Jsonclick, 5, "Eliminar", "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DODELETE\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_DocAnexoGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START6E2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Doc Anexo General", 0) ;
            }
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "docanexogeneral.aspx")), "docanexogeneral.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "docanexogeneral.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void RF6E2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A75DocumentoId = H006E2_A75DocumentoId[0];
               A96DocAnexoDataInclusao = H006E2_A96DocAnexoDataInclusao[0];
               AssignAttri(sPrefix, false, "A96DocAnexoDataInclusao", context.localUtil.Format(A96DocAnexoDataInclusao, "99/99/99"));
               A95DocAnexoArquivo = H006E2_A95DocAnexoArquivo[0];
               AssignAttri(sPrefix, false, "A95DocAnexoArquivo", A95DocAnexoArquivo);
               A94DocAnexoDescricao = H006E2_A94DocAnexoDescricao[0];
               AssignAttri(sPrefix, false, "A94DocAnexoDescricao", A94DocAnexoDescricao);
               A76DocumentoNome = H006E2_A76DocumentoNome[0];
               n76DocumentoNome = H006E2_n76DocumentoNome[0];
      ...
      protected void STRUP6E0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA93DocAnexoId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA93DocAnexoId"), ",", "."));
      ...
      protected void S112( )
      {
         ...
         AV8TrnContext.gxTpr_Transactionname = "DocAnexo";
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A93DocAnexoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri(sPrefix, false, "A93DocAnexoId", StringUtil.LTrimStr( (decimal)(A93DocAnexoId), 8, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA93DocAnexoId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "docanexogeneral", GetJustCreated( ));
         ...
         {
            A93DocAnexoId = Convert.ToInt32(getParm(obj,2));
            AssignAttri(sPrefix, false, "A93DocAnexoId", StringUtil.LTrimStr( (decimal)(A93DocAnexoId), 8, 0));
         }
         wcpOA93DocAnexoId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA93DocAnexoId"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( A93DocAnexoId != wcpOA93DocAnexoId ) ) )
         {
            setjustcreated();
         }
         wcpOA93DocAnexoId = A93DocAnexoId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA93DocAnexoId = cgiGet( sPrefix+"A93DocAnexoId_CTRL");
         if ( StringUtil.Len( sCtrlA93DocAnexoId) > 0 )
         {
            A93DocAnexoId = (int)(context.localUtil.CToN( cgiGet( sCtrlA93DocAnexoId), ",", "."));
            AssignAttri(sPrefix, false, "A93DocAnexoId", StringUtil.LTrimStr( (decimal)(A93DocAnexoId), 8, 0));
         }
         else
         {
            A93DocAnexoId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"A93DocAnexoId_PARM"), ",", "."));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A93DocAnexoId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(A93DocAnexoId), 8, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA93DocAnexoId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A93DocAnexoId_CTRL", StringUtil.RTrim( sCtrlA93DocAnexoId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202312417261596", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("docanexogeneral.js", "?202312417261596", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A93DocAnexoId',fld:'DOCANEXOID',pic:'ZZZZZZZ9'},{av:'AV12IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV13IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DOUPDATE'","{handler:'E136E2',iparms:[{av:'AV12IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A93DocAnexoId',fld:'DOCANEXOID',pic:'ZZZZZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[{ctrl:'BTNUPDATE',prop:'Visible'}]}");
         setEventMetadata("'DODELETE'","{handler:'E146E2',iparms:[{av:'AV13IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'A93DocAnexoId',fld:'DOCANEXOID',pic:'ZZZZZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         scmdbuf = "";
         H006E2_A75DocumentoId = new int[1] ;
         H006E2_A93DocAnexoId = new int[1] ;
         H006E2_A96DocAnexoDataInclusao = new DateTime[] {DateTime.MinValue} ;
         H006E2_A95DocAnexoArquivo = new string[] {""} ;
         H006E2_A94DocAnexoDescricao = new string[] {""} ;
         H006E2_A76DocumentoNome = new string[] {""} ;
         H006E2_n76DocumentoNome = new bool[] {false} ;
         ...
         sCtrlA93DocAnexoId = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.docanexogeneral__default(),
            new Object[][] {
                new Object[] {
               H006E2_A75DocumentoId, H006E2_A93DocAnexoId, H006E2_A96DocAnexoDataInclusao, H006E2_A95DocAnexoArquivo, H006E2_A94DocAnexoDescricao, H006E2_A76DocumentoNome, H006E2_n76DocumentoNome
               }
            }
         );
         AV17Pgmname = "DocAnexoGeneral";
      ...
      private string sCtrlA93DocAnexoId ;
      ...
      private int[] H006E2_A75DocumentoId ;
      private int[] H006E2_A93DocAnexoId ;
      private DateTime[] H006E2_A96DocAnexoDataInclusao ;
      private string[] H006E2_A95DocAnexoArquivo ;
      private string[] H006E2_A94DocAnexoDescricao ;
      private string[] H006E2_A76DocumentoNome ;
      private bool[] H006E2_n76DocumentoNome ;
   ...
   public class docanexogeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H006E2", "SELECT T1.[DocumentoId], T1.[DocAnexoId], T1.[DocAnexoDataInclusao], T1.[DocAnexoArquivo], T1.[DocAnexoDescricao], T2.[DocumentoNome] FROM ([DocAnexo] T1 INNER JOIN [Documento] T2 ON T2.[DocumentoId] = T1.[DocumentoId]) WHERE T1.[DocAnexoId] = @DocAnexoId ORDER BY T1.[DocAnexoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006E2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }

...
namespace GeneXus.Programs {
   public class tipodescarteprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public tipodescarteprompt( )
      {
      ...
      public tipodescarteprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutTipoDescarteId ,
                           ref string aP1_InOutTipoDescarteNome )
      {
         this.AV8InOutTipoDescarteId = aP0_InOutTipoDescarteId;
         this.AV9InOutTipoDescarteNome = aP1_InOutTipoDescarteNome;
         executePrivate();
         aP0_InOutTipoDescarteId=this.AV8InOutTipoDescarteId;
         aP1_InOutTipoDescarteNome=this.AV9InOutTipoDescarteNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutTipoDescarteId");
            ...
            {
               AV8InOutTipoDescarteId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutTipoDescarteId", StringUtil.LTrimStr( (decimal)(AV8InOutTipoDescarteId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutTipoDescarteNome = GetPar( "InOutTipoDescarteNome");
                  AssignAttri("", false, "AV9InOutTipoDescarteNome", AV9InOutTipoDescarteNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      {
         get {
            return "tipodescarteprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("tipodescarteprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutTipoDescarteId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutTipoDescarteNome))}, new string[] {"InOutTipoDescarteId","InOutTipoDescarteNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTTIPODESCARTEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutTipoDescarteId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTTIPODESCARTENOME", AV9InOutTipoDescarteNome);
      ...
      {
         return formatLink("tipodescarteprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutTipoDescarteId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutTipoDescarteNome))}, new string[] {"InOutTipoDescarteId","InOutTipoDescarteNome"})  ;
      }

      public override string GetPgmname( )
      {
         return "TipoDescartePrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Tipo Descarte" ;
      }
      ...
      protected void WB4T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_4T2( true) ;
         }
         else
         {
            wb_table1_14_4T2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_4T2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START4T2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Tipo Descarte", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_TIPODESCARTENOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A46TipoDescarteNome, "")), context));
         GxWebStd.gx_hidden_field( context, "TIPODESCARTENOME", A46TipoDescarteNome);
      }
      ...
      {
         /* GeneXus formulas. */
         AV22Pgmname = "TipoDescartePrompt";
         context.Gx_err = 0;
      ...
      protected void RF4T2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A47TipoDescarteAtivo = H004T2_A47TipoDescarteAtivo[0];
               A46TipoDescarteNome = H004T2_A46TipoDescarteNome[0];
               A45TipoDescarteId = H004T2_A45TipoDescarteId[0];
               E174T2 ();
      ...
      protected void send_integrity_lvl_hashes4T2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_TIPODESCARTEID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A45TipoDescarteId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_TIPODESCARTENOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A46TipoDescarteNome, "")), context));
      }
      ...
      protected void E154T2( )
      {
         ...
         Form.Caption = "Consulta de Tipo Descarte";
      ...
      protected void E184T2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutTipoDescarteId = A45TipoDescarteId;
         AssignAttri("", false, "AV8InOutTipoDescarteId", StringUtil.LTrimStr( (decimal)(AV8InOutTipoDescarteId), 8, 0));
         AV9InOutTipoDescarteNome = A46TipoDescarteNome;
         AssignAttri("", false, "AV9InOutTipoDescarteNome", AV9InOutTipoDescarteNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutTipoDescarteId,(string)AV9InOutTipoDescarteNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutTipoDescarteId","AV9InOutTipoDescarteNome"});
      ...
      protected void wb_table1_14_4T2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_TipoDescartePrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutTipoDescarteId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutTipoDescarteId", StringUtil.LTrimStr( (decimal)(AV8InOutTipoDescarteId), 8, 0));
         AV9InOutTipoDescarteNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutTipoDescarteNome", AV9InOutTipoDescarteNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910504142", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("tipodescarteprompt.js", "?202311910504142", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtTipoDescarteId_Internalname = "TIPODESCARTEID_"+sGXsfl_26_idx;
         edtTipoDescarteNome_Internalname = "TIPODESCARTENOME_"+sGXsfl_26_idx;
         cmbTipoDescarteAtivo_Internalname = "TIPODESCARTEATIVO_"+sGXsfl_26_idx;
      }

      protected void SubsflControlProps_fel_262( )
      {
         edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx;
         edtTipoDescarteId_Internalname = "TIPODESCARTEID_"+sGXsfl_26_fel_idx;
         edtTipoDescarteNome_Internalname = "TIPODESCARTENOME_"+sGXsfl_26_fel_idx;
         cmbTipoDescarteAtivo_Internalname = "TIPODESCARTEATIVO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "TIPODESCARTEATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbTipoDescarteAtivo_Internalname, "Values", (string)(cmbTipoDescarteAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:TipoDescarteId|2:TipoDescarteNome|3:TipoDescarteAtivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E174T2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E184T2',iparms:[{av:'A45TipoDescarteId',fld:'TIPODESCARTEID',pic:'ZZZZZZZ9',hsh:true},{av:'A46TipoDescarteNome',fld:'TIPODESCARTENOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutTipoDescarteId',fld:'vINOUTTIPODESCARTEID',pic:'ZZZZZZZ9'},{av:'AV9InOutTipoDescarteNome',fld:'vINOUTTIPODESCARTENOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E144T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H004T2_A47TipoDescarteAtivo = new bool[] {false} ;
         H004T2_A46TipoDescarteNome = new string[] {""} ;
         H004T2_A45TipoDescarteId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tipodescarteprompt__default(),
            new Object[][] {
                new Object[] {
               H004T2_A47TipoDescarteAtivo, H004T2_A46TipoDescarteNome, H004T2_A45TipoDescarteId
               }
               , new Object[] {
      ...
      private int AV8InOutTipoDescarteId ;
      private int wcpOAV8InOutTipoDescarteId ;
      ...
      private string AV9InOutTipoDescarteNome ;
      private string wcpOAV9InOutTipoDescarteNome ;
      ...
      private int aP0_InOutTipoDescarteId ;
      private string aP1_InOutTipoDescarteNome ;
      private GXCombobox cmbTipoDescarteAtivo ;
      private IDataStoreProvider pr_default ;
      private bool[] H004T2_A47TipoDescarteAtivo ;
      private string[] H004T2_A46TipoDescarteNome ;
      private int[] H004T2_A45TipoDescarteId ;
   ...
   public class tipodescarteprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([TipoDescarteId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [TipoDescarteNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and [TipoDescarteAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and [TipoDescarteAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H004T2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
               case 1 :
                     return conditional_H004T3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
         }

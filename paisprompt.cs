...
namespace GeneXus.Programs {
   public class paisprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public paisprompt( )
      {
      ...
      public paisprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutPaisId ,
                           ref string aP1_InOutPaisNome )
      {
         this.AV8InOutPaisId = aP0_InOutPaisId;
         this.AV9InOutPaisNome = aP1_InOutPaisNome;
         executePrivate();
         aP0_InOutPaisId=this.AV8InOutPaisId;
         aP1_InOutPaisNome=this.AV9InOutPaisNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutPaisId");
            ...
            {
               AV8InOutPaisId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutPaisId", StringUtil.LTrimStr( (decimal)(AV8InOutPaisId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutPaisNome = GetPar( "InOutPaisNome");
                  AssignAttri("", false, "AV9InOutPaisNome", AV9InOutPaisNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("paisprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutPaisId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutPaisNome))}, new string[] {"InOutPaisId","InOutPaisNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTPAISID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutPaisId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTPAISNOME", AV9InOutPaisNome);
      ...
      {
         return formatLink("paisprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutPaisId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutPaisNome))}, new string[] {"InOutPaisId","InOutPaisNome"})  ;
      }
      ...
      protected void WB2G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_2G2( true) ;
         }
         else
         {
            wb_table1_14_2G2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_2G2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START2G2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Pais", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_PAISNOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A5PaisNome, "")), context));
         GxWebStd.gx_hidden_field( context, "PAISNOME", A5PaisNome);
      }
      ...
      protected void RF2G2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A6PaisAtivo = H002G2_A6PaisAtivo[0];
               A5PaisNome = H002G2_A5PaisNome[0];
               A4PaisId = H002G2_A4PaisId[0];
               E172G2 ();
      ...
      protected void send_integrity_lvl_hashes2G2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_PAISID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A4PaisId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_PAISNOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A5PaisNome, "")), context));
      }
      ...
      protected void E182G2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutPaisId = A4PaisId;
         AssignAttri("", false, "AV8InOutPaisId", StringUtil.LTrimStr( (decimal)(AV8InOutPaisId), 8, 0));
         AV9InOutPaisNome = A5PaisNome;
         AssignAttri("", false, "AV9InOutPaisNome", AV9InOutPaisNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutPaisId,(string)AV9InOutPaisNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutPaisId","AV9InOutPaisNome"});
      ...
      protected void wb_table1_14_2G2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_PaisPrompt.htm");
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_14_2G2e( true) ;
         }
         else
         {
            wb_table1_14_2G2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutPaisId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutPaisId", StringUtil.LTrimStr( (decimal)(AV8InOutPaisId), 8, 0));
         AV9InOutPaisNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutPaisNome", AV9InOutPaisNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910494592", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("paisprompt.js", "?202311910494592", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         cmbPaisAtivo_Internalname = "PAISATIVO_"+sGXsfl_26_idx;
      }
      ...
      protected void SubsflControlProps_fel_262( )
      {
         ...
         cmbPaisAtivo_Internalname = "PAISATIVO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "PAISATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbPaisAtivo_Internalname, "Values", (string)(cmbPaisAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:PaisId|2:PaisNome|3:PaisAtivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E172G2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E182G2',iparms:[{av:'A4PaisId',fld:'PAISID',pic:'ZZZZZZZ9',hsh:true},{av:'A5PaisNome',fld:'PAISNOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutPaisId',fld:'vINOUTPAISID',pic:'ZZZZZZZ9'},{av:'AV9InOutPaisNome',fld:'vINOUTPAISNOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E142G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H002G2_A6PaisAtivo = new bool[] {false} ;
         H002G2_A5PaisNome = new string[] {""} ;
         H002G2_A4PaisId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.paisprompt__default(),
            new Object[][] {
                new Object[] {
               H002G2_A6PaisAtivo, H002G2_A5PaisNome, H002G2_A4PaisId
               }
               , new Object[] {
      ...
      private int AV8InOutPaisId ;
      private int wcpOAV8InOutPaisId ;
      ...
      private string AV9InOutPaisNome ;
      private string wcpOAV9InOutPaisNome ;
      ...
      private int aP0_InOutPaisId ;
      private string aP1_InOutPaisNome ;
      private GXCombobox cmbPaisAtivo ;
      private IDataStoreProvider pr_default ;
      private bool[] H002G2_A6PaisAtivo ;
      private string[] H002G2_A5PaisNome ;
      private int[] H002G2_A4PaisId ;
   ...
   public class paisprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([PaisId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [PaisNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and [PaisAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and [PaisAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002G2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
               case 1 :
                     return conditional_H002G3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
         }

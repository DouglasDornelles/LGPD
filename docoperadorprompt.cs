...
namespace GeneXus.Programs {
   public class docoperadorprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public docoperadorprompt( )
      {
      ...
      public docoperadorprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutDocOperadorId ,
                           ref bool aP1_InOutDocOperadorColeta )
      {
         this.AV8InOutDocOperadorId = aP0_InOutDocOperadorId;
         this.AV9InOutDocOperadorColeta = aP1_InOutDocOperadorColeta;
         executePrivate();
         aP0_InOutDocOperadorId=this.AV8InOutDocOperadorId;
         aP1_InOutDocOperadorColeta=this.AV9InOutDocOperadorColeta;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutDocOperadorId");
            ...
            {
               AV8InOutDocOperadorId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutDocOperadorId", StringUtil.LTrimStr( (decimal)(AV8InOutDocOperadorId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutDocOperadorColeta = StringUtil.StrToBool( GetPar( "InOutDocOperadorColeta"));
                  AssignAttri("", false, "AV9InOutDocOperadorColeta", AV9InOutDocOperadorColeta);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      {
         get {
            return "docoperadorprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("docoperadorprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutDocOperadorId,8,0)),UrlEncode(StringUtil.BoolToStr(AV9InOutDocOperadorColeta))}, new string[] {"InOutDocOperadorId","InOutDocOperadorColeta"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTDOCOPERADORID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutDocOperadorId), 8, 0, ",", "")));
         GxWebStd.gx_boolean_hidden_field( context, "vINOUTDOCOPERADORCOLETA", AV9InOutDocOperadorColeta);
      ...
      {
         return formatLink("docoperadorprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutDocOperadorId,8,0)),UrlEncode(StringUtil.BoolToStr(AV9InOutDocOperadorColeta))}, new string[] {"InOutDocOperadorId","InOutDocOperadorColeta"})  ;
      }

      public override string GetPgmname( )
      {
         return "DocOperadorPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Doc Operador" ;
      }
      ...
      protected void WB6P0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_6P2( true) ;
         }
         else
         {
            wb_table1_14_6P2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_6P2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START6P2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Doc Operador", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_DOCOPERADORCOLETA", GetSecureSignedToken( "", A87DocOperadorColeta, context));
         GxWebStd.gx_hidden_field( context, "DOCOPERADORCOLETA", StringUtil.BoolToStr( A87DocOperadorColeta));
      }
      ...
      protected void RF6P2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV13FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV13FilterFullText), "%", "");
            /* Using cursor H006P2 */
            pr_default.execute(0, new Object[] {lV13FilterFullText, lV13FilterFullText, lV13FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_26_idx = 1;
            sGXsfl_26_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_26_idx), 4, 0), 4, "0");
            SubsflControlProps_262( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A92DocOperadorDataInclusao = H006P2_A92DocOperadorDataInclusao[0];
               A91DocOperadorProcessamento = H006P2_A91DocOperadorProcessamento[0];
               A90DocOperadorEliminacao = H006P2_A90DocOperadorEliminacao[0];
               A89DocOperadorCompartilhamento = H006P2_A89DocOperadorCompartilhamento[0];
               A88DocOperadorRetencao = H006P2_A88DocOperadorRetencao[0];
               A87DocOperadorColeta = H006P2_A87DocOperadorColeta[0];
               A42OperadorId = H006P2_A42OperadorId[0];
               A75DocumentoId = H006P2_A75DocumentoId[0];
               A86DocOperadorId = H006P2_A86DocOperadorId[0];
               E176P2 ();
      ...
      protected void send_integrity_lvl_hashes6P2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_DOCOPERADORID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A86DocOperadorId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_DOCOPERADORCOLETA"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, A87DocOperadorColeta, context));
      }
      ...
      protected void E156P2( )
      {
         ...
         Form.Caption = "Consulta de Doc Operador";
      ...
      protected void E186P2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutDocOperadorId = A86DocOperadorId;
         AssignAttri("", false, "AV8InOutDocOperadorId", StringUtil.LTrimStr( (decimal)(AV8InOutDocOperadorId), 8, 0));
         AV9InOutDocOperadorColeta = A87DocOperadorColeta;
         AssignAttri("", false, "AV9InOutDocOperadorColeta", AV9InOutDocOperadorColeta);
         context.setWebReturnParms(new Object[] {(int)AV8InOutDocOperadorId,(bool)AV9InOutDocOperadorColeta});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutDocOperadorId","AV9InOutDocOperadorColeta"});
      ...
      protected void wb_table1_14_6P2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_DocOperadorPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutDocOperadorId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutDocOperadorId", StringUtil.LTrimStr( (decimal)(AV8InOutDocOperadorId), 8, 0));
         AV9InOutDocOperadorColeta = (bool)getParm(obj,1);
         AssignAttri("", false, "AV9InOutDocOperadorColeta", AV9InOutDocOperadorColeta);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231191051222", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("docoperadorprompt.js", "?20231191051222", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtDocOperadorId_Internalname = "DOCOPERADORID_"+sGXsfl_26_idx;
         edtDocumentoId_Internalname = "DOCUMENTOID_"+sGXsfl_26_idx;
         edtOperadorId_Internalname = "OPERADORID_"+sGXsfl_26_idx;
         chkDocOperadorColeta_Internalname = "DOCOPERADORCOLETA_"+sGXsfl_26_idx;
         chkDocOperadorRetencao_Internalname = "DOCOPERADORRETENCAO_"+sGXsfl_26_idx;
         chkDocOperadorCompartilhamento_Internalname = "DOCOPERADORCOMPARTILHAMENTO_"+sGXsfl_26_idx;
         chkDocOperadorEliminacao_Internalname = "DOCOPERADORELIMINACAO_"+sGXsfl_26_idx;
         chkDocOperadorProcessamento_Internalname = "DOCOPERADORPROCESSAMENTO_"+sGXsfl_26_idx;
         edtDocOperadorDataInclusao_Internalname = "DOCOPERADORDATAINCLUSAO_"+sGXsfl_26_idx;
      }

      protected void SubsflControlProps_fel_262( )
      {
         edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx;
         edtDocOperadorId_Internalname = "DOCOPERADORID_"+sGXsfl_26_fel_idx;
         edtDocumentoId_Internalname = "DOCUMENTOID_"+sGXsfl_26_fel_idx;
         edtOperadorId_Internalname = "OPERADORID_"+sGXsfl_26_fel_idx;
         chkDocOperadorColeta_Internalname = "DOCOPERADORCOLETA_"+sGXsfl_26_fel_idx;
         chkDocOperadorRetencao_Internalname = "DOCOPERADORRETENCAO_"+sGXsfl_26_fel_idx;
         chkDocOperadorCompartilhamento_Internalname = "DOCOPERADORCOMPARTILHAMENTO_"+sGXsfl_26_fel_idx;
         chkDocOperadorEliminacao_Internalname = "DOCOPERADORELIMINACAO_"+sGXsfl_26_fel_idx;
         chkDocOperadorProcessamento_Internalname = "DOCOPERADORPROCESSAMENTO_"+sGXsfl_26_fel_idx;
         edtDocOperadorDataInclusao_Internalname = "DOCOPERADORDATAINCLUSAO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            GXCCtl = "DOCOPERADORCOLETA_" + sGXsfl_26_idx;
            chkDocOperadorColeta.Name = GXCCtl;
            chkDocOperadorColeta.WebTags = "";
            chkDocOperadorColeta.Caption = "";
            AssignProp("", false, chkDocOperadorColeta_Internalname, "TitleCaption", chkDocOperadorColeta.Caption, !bGXsfl_26_Refreshing);
            ...
            GridRow.AddColumnProperties("checkbox", 1, isAjaxCallMode( ), new Object[] {(string)chkDocOperadorColeta_Internalname,StringUtil.BoolToStr( A87DocOperadorColeta),(string)"",(string)"",(short)-1,(short)0,(string)"true",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn",(string)"",(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+""+"\""+" style=\""+""+"\">") ;
            ...
            ClassString = "Attribute";
            StyleString = "";
            GXCCtl = "DOCOPERADORRETENCAO_" + sGXsfl_26_idx;
            chkDocOperadorRetencao.Name = GXCCtl;
            chkDocOperadorRetencao.WebTags = "";
            chkDocOperadorRetencao.Caption = "";
            AssignProp("", false, chkDocOperadorRetencao_Internalname, "TitleCaption", chkDocOperadorRetencao.Caption, !bGXsfl_26_Refreshing);
            ...
            GridRow.AddColumnProperties("checkbox", 1, isAjaxCallMode( ), new Object[] {(string)chkDocOperadorRetencao_Internalname,StringUtil.BoolToStr( A88DocOperadorRetencao),(string)"",(string)"",(short)-1,(short)0,(string)"true",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn hidden-xs",(string)"",(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+""+"\""+" style=\""+""+"\">") ;
            ...
            ClassString = "Attribute";
            StyleString = "";
            GXCCtl = "DOCOPERADORCOMPARTILHAMENTO_" + sGXsfl_26_idx;
            chkDocOperadorCompartilhamento.Name = GXCCtl;
            chkDocOperadorCompartilhamento.WebTags = "";
            chkDocOperadorCompartilhamento.Caption = "";
            AssignProp("", false, chkDocOperadorCompartilhamento_Internalname, "TitleCaption", chkDocOperadorCompartilhamento.Caption, !bGXsfl_26_Refreshing);
            ...
            GridRow.AddColumnProperties("checkbox", 1, isAjaxCallMode( ), new Object[] {(string)chkDocOperadorCompartilhamento_Internalname,StringUtil.BoolToStr( A89DocOperadorCompartilhamento),(string)"",(string)"",(short)-1,(short)0,(string)"true",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn hidden-xs",(string)"",(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+""+"\""+" style=\""+""+"\">") ;
            ...
            ClassString = "Attribute";
            StyleString = "";
            GXCCtl = "DOCOPERADORELIMINACAO_" + sGXsfl_26_idx;
            chkDocOperadorEliminacao.Name = GXCCtl;
            chkDocOperadorEliminacao.WebTags = "";
            chkDocOperadorEliminacao.Caption = "";
            AssignProp("", false, chkDocOperadorEliminacao_Internalname, "TitleCaption", chkDocOperadorEliminacao.Caption, !bGXsfl_26_Refreshing);
            ...
            GridRow.AddColumnProperties("checkbox", 1, isAjaxCallMode( ), new Object[] {(string)chkDocOperadorEliminacao_Internalname,StringUtil.BoolToStr( A90DocOperadorEliminacao),(string)"",(string)"",(short)-1,(short)0,(string)"true",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn hidden-xs",(string)"",(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+""+"\""+" style=\""+""+"\">") ;
            ...
            ClassString = "Attribute";
            StyleString = "";
            GXCCtl = "DOCOPERADORPROCESSAMENTO_" + sGXsfl_26_idx;
            chkDocOperadorProcessamento.Name = GXCCtl;
            chkDocOperadorProcessamento.WebTags = "";
            chkDocOperadorProcessamento.Caption = "";
            AssignProp("", false, chkDocOperadorProcessamento_Internalname, "TitleCaption", chkDocOperadorProcessamento.Caption, !bGXsfl_26_Refreshing);
            ...
            GridRow.AddColumnProperties("checkbox", 1, isAjaxCallMode( ), new Object[] {(string)chkDocOperadorProcessamento_Internalname,StringUtil.BoolToStr( A91DocOperadorProcessamento),(string)"",(string)"",(short)-1,(short)0,(string)"true",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn hidden-xs",(string)"",(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:DocOperadorId|2:DocumentoId|3:OperadorId|4:DocOperadorColeta|5:DocOperadorRetencao|6:DocOperadorCompartilhamento|7:DocOperadorEliminacao|8:DocOperadorProcessamento|9:DocOperadorDataInclusao";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E176P2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E186P2',iparms:[{av:'A86DocOperadorId',fld:'DOCOPERADORID',pic:'ZZZZZZZ9',hsh:true},{av:'A87DocOperadorColeta',fld:'DOCOPERADORCOLETA',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutDocOperadorId',fld:'vINOUTDOCOPERADORID',pic:'ZZZZZZZ9'},{av:'AV9InOutDocOperadorColeta',fld:'vINOUTDOCOPERADORCOLETA',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E146P2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H006P2_A92DocOperadorDataInclusao = new DateTime[] {DateTime.MinValue} ;
         H006P2_A91DocOperadorProcessamento = new bool[] {false} ;
         H006P2_A90DocOperadorEliminacao = new bool[] {false} ;
         H006P2_A89DocOperadorCompartilhamento = new bool[] {false} ;
         H006P2_A88DocOperadorRetencao = new bool[] {false} ;
         H006P2_A87DocOperadorColeta = new bool[] {false} ;
         H006P2_A42OperadorId = new int[1] ;
         H006P2_A75DocumentoId = new int[1] ;
         H006P2_A86DocOperadorId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.docoperadorprompt__default(),
            new Object[][] {
                new Object[] {
               H006P2_A92DocOperadorDataInclusao, H006P2_A91DocOperadorProcessamento, H006P2_A90DocOperadorEliminacao, H006P2_A89DocOperadorCompartilhamento, H006P2_A88DocOperadorRetencao, H006P2_A87DocOperadorColeta, H006P2_A42OperadorId, H006P2_A75DocumentoId, H006P2_A86DocOperadorId
               }
               , new Object[] {
      ...
      private int AV8InOutDocOperadorId ;
      private int wcpOAV8InOutDocOperadorId ;
      ...
      private bool AV9InOutDocOperadorColeta ;
      private bool wcpOAV9InOutDocOperadorColeta ;
      ...
      private int aP0_InOutDocOperadorId ;
      private bool aP1_InOutDocOperadorColeta ;
      ...
      private DateTime[] H006P2_A92DocOperadorDataInclusao ;
      private bool[] H006P2_A91DocOperadorProcessamento ;
      private bool[] H006P2_A90DocOperadorEliminacao ;
      private bool[] H006P2_A89DocOperadorCompartilhamento ;
      private bool[] H006P2_A88DocOperadorRetencao ;
      private bool[] H006P2_A87DocOperadorColeta ;
      private int[] H006P2_A42OperadorId ;
      private int[] H006P2_A75DocumentoId ;
      private int[] H006P2_A86DocOperadorId ;
   ...
   public class docoperadorprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([DocOperadorId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( CONVERT( char(8), CAST([DocumentoId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( CONVERT( char(8), CAST([OperadorId] AS decimal(8,0))) like '%' + @lV13FilterFullText))");
         }
         else
         {
            GXv_int3[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H006P2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (int)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
               case 1 :
                     return conditional_H006P3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (int)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
         }

...
namespace GeneXus.Programs {
   public class telaprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public telaprompt( )
      {
      ...
      public telaprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutTelaId ,
                           ref string aP1_InOutTelaNome )
      {
         this.AV8InOutTelaId = aP0_InOutTelaId;
         this.AV9InOutTelaNome = aP1_InOutTelaNome;
         executePrivate();
         aP0_InOutTelaId=this.AV8InOutTelaId;
         aP1_InOutTelaNome=this.AV9InOutTelaNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutTelaId");
            ...
            {
               AV8InOutTelaId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutTelaId", StringUtil.LTrimStr( (decimal)(AV8InOutTelaId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutTelaNome = GetPar( "InOutTelaNome");
                  AssignAttri("", false, "AV9InOutTelaNome", AV9InOutTelaNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("telaprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutTelaId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutTelaNome))}, new string[] {"InOutTelaId","InOutTelaNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTTELAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutTelaId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTTELANOME", AV9InOutTelaNome);
      ...
      {
         return formatLink("telaprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutTelaId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutTelaNome))}, new string[] {"InOutTelaId","InOutTelaNome"})  ;
      }
      ...
      protected void START8D2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Tela", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_TELANOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A134TelaNome, "")), context));
         GxWebStd.gx_hidden_field( context, "TELANOME", A134TelaNome);
      }
      ...
      protected void RF8D2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A137TelaAtivo = H008D2_A137TelaAtivo[0];
               A134TelaNome = H008D2_A134TelaNome[0];
               A133TelaId = H008D2_A133TelaId[0];
               E178D2 ();
      ...
      protected void send_integrity_lvl_hashes8D2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_TELAID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A133TelaId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_TELANOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A134TelaNome, "")), context));
      }
      ...
      protected void E188D2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutTelaId = A133TelaId;
         AssignAttri("", false, "AV8InOutTelaId", StringUtil.LTrimStr( (decimal)(AV8InOutTelaId), 8, 0));
         AV9InOutTelaNome = A134TelaNome;
         AssignAttri("", false, "AV9InOutTelaNome", AV9InOutTelaNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutTelaId,(string)AV9InOutTelaNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutTelaId","AV9InOutTelaNome"});
      ...
      protected void wb_table1_14_8D2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_TelaPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutTelaId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutTelaId", StringUtil.LTrimStr( (decimal)(AV8InOutTelaId), 8, 0));
         AV9InOutTelaNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutTelaNome", AV9InOutTelaNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910512538", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("telaprompt.js", "?202311910512539", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtTelaNome_Internalname = "TELANOME_"+sGXsfl_26_idx;
         cmbTelaAtivo_Internalname = "TELAATIVO_"+sGXsfl_26_idx;
      }
      ...
      protected void SubsflControlProps_fel_262( )
      {
         ...
         edtTelaNome_Internalname = "TELANOME_"+sGXsfl_26_fel_idx;
         cmbTelaAtivo_Internalname = "TELAATIVO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "TELAATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbTelaAtivo_Internalname, "Values", (string)(cmbTelaAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:TelaId|2:TelaNome|3:TelaAtivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E178D2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E188D2',iparms:[{av:'A133TelaId',fld:'TELAID',pic:'ZZZZZZZ9',hsh:true},{av:'A134TelaNome',fld:'TELANOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutTelaId',fld:'vINOUTTELAID',pic:'ZZZZZZZ9'},{av:'AV9InOutTelaNome',fld:'vINOUTTELANOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E148D2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H008D2_A137TelaAtivo = new bool[] {false} ;
         H008D2_A134TelaNome = new string[] {""} ;
         H008D2_A133TelaId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.telaprompt__default(),
            new Object[][] {
                new Object[] {
               H008D2_A137TelaAtivo, H008D2_A134TelaNome, H008D2_A133TelaId
               }
               , new Object[] {
      ...
      private int AV8InOutTelaId ;
      private int wcpOAV8InOutTelaId ;
      ...
      private string AV9InOutTelaNome ;
      private string wcpOAV9InOutTelaNome ;
      ...
      private int aP0_InOutTelaId ;
      private string aP1_InOutTelaNome ;
      private GXCombobox cmbTelaAtivo ;
      private IDataStoreProvider pr_default ;
      private bool[] H008D2_A137TelaAtivo ;
      private string[] H008D2_A134TelaNome ;
      private int[] H008D2_A133TelaId ;
   ...
   public class telaprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([TelaId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [TelaNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and [TelaAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and [TelaAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H008D2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
               case 1 :
                     return conditional_H008D3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
         }

...
namespace GeneXus.Programs {
   public class hipotesetratamentoprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public hipotesetratamentoprompt( )
      {
      ...
      public hipotesetratamentoprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutHipoteseTratamentoId ,
                           ref string aP1_InOutHipoteseTratamentoNome )
      {
         this.AV8InOutHipoteseTratamentoId = aP0_InOutHipoteseTratamentoId;
         this.AV9InOutHipoteseTratamentoNome = aP1_InOutHipoteseTratamentoNome;
         executePrivate();
         aP0_InOutHipoteseTratamentoId=this.AV8InOutHipoteseTratamentoId;
         aP1_InOutHipoteseTratamentoNome=this.AV9InOutHipoteseTratamentoNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutHipoteseTratamentoId");
            ...
            {
               AV8InOutHipoteseTratamentoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutHipoteseTratamentoId", StringUtil.LTrimStr( (decimal)(AV8InOutHipoteseTratamentoId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutHipoteseTratamentoNome = GetPar( "InOutHipoteseTratamentoNome");
                  AssignAttri("", false, "AV9InOutHipoteseTratamentoNome", AV9InOutHipoteseTratamentoNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      {
         get {
            return "hipotesetratamentoprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("hipotesetratamentoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutHipoteseTratamentoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutHipoteseTratamentoNome))}, new string[] {"InOutHipoteseTratamentoId","InOutHipoteseTratamentoNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTHIPOTESETRATAMENTOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutHipoteseTratamentoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTHIPOTESETRATAMENTONOME", AV9InOutHipoteseTratamentoNome);
      ...
      {
         return formatLink("hipotesetratamentoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutHipoteseTratamentoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutHipoteseTratamentoNome))}, new string[] {"InOutHipoteseTratamentoId","InOutHipoteseTratamentoNome"})  ;
      }

      public override string GetPgmname( )
      {
         return "HipoteseTratamentoPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Hipotese Tratamento" ;
      }
      ...
      protected void WB2Q0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_2Q2( true) ;
         }
         else
         {
            wb_table1_14_2Q2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_2Q2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START2Q2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Hipotese Tratamento", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_HIPOTESETRATAMENTONOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A73HipoteseTratamentoNome, "")), context));
         GxWebStd.gx_hidden_field( context, "HIPOTESETRATAMENTONOME", A73HipoteseTratamentoNome);
      }
      ...
      {
         /* GeneXus formulas. */
         AV22Pgmname = "HipoteseTratamentoPrompt";
         context.Gx_err = 0;
      ...
      protected void RF2Q2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A74HipoteseTratamentoAtivo = H002Q2_A74HipoteseTratamentoAtivo[0];
               A73HipoteseTratamentoNome = H002Q2_A73HipoteseTratamentoNome[0];
               A72HipoteseTratamentoId = H002Q2_A72HipoteseTratamentoId[0];
               E172Q2 ();
      ...
      protected void send_integrity_lvl_hashes2Q2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_HIPOTESETRATAMENTOID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A72HipoteseTratamentoId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_HIPOTESETRATAMENTONOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A73HipoteseTratamentoNome, "")), context));
      }
      ...
      protected void E152Q2( )
      {
         ...
         Form.Caption = "Consulta de Hipotese Tratamento";
      ...
      protected void E182Q2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutHipoteseTratamentoId = A72HipoteseTratamentoId;
         AssignAttri("", false, "AV8InOutHipoteseTratamentoId", StringUtil.LTrimStr( (decimal)(AV8InOutHipoteseTratamentoId), 8, 0));
         AV9InOutHipoteseTratamentoNome = A73HipoteseTratamentoNome;
         AssignAttri("", false, "AV9InOutHipoteseTratamentoNome", AV9InOutHipoteseTratamentoNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutHipoteseTratamentoId,(string)AV9InOutHipoteseTratamentoNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutHipoteseTratamentoId","AV9InOutHipoteseTratamentoNome"});
      ...
      protected void wb_table1_14_2Q2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_HipoteseTratamentoPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutHipoteseTratamentoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutHipoteseTratamentoId", StringUtil.LTrimStr( (decimal)(AV8InOutHipoteseTratamentoId), 8, 0));
         AV9InOutHipoteseTratamentoNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutHipoteseTratamentoNome", AV9InOutHipoteseTratamentoNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910494950", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("hipotesetratamentoprompt.js", "?202311910494950", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         cmbHipoteseTratamentoAtivo_Internalname = "HIPOTESETRATAMENTOATIVO_"+sGXsfl_26_idx;
      }
      ...
      protected void SubsflControlProps_fel_262( )
      {
         ...
         cmbHipoteseTratamentoAtivo_Internalname = "HIPOTESETRATAMENTOATIVO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "HIPOTESETRATAMENTOATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbHipoteseTratamentoAtivo_Internalname, "Values", (string)(cmbHipoteseTratamentoAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:HipoteseTratamentoId|2:HipoteseTratamentoNome|3:HipoteseTratamentoAtivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E172Q2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E182Q2',iparms:[{av:'A72HipoteseTratamentoId',fld:'HIPOTESETRATAMENTOID',pic:'ZZZZZZZ9',hsh:true},{av:'A73HipoteseTratamentoNome',fld:'HIPOTESETRATAMENTONOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutHipoteseTratamentoId',fld:'vINOUTHIPOTESETRATAMENTOID',pic:'ZZZZZZZ9'},{av:'AV9InOutHipoteseTratamentoNome',fld:'vINOUTHIPOTESETRATAMENTONOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E142Q2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      {
         wcpOAV9InOutHipoteseTratamentoNome = "";
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H002Q2_A74HipoteseTratamentoAtivo = new bool[] {false} ;
         H002Q2_A73HipoteseTratamentoNome = new string[] {""} ;
         H002Q2_A72HipoteseTratamentoId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.hipotesetratamentoprompt__default(),
            new Object[][] {
                new Object[] {
               H002Q2_A74HipoteseTratamentoAtivo, H002Q2_A73HipoteseTratamentoNome, H002Q2_A72HipoteseTratamentoId
               }
               , new Object[] {
      ...
      private int AV8InOutHipoteseTratamentoId ;
      private int wcpOAV8InOutHipoteseTratamentoId ;
      ...
      private string AV9InOutHipoteseTratamentoNome ;
      private string wcpOAV9InOutHipoteseTratamentoNome ;
      ...
      private int aP0_InOutHipoteseTratamentoId ;
      private string aP1_InOutHipoteseTratamentoNome ;
      private GXCombobox cmbHipoteseTratamentoAtivo ;
      private IDataStoreProvider pr_default ;
      private bool[] H002Q2_A74HipoteseTratamentoAtivo ;
      private string[] H002Q2_A73HipoteseTratamentoNome ;
      private int[] H002Q2_A72HipoteseTratamentoId ;
   ...
   public class hipotesetratamentoprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([HipoteseTratamentoId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [HipoteseTratamentoNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and [HipoteseTratamentoAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and [HipoteseTratamentoAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
         ...
         {
            sOrderString += " ORDER BY [HipoteseTratamentoId] DESC";
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002Q2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
               case 1 :
                     return conditional_H002Q3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
         }

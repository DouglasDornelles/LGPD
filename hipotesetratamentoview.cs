...
namespace GeneXus.Programs {
   public class hipotesetratamentoview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public hipotesetratamentoview( )
      {
      ...
      public hipotesetratamentoview( IGxContext context )
      {
      ...
      public void execute( int aP0_HipoteseTratamentoId ,
                           string aP1_TabCode )
      {
         this.AV10HipoteseTratamentoId = aP0_HipoteseTratamentoId;
      ...
      {
         get {
            return "hipotesetratamentoview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "hipotesetratamentoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10HipoteseTratamentoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("hipotesetratamentoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vHIPOTESETRATAMENTOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10HipoteseTratamentoId), "ZZZZZZZ9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vHIPOTESETRATAMENTOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10HipoteseTratamentoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vHIPOTESETRATAMENTOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10HipoteseTratamentoId), "ZZZZZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "hipotesetratamentoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10HipoteseTratamentoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("hipotesetratamentoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "HipoteseTratamentoView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Hipotese Tratamento View" ;
      }
      ...
      protected void WB2O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Hipotese Tratamento", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_HipoteseTratamentoView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divHipotesetratamentogeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDocdicionario_title_Internalname, "Doc Dicionario", "", "", lblDocdicionario_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_HipoteseTratamentoView.htm");
            /* Div Control */
      ...
      protected void START2O2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Hipotese Tratamento View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA2O2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "hipotesetratamentoview.aspx")), "hipotesetratamentoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "hipotesetratamentoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10HipoteseTratamentoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10HipoteseTratamentoId", StringUtil.LTrimStr( (decimal)(AV10HipoteseTratamentoId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vHIPOTESETRATAMENTOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10HipoteseTratamentoId), "ZZZZZZZ9"), context));
      ...
      protected void E122O2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("hipotesetratamentoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H002O2 */
         pr_default.execute(0, new Object[] {AV10HipoteseTratamentoId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A72HipoteseTratamentoId = H002O2_A72HipoteseTratamentoId[0];
            A73HipoteseTratamentoNome = H002O2_A73HipoteseTratamentoNome[0];
            AV16GXLvl9 = 1;
            Form.Caption = A73HipoteseTratamentoNome;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "HipoteseTratamentoGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "hipotesetratamentogeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "HipoteseTratamentoGeneral";
            WebComp_Webcomponent_general_Component = "HipoteseTratamentoGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10HipoteseTratamentoId});
      ...
      protected void S122( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "DocDicionario") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Docdicionariowc_Component), StringUtil.Lower( "HipoteseTratamentoDocDicionarioWC")) != 0 )
            {
               WebComp_Docdicionariowc = getWebComponent(GetType(), "GeneXus.Programs", "hipotesetratamentodocdicionariowc", new Object[] {context} );
               WebComp_Docdicionariowc.ComponentInit();
               WebComp_Docdicionariowc.Name = "HipoteseTratamentoDocDicionarioWC";
               WebComp_Docdicionariowc_Component = "HipoteseTratamentoDocDicionarioWC";
            }
            if ( StringUtil.Len( WebComp_Docdicionariowc_Component) != 0 )
            {
               WebComp_Docdicionariowc.setjustcreated();
               WebComp_Docdicionariowc.componentprepare(new Object[] {(string)"W0033",(string)"",(int)AV10HipoteseTratamentoId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10HipoteseTratamentoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10HipoteseTratamentoId", StringUtil.LTrimStr( (decimal)(AV10HipoteseTratamentoId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vHIPOTESETRATAMENTOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10HipoteseTratamentoId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910494841", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("hipotesetratamentoview.js", "?202311910494841", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divHipotesetratamentogeneral_cell_Internalname = "HIPOTESETRATAMENTOGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Hipotese Tratamento View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10HipoteseTratamentoId',fld:'vHIPOTESETRATAMENTOID',pic:'ZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E112O2',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10HipoteseTratamentoId',fld:'vHIPOTESETRATAMENTOID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H002O2_A72HipoteseTratamentoId = new int[1] ;
         H002O2_A73HipoteseTratamentoNome = new string[] {""} ;
         A73HipoteseTratamentoNome = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.hipotesetratamentoview__default(),
            new Object[][] {
                new Object[] {
               H002O2_A72HipoteseTratamentoId, H002O2_A73HipoteseTratamentoNome
               }
            }
         );
      ...
      private int AV10HipoteseTratamentoId ;
      private int wcpOAV10HipoteseTratamentoId ;
      ...
      private string divHipotesetratamentogeneral_cell_Internalname ;
      ...
      private int[] H002O2_A72HipoteseTratamentoId ;
      private string[] H002O2_A73HipoteseTratamentoNome ;
   ...
   public class hipotesetratamentoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10HipoteseTratamentoId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H002O2", "SELECT [HipoteseTratamentoId], [HipoteseTratamentoNome] FROM [HipoteseTratamento] WHERE [HipoteseTratamentoId] = @AV10HipoteseTratamentoId ORDER BY [HipoteseTratamentoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002O2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

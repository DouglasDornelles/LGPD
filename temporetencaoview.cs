...
namespace GeneXus.Programs {
   public class temporetencaoview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public temporetencaoview( )
      {
      ...
      public temporetencaoview( IGxContext context )
      {
      ...
      public void execute( int aP0_TempoRetencaoId ,
                           string aP1_TabCode )
      {
         this.AV10TempoRetencaoId = aP0_TempoRetencaoId;
      ...
      {
         get {
            return "temporetencaoview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "temporetencaoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10TempoRetencaoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("temporetencaoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vTEMPORETENCAOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10TempoRetencaoId), "ZZZZZZZ9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vTEMPORETENCAOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10TempoRetencaoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vTEMPORETENCAOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10TempoRetencaoId), "ZZZZZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "temporetencaoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10TempoRetencaoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("temporetencaoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "TempoRetencaoView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Tempo Retencao View" ;
      }
      ...
      protected void WB4W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Tempo Retencao", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_TempoRetencaoView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTemporetencaogeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDocumento_title_Internalname, "Documento", "", "", lblDocumento_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_TempoRetencaoView.htm");
            /* Div Control */
      ...
      protected void START4W2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Tempo Retencao View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA4W2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "temporetencaoview.aspx")), "temporetencaoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "temporetencaoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10TempoRetencaoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10TempoRetencaoId", StringUtil.LTrimStr( (decimal)(AV10TempoRetencaoId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vTEMPORETENCAOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10TempoRetencaoId), "ZZZZZZZ9"), context));
      ...
      protected void E124W2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("temporetencaoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H004W2 */
         pr_default.execute(0, new Object[] {AV10TempoRetencaoId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A48TempoRetencaoId = H004W2_A48TempoRetencaoId[0];
            A49TempoRetencaoNome = H004W2_A49TempoRetencaoNome[0];
            AV16GXLvl9 = 1;
            Form.Caption = A49TempoRetencaoNome;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "TempoRetencaoGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "temporetencaogeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "TempoRetencaoGeneral";
            WebComp_Webcomponent_general_Component = "TempoRetencaoGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10TempoRetencaoId});
      ...
      protected void S122( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "Documento") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Documentowc_Component), StringUtil.Lower( "TempoRetencaoDocumentoWC")) != 0 )
            {
               WebComp_Documentowc = getWebComponent(GetType(), "GeneXus.Programs", "temporetencaodocumentowc", new Object[] {context} );
               WebComp_Documentowc.ComponentInit();
               WebComp_Documentowc.Name = "TempoRetencaoDocumentoWC";
               WebComp_Documentowc_Component = "TempoRetencaoDocumentoWC";
            }
            if ( StringUtil.Len( WebComp_Documentowc_Component) != 0 )
            {
               WebComp_Documentowc.setjustcreated();
               WebComp_Documentowc.componentprepare(new Object[] {(string)"W0033",(string)"",(int)AV10TempoRetencaoId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10TempoRetencaoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10TempoRetencaoId", StringUtil.LTrimStr( (decimal)(AV10TempoRetencaoId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vTEMPORETENCAOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10TempoRetencaoId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910503996", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("temporetencaoview.js", "?202311910503996", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTemporetencaogeneral_cell_Internalname = "TEMPORETENCAOGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Tempo Retencao View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10TempoRetencaoId',fld:'vTEMPORETENCAOID',pic:'ZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E114W2',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10TempoRetencaoId',fld:'vTEMPORETENCAOID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H004W2_A48TempoRetencaoId = new int[1] ;
         H004W2_A49TempoRetencaoNome = new string[] {""} ;
         A49TempoRetencaoNome = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.temporetencaoview__default(),
            new Object[][] {
                new Object[] {
               H004W2_A48TempoRetencaoId, H004W2_A49TempoRetencaoNome
               }
            }
         );
      ...
      private int AV10TempoRetencaoId ;
      private int wcpOAV10TempoRetencaoId ;
      ...
      private string divTemporetencaogeneral_cell_Internalname ;
      ...
      private int[] H004W2_A48TempoRetencaoId ;
      private string[] H004W2_A49TempoRetencaoNome ;
   ...
   public class temporetencaoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10TempoRetencaoId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H004W2", "SELECT [TempoRetencaoId], [TempoRetencaoNome] FROM [TempoRetencao] WHERE [TempoRetencaoId] = @AV10TempoRetencaoId ORDER BY [TempoRetencaoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004W2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

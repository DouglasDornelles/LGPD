...
namespace GeneXus.Programs {
   public class medidasegurancadocumentowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public medidasegurancadocumentowc( )
      {
      ...
      public medidasegurancadocumentowc( IGxContext context )
      {
      ...
      public void execute( int aP0_MedidaSegurancaId )
      {
         this.AV8MedidaSegurancaId = aP0_MedidaSegurancaId;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "MedidaSegurancaId");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8MedidaSegurancaId = (int)(NumberUtil.Val( GetPar( "MedidaSegurancaId"), "."));
                  AssignAttri(sPrefix, false, "AV8MedidaSegurancaId", StringUtil.LTrimStr( (decimal)(AV8MedidaSegurancaId), 8, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(int)AV8MedidaSegurancaId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV20ManageFiltersExecutionStep, AV36Pgmname, AV14OrderedBy, AV15OrderedDsc, AV16FilterFullText, AV28IsAuthorized_Update, AV33Aba, AV30IsAuthorized_Delete, AV31IsAuthorized_Insert, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV36Pgmname = "MedidaSegurancaDocumentoWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Medida Seguranca Documento WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "medidasegurancadocumentowc.aspx"+UrlEncode(StringUtil.LTrimStr(AV8MedidaSegurancaId,8,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("medidasegurancadocumentowc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8MedidaSegurancaId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV8MedidaSegurancaId), 8, 0, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV31IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vMEDIDASEGURANCAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8MedidaSegurancaId), 8, 0, ",", "")));
      ...
      {
         return "MedidaSegurancaDocumentoWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Medida Seguranca Documento WC" ;
      }
      ...
      protected void WB550( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "medidasegurancadocumentowc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "Inserir", bttBtninsert_Jsonclick, 5, "Inserir", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_MedidaSegurancaDocumentoWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
            wb_table1_24_552( true) ;
         }
         else
         {
            wb_table1_24_552( false) ;
         }
         return  ;
      }

      protected void wb_table1_24_552e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START552( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Medida Seguranca Documento WC", 0) ;
            }
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "medidasegurancadocumentowc.aspx")), "medidasegurancadocumentowc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "medidasegurancadocumentowc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void RF552( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A105DocumentoOperador = H00552_A105DocumentoOperador[0];
               n105DocumentoOperador = H00552_n105DocumentoOperador[0];
               A85DocumentoAtivo = H00552_A85DocumentoAtivo[0];
               n85DocumentoAtivo = H00552_n85DocumentoAtivo[0];
               A84DocumentoFluxoTratDadosDesc = H00552_A84DocumentoFluxoTratDadosDesc[0];
               n84DocumentoFluxoTratDadosDesc = H00552_n84DocumentoFluxoTratDadosDesc[0];
               A83DocumentoMedidaSegurancaDesc = H00552_A83DocumentoMedidaSegurancaDesc[0];
               n83DocumentoMedidaSegurancaDesc = H00552_n83DocumentoMedidaSegurancaDesc[0];
               A82DocumentoDadosGrupoVul = H00552_A82DocumentoDadosGrupoVul[0];
               n82DocumentoDadosGrupoVul = H00552_n82DocumentoDadosGrupoVul[0];
               A81DocumentoDadosCriancaAdolesc = H00552_A81DocumentoDadosCriancaAdolesc[0];
               n81DocumentoDadosCriancaAdolesc = H00552_n81DocumentoDadosCriancaAdolesc[0];
               A80DocumentoBaseLegalNormIntExt = H00552_A80DocumentoBaseLegalNormIntExt[0];
               n80DocumentoBaseLegalNormIntExt = H00552_n80DocumentoBaseLegalNormIntExt[0];
               A79DocumentoBaseLegalNorm = H00552_A79DocumentoBaseLegalNorm[0];
               n79DocumentoBaseLegalNorm = H00552_n79DocumentoBaseLegalNorm[0];
               A78DocumentoPrevColetaDados = H00552_A78DocumentoPrevColetaDados[0];
               n78DocumentoPrevColetaDados = H00552_n78DocumentoPrevColetaDados[0];
               A48TempoRetencaoId = H00552_A48TempoRetencaoId[0];
               n48TempoRetencaoId = H00552_n48TempoRetencaoId[0];
               A45TipoDescarteId = H00552_A45TipoDescarteId[0];
               n45TipoDescarteId = H00552_n45TipoDescarteId[0];
               A39FrequenciaTratamentoId = H00552_A39FrequenciaTratamentoId[0];
               n39FrequenciaTratamentoId = H00552_n39FrequenciaTratamentoId[0];
               A36AbrangenciaGeograficaId = H00552_A36AbrangenciaGeograficaId[0];
               n36AbrangenciaGeograficaId = H00552_n36AbrangenciaGeograficaId[0];
               A33FerramentaColetaId = H00552_A33FerramentaColetaId[0];
               n33FerramentaColetaId = H00552_n33FerramentaColetaId[0];
               A30TipoDadoId = H00552_A30TipoDadoId[0];
               n30TipoDadoId = H00552_n30TipoDadoId[0];
               A27CategoriaId = H00552_A27CategoriaId[0];
               n27CategoriaId = H00552_n27CategoriaId[0];
               A77DocumentoFinalidadeTratamento = H00552_A77DocumentoFinalidadeTratamento[0];
               n77DocumentoFinalidadeTratamento = H00552_n77DocumentoFinalidadeTratamento[0];
               A13PersonaId = H00552_A13PersonaId[0];
               n13PersonaId = H00552_n13PersonaId[0];
               A7EncarregadoId = H00552_A7EncarregadoId[0];
               n7EncarregadoId = H00552_n7EncarregadoId[0];
               A20SubprocessoId = H00552_A20SubprocessoId[0];
               n20SubprocessoId = H00552_n20SubprocessoId[0];
               A76DocumentoNome = H00552_A76DocumentoNome[0];
               n76DocumentoNome = H00552_n76DocumentoNome[0];
               A75DocumentoId = H00552_A75DocumentoId[0];
               E18552 ();
      ...
      protected void STRUP550( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8MedidaSegurancaId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8MedidaSegurancaId"), ",", "."));
      ...
      protected void E16552( )
      {
         ...
         AssignProp(sPrefix, false, edtMedidaSegurancaId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtMedidaSegurancaId_Visible), 5, 0), true);
      ...
      protected void E11552( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("MedidaSegurancaDocumentoWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV36Pgmname+"GridState"));
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("MedidaSegurancaDocumentoWCFilters"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "MedidaSegurancaDocumentoWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "MedidaSegurancaDocumentoWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "MedidaSegurancaId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8MedidaSegurancaId), 8, 0);
         AV10TrnContext.gxTpr_Attributes.Add(AV11TrnContextAtt, 0);
         AV17Session.Set("TrnContext", AV10TrnContext.ToXml(false, true, "", ""));
      }

      protected void wb_table1_24_552( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table2_29_552( true) ;
         }
         else
         {
            wb_table2_29_552( false) ;
         }
         return  ;
      }

      protected void wb_table2_29_552e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_24_552e( true) ;
         }
         else
         {
            wb_table1_24_552e( false) ;
         }
      }

      protected void wb_table2_29_552( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8MedidaSegurancaId = Convert.ToInt32(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8MedidaSegurancaId", StringUtil.LTrimStr( (decimal)(AV8MedidaSegurancaId), 8, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8MedidaSegurancaId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "medidasegurancadocumentowc", GetJustCreated( ));
         ...
         {
            AV8MedidaSegurancaId = Convert.ToInt32(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8MedidaSegurancaId", StringUtil.LTrimStr( (decimal)(AV8MedidaSegurancaId), 8, 0));
         }
         wcpOAV8MedidaSegurancaId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8MedidaSegurancaId"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( AV8MedidaSegurancaId != wcpOAV8MedidaSegurancaId ) ) )
         {
            setjustcreated();
         }
         wcpOAV8MedidaSegurancaId = AV8MedidaSegurancaId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8MedidaSegurancaId = cgiGet( sPrefix+"AV8MedidaSegurancaId_CTRL");
         if ( StringUtil.Len( sCtrlAV8MedidaSegurancaId) > 0 )
         {
            AV8MedidaSegurancaId = (int)(context.localUtil.CToN( cgiGet( sCtrlAV8MedidaSegurancaId), ",", "."));
            AssignAttri(sPrefix, false, "AV8MedidaSegurancaId", StringUtil.LTrimStr( (decimal)(AV8MedidaSegurancaId), 8, 0));
         }
         else
         {
            AV8MedidaSegurancaId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"AV8MedidaSegurancaId_PARM"), ",", "."));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8MedidaSegurancaId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8MedidaSegurancaId), 8, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8MedidaSegurancaId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8MedidaSegurancaId_CTRL", StringUtil.RTrim( sCtrlAV8MedidaSegurancaId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202312417262047", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("medidasegurancadocumentowc.js", "?202312417262048", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "2:DocumentoId|3:DocumentoNome|4:SubprocessoId|5:ControladorId|6:EncarregadoId|7:PersonaId|8:DocumentoFinalidadeTratamento|9:CategoriaId|10:TipoDadoId|11:FerramentaColetaId|12:AbrangenciaGeograficaId|13:FrequenciaTratamentoId|14:TipoDescarteId|15:TempoRetencaoId|16:DocumentoPrevColetaDados|17:DocumentoBaseLegalNorm|18:DocumentoBaseLegalNormIntExt|19:DocumentoDadosCriancaAdolesc|20:DocumentoDadosGrupoVul|21:DocumentoMedidaSegurancaDesc|22:DocumentoFluxoTratDadosDesc|23:DocumentoAtivo|24:DocumentoOperador";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E18552',iparms:[{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A75DocumentoId',fld:'DOCUMENTOID',pic:'ZZZZZZZ9',hsh:true},{av:'AV33Aba',fld:'vABA',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         scmdbuf = "";
         H00552_A105DocumentoOperador = new bool[] {false} ;
         H00552_n105DocumentoOperador = new bool[] {false} ;
         H00552_A85DocumentoAtivo = new bool[] {false} ;
         H00552_n85DocumentoAtivo = new bool[] {false} ;
         H00552_A84DocumentoFluxoTratDadosDesc = new string[] {""} ;
         H00552_n84DocumentoFluxoTratDadosDesc = new bool[] {false} ;
         H00552_A83DocumentoMedidaSegurancaDesc = new string[] {""} ;
         H00552_n83DocumentoMedidaSegurancaDesc = new bool[] {false} ;
         H00552_A82DocumentoDadosGrupoVul = new bool[] {false} ;
         H00552_n82DocumentoDadosGrupoVul = new bool[] {false} ;
         H00552_A81DocumentoDadosCriancaAdolesc = new bool[] {false} ;
         H00552_n81DocumentoDadosCriancaAdolesc = new bool[] {false} ;
         H00552_A80DocumentoBaseLegalNormIntExt = new string[] {""} ;
         H00552_n80DocumentoBaseLegalNormIntExt = new bool[] {false} ;
         H00552_A79DocumentoBaseLegalNorm = new string[] {""} ;
         H00552_n79DocumentoBaseLegalNorm = new bool[] {false} ;
         H00552_A78DocumentoPrevColetaDados = new bool[] {false} ;
         H00552_n78DocumentoPrevColetaDados = new bool[] {false} ;
         H00552_A48TempoRetencaoId = new int[1] ;
         H00552_n48TempoRetencaoId = new bool[] {false} ;
         H00552_A45TipoDescarteId = new int[1] ;
         H00552_n45TipoDescarteId = new bool[] {false} ;
         H00552_A39FrequenciaTratamentoId = new int[1] ;
         H00552_n39FrequenciaTratamentoId = new bool[] {false} ;
         H00552_A36AbrangenciaGeograficaId = new int[1] ;
         H00552_n36AbrangenciaGeograficaId = new bool[] {false} ;
         H00552_A33FerramentaColetaId = new int[1] ;
         H00552_n33FerramentaColetaId = new bool[] {false} ;
         H00552_A30TipoDadoId = new int[1] ;
         H00552_n30TipoDadoId = new bool[] {false} ;
         H00552_A27CategoriaId = new int[1] ;
         H00552_n27CategoriaId = new bool[] {false} ;
         H00552_A77DocumentoFinalidadeTratamento = new string[] {""} ;
         H00552_n77DocumentoFinalidadeTratamento = new bool[] {false} ;
         H00552_A13PersonaId = new int[1] ;
         H00552_n13PersonaId = new bool[] {false} ;
         H00552_A7EncarregadoId = new int[1] ;
         H00552_n7EncarregadoId = new bool[] {false} ;
         H00552_A20SubprocessoId = new int[1] ;
         H00552_n20SubprocessoId = new bool[] {false} ;
         H00552_A76DocumentoNome = new string[] {""} ;
         H00552_n76DocumentoNome = new bool[] {false} ;
         H00552_A75DocumentoId = new int[1] ;
         ...
         sCtrlAV8MedidaSegurancaId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         GXCCtl = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.medidasegurancadocumentowc__default(),
            new Object[][] {
                new Object[] {
               H00552_A105DocumentoOperador, H00552_n105DocumentoOperador, H00552_A85DocumentoAtivo, H00552_n85DocumentoAtivo, H00552_A84DocumentoFluxoTratDadosDesc, H00552_n84DocumentoFluxoTratDadosDesc, H00552_A83DocumentoMedidaSegurancaDesc, H00552_n83DocumentoMedidaSegurancaDesc, H00552_A82DocumentoDadosGrupoVul, H00552_n82DocumentoDadosGrupoVul,
               H00552_A81DocumentoDadosCriancaAdolesc, H00552_n81DocumentoDadosCriancaAdolesc, H00552_A80DocumentoBaseLegalNormIntExt, H00552_n80DocumentoBaseLegalNormIntExt, H00552_A79DocumentoBaseLegalNorm, H00552_n79DocumentoBaseLegalNorm, H00552_A78DocumentoPrevColetaDados, H00552_n78DocumentoPrevColetaDados, H00552_A48TempoRetencaoId, H00552_n48TempoRetencaoId,
               H00552_A45TipoDescarteId, H00552_n45TipoDescarteId, H00552_A39FrequenciaTratamentoId, H00552_n39FrequenciaTratamentoId, H00552_A36AbrangenciaGeograficaId, H00552_n36AbrangenciaGeograficaId, H00552_A33FerramentaColetaId, H00552_n33FerramentaColetaId, H00552_A30TipoDadoId, H00552_n30TipoDadoId,
               H00552_A27CategoriaId, H00552_n27CategoriaId, H00552_A77DocumentoFinalidadeTratamento, H00552_n77DocumentoFinalidadeTratamento, H00552_A13PersonaId, H00552_n13PersonaId, H00552_A7EncarregadoId, H00552_n7EncarregadoId, H00552_A20SubprocessoId, H00552_n20SubprocessoId,
               H00552_A76DocumentoNome, H00552_n76DocumentoNome, H00552_A75DocumentoId
               }
               , new Object[] {
      ...
      private int AV8MedidaSegurancaId ;
      private int wcpOAV8MedidaSegurancaId ;
      ...
      private string sCtrlAV8MedidaSegurancaId ;
      ...
      private bool[] H00552_A105DocumentoOperador ;
      private bool[] H00552_n105DocumentoOperador ;
      private bool[] H00552_A85DocumentoAtivo ;
      private bool[] H00552_n85DocumentoAtivo ;
      private string[] H00552_A84DocumentoFluxoTratDadosDesc ;
      private bool[] H00552_n84DocumentoFluxoTratDadosDesc ;
      private string[] H00552_A83DocumentoMedidaSegurancaDesc ;
      private bool[] H00552_n83DocumentoMedidaSegurancaDesc ;
      private bool[] H00552_A82DocumentoDadosGrupoVul ;
      private bool[] H00552_n82DocumentoDadosGrupoVul ;
      private bool[] H00552_A81DocumentoDadosCriancaAdolesc ;
      private bool[] H00552_n81DocumentoDadosCriancaAdolesc ;
      private string[] H00552_A80DocumentoBaseLegalNormIntExt ;
      private bool[] H00552_n80DocumentoBaseLegalNormIntExt ;
      private string[] H00552_A79DocumentoBaseLegalNorm ;
      private bool[] H00552_n79DocumentoBaseLegalNorm ;
      private bool[] H00552_A78DocumentoPrevColetaDados ;
      private bool[] H00552_n78DocumentoPrevColetaDados ;
      private int[] H00552_A48TempoRetencaoId ;
      private bool[] H00552_n48TempoRetencaoId ;
      private int[] H00552_A45TipoDescarteId ;
      private bool[] H00552_n45TipoDescarteId ;
      private int[] H00552_A39FrequenciaTratamentoId ;
      private bool[] H00552_n39FrequenciaTratamentoId ;
      private int[] H00552_A36AbrangenciaGeograficaId ;
      private bool[] H00552_n36AbrangenciaGeograficaId ;
      private int[] H00552_A33FerramentaColetaId ;
      private bool[] H00552_n33FerramentaColetaId ;
      private int[] H00552_A30TipoDadoId ;
      private bool[] H00552_n30TipoDadoId ;
      private int[] H00552_A27CategoriaId ;
      private bool[] H00552_n27CategoriaId ;
      private string[] H00552_A77DocumentoFinalidadeTratamento ;
      private bool[] H00552_n77DocumentoFinalidadeTratamento ;
      private int[] H00552_A13PersonaId ;
      private bool[] H00552_n13PersonaId ;
      private int[] H00552_A7EncarregadoId ;
      private bool[] H00552_n7EncarregadoId ;
      private int[] H00552_A20SubprocessoId ;
      private bool[] H00552_n20SubprocessoId ;
      private string[] H00552_A76DocumentoNome ;
      private bool[] H00552_n76DocumentoNome ;
      private int[] H00552_A75DocumentoId ;
   ...
   public class medidasegurancadocumentowc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV15OrderedDsc )
      {
         ...
         {
            sOrderString += " ORDER BY [SubprocessoId] DESC";
         }
         ...
         {
            sOrderString += " ORDER BY [EncarregadoId] DESC";
         }
         ...
         {
            sOrderString += " ORDER BY [PersonaId] DESC";
         }
         else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [DocumentoFinalidadeTratamento]";
         }
         else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [DocumentoFinalidadeTratamento] DESC";
         }
         ...
         {
            sOrderString += " ORDER BY [CategoriaId] DESC";
         }
         ...
         {
            sOrderString += " ORDER BY [TipoDadoId] DESC";
         }
         ...
         {
            sOrderString += " ORDER BY [FerramentaColetaId] DESC";
         }
         ...
         {
            sOrderString += " ORDER BY [FrequenciaTratamentoId] DESC";
         }
         ...
         {
            sOrderString += " ORDER BY [DocumentoPrevColetaDados]";
         }
         else if ( ( AV14OrderedBy == 15 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [DocumentoPrevColetaDados] DESC";
         }
         else if ( ( AV14OrderedBy == 16 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [DocumentoBaseLegalNorm]";
         }
         else if ( ( AV14OrderedBy == 16 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [DocumentoBaseLegalNorm] DESC";
         }
         else if ( ( AV14OrderedBy == 17 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [DocumentoBaseLegalNormIntExt]";
         }
         else if ( ( AV14OrderedBy == 17 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [DocumentoBaseLegalNormIntExt] DESC";
         }
         else if ( ( AV14OrderedBy == 18 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [DocumentoDadosCriancaAdolesc]";
         }
         else if ( ( AV14OrderedBy == 18 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [DocumentoDadosCriancaAdolesc] DESC";
         }
         else if ( ( AV14OrderedBy == 19 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [DocumentoDadosGrupoVul]";
         }
         else if ( ( AV14OrderedBy == 19 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [DocumentoDadosGrupoVul] DESC";
         }
         else if ( ( AV14OrderedBy == 20 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [DocumentoMedidaSegurancaDesc]";
         }
         else if ( ( AV14OrderedBy == 20 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [DocumentoMedidaSegurancaDesc] DESC";
         }
         else if ( ( AV14OrderedBy == 21 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [DocumentoFluxoTratDadosDesc]";
         }
         else if ( ( AV14OrderedBy == 21 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [DocumentoFluxoTratDadosDesc] DESC";
         }
         else if ( ( AV14OrderedBy == 22 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [DocumentoAtivo]";
         }
         else if ( ( AV14OrderedBy == 22 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [DocumentoAtivo] DESC";
         }
         else if ( ( AV14OrderedBy == 23 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [DocumentoOperador]";
         }
         else if ( ( AV14OrderedBy == 23 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [DocumentoOperador] DESC";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY [DocumentoId]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00552(context, (short)dynConstraints[0] , (bool)dynConstraints[1] );
               case 1 :
                     return conditional_H00553(context, (short)dynConstraints[0] , (bool)dynConstraints[1] );
         }

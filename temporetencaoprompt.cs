...
namespace GeneXus.Programs {
   public class temporetencaoprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public temporetencaoprompt( )
      {
      ...
      public temporetencaoprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutTempoRetencaoId ,
                           ref string aP1_InOutTempoRetencaoNome )
      {
         this.AV8InOutTempoRetencaoId = aP0_InOutTempoRetencaoId;
         this.AV9InOutTempoRetencaoNome = aP1_InOutTempoRetencaoNome;
         executePrivate();
         aP0_InOutTempoRetencaoId=this.AV8InOutTempoRetencaoId;
         aP1_InOutTempoRetencaoNome=this.AV9InOutTempoRetencaoNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutTempoRetencaoId");
            ...
            {
               AV8InOutTempoRetencaoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutTempoRetencaoId", StringUtil.LTrimStr( (decimal)(AV8InOutTempoRetencaoId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutTempoRetencaoNome = GetPar( "InOutTempoRetencaoNome");
                  AssignAttri("", false, "AV9InOutTempoRetencaoNome", AV9InOutTempoRetencaoNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      {
         get {
            return "temporetencaoprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("temporetencaoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutTempoRetencaoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutTempoRetencaoNome))}, new string[] {"InOutTempoRetencaoId","InOutTempoRetencaoNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTTEMPORETENCAOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutTempoRetencaoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTTEMPORETENCAONOME", AV9InOutTempoRetencaoNome);
      ...
      {
         return formatLink("temporetencaoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutTempoRetencaoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutTempoRetencaoNome))}, new string[] {"InOutTempoRetencaoId","InOutTempoRetencaoNome"})  ;
      }

      public override string GetPgmname( )
      {
         return "TempoRetencaoPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Tempo Retencao" ;
      }
      ...
      protected void wb_table1_14_4Y2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START4Y2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Tempo Retencao", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_TEMPORETENCAONOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A49TempoRetencaoNome, "")), context));
         GxWebStd.gx_hidden_field( context, "TEMPORETENCAONOME", A49TempoRetencaoNome);
      }
      ...
      {
         /* GeneXus formulas. */
         AV22Pgmname = "TempoRetencaoPrompt";
         context.Gx_err = 0;
      ...
      protected void RF4Y2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A50TempoRetencaoAtivo = H004Y2_A50TempoRetencaoAtivo[0];
               A49TempoRetencaoNome = H004Y2_A49TempoRetencaoNome[0];
               A48TempoRetencaoId = H004Y2_A48TempoRetencaoId[0];
               E174Y2 ();
      ...
      protected void send_integrity_lvl_hashes4Y2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_TEMPORETENCAOID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A48TempoRetencaoId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_TEMPORETENCAONOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A49TempoRetencaoNome, "")), context));
      }
      ...
      protected void E154Y2( )
      {
         ...
         Form.Caption = "Consulta de Tempo Retencao";
      ...
      protected void E184Y2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutTempoRetencaoId = A48TempoRetencaoId;
         AssignAttri("", false, "AV8InOutTempoRetencaoId", StringUtil.LTrimStr( (decimal)(AV8InOutTempoRetencaoId), 8, 0));
         AV9InOutTempoRetencaoNome = A49TempoRetencaoNome;
         AssignAttri("", false, "AV9InOutTempoRetencaoNome", AV9InOutTempoRetencaoNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutTempoRetencaoId,(string)AV9InOutTempoRetencaoNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutTempoRetencaoId","AV9InOutTempoRetencaoNome"});
      ...
      protected void wb_table1_14_4Y2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_TempoRetencaoPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutTempoRetencaoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutTempoRetencaoId", StringUtil.LTrimStr( (decimal)(AV8InOutTempoRetencaoId), 8, 0));
         AV9InOutTempoRetencaoNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutTempoRetencaoNome", AV9InOutTempoRetencaoNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910504324", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("temporetencaoprompt.js", "?202311910504324", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtTempoRetencaoId_Internalname = "TEMPORETENCAOID_"+sGXsfl_26_idx;
         edtTempoRetencaoNome_Internalname = "TEMPORETENCAONOME_"+sGXsfl_26_idx;
         cmbTempoRetencaoAtivo_Internalname = "TEMPORETENCAOATIVO_"+sGXsfl_26_idx;
      }

      protected void SubsflControlProps_fel_262( )
      {
         edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx;
         edtTempoRetencaoId_Internalname = "TEMPORETENCAOID_"+sGXsfl_26_fel_idx;
         edtTempoRetencaoNome_Internalname = "TEMPORETENCAONOME_"+sGXsfl_26_fel_idx;
         cmbTempoRetencaoAtivo_Internalname = "TEMPORETENCAOATIVO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "TEMPORETENCAOATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbTempoRetencaoAtivo_Internalname, "Values", (string)(cmbTempoRetencaoAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:TempoRetencaoId|2:TempoRetencaoNome|3:TempoRetencaoAtivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","{handler:'E184Y2',iparms:[{av:'A48TempoRetencaoId',fld:'TEMPORETENCAOID',pic:'ZZZZZZZ9',hsh:true},{av:'A49TempoRetencaoNome',fld:'TEMPORETENCAONOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutTempoRetencaoId',fld:'vINOUTTEMPORETENCAOID',pic:'ZZZZZZZ9'},{av:'AV9InOutTempoRetencaoNome',fld:'vINOUTTEMPORETENCAONOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E144Y2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H004Y2_A50TempoRetencaoAtivo = new bool[] {false} ;
         H004Y2_A49TempoRetencaoNome = new string[] {""} ;
         H004Y2_A48TempoRetencaoId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.temporetencaoprompt__default(),
            new Object[][] {
                new Object[] {
               H004Y2_A50TempoRetencaoAtivo, H004Y2_A49TempoRetencaoNome, H004Y2_A48TempoRetencaoId
               }
               , new Object[] {
      ...
      private int AV8InOutTempoRetencaoId ;
      private int wcpOAV8InOutTempoRetencaoId ;
      ...
      private string AV9InOutTempoRetencaoNome ;
      private string wcpOAV9InOutTempoRetencaoNome ;
      ...
      private int aP0_InOutTempoRetencaoId ;
      private string aP1_InOutTempoRetencaoNome ;
      private GXCombobox cmbTempoRetencaoAtivo ;
      private IDataStoreProvider pr_default ;
      private bool[] H004Y2_A50TempoRetencaoAtivo ;
      private string[] H004Y2_A49TempoRetencaoNome ;
      private int[] H004Y2_A48TempoRetencaoId ;
   ...
   public class temporetencaoprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([TempoRetencaoId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [TempoRetencaoNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and [TempoRetencaoAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and [TempoRetencaoAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H004Y2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
               case 1 :
                     return conditional_H004Y3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
         }

...
namespace GeneXus.Programs {
   public class tipodescarteview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public tipodescarteview( )
      {
      ...
      public tipodescarteview( IGxContext context )
      {
      ...
      public void execute( int aP0_TipoDescarteId ,
                           string aP1_TabCode )
      {
         this.AV10TipoDescarteId = aP0_TipoDescarteId;
      ...
      {
         get {
            return "tipodescarteview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "tipodescarteview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10TipoDescarteId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("tipodescarteview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vTIPODESCARTEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10TipoDescarteId), "ZZZZZZZ9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vTIPODESCARTEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10TipoDescarteId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vTIPODESCARTEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10TipoDescarteId), "ZZZZZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "tipodescarteview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10TipoDescarteId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("tipodescarteview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "TipoDescarteView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Tipo Descarte View" ;
      }
      ...
      protected void WB4R0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Tipo Descarte", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_TipoDescarteView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTipodescartegeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDocumento_title_Internalname, "Documento", "", "", lblDocumento_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_TipoDescarteView.htm");
            /* Div Control */
      ...
      protected void START4R2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Tipo Descarte View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA4R2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "tipodescarteview.aspx")), "tipodescarteview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "tipodescarteview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10TipoDescarteId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10TipoDescarteId", StringUtil.LTrimStr( (decimal)(AV10TipoDescarteId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vTIPODESCARTEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10TipoDescarteId), "ZZZZZZZ9"), context));
      ...
      protected void E124R2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("tipodescarteww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H004R2 */
         pr_default.execute(0, new Object[] {AV10TipoDescarteId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A45TipoDescarteId = H004R2_A45TipoDescarteId[0];
            A46TipoDescarteNome = H004R2_A46TipoDescarteNome[0];
            AV16GXLvl9 = 1;
            Form.Caption = A46TipoDescarteNome;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "TipoDescarteGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "tipodescartegeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "TipoDescarteGeneral";
            WebComp_Webcomponent_general_Component = "TipoDescarteGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10TipoDescarteId});
      ...
      protected void S122( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "Documento") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Documentowc_Component), StringUtil.Lower( "TipoDescarteDocumentoWC")) != 0 )
            {
               WebComp_Documentowc = getWebComponent(GetType(), "GeneXus.Programs", "tipodescartedocumentowc", new Object[] {context} );
               WebComp_Documentowc.ComponentInit();
               WebComp_Documentowc.Name = "TipoDescarteDocumentoWC";
               WebComp_Documentowc_Component = "TipoDescarteDocumentoWC";
            }
            if ( StringUtil.Len( WebComp_Documentowc_Component) != 0 )
            {
               WebComp_Documentowc.setjustcreated();
               WebComp_Documentowc.componentprepare(new Object[] {(string)"W0033",(string)"",(int)AV10TipoDescarteId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10TipoDescarteId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10TipoDescarteId", StringUtil.LTrimStr( (decimal)(AV10TipoDescarteId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vTIPODESCARTEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10TipoDescarteId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910504482", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("tipodescarteview.js", "?202311910504482", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTipodescartegeneral_cell_Internalname = "TIPODESCARTEGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Tipo Descarte View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10TipoDescarteId',fld:'vTIPODESCARTEID',pic:'ZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E114R2',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10TipoDescarteId',fld:'vTIPODESCARTEID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H004R2_A45TipoDescarteId = new int[1] ;
         H004R2_A46TipoDescarteNome = new string[] {""} ;
         A46TipoDescarteNome = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tipodescarteview__default(),
            new Object[][] {
                new Object[] {
               H004R2_A45TipoDescarteId, H004R2_A46TipoDescarteNome
               }
            }
         );
      ...
      private int AV10TipoDescarteId ;
      private int wcpOAV10TipoDescarteId ;
      ...
      private string divTipodescartegeneral_cell_Internalname ;
      ...
      private int[] H004R2_A45TipoDescarteId ;
      private string[] H004R2_A46TipoDescarteNome ;
   ...
   public class tipodescarteview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10TipoDescarteId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H004R2", "SELECT [TipoDescarteId], [TipoDescarteNome] FROM [TipoDescarte] WHERE [TipoDescarteId] = @AV10TipoDescarteId ORDER BY [TipoDescarteId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004R2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

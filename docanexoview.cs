...
namespace GeneXus.Programs {
   public class docanexoview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public docanexoview( )
      {
      ...
      public docanexoview( IGxContext context )
      {
      ...
      public void execute( int aP0_DocAnexoId ,
                           string aP1_TabCode )
      {
         this.AV10DocAnexoId = aP0_DocAnexoId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "DocAnexoId");
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "docanexoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10DocAnexoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("docanexoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vDOCANEXOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10DocAnexoId), "ZZZZZZZ9"), context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vDOCANEXOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10DocAnexoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vDOCANEXOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10DocAnexoId), "ZZZZZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "docanexoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10DocAnexoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("docanexoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      protected void WB6D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Doc Anexo", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_DocAnexoView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divDocanexogeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
      ...
      protected void START6D2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Doc Anexo View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA6D2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "docanexoview.aspx")), "docanexoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "docanexoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10DocAnexoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10DocAnexoId", StringUtil.LTrimStr( (decimal)(AV10DocAnexoId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vDOCANEXOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10DocAnexoId), "ZZZZZZZ9"), context));
      ...
      protected void E116D2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("docanexoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H006D2 */
         pr_default.execute(0, new Object[] {AV10DocAnexoId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A93DocAnexoId = H006D2_A93DocAnexoId[0];
            A94DocAnexoDescricao = H006D2_A94DocAnexoDescricao[0];
            AV16GXLvl9 = 1;
            Form.Caption = A94DocAnexoDescricao;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "DocAnexoGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "docanexogeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "DocAnexoGeneral";
            WebComp_Webcomponent_general_Component = "DocAnexoGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10DocAnexoId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10DocAnexoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10DocAnexoId", StringUtil.LTrimStr( (decimal)(AV10DocAnexoId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vDOCANEXOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10DocAnexoId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910511675", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("docanexoview.js", "?202311910511676", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divDocanexogeneral_cell_Internalname = "DOCANEXOGENERAL_CELL";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10DocAnexoId',fld:'vDOCANEXOID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H006D2_A93DocAnexoId = new int[1] ;
         H006D2_A94DocAnexoDescricao = new string[] {""} ;
         A94DocAnexoDescricao = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.docanexoview__default(),
            new Object[][] {
                new Object[] {
               H006D2_A93DocAnexoId, H006D2_A94DocAnexoDescricao
               }
            }
         );
      ...
      private int wcpOAV10DocAnexoId ;
      ...
      private string divDocanexogeneral_cell_Internalname ;
      ...
      private int[] H006D2_A93DocAnexoId ;
      private string[] H006D2_A94DocAnexoDescricao ;
   ...
   public class docanexoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10DocAnexoId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H006D2", "SELECT [DocAnexoId], [DocAnexoDescricao] FROM [DocAnexo] WHERE [DocAnexoId] = @AV10DocAnexoId ORDER BY [DocAnexoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006D2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

...
namespace GeneXus.Programs {
   public class abrangenciageograficaprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public abrangenciageograficaprompt( )
      {
      ...
      public abrangenciageograficaprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutAbrangenciaGeograficaId ,
                           ref string aP1_InOutAbrangenciaGeograficaNome )
      {
         this.AV8InOutAbrangenciaGeograficaId = aP0_InOutAbrangenciaGeograficaId;
         this.AV9InOutAbrangenciaGeograficaNome = aP1_InOutAbrangenciaGeograficaNome;
         executePrivate();
         aP0_InOutAbrangenciaGeograficaId=this.AV8InOutAbrangenciaGeograficaId;
         aP1_InOutAbrangenciaGeograficaNome=this.AV9InOutAbrangenciaGeograficaNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutAbrangenciaGeograficaId");
            ...
            {
               AV8InOutAbrangenciaGeograficaId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutAbrangenciaGeograficaId", StringUtil.LTrimStr( (decimal)(AV8InOutAbrangenciaGeograficaId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutAbrangenciaGeograficaNome = GetPar( "InOutAbrangenciaGeograficaNome");
                  AssignAttri("", false, "AV9InOutAbrangenciaGeograficaNome", AV9InOutAbrangenciaGeograficaNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      {
         get {
            return "abrangenciageograficaprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("abrangenciageograficaprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutAbrangenciaGeograficaId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutAbrangenciaGeograficaNome))}, new string[] {"InOutAbrangenciaGeograficaId","InOutAbrangenciaGeograficaNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTABRANGENCIAGEOGRAFICAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutAbrangenciaGeograficaId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTABRANGENCIAGEOGRAFICANOME", AV9InOutAbrangenciaGeograficaNome);
      ...
      {
         return formatLink("abrangenciageograficaprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutAbrangenciaGeograficaId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutAbrangenciaGeograficaNome))}, new string[] {"InOutAbrangenciaGeograficaId","InOutAbrangenciaGeograficaNome"})  ;
      }

      public override string GetPgmname( )
      {
         return "AbrangenciaGeograficaPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Abrangencia Geografica" ;
      }
      ...
      protected void WB8N0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_8N2( true) ;
         }
         else
         {
            wb_table1_14_8N2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_8N2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START8N2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Abrangencia Geografica", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_ABRANGENCIAGEOGRAFICANOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A37AbrangenciaGeograficaNome, "")), context));
         GxWebStd.gx_hidden_field( context, "ABRANGENCIAGEOGRAFICANOME", A37AbrangenciaGeograficaNome);
      }
      ...
      {
         /* GeneXus formulas. */
         AV22Pgmname = "AbrangenciaGeograficaPrompt";
         context.Gx_err = 0;
      ...
      protected void RF8N2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A38AbrangenciaGeograficaAtivo = H008N2_A38AbrangenciaGeograficaAtivo[0];
               A37AbrangenciaGeograficaNome = H008N2_A37AbrangenciaGeograficaNome[0];
               A36AbrangenciaGeograficaId = H008N2_A36AbrangenciaGeograficaId[0];
               E178N2 ();
      ...
      protected void send_integrity_lvl_hashes8N2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_ABRANGENCIAGEOGRAFICAID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A36AbrangenciaGeograficaId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_ABRANGENCIAGEOGRAFICANOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A37AbrangenciaGeograficaNome, "")), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         GRID_nRecordCount = H008N3_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void E158N2( )
      {
         ...
         Form.Caption = "Consulta de Abrangencia Geografica";
      ...
      protected void E188N2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutAbrangenciaGeograficaId = A36AbrangenciaGeograficaId;
         AssignAttri("", false, "AV8InOutAbrangenciaGeograficaId", StringUtil.LTrimStr( (decimal)(AV8InOutAbrangenciaGeograficaId), 8, 0));
         AV9InOutAbrangenciaGeograficaNome = A37AbrangenciaGeograficaNome;
         AssignAttri("", false, "AV9InOutAbrangenciaGeograficaNome", AV9InOutAbrangenciaGeograficaNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutAbrangenciaGeograficaId,(string)AV9InOutAbrangenciaGeograficaNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutAbrangenciaGeograficaId","AV9InOutAbrangenciaGeograficaNome"});
      ...
      protected void wb_table1_14_8N2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_AbrangenciaGeograficaPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutAbrangenciaGeograficaId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutAbrangenciaGeograficaId", StringUtil.LTrimStr( (decimal)(AV8InOutAbrangenciaGeograficaId), 8, 0));
         AV9InOutAbrangenciaGeograficaNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutAbrangenciaGeograficaNome", AV9InOutAbrangenciaGeograficaNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910514049", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("abrangenciageograficaprompt.js", "?202311910514049", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtAbrangenciaGeograficaId_Internalname = "ABRANGENCIAGEOGRAFICAID_"+sGXsfl_26_idx;
         edtAbrangenciaGeograficaNome_Internalname = "ABRANGENCIAGEOGRAFICANOME_"+sGXsfl_26_idx;
         cmbAbrangenciaGeograficaAtivo_Internalname = "ABRANGENCIAGEOGRAFICAATIVO_"+sGXsfl_26_idx;
      }

      protected void SubsflControlProps_fel_262( )
      {
         edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx;
         edtAbrangenciaGeograficaId_Internalname = "ABRANGENCIAGEOGRAFICAID_"+sGXsfl_26_fel_idx;
         edtAbrangenciaGeograficaNome_Internalname = "ABRANGENCIAGEOGRAFICANOME_"+sGXsfl_26_fel_idx;
         cmbAbrangenciaGeograficaAtivo_Internalname = "ABRANGENCIAGEOGRAFICAATIVO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "ABRANGENCIAGEOGRAFICAATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbAbrangenciaGeograficaAtivo_Internalname, "Values", (string)(cmbAbrangenciaGeograficaAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:AbrangenciaGeograficaId|2:AbrangenciaGeograficaNome|3:AbrangenciaGeograficaAtivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E178N2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E188N2',iparms:[{av:'A36AbrangenciaGeograficaId',fld:'ABRANGENCIAGEOGRAFICAID',pic:'ZZZZZZZ9',hsh:true},{av:'A37AbrangenciaGeograficaNome',fld:'ABRANGENCIAGEOGRAFICANOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutAbrangenciaGeograficaId',fld:'vINOUTABRANGENCIAGEOGRAFICAID',pic:'ZZZZZZZ9'},{av:'AV9InOutAbrangenciaGeograficaNome',fld:'vINOUTABRANGENCIAGEOGRAFICANOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E148N2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      {
         wcpOAV9InOutAbrangenciaGeograficaNome = "";
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H008N2_A38AbrangenciaGeograficaAtivo = new bool[] {false} ;
         H008N2_A37AbrangenciaGeograficaNome = new string[] {""} ;
         H008N2_A36AbrangenciaGeograficaId = new int[1] ;
         H008N3_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.abrangenciageograficaprompt__default(),
            new Object[][] {
                new Object[] {
               H008N2_A38AbrangenciaGeograficaAtivo, H008N2_A37AbrangenciaGeograficaNome, H008N2_A36AbrangenciaGeograficaId
               }
               , new Object[] {
               H008N3_AGRID_nRecordCount
               }
            }
         );
         AV22Pgmname = "AbrangenciaGeograficaPrompt";
      ...
      private int AV8InOutAbrangenciaGeograficaId ;
      private int wcpOAV8InOutAbrangenciaGeograficaId ;
      ...
      private string AV9InOutAbrangenciaGeograficaNome ;
      private string wcpOAV9InOutAbrangenciaGeograficaNome ;
      ...
      private int aP0_InOutAbrangenciaGeograficaId ;
      private string aP1_InOutAbrangenciaGeograficaNome ;
      private GXCombobox cmbAbrangenciaGeograficaAtivo ;
      private IDataStoreProvider pr_default ;
      private bool[] H008N2_A38AbrangenciaGeograficaAtivo ;
      private string[] H008N2_A37AbrangenciaGeograficaNome ;
      private int[] H008N2_A36AbrangenciaGeograficaId ;
      private long[] H008N3_AGRID_nRecordCount ;
   ...
   public class abrangenciageograficaprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H008N2( IGxContext context ,
                                             string AV13FilterFullText ,
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([AbrangenciaGeograficaId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [AbrangenciaGeograficaNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and [AbrangenciaGeograficaAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and [AbrangenciaGeograficaAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
      ...
      protected Object[] conditional_H008N3( IGxContext context ,
                                             string AV13FilterFullText ,
                                             int A36AbrangenciaGeograficaId ,
                                             string A37AbrangenciaGeograficaNome ,
                                             bool A38AbrangenciaGeograficaAtivo ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H008N2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
               case 1 :
                     return conditional_H008N3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H008N2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008N2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H008N3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008N3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }

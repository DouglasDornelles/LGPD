...
namespace GeneXus.Programs {
   public class encarregadoview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public encarregadoview( )
      {
      ...
      public encarregadoview( IGxContext context )
      {
      ...
      public void execute( int aP0_EncarregadoId ,
                           string aP1_TabCode )
      {
         this.AV10EncarregadoId = aP0_EncarregadoId;
      ...
      {
         get {
            return "encarregadoview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "encarregadoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10EncarregadoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("encarregadoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vENCARREGADOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10EncarregadoId), "ZZZZZZZ9"), context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vENCARREGADOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10EncarregadoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vENCARREGADOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10EncarregadoId), "ZZZZZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "encarregadoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10EncarregadoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("encarregadoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "EncarregadoView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Encarregado View" ;
      }
      ...
      protected void WB3H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Encarregado", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_EncarregadoView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divEncarregadogeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
      ...
      protected void START3H2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Encarregado View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA3H2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "encarregadoview.aspx")), "encarregadoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "encarregadoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10EncarregadoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10EncarregadoId", StringUtil.LTrimStr( (decimal)(AV10EncarregadoId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vENCARREGADOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10EncarregadoId), "ZZZZZZZ9"), context));
      ...
      protected void E113H2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("encarregadoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H003H2 */
         pr_default.execute(0, new Object[] {AV10EncarregadoId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A7EncarregadoId = H003H2_A7EncarregadoId[0];
            A8EncarregadoNome = H003H2_A8EncarregadoNome[0];
            AV16GXLvl9 = 1;
            Form.Caption = A8EncarregadoNome;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "EncarregadoGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "encarregadogeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "EncarregadoGeneral";
            WebComp_Webcomponent_general_Component = "EncarregadoGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10EncarregadoId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10EncarregadoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10EncarregadoId", StringUtil.LTrimStr( (decimal)(AV10EncarregadoId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vENCARREGADOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10EncarregadoId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231191050757", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("encarregadoview.js", "?20231191050757", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divEncarregadogeneral_cell_Internalname = "ENCARREGADOGENERAL_CELL";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10EncarregadoId',fld:'vENCARREGADOID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H003H2_A7EncarregadoId = new int[1] ;
         H003H2_A8EncarregadoNome = new string[] {""} ;
         A8EncarregadoNome = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.encarregadoview__default(),
            new Object[][] {
                new Object[] {
               H003H2_A7EncarregadoId, H003H2_A8EncarregadoNome
               }
            }
         );
      ...
      private int AV10EncarregadoId ;
      private int wcpOAV10EncarregadoId ;
      ...
      private string divEncarregadogeneral_cell_Internalname ;
      ...
      private int[] H003H2_A7EncarregadoId ;
      private string[] H003H2_A8EncarregadoNome ;
   ...
   public class encarregadoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10EncarregadoId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H003H2", "SELECT [EncarregadoId], [EncarregadoNome] FROM [Encarregado] WHERE [EncarregadoId] = @AV10EncarregadoId ORDER BY [EncarregadoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003H2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

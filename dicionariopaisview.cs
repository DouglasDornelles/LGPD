...
namespace GeneXus.Programs {
   public class dicionariopaisview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public dicionariopaisview( )
      {
      ...
      public dicionariopaisview( IGxContext context )
      {
      ...
      {
         get {
            return "dicionariopaisview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "dicionariopaisview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10PaisId,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV11DocDicionarioId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("dicionariopaisview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "dicionariopaisview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10PaisId,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV11DocDicionarioId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("dicionariopaisview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "DicionarioPaisView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Dicionario Pais View" ;
      }
      ...
      protected void WB8U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Dicionario Pais", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_DicionarioPaisView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divDicionariopaisgeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
      ...
      protected void START8U2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Dicionario Pais View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA8U2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "dicionariopaisview.aspx")), "dicionariopaisview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "dicionariopaisview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      protected void E118U2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("dicionariopaisww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV17GXLvl9 = 0;
         /* Using cursor H008U2 */
         pr_default.execute(0, new Object[] {AV10PaisId, AV11DocDicionarioId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A98DocDicionarioId = H008U2_A98DocDicionarioId[0];
            A4PaisId = H008U2_A4PaisId[0];
            AV17GXLvl9 = 1;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "DicionarioPaisGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "dicionariopaisgeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "DicionarioPaisGeneral";
            WebComp_Webcomponent_general_Component = "DicionarioPaisGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10PaisId,(int)AV11DocDicionarioId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910514421", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("dicionariopaisview.js", "?202311910514421", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divDicionariopaisgeneral_cell_Internalname = "DICIONARIOPAISGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Dicionario Pais View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10PaisId',fld:'vPAISID',pic:'ZZZZZZZ9',hsh:true},{av:'AV11DocDicionarioId',fld:'vDOCDICIONARIOID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H008U2_A98DocDicionarioId = new int[1] ;
         H008U2_A4PaisId = new int[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.dicionariopaisview__default(),
            new Object[][] {
                new Object[] {
               H008U2_A98DocDicionarioId, H008U2_A4PaisId
               }
            }
         );
      ...
      private string divDicionariopaisgeneral_cell_Internalname ;
      ...
      private int[] H008U2_A98DocDicionarioId ;
      private int[] H008U2_A4PaisId ;
   ...
   public class dicionariopaisview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmH008U2;
          prmH008U2 = new Object[] {
          new ParDef("@AV10PaisId",GXType.Int32,8,0) ,
          new ParDef("@AV11DocDicionarioId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H008U2", "SELECT [DocDicionarioId], [PaisId] FROM [DicionarioPais] WHERE ([PaisId] = @AV10PaisId and [DocDicionarioId] = @AV11DocDicionarioId) AND ([PaisId] = @AV10PaisId and [DocDicionarioId] = @AV11DocDicionarioId) ORDER BY [PaisId], [DocDicionarioId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008U2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

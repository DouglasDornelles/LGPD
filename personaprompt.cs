...
namespace GeneXus.Programs {
   public class personaprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public personaprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutPersonaId ,
                           ref string aP1_InOutPersonaNome )
      {
         this.AV8InOutPersonaId = aP0_InOutPersonaId;
         this.AV9InOutPersonaNome = aP1_InOutPersonaNome;
         executePrivate();
         aP0_InOutPersonaId=this.AV8InOutPersonaId;
         aP1_InOutPersonaNome=this.AV9InOutPersonaNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutPersonaId");
            ...
            {
               AV8InOutPersonaId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutPersonaId", StringUtil.LTrimStr( (decimal)(AV8InOutPersonaId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutPersonaNome = GetPar( "InOutPersonaNome");
                  AssignAttri("", false, "AV9InOutPersonaNome", AV9InOutPersonaNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("personaprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutPersonaId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutPersonaNome))}, new string[] {"InOutPersonaId","InOutPersonaNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTPERSONAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutPersonaId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTPERSONANOME", AV9InOutPersonaNome);
      ...
      {
         return formatLink("personaprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutPersonaId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutPersonaNome))}, new string[] {"InOutPersonaId","InOutPersonaNome"})  ;
      }
      ...
      protected void START392( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Persona", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_PERSONANOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A14PersonaNome, "")), context));
         GxWebStd.gx_hidden_field( context, "PERSONANOME", A14PersonaNome);
      }
      ...
      protected void RF392( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A15PersonaAtivo = H00392_A15PersonaAtivo[0];
               A14PersonaNome = H00392_A14PersonaNome[0];
               A13PersonaId = H00392_A13PersonaId[0];
               E17392 ();
      ...
      protected void send_integrity_lvl_hashes392( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_PERSONAID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A13PersonaId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_PERSONANOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A14PersonaNome, "")), context));
      }
      ...
      protected void E15392( )
      {
         ...
         Form.Caption = "Consulta de Persona";
      ...
      protected void E18392( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutPersonaId = A13PersonaId;
         AssignAttri("", false, "AV8InOutPersonaId", StringUtil.LTrimStr( (decimal)(AV8InOutPersonaId), 8, 0));
         AV9InOutPersonaNome = A14PersonaNome;
         AssignAttri("", false, "AV9InOutPersonaNome", AV9InOutPersonaNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutPersonaId,(string)AV9InOutPersonaNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutPersonaId","AV9InOutPersonaNome"});
      ...
      protected void wb_table1_14_392( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_PersonaPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutPersonaId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutPersonaId", StringUtil.LTrimStr( (decimal)(AV8InOutPersonaId), 8, 0));
         AV9InOutPersonaNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutPersonaNome", AV9InOutPersonaNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910495147", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("personaprompt.js", "?202311910495147", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtPersonaNome_Internalname = "PERSONANOME_"+sGXsfl_26_idx;
         cmbPersonaAtivo_Internalname = "PERSONAATIVO_"+sGXsfl_26_idx;
      }
      ...
      protected void SubsflControlProps_fel_262( )
      {
         ...
         edtPersonaNome_Internalname = "PERSONANOME_"+sGXsfl_26_fel_idx;
         cmbPersonaAtivo_Internalname = "PERSONAATIVO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "PERSONAATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbPersonaAtivo_Internalname, "Values", (string)(cmbPersonaAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:PersonaId|2:PersonaNome|3:PersonaAtivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","{handler:'E18392',iparms:[{av:'A13PersonaId',fld:'PERSONAID',pic:'ZZZZZZZ9',hsh:true},{av:'A14PersonaNome',fld:'PERSONANOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutPersonaId',fld:'vINOUTPERSONAID',pic:'ZZZZZZZ9'},{av:'AV9InOutPersonaNome',fld:'vINOUTPERSONANOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E14392',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H00392_A15PersonaAtivo = new bool[] {false} ;
         H00392_A14PersonaNome = new string[] {""} ;
         H00392_A13PersonaId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.personaprompt__default(),
            new Object[][] {
                new Object[] {
               H00392_A15PersonaAtivo, H00392_A14PersonaNome, H00392_A13PersonaId
               }
               , new Object[] {
      ...
      private int AV8InOutPersonaId ;
      private int wcpOAV8InOutPersonaId ;
      ...
      private string AV9InOutPersonaNome ;
      private string wcpOAV9InOutPersonaNome ;
      ...
      private int aP0_InOutPersonaId ;
      private string aP1_InOutPersonaNome ;
      private GXCombobox cmbPersonaAtivo ;
      private IDataStoreProvider pr_default ;
      private bool[] H00392_A15PersonaAtivo ;
      private string[] H00392_A14PersonaNome ;
      private int[] H00392_A13PersonaId ;
   ...
   public class personaprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([PersonaId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [PersonaNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and [PersonaAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and [PersonaAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00392(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
               case 1 :
                     return conditional_H00393(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
         }

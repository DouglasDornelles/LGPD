...
namespace GeneXus.Programs {
   public class campoprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public campoprompt( )
      {
      ...
      public campoprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutCampoId ,
                           ref string aP1_InOutCampoNome )
      {
         this.AV8InOutCampoId = aP0_InOutCampoId;
         this.AV9InOutCampoNome = aP1_InOutCampoNome;
         executePrivate();
         aP0_InOutCampoId=this.AV8InOutCampoId;
         aP1_InOutCampoNome=this.AV9InOutCampoNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutCampoId");
            ...
            {
               AV8InOutCampoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutCampoId", StringUtil.LTrimStr( (decimal)(AV8InOutCampoId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutCampoNome = GetPar( "InOutCampoNome");
                  AssignAttri("", false, "AV9InOutCampoNome", AV9InOutCampoNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("campoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutCampoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutCampoNome))}, new string[] {"InOutCampoId","InOutCampoNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTCAMPOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutCampoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTCAMPONOME", AV9InOutCampoNome);
      ...
      {
         return formatLink("campoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutCampoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutCampoNome))}, new string[] {"InOutCampoId","InOutCampoNome"})  ;
      }
      ...
      protected void WB8G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_8G2( true) ;
         }
         else
         {
            wb_table1_14_8G2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_8G2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START8G2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Campo", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_CAMPONOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A136CampoNome, "")), context));
      ...
      protected void RF8G2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV12OrderedDsc } ,
                                                 new int[]{
                                                 TypeConstants.INT, TypeConstants.BOOLEAN, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.BOOLEAN
                                                 }
            });
            ...
            {
               A133TelaId = H008G2_A133TelaId[0];
               A138CampoAtivo = H008G2_A138CampoAtivo[0];
               A136CampoNome = H008G2_A136CampoNome[0];
               A135CampoId = H008G2_A135CampoId[0];
               E178G2 ();
      ...
      protected void send_integrity_lvl_hashes8G2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_CAMPOID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A135CampoId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_CAMPONOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A136CampoNome, "")), context));
      }
      ...
      protected void E158G2( )
      {
         ...
         Form.Caption = "Consulta de Campo";
      ...
      protected void E188G2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutCampoId = A135CampoId;
         AssignAttri("", false, "AV8InOutCampoId", StringUtil.LTrimStr( (decimal)(AV8InOutCampoId), 8, 0));
         AV9InOutCampoNome = A136CampoNome;
         AssignAttri("", false, "AV9InOutCampoNome", AV9InOutCampoNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutCampoId,(string)AV9InOutCampoNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutCampoId","AV9InOutCampoNome"});
      ...
      protected void wb_table1_14_8G2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_CampoPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutCampoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutCampoId", StringUtil.LTrimStr( (decimal)(AV8InOutCampoId), 8, 0));
         AV9InOutCampoNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutCampoNome", AV9InOutCampoNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910512946", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("campoprompt.js", "?202311910512946", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtCampoId_Internalname = "CAMPOID_"+sGXsfl_26_idx;
         edtCampoNome_Internalname = "CAMPONOME_"+sGXsfl_26_idx;
         cmbCampoAtivo_Internalname = "CAMPOATIVO_"+sGXsfl_26_idx;
         edtTelaId_Internalname = "TELAID_"+sGXsfl_26_idx;
      }

      protected void SubsflControlProps_fel_262( )
      {
         edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx;
         edtCampoId_Internalname = "CAMPOID_"+sGXsfl_26_fel_idx;
         edtCampoNome_Internalname = "CAMPONOME_"+sGXsfl_26_fel_idx;
         cmbCampoAtivo_Internalname = "CAMPOATIVO_"+sGXsfl_26_fel_idx;
         edtTelaId_Internalname = "TELAID_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "CAMPOATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbCampoAtivo_Internalname, "Values", (string)(cmbCampoAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:CampoId|2:CampoNome|3:CampoAtivo|4:TelaId";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E178G2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E188G2',iparms:[{av:'A135CampoId',fld:'CAMPOID',pic:'ZZZZZZZ9',hsh:true},{av:'A136CampoNome',fld:'CAMPONOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutCampoId',fld:'vINOUTCAMPOID',pic:'ZZZZZZZ9'},{av:'AV9InOutCampoNome',fld:'vINOUTCAMPONOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E148G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         ...
         setEventMetadata("NULL","{handler:'Valid_Telaid',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H008G2_A133TelaId = new int[1] ;
         H008G2_A138CampoAtivo = new bool[] {false} ;
         H008G2_A136CampoNome = new string[] {""} ;
         H008G2_A135CampoId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.campoprompt__default(),
            new Object[][] {
                new Object[] {
               H008G2_A133TelaId, H008G2_A138CampoAtivo, H008G2_A136CampoNome, H008G2_A135CampoId
               }
               , new Object[] {
      ...
      private int AV8InOutCampoId ;
      private int wcpOAV8InOutCampoId ;
      ...
      private string AV9InOutCampoNome ;
      private string wcpOAV9InOutCampoNome ;
      ...
      private int aP0_InOutCampoId ;
      private string aP1_InOutCampoNome ;
      private GXCombobox cmbCampoAtivo ;
      private IDataStoreProvider pr_default ;
      private int[] H008G2_A133TelaId ;
      private bool[] H008G2_A138CampoAtivo ;
      private string[] H008G2_A136CampoNome ;
      private int[] H008G2_A135CampoId ;
   ...
   public class campoprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [TelaId], [CampoAtivo], [CampoNome], [CampoId]";
         sFromString = " FROM [Campo]";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13FilterFullText)) )
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([CampoId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [CampoNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and [CampoAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and [CampoAtivo] = 0) or ( CONVERT( char(8), CAST([TelaId] AS decimal(8,0))) like '%' + @lV13FilterFullText))");
         }
         else
         {
            GXv_int3[0] = 1;
         ...
         {
            sOrderString += " ORDER BY [CampoNome]";
         }
         else if ( ( AV11OrderedBy == 1 ) && ( AV12OrderedDsc ) )
         {
            sOrderString += " ORDER BY [CampoNome] DESC";
         }
         ...
         {
            sOrderString += " ORDER BY [CampoId] DESC";
         }
         else if ( ( AV11OrderedBy == 3 ) && ! AV12OrderedDsc )
         {
            sOrderString += " ORDER BY [CampoAtivo]";
         }
         else if ( ( AV11OrderedBy == 3 ) && ( AV12OrderedDsc ) )
         {
            sOrderString += " ORDER BY [CampoAtivo] DESC";
         }
         ...
         {
            sOrderString += " ORDER BY [TelaId] DESC";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY [CampoId]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H008G2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (int)dynConstraints[4] , (short)dynConstraints[5] , (bool)dynConstraints[6] );
               case 1 :
                     return conditional_H008G3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (int)dynConstraints[4] , (short)dynConstraints[5] , (bool)dynConstraints[6] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H008G2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008G2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H008G3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008G3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }

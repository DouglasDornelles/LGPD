...
namespace GeneXus.Programs {
   public class operadorview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public operadorview( )
      {
      ...
      public operadorview( IGxContext context )
      {
      ...
      public void execute( int aP0_OperadorId ,
                           string aP1_TabCode )
      {
         this.AV10OperadorId = aP0_OperadorId;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "operadorview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10OperadorId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("operadorview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vOPERADORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10OperadorId), "ZZZZZZZ9"), context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vOPERADORID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10OperadorId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vOPERADORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10OperadorId), "ZZZZZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "operadorview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10OperadorId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("operadorview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      protected void WB4M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Operador", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_OperadorView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divOperadorgeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
      ...
      protected void START4M2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Operador View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA4M2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "operadorview.aspx")), "operadorview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "operadorview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10OperadorId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10OperadorId", StringUtil.LTrimStr( (decimal)(AV10OperadorId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vOPERADORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10OperadorId), "ZZZZZZZ9"), context));
      ...
      protected void E114M2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("operadorww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H004M2 */
         pr_default.execute(0, new Object[] {AV10OperadorId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A42OperadorId = H004M2_A42OperadorId[0];
            A43OperadorNome = H004M2_A43OperadorNome[0];
            AV16GXLvl9 = 1;
            Form.Caption = A43OperadorNome;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "OperadorGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "operadorgeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "OperadorGeneral";
            WebComp_Webcomponent_general_Component = "OperadorGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10OperadorId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10OperadorId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10OperadorId", StringUtil.LTrimStr( (decimal)(AV10OperadorId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vOPERADORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10OperadorId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910502724", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("operadorview.js", "?202311910502724", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divOperadorgeneral_cell_Internalname = "OPERADORGENERAL_CELL";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10OperadorId',fld:'vOPERADORID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H004M2_A42OperadorId = new int[1] ;
         H004M2_A43OperadorNome = new string[] {""} ;
         A43OperadorNome = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.operadorview__default(),
            new Object[][] {
                new Object[] {
               H004M2_A42OperadorId, H004M2_A43OperadorNome
               }
            }
         );
      ...
      private int AV10OperadorId ;
      private int wcpOAV10OperadorId ;
      ...
      private string divOperadorgeneral_cell_Internalname ;
      ...
      private int[] H004M2_A42OperadorId ;
      private string[] H004M2_A43OperadorNome ;
   ...
   public class operadorview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10OperadorId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H004M2", "SELECT [OperadorId], [OperadorNome] FROM [Operador] WHERE [OperadorId] = @AV10OperadorId ORDER BY [OperadorId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004M2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

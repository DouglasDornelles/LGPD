...
namespace GeneXus.Programs {
   ...
   public class ferramentacoletawwexport__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV18OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( [FerramentaColetaNome] like '%' + @lV46Ferramentacoletawwds_1_filterfulltext) or ( 'sim' like '%' + LOWER(@lV46Ferramentacoletawwds_1_filterfulltext) and [FerramentaColetaAtivo] = 1) or ( 'não' like '%' + LOWER(@lV46Ferramentacoletawwds_1_filterfulltext) and [FerramentaColetaAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;

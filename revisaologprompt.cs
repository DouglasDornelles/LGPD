...
namespace GeneXus.Programs {
   public class revisaologprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public revisaologprompt( )
      {
      ...
      public revisaologprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutRevisaoLogId ,
                           ref string aP1_InOutRevisaoLogUsuarioAlteracao )
      {
         this.AV8InOutRevisaoLogId = aP0_InOutRevisaoLogId;
         this.AV9InOutRevisaoLogUsuarioAlteracao = aP1_InOutRevisaoLogUsuarioAlteracao;
         executePrivate();
         aP0_InOutRevisaoLogId=this.AV8InOutRevisaoLogId;
         aP1_InOutRevisaoLogUsuarioAlteracao=this.AV9InOutRevisaoLogUsuarioAlteracao;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutRevisaoLogId");
            ...
            {
               AV8InOutRevisaoLogId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutRevisaoLogId", StringUtil.LTrimStr( (decimal)(AV8InOutRevisaoLogId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutRevisaoLogUsuarioAlteracao = GetPar( "InOutRevisaoLogUsuarioAlteracao");
                  AssignAttri("", false, "AV9InOutRevisaoLogUsuarioAlteracao", AV9InOutRevisaoLogUsuarioAlteracao);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      {
         get {
            return "revisaologprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("revisaologprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutRevisaoLogId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutRevisaoLogUsuarioAlteracao))}, new string[] {"InOutRevisaoLogId","InOutRevisaoLogUsuarioAlteracao"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTREVISAOLOGID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutRevisaoLogId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTREVISAOLOGUSUARIOALTERACAO", AV9InOutRevisaoLogUsuarioAlteracao);
      ...
      {
         return formatLink("revisaologprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutRevisaoLogId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutRevisaoLogUsuarioAlteracao))}, new string[] {"InOutRevisaoLogId","InOutRevisaoLogUsuarioAlteracao"})  ;
      }

      public override string GetPgmname( )
      {
         return "RevisaoLogPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Revisao Log" ;
      }
      ...
      protected void WB8R0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_8R2( true) ;
         }
         else
         {
            wb_table1_14_8R2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_8R2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START8R2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Revisao Log", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_REVISAOLOGUSUARIOALTERACAO", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A121RevisaoLogUsuarioAlteracao, "")), context));
         GxWebStd.gx_hidden_field( context, "REVISAOLOGUSUARIOALTERACAO", A121RevisaoLogUsuarioAlteracao);
      }
      ...
      protected void RF8R2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A75DocumentoId = H008R2_A75DocumentoId[0];
               A123RevisaoLogDataAlteracao = H008R2_A123RevisaoLogDataAlteracao[0];
               A122RevisaoLogObservacao = H008R2_A122RevisaoLogObservacao[0];
               A121RevisaoLogUsuarioAlteracao = H008R2_A121RevisaoLogUsuarioAlteracao[0];
               A120RevisaoLogId = H008R2_A120RevisaoLogId[0];
               E178R2 ();
      ...
      protected void send_integrity_lvl_hashes8R2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_REVISAOLOGID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A120RevisaoLogId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_REVISAOLOGUSUARIOALTERACAO"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A121RevisaoLogUsuarioAlteracao, "")), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         GRID_nRecordCount = H008R3_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void E158R2( )
      {
         ...
         Form.Caption = "Consulta de Revisao Log";
      ...
      protected void E188R2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutRevisaoLogId = A120RevisaoLogId;
         AssignAttri("", false, "AV8InOutRevisaoLogId", StringUtil.LTrimStr( (decimal)(AV8InOutRevisaoLogId), 8, 0));
         AV9InOutRevisaoLogUsuarioAlteracao = A121RevisaoLogUsuarioAlteracao;
         AssignAttri("", false, "AV9InOutRevisaoLogUsuarioAlteracao", AV9InOutRevisaoLogUsuarioAlteracao);
         context.setWebReturnParms(new Object[] {(int)AV8InOutRevisaoLogId,(string)AV9InOutRevisaoLogUsuarioAlteracao});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutRevisaoLogId","AV9InOutRevisaoLogUsuarioAlteracao"});
      ...
      protected void wb_table1_14_8R2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_RevisaoLogPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutRevisaoLogId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutRevisaoLogId", StringUtil.LTrimStr( (decimal)(AV8InOutRevisaoLogId), 8, 0));
         AV9InOutRevisaoLogUsuarioAlteracao = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutRevisaoLogUsuarioAlteracao", AV9InOutRevisaoLogUsuarioAlteracao);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910514285", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("revisaologprompt.js", "?202311910514287", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtRevisaoLogId_Internalname = "REVISAOLOGID_"+sGXsfl_26_idx;
         edtRevisaoLogUsuarioAlteracao_Internalname = "REVISAOLOGUSUARIOALTERACAO_"+sGXsfl_26_idx;
         edtRevisaoLogObservacao_Internalname = "REVISAOLOGOBSERVACAO_"+sGXsfl_26_idx;
         edtRevisaoLogDataAlteracao_Internalname = "REVISAOLOGDATAALTERACAO_"+sGXsfl_26_idx;
      ...
      protected void SubsflControlProps_fel_262( )
      {
         ...
         edtRevisaoLogId_Internalname = "REVISAOLOGID_"+sGXsfl_26_fel_idx;
         edtRevisaoLogUsuarioAlteracao_Internalname = "REVISAOLOGUSUARIOALTERACAO_"+sGXsfl_26_fel_idx;
         edtRevisaoLogObservacao_Internalname = "REVISAOLOGOBSERVACAO_"+sGXsfl_26_fel_idx;
         edtRevisaoLogDataAlteracao_Internalname = "REVISAOLOGDATAALTERACAO_"+sGXsfl_26_fel_idx;
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:RevisaoLogId|2:RevisaoLogUsuarioAlteracao|3:RevisaoLogObservacao|4:RevisaoLogDataAlteracao|5:DocumentoId";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E178R2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E188R2',iparms:[{av:'A120RevisaoLogId',fld:'REVISAOLOGID',pic:'ZZZZZZZ9',hsh:true},{av:'A121RevisaoLogUsuarioAlteracao',fld:'REVISAOLOGUSUARIOALTERACAO',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutRevisaoLogId',fld:'vINOUTREVISAOLOGID',pic:'ZZZZZZZ9'},{av:'AV9InOutRevisaoLogUsuarioAlteracao',fld:'vINOUTREVISAOLOGUSUARIOALTERACAO',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E148R2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      {
         wcpOAV9InOutRevisaoLogUsuarioAlteracao = "";
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H008R2_A75DocumentoId = new int[1] ;
         H008R2_A123RevisaoLogDataAlteracao = new DateTime[] {DateTime.MinValue} ;
         H008R2_A122RevisaoLogObservacao = new string[] {""} ;
         H008R2_A121RevisaoLogUsuarioAlteracao = new string[] {""} ;
         H008R2_A120RevisaoLogId = new int[1] ;
         H008R3_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.revisaologprompt__default(),
            new Object[][] {
                new Object[] {
               H008R2_A75DocumentoId, H008R2_A123RevisaoLogDataAlteracao, H008R2_A122RevisaoLogObservacao, H008R2_A121RevisaoLogUsuarioAlteracao, H008R2_A120RevisaoLogId
               }
               , new Object[] {
               H008R3_AGRID_nRecordCount
               }
            }
         );
         AV22Pgmname = "RevisaoLogPrompt";
      ...
      private int AV8InOutRevisaoLogId ;
      private int wcpOAV8InOutRevisaoLogId ;
      ...
      private string AV9InOutRevisaoLogUsuarioAlteracao ;
      private string wcpOAV9InOutRevisaoLogUsuarioAlteracao ;
      ...
      private int aP0_InOutRevisaoLogId ;
      private string aP1_InOutRevisaoLogUsuarioAlteracao ;
      private IDataStoreProvider pr_default ;
      private int[] H008R2_A75DocumentoId ;
      private DateTime[] H008R2_A123RevisaoLogDataAlteracao ;
      private string[] H008R2_A122RevisaoLogObservacao ;
      private string[] H008R2_A121RevisaoLogUsuarioAlteracao ;
      private int[] H008R2_A120RevisaoLogId ;
      private long[] H008R3_AGRID_nRecordCount ;
   ...
   public class revisaologprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H008R2( IGxContext context ,
                                             string AV13FilterFullText ,
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([RevisaoLogId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [RevisaoLogUsuarioAlteracao] like '%' + @lV13FilterFullText) or ( [RevisaoLogObservacao] like '%' + @lV13FilterFullText) or ( CONVERT( char(8), CAST([DocumentoId] AS decimal(8,0))) like '%' + @lV13FilterFullText))");
         }
         else
         {
            GXv_int3[0] = 1;
      ...
      protected Object[] conditional_H008R3( IGxContext context ,
                                             string AV13FilterFullText ,
                                             int A120RevisaoLogId ,
                                             string A121RevisaoLogUsuarioAlteracao ,
                                             string A122RevisaoLogObservacao ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H008R2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (int)dynConstraints[4] , (short)dynConstraints[5] , (bool)dynConstraints[6] );
               case 1 :
                     return conditional_H008R3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (int)dynConstraints[4] , (short)dynConstraints[5] , (bool)dynConstraints[6] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H008R2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008R2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H008R3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008R3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }

   ...
   public class gamroleselect : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void WB1P0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_16_1P2( true) ;
         }
         else
         {
            wb_table1_16_1P2( false) ;
         }
         return  ;
      }

      protected void wb_table1_16_1P2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void E111P2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            if (returnInSub) return;
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("GAMRoleSelectFilters")) + "," + UrlEncode(StringUtil.RTrim(AV43Pgmname+"GridState"));
      ...
      protected void S122( )
      {
         ...
         {
            AV30GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV43Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV30GridState.FromXml(AV32Session.Get(AV43Pgmname+"GridState"), null, "", "");
         }
         /* Execute user subroutine: 'LOADREGFILTERSSTATE' */
         S152 ();
         if (returnInSub) return;
      ...
      protected void S132( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV43Pgmname+"GridState",  AV30GridState.ToXml(false, true, "", "")) ;
      }

      protected void wb_table1_16_1P2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            wb_table2_21_1P2( true) ;
         }
         else
         {
            wb_table2_21_1P2( false) ;
         }
         return  ;
      }

      protected void wb_table2_21_1P2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_16_1P2e( true) ;
         }
         else
         {
            wb_table1_16_1P2e( false) ;
         }
      }

      protected void wb_table2_21_1P2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_21_1P2e( true) ;
         }
         else
         {
            wb_table2_21_1P2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910481670", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamroleselect.js", "?202311910481671", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E171P2',iparms:[{av:'AV21RoleIdAux',fld:'vROLEIDAUX',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV11FilName',fld:'vFILNAME',pic:''},{av:'AV10FilExternalId',fld:'vFILEXTERNALID',pic:''}]");
         ...
         setEventMetadata("'DOADD'","{handler:'E141P2',iparms:[{av:'AV21RoleIdAux',fld:'vROLEIDAUX',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV22Select',fld:'vSELECT',grid:40,pic:''},{av:'GRID_nFirstRecordOnPage'},{av:'nRC_GXsfl_40',ctrl:'GRID',grid:40,prop:'GridRC',grid:40},{av:'AV15Id',fld:'vID',grid:40,pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV16isOK',fld:'vISOK',pic:''}]");

...
namespace GeneXus.Programs {
   public class tipodadoww : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void initialize_properties( )
      {
         ...
         Dvelop_confirmpanel_btnexcluir_Confirmationtext = "Confirma a exclusão do Tipo de Dado?";
   ...
   public class tipodadoww__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV14OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( [TipoDadoNome] like '%' + @lV55Tipodadowwds_1_filterfulltext) or ( 'sim' like '%' + LOWER(@lV55Tipodadowwds_1_filterfulltext) and [TipoDadoAtivo] = 1) or ( 'não' like '%' + LOWER(@lV55Tipodadowwds_1_filterfulltext) and [TipoDadoAtivo] = 0))");
         }
         else
         {
            GXv_int5[0] = 1;

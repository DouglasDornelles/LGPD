...
namespace GeneXus.Programs {
   public class gamwwconnections : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void gxnrGrid_newrow_invoke( )
      {
         ...
         AssignProp("", false, edtavBtnkeys_Internalname, "Title", edtavBtnkeys_Title, !bGXsfl_42_Refreshing);
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV51ManageFiltersExecutionStep, AV45ColumnsSelector, AV74Pgmname, AV11FilName, AV65IsAuthorized_Display, AV66IsAuthorized_Update, AV67IsAuthorized_Delete, AV70IsAuthorized_BtnKeys, AV17IsAuthorized_Name, AV68IsAuthorized_Insert) ;
      ...
      protected void WB1J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtneditcolumns_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(42), 2, 0)+","+"null"+");", "Selecionar colunas", bttBtneditcolumns_Jsonclick, 0, "Selecionar colunas", "", StyleString, ClassString, 1, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMWWConnections.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void initialize_formulas( )
      {
         ...
         AssignProp("", false, edtavBtnkeys_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavBtnkeys_Enabled), 5, 0), !bGXsfl_42_Refreshing);
         edtavName_Enabled = 0;
      ...
      private void E181J2( )
      {
         ...
         AV75GXV1 = 1;
         while ( AV75GXV1 <= AV60GAMConnections.Count )
         {
            AV20RepositoryConnection = ((GeneXus.Programs.genexussecurity.SdtGAMRepositoryConnection)AV60GAMConnections.Item(AV75GXV1));
      ...
      protected void E111J2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            if (returnInSub) return;
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("GAMWWConnectionsFilters")) + "," + UrlEncode(StringUtil.RTrim(AV74Pgmname+"GridState"));
         ...
         else
         {
            ...
            else
            {
               ...
               S162 ();
               if (returnInSub) return;
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV74Pgmname+"GridState",  AV52ManageFiltersXml) ;
      ...
      protected void S132( )
      {
         ...
         if ( ! ( AV70IsAuthorized_BtnKeys ) )
         {
            ...
            AssignProp("", false, edtavBtnkeys_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavBtnkeys_Visible), 5, 0), !bGXsfl_42_Refreshing);
         }
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV50Session.Get(AV74Pgmname+"GridState"), "") == 0 )
         {
            AV31GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV74Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV31GridState.FromXml(AV50Session.Get(AV74Pgmname+"GridState"), null, "", "");
         }
         /* Execute user subroutine: 'LOADREGFILTERSSTATE' */
         S172 ();
         if (returnInSub) return;
      ...
      protected void S172( )
      {
         ...
         returnInSub = false;
         AV76GXV2 = 1;
         while ( AV76GXV2 <= AV31GridState.gxTpr_Filtervalues.Count )
         {
            AV32GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV31GridState.gxTpr_Filtervalues.Item(AV76GXV2));
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV74Pgmname+"GridState",  AV31GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231191048191", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamwwconnections.js", "?20231191048195", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_422( )
      {
         ...
         edtavBtnkeys_Internalname = "vBTNKEYS_"+sGXsfl_42_idx;
      ...
      protected void SubsflControlProps_fel_422( )
      {
         ...
         edtavBtnkeys_Internalname = "vBTNKEYS_"+sGXsfl_42_fel_idx;
      ...
      protected void sendrow_422( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_42_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+((edtavBtnkeys_Visible==0) ? "display:none;" : "")+"\">") ;
            }
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavBtnkeys_Internalname,StringUtil.RTrim( AV69BtnKeys),(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtavBtnkeys_Link,(string)"",(string)"Chaves",(string)"",(string)edtavBtnkeys_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWIconActionColumn hidden-xs",(string)"",(int)edtavBtnkeys_Visible,(int)edtavBtnkeys_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)1,(short)42,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void StartGridControl42( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( "") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+((edtavBtnkeys_Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"left"+"\" "+" width="+StringUtil.LTrimStr( (decimal)(570), 4, 0)+"px"+" class=\""+"Attribute"+"\" "+" style=\""+((edtavUsername_Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", StringUtil.RTrim( AV69BtnKeys));
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'edtavBtnkeys_Title',ctrl:'vBTNKEYS',prop:'Title'},{av:'AV51ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV45ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV74Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV11FilName',fld:'vFILNAME',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV66IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV67IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV70IsAuthorized_BtnKeys',fld:'vISAUTHORIZED_BTNKEYS',pic:'',hsh:true},{av:'AV17IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true},{av:'AV68IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E121J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV51ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV45ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV74Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV11FilName',fld:'vFILNAME',pic:''},{av:'edtavBtnkeys_Title',ctrl:'vBTNKEYS',prop:'Title'},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV66IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV67IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV70IsAuthorized_BtnKeys',fld:'vISAUTHORIZED_BTNKEYS',pic:'',hsh:true},{av:'AV17IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true},{av:'AV68IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E181J2',iparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11FilName',fld:'vFILNAME',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV66IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV67IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV70IsAuthorized_BtnKeys',fld:'vISAUTHORIZED_BTNKEYS',pic:'',hsh:true},{av:'AV17IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true}]");

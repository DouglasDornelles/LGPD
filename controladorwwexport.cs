...
namespace GeneXus.Programs {
   ...
   public class controladorwwexport__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV18OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( [ControladorNome] like '%' + @lV46Controladorwwds_1_filterfulltext) or ( 'sim' like '%' + LOWER(@lV46Controladorwwds_1_filterfulltext) and [ControladorAtivo] = 1) or ( 'não' like '%' + LOWER(@lV46Controladorwwds_1_filterfulltext) and [ControladorAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;

...
namespace GeneXus.Programs {
   public class documentodocdicionariowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public documentodocdicionariowc( )
      {
      ...
      public documentodocdicionariowc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(int)AV8DocumentoId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV32IsAuthorized_InformacaoNome = StringUtil.StrToBool( GetPar( "IsAuthorized_InformacaoNome"));
         AV33IsAuthorized_HipoteseTratamentoNome = StringUtil.StrToBool( GetPar( "IsAuthorized_HipoteseTratamentoNome"));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV8DocumentoId, AV20ManageFiltersExecutionStep, AV38Pgmname, AV14OrderedBy, AV15OrderedDsc, AV16FilterFullText, AV28IsAuthorized_Update, AV30IsAuthorized_Delete, AV32IsAuthorized_InformacaoNome, AV33IsAuthorized_HipoteseTratamentoNome, AV34IsAuthorized_PaisNome, A4PaisId, AV35IsAuthorized_Insert, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV38Pgmname = "DocumentoDocDicionarioWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Documento Doc Dicionario WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "documentodocdicionariowc.aspx"+UrlEncode(StringUtil.LTrimStr(AV8DocumentoId,8,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("documentodocdicionariowc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INFORMACAONOME", GetSecureSignedToken( sPrefix, AV32IsAuthorized_InformacaoNome, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_HIPOTESETRATAMENTONOME", GetSecureSignedToken( sPrefix, AV33IsAuthorized_HipoteseTratamentoNome, context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( sPrefix, AV30IsAuthorized_Delete, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INFORMACAONOME", AV32IsAuthorized_InformacaoNome);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INFORMACAONOME", GetSecureSignedToken( sPrefix, AV32IsAuthorized_InformacaoNome, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_HIPOTESETRATAMENTONOME", AV33IsAuthorized_HipoteseTratamentoNome);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_HIPOTESETRATAMENTONOME", GetSecureSignedToken( sPrefix, AV33IsAuthorized_HipoteseTratamentoNome, context));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV35IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vDOCUMENTOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8DocumentoId), 8, 0, ",", "")));
      ...
      {
         return "DocumentoDocDicionarioWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Documento Doc Dicionario WC" ;
      }
      ...
      protected void WB690( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "documentodocdicionariowc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "Inserir", bttBtninsert_Jsonclick, 5, "Inserir", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_DocumentoDocDicionarioWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
            wb_table1_24_692( true) ;
         }
         else
         {
            wb_table1_24_692( false) ;
         }
         return  ;
      }

      protected void wb_table1_24_692e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START692( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Documento Doc Dicionario WC", 0) ;
            }
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "documentodocdicionariowc.aspx")), "documentodocdicionariowc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "documentodocdicionariowc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       bool AV32IsAuthorized_InformacaoNome ,
                                       bool AV33IsAuthorized_HipoteseTratamentoNome ,
      ...
      protected void RF692( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00692 */
            pr_default.execute(0, new Object[] {AV8DocumentoId, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_39_idx = 1;
            sGXsfl_39_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_39_idx), 4, 0), 4, "0");
            SubsflControlProps_392( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A75DocumentoId = H00692_A75DocumentoId[0];
               AssignAttri(sPrefix, false, "A75DocumentoId", StringUtil.LTrimStr( (decimal)(A75DocumentoId), 8, 0));
               A119DocDicionarioTipoTransfInterGa = H00692_A119DocDicionarioTipoTransfInterGa[0];
               A73HipoteseTratamentoNome = H00692_A73HipoteseTratamentoNome[0];
               A70InformacaoNome = H00692_A70InformacaoNome[0];
               A103DocDicionarioDataInclusao = H00692_A103DocDicionarioDataInclusao[0];
               A102DocDicionarioFinalidade = H00692_A102DocDicionarioFinalidade[0];
               A101DocDicionarioTransfInter = H00692_A101DocDicionarioTransfInter[0];
               A100DocDicionarioPodeEliminar = H00692_A100DocDicionarioPodeEliminar[0];
               A99DocDicionarioSensivel = H00692_A99DocDicionarioSensivel[0];
               A72HipoteseTratamentoId = H00692_A72HipoteseTratamentoId[0];
               A69InformacaoId = H00692_A69InformacaoId[0];
               A98DocDicionarioId = H00692_A98DocDicionarioId[0];
               A73HipoteseTratamentoNome = H00692_A73HipoteseTratamentoNome[0];
               A70InformacaoNome = H00692_A70InformacaoNome[0];
               E18692 ();
      ...
      protected void E16692( )
      {
         ...
         GXt_boolean1 = AV32IsAuthorized_InformacaoNome;
         ...
         AV32IsAuthorized_InformacaoNome = GXt_boolean1;
         AssignAttri(sPrefix, false, "AV32IsAuthorized_InformacaoNome", AV32IsAuthorized_InformacaoNome);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INFORMACAONOME", GetSecureSignedToken( sPrefix, AV32IsAuthorized_InformacaoNome, context));
         GXt_boolean1 = AV33IsAuthorized_HipoteseTratamentoNome;
         ...
         AV33IsAuthorized_HipoteseTratamentoNome = GXt_boolean1;
         AssignAttri(sPrefix, false, "AV33IsAuthorized_HipoteseTratamentoNome", AV33IsAuthorized_HipoteseTratamentoNome);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_HIPOTESETRATAMENTONOME", GetSecureSignedToken( sPrefix, AV33IsAuthorized_HipoteseTratamentoNome, context));
      ...
      private void E18692( )
      {
         ...
         if ( AV32IsAuthorized_InformacaoNome )
         {
            GXKey = Crypto.GetSiteKey( );
         ...
         if ( AV33IsAuthorized_HipoteseTratamentoNome )
         {
            GXKey = Crypto.GetSiteKey( );
      ...
      protected void E11692( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("DocumentoDocDicionarioWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV38Pgmname+"GridState"));
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("DocumentoDocDicionarioWCFilters"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "DocumentoDocDicionarioWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "DocumentoDocDicionarioWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "DocumentoId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8DocumentoId), 8, 0);
         AV10TrnContext.gxTpr_Attributes.Add(AV11TrnContextAtt, 0);
         AV17Session.Set("TrnContext", AV10TrnContext.ToXml(false, true, "", ""));
      }

      protected void wb_table1_24_692( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table2_29_692( true) ;
         }
         else
         {
            wb_table2_29_692( false) ;
         }
         return  ;
      }

      protected void wb_table2_29_692e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_24_692e( true) ;
         }
         else
         {
            wb_table1_24_692e( false) ;
         }
      }

      protected void wb_table2_29_692( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8DocumentoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8DocumentoId", StringUtil.LTrimStr( (decimal)(AV8DocumentoId), 8, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8DocumentoId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "documentodocdicionariowc", GetJustCreated( ));
         ...
         {
            AV8DocumentoId = Convert.ToInt32(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8DocumentoId", StringUtil.LTrimStr( (decimal)(AV8DocumentoId), 8, 0));
         }
         wcpOAV8DocumentoId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8DocumentoId"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( AV8DocumentoId != wcpOAV8DocumentoId ) ) )
         {
            setjustcreated();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910445727", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("documentodocdicionariowc.js", "?202311910445727", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_392( )
      {
         ...
         edtHipoteseTratamentoId_Internalname = sPrefix+"HIPOTESETRATAMENTOID_"+sGXsfl_39_idx;
         ...
         edtHipoteseTratamentoNome_Internalname = sPrefix+"HIPOTESETRATAMENTONOME_"+sGXsfl_39_idx;
         edtPaisNome_Internalname = sPrefix+"PAISNOME_"+sGXsfl_39_idx;
         edtDocDicionarioTipoTransfInterGa_Internalname = sPrefix+"DOCDICIONARIOTIPOTRANSFINTERGA_"+sGXsfl_39_idx;
      }
      ...
      protected void SubsflControlProps_fel_392( )
      {
         ...
         edtHipoteseTratamentoId_Internalname = sPrefix+"HIPOTESETRATAMENTOID_"+sGXsfl_39_fel_idx;
         ...
         edtHipoteseTratamentoNome_Internalname = sPrefix+"HIPOTESETRATAMENTONOME_"+sGXsfl_39_fel_idx;
         edtPaisNome_Internalname = sPrefix+"PAISNOME_"+sGXsfl_39_fel_idx;
         edtDocDicionarioTipoTransfInterGa_Internalname = sPrefix+"DOCDICIONARIOTIPOTRANSFINTERGA_"+sGXsfl_39_fel_idx;
      }
      ...
      protected void sendrow_392( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_39_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtHipoteseTratamentoId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A72HipoteseTratamentoId), 8, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A72HipoteseTratamentoId), "ZZZZZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtHipoteseTratamentoId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)39,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtHipoteseTratamentoNome_Internalname,(string)A73HipoteseTratamentoNome,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)edtHipoteseTratamentoNome_Link,(string)"",(string)"",(string)"",(string)edtHipoteseTratamentoNome_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)100,(short)0,(short)0,(short)39,(short)0,(short)-1,(short)-1,(bool)true,(string)"Nome",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl39( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Id da Hipótese de Tratamento") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Id do País") ;
            context.WriteHtmlTextNl( "</th>") ;
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnssortvalues = "2|3|4|5|1|6|7|8|9|10|11|12|13";
         Ddo_grid_Columnids = "2:DocDicionarioId|3:InformacaoId|4:HipoteseTratamentoId|5:PaisId|6:DocDicionarioSensivel|7:DocDicionarioPodeEliminar|8:DocDicionarioTransfInter|9:DocDicionarioFinalidade|10:DocDicionarioDataInclusao|11:InformacaoNome|12:HipoteseTratamentoNome|13:PaisNome|14:DocDicionarioTipoTransfInterGarantia";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8DocumentoId',fld:'vDOCUMENTOID',pic:'ZZZZZZZ9'},{av:'A4PaisId',fld:'PAISID',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_InformacaoNome',fld:'vISAUTHORIZED_INFORMACAONOME',pic:'',hsh:true},{av:'AV33IsAuthorized_HipoteseTratamentoNome',fld:'vISAUTHORIZED_HIPOTESETRATAMENTONOME',pic:'',hsh:true},{av:'AV34IsAuthorized_PaisNome',fld:'vISAUTHORIZED_PAISNOME',pic:'',hsh:true},{av:'AV35IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV25GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV26GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV35IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{av:'AV18ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E12692',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8DocumentoId',fld:'vDOCUMENTOID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_InformacaoNome',fld:'vISAUTHORIZED_INFORMACAONOME',pic:'',hsh:true},{av:'AV33IsAuthorized_HipoteseTratamentoNome',fld:'vISAUTHORIZED_HIPOTESETRATAMENTONOME',pic:'',hsh:true},{av:'AV34IsAuthorized_PaisNome',fld:'vISAUTHORIZED_PAISNOME',pic:'',hsh:true},{av:'A4PaisId',fld:'PAISID',pic:'ZZZZZZZ9'},{av:'AV35IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E13692',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8DocumentoId',fld:'vDOCUMENTOID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_InformacaoNome',fld:'vISAUTHORIZED_INFORMACAONOME',pic:'',hsh:true},{av:'AV33IsAuthorized_HipoteseTratamentoNome',fld:'vISAUTHORIZED_HIPOTESETRATAMENTONOME',pic:'',hsh:true},{av:'AV34IsAuthorized_PaisNome',fld:'vISAUTHORIZED_PAISNOME',pic:'',hsh:true},{av:'A4PaisId',fld:'PAISID',pic:'ZZZZZZZ9'},{av:'AV35IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E14692',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8DocumentoId',fld:'vDOCUMENTOID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_InformacaoNome',fld:'vISAUTHORIZED_INFORMACAONOME',pic:'',hsh:true},{av:'AV33IsAuthorized_HipoteseTratamentoNome',fld:'vISAUTHORIZED_HIPOTESETRATAMENTONOME',pic:'',hsh:true},{av:'AV34IsAuthorized_PaisNome',fld:'vISAUTHORIZED_PAISNOME',pic:'',hsh:true},{av:'A4PaisId',fld:'PAISID',pic:'ZZZZZZZ9'},{av:'AV35IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E18692',iparms:[{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A98DocDicionarioId',fld:'DOCDICIONARIOID',pic:'ZZZZZZZ9',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_InformacaoNome',fld:'vISAUTHORIZED_INFORMACAONOME',pic:'',hsh:true},{av:'A69InformacaoId',fld:'INFORMACAOID',pic:'ZZZZZZZ9'},{av:'AV33IsAuthorized_HipoteseTratamentoNome',fld:'vISAUTHORIZED_HIPOTESETRATAMENTONOME',pic:'',hsh:true},{av:'A72HipoteseTratamentoId',fld:'HIPOTESETRATAMENTOID',pic:'ZZZZZZZ9'},{av:'AV34IsAuthorized_PaisNome',fld:'vISAUTHORIZED_PAISNOME',pic:'',hsh:true},{av:'A4PaisId',fld:'PAISID',pic:'ZZZZZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV27Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV29Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtInformacaoNome_Link',ctrl:'INFORMACAONOME',prop:'Link'},{av:'edtHipoteseTratamentoNome_Link',ctrl:'HIPOTESETRATAMENTONOME',prop:'Link'},{av:'edtPaisNome_Link',ctrl:'PAISNOME',prop:'Link'}]}");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'E11692',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8DocumentoId',fld:'vDOCUMENTOID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_InformacaoNome',fld:'vISAUTHORIZED_INFORMACAONOME',pic:'',hsh:true},{av:'AV33IsAuthorized_HipoteseTratamentoNome',fld:'vISAUTHORIZED_HIPOTESETRATAMENTONOME',pic:'',hsh:true},{av:'AV34IsAuthorized_PaisNome',fld:'vISAUTHORIZED_PAISNOME',pic:'',hsh:true},{av:'A4PaisId',fld:'PAISID',pic:'ZZZZZZZ9'},{av:'AV35IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",",oparms:[{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'},{av:'AV24GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV25GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV26GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV35IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{av:'AV18ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''}]}");
         setEventMetadata("'DOINSERT'","{handler:'E15692',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8DocumentoId',fld:'vDOCUMENTOID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_InformacaoNome',fld:'vISAUTHORIZED_INFORMACAONOME',pic:'',hsh:true},{av:'AV33IsAuthorized_HipoteseTratamentoNome',fld:'vISAUTHORIZED_HIPOTESETRATAMENTONOME',pic:'',hsh:true},{av:'AV34IsAuthorized_PaisNome',fld:'vISAUTHORIZED_PAISNOME',pic:'',hsh:true},{av:'A4PaisId',fld:'PAISID',pic:'ZZZZZZZ9'},{av:'AV35IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'A98DocDicionarioId',fld:'DOCDICIONARIOID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         scmdbuf = "";
         H00692_A75DocumentoId = new int[1] ;
         H00692_A119DocDicionarioTipoTransfInterGa = new string[] {""} ;
         H00692_A73HipoteseTratamentoNome = new string[] {""} ;
         H00692_A70InformacaoNome = new string[] {""} ;
         H00692_A103DocDicionarioDataInclusao = new DateTime[] {DateTime.MinValue} ;
         H00692_A102DocDicionarioFinalidade = new string[] {""} ;
         H00692_A101DocDicionarioTransfInter = new bool[] {false} ;
         H00692_A100DocDicionarioPodeEliminar = new bool[] {false} ;
         H00692_A99DocDicionarioSensivel = new bool[] {false} ;
         H00692_A72HipoteseTratamentoId = new int[1] ;
         H00692_A69InformacaoId = new int[1] ;
         H00692_A98DocDicionarioId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.documentodocdicionariowc__default(),
            new Object[][] {
                new Object[] {
               H00692_A75DocumentoId, H00692_A119DocDicionarioTipoTransfInterGa, H00692_A73HipoteseTratamentoNome, H00692_A70InformacaoNome, H00692_A103DocDicionarioDataInclusao, H00692_A102DocDicionarioFinalidade, H00692_A101DocDicionarioTransfInter, H00692_A100DocDicionarioPodeEliminar, H00692_A99DocDicionarioSensivel, H00692_A72HipoteseTratamentoId,
               H00692_A69InformacaoId, H00692_A98DocDicionarioId
               }
               , new Object[] {
      ...
      private bool AV32IsAuthorized_InformacaoNome ;
      private bool AV33IsAuthorized_HipoteseTratamentoNome ;
      ...
      private int[] H00692_A75DocumentoId ;
      private string[] H00692_A119DocDicionarioTipoTransfInterGa ;
      private string[] H00692_A73HipoteseTratamentoNome ;
      private string[] H00692_A70InformacaoNome ;
      private DateTime[] H00692_A103DocDicionarioDataInclusao ;
      private string[] H00692_A102DocDicionarioFinalidade ;
      private bool[] H00692_A101DocDicionarioTransfInter ;
      private bool[] H00692_A100DocDicionarioPodeEliminar ;
      private bool[] H00692_A99DocDicionarioSensivel ;
      private int[] H00692_A72HipoteseTratamentoId ;
      private int[] H00692_A69InformacaoId ;
      private int[] H00692_A98DocDicionarioId ;
   ...
   public class documentodocdicionariowc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int A75DocumentoId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.[DocumentoId], T1.[DocDicionarioTipoTransfInterGa], T2.[HipoteseTratamentoNome], T3.[InformacaoNome], T1.[DocDicionarioDataInclusao], T1.[DocDicionarioFinalidade], T1.[DocDicionarioTransfInter], T1.[DocDicionarioPodeEliminar], T1.[DocDicionarioSensivel], T1.[HipoteseTratamentoId], T1.[InformacaoId], T1.[DocDicionarioId]";
         sFromString = " FROM (([DocDicionario] T1 INNER JOIN [HipoteseTratamento] T2 ON T2.[HipoteseTratamentoId] = T1.[HipoteseTratamentoId]) INNER JOIN [Informacao] T3 ON T3.[InformacaoId] = T1.[InformacaoId])";
         sOrderString = "";
         AddWhere(sWhereString, "(T1.[DocumentoId] = @AV8DocumentoId)");
         if ( ( AV14OrderedBy == 1 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.[DocumentoId], T1.[DocDicionarioSensivel]";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[DocumentoId] DESC, T1.[DocDicionarioSensivel] DESC";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.[DocumentoId], T1.[DocDicionarioId]";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[DocumentoId] DESC, T1.[DocDicionarioId] DESC";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.[DocumentoId], T1.[InformacaoId]";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[DocumentoId] DESC, T1.[InformacaoId] DESC";
         }
         else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.[DocumentoId], T1.[HipoteseTratamentoId]";
         }
         else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[DocumentoId] DESC, T1.[HipoteseTratamentoId] DESC";
         }
         ...
         {
            sOrderString += " ORDER BY T1.[DocumentoId], T1.[DocDicionarioPodeEliminar]";
         }
         else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[DocumentoId] DESC, T1.[DocDicionarioPodeEliminar] DESC";
         }
         else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.[DocumentoId], T1.[DocDicionarioTransfInter]";
         }
         else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[DocumentoId] DESC, T1.[DocDicionarioTransfInter] DESC";
         }
         else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.[DocumentoId], T1.[DocDicionarioFinalidade]";
         }
         else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[DocumentoId] DESC, T1.[DocDicionarioFinalidade] DESC";
         }
         else if ( ( AV14OrderedBy == 9 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.[DocumentoId], T1.[DocDicionarioDataInclusao]";
         }
         else if ( ( AV14OrderedBy == 9 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[DocumentoId] DESC, T1.[DocDicionarioDataInclusao] DESC";
         }
         else if ( ( AV14OrderedBy == 10 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.[DocumentoId], T3.[InformacaoNome]";
         }
         else if ( ( AV14OrderedBy == 10 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[DocumentoId] DESC, T3.[InformacaoNome] DESC";
         }
         else if ( ( AV14OrderedBy == 11 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.[DocumentoId], T2.[HipoteseTratamentoNome]";
         }
         else if ( ( AV14OrderedBy == 11 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[DocumentoId] DESC, T2.[HipoteseTratamentoNome] DESC";
         }
         ...
         {
            sOrderString += " ORDER BY T1.[DocumentoId], T1.[DocDicionarioTipoTransfInterGa]";
         }
         else if ( ( AV14OrderedBy == 13 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[DocumentoId] DESC, T1.[DocDicionarioTipoTransfInterGa] DESC";
         }
         else if ( true )
         {
                                             ...
                                             int A75DocumentoId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM (([DocDicionario] T1 INNER JOIN [HipoteseTratamento] T3 ON T3.[HipoteseTratamentoId] = T1.[HipoteseTratamentoId]) INNER JOIN [Informacao] T2 ON T2.[InformacaoId] = T1.[InformacaoId])";
         AddWhere(sWhereString, "(T1.[DocumentoId] = @AV8DocumentoId)");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00692(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (int)dynConstraints[2] , (int)dynConstraints[3] );
               case 1 :
                     return conditional_H00693(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (int)dynConstraints[2] , (int)dynConstraints[3] );
         }

...
namespace GeneXus.Programs {
   public class personaview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public personaview( )
      {
      ...
      public personaview( IGxContext context )
      {
      ...
      public void execute( int aP0_PersonaId ,
                           string aP1_TabCode )
      {
         this.AV10PersonaId = aP0_PersonaId;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "personaview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10PersonaId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("personaview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vPERSONAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10PersonaId), "ZZZZZZZ9"), context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPERSONAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10PersonaId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vPERSONAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10PersonaId), "ZZZZZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "personaview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10PersonaId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("personaview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      protected void WB370( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Persona", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_PersonaView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divPersonageneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
      ...
      protected void START372( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Persona View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA372( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "personaview.aspx")), "personaview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "personaview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10PersonaId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10PersonaId", StringUtil.LTrimStr( (decimal)(AV10PersonaId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vPERSONAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10PersonaId), "ZZZZZZZ9"), context));
      ...
      protected void E11372( )
      {
         ...
         lblWorkwithlink_Link = formatLink("personaww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H00372 */
         pr_default.execute(0, new Object[] {AV10PersonaId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A13PersonaId = H00372_A13PersonaId[0];
            A14PersonaNome = H00372_A14PersonaNome[0];
            AV16GXLvl9 = 1;
            Form.Caption = A14PersonaNome;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "PersonaGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "personageneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "PersonaGeneral";
            WebComp_Webcomponent_general_Component = "PersonaGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10PersonaId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10PersonaId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10PersonaId", StringUtil.LTrimStr( (decimal)(AV10PersonaId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vPERSONAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10PersonaId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910495049", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("personaview.js", "?202311910495049", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divPersonageneral_cell_Internalname = "PERSONAGENERAL_CELL";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10PersonaId',fld:'vPERSONAID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00372_A13PersonaId = new int[1] ;
         H00372_A14PersonaNome = new string[] {""} ;
         A14PersonaNome = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.personaview__default(),
            new Object[][] {
                new Object[] {
               H00372_A13PersonaId, H00372_A14PersonaNome
               }
            }
         );
      ...
      private int AV10PersonaId ;
      private int wcpOAV10PersonaId ;
      ...
      private string divPersonageneral_cell_Internalname ;
      ...
      private int[] H00372_A13PersonaId ;
      private string[] H00372_A14PersonaNome ;
   ...
   public class personaview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10PersonaId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H00372", "SELECT [PersonaId], [PersonaNome] FROM [Persona] WHERE [PersonaId] = @AV10PersonaId ORDER BY [PersonaId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00372,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

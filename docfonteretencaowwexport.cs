...
namespace GeneXus.Programs {
   public class docfonteretencaowwexport : GXProcedure
   {
      ...
      protected void S131( )
      {
         ...
         {
            GXt_int1 = (short)(AV14CellRow);
            new GeneXus.Programs.wwpbaseobjects.wwp_exportwritefilter(context ).execute( ref  AV11ExcelDocument,  true, ref  GXt_int1,  (short)(AV15FirstColumn),  "Fonte Retenção") ;
            AV14CellRow = GXt_int1;
      ...
      protected void S151( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV24ColumnsSelector,  "FonteRetencaoId",  "",  "Fonte Retenção",  true,  "") ;

...
namespace GeneXus.Programs {
   public class envolvidoscoletaprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public envolvidoscoletaprompt( )
      {
      ...
      public envolvidoscoletaprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutEnvolvidosColetaId ,
                           ref string aP1_InOutEnvolvidosColetaNome )
      {
         this.AV8InOutEnvolvidosColetaId = aP0_InOutEnvolvidosColetaId;
         this.AV9InOutEnvolvidosColetaNome = aP1_InOutEnvolvidosColetaNome;
         executePrivate();
         aP0_InOutEnvolvidosColetaId=this.AV8InOutEnvolvidosColetaId;
         aP1_InOutEnvolvidosColetaNome=this.AV9InOutEnvolvidosColetaNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutEnvolvidosColetaId");
            ...
            {
               AV8InOutEnvolvidosColetaId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutEnvolvidosColetaId", StringUtil.LTrimStr( (decimal)(AV8InOutEnvolvidosColetaId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutEnvolvidosColetaNome = GetPar( "InOutEnvolvidosColetaNome");
                  AssignAttri("", false, "AV9InOutEnvolvidosColetaNome", AV9InOutEnvolvidosColetaNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      {
         get {
            return "envolvidoscoletaprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("envolvidoscoletaprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutEnvolvidosColetaId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutEnvolvidosColetaNome))}, new string[] {"InOutEnvolvidosColetaId","InOutEnvolvidosColetaNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTENVOLVIDOSCOLETAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutEnvolvidosColetaId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTENVOLVIDOSCOLETANOME", AV9InOutEnvolvidosColetaNome);
      ...
      {
         return formatLink("envolvidoscoletaprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutEnvolvidosColetaId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutEnvolvidosColetaNome))}, new string[] {"InOutEnvolvidosColetaId","InOutEnvolvidosColetaNome"})  ;
      }

      public override string GetPgmname( )
      {
         return "EnvolvidosColetaPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Envolvidos Coleta" ;
      }
      ...
      protected void WB580( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_582( true) ;
         }
         else
         {
            wb_table1_14_582( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_582e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START582( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Envolvidos Coleta", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_ENVOLVIDOSCOLETANOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A55EnvolvidosColetaNome, "")), context));
         GxWebStd.gx_hidden_field( context, "ENVOLVIDOSCOLETANOME", A55EnvolvidosColetaNome);
      }
      ...
      {
         /* GeneXus formulas. */
         AV22Pgmname = "EnvolvidosColetaPrompt";
         context.Gx_err = 0;
      ...
      protected void RF582( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A56EnvolvidosColetaAtivo = H00582_A56EnvolvidosColetaAtivo[0];
               A55EnvolvidosColetaNome = H00582_A55EnvolvidosColetaNome[0];
               A54EnvolvidosColetaId = H00582_A54EnvolvidosColetaId[0];
               E17582 ();
      ...
      protected void send_integrity_lvl_hashes582( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_ENVOLVIDOSCOLETAID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A54EnvolvidosColetaId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_ENVOLVIDOSCOLETANOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A55EnvolvidosColetaNome, "")), context));
      }
      ...
      protected void E15582( )
      {
         ...
         Form.Caption = "Consulta de Envolvidos Coleta";
      ...
      protected void E18582( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutEnvolvidosColetaId = A54EnvolvidosColetaId;
         AssignAttri("", false, "AV8InOutEnvolvidosColetaId", StringUtil.LTrimStr( (decimal)(AV8InOutEnvolvidosColetaId), 8, 0));
         AV9InOutEnvolvidosColetaNome = A55EnvolvidosColetaNome;
         AssignAttri("", false, "AV9InOutEnvolvidosColetaNome", AV9InOutEnvolvidosColetaNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutEnvolvidosColetaId,(string)AV9InOutEnvolvidosColetaNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutEnvolvidosColetaId","AV9InOutEnvolvidosColetaNome"});
      ...
      protected void wb_table1_14_582( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_EnvolvidosColetaPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutEnvolvidosColetaId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutEnvolvidosColetaId", StringUtil.LTrimStr( (decimal)(AV8InOutEnvolvidosColetaId), 8, 0));
         AV9InOutEnvolvidosColetaNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutEnvolvidosColetaNome", AV9InOutEnvolvidosColetaNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910504868", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("envolvidoscoletaprompt.js", "?202311910504869", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtEnvolvidosColetaId_Internalname = "ENVOLVIDOSCOLETAID_"+sGXsfl_26_idx;
         edtEnvolvidosColetaNome_Internalname = "ENVOLVIDOSCOLETANOME_"+sGXsfl_26_idx;
         cmbEnvolvidosColetaAtivo_Internalname = "ENVOLVIDOSCOLETAATIVO_"+sGXsfl_26_idx;
      }

      protected void SubsflControlProps_fel_262( )
      {
         edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx;
         edtEnvolvidosColetaId_Internalname = "ENVOLVIDOSCOLETAID_"+sGXsfl_26_fel_idx;
         edtEnvolvidosColetaNome_Internalname = "ENVOLVIDOSCOLETANOME_"+sGXsfl_26_fel_idx;
         cmbEnvolvidosColetaAtivo_Internalname = "ENVOLVIDOSCOLETAATIVO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "ENVOLVIDOSCOLETAATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbEnvolvidosColetaAtivo_Internalname, "Values", (string)(cmbEnvolvidosColetaAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:EnvolvidosColetaId|2:EnvolvidosColetaNome|3:EnvolvidosColetaAtivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E17582',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E18582',iparms:[{av:'A54EnvolvidosColetaId',fld:'ENVOLVIDOSCOLETAID',pic:'ZZZZZZZ9',hsh:true},{av:'A55EnvolvidosColetaNome',fld:'ENVOLVIDOSCOLETANOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutEnvolvidosColetaId',fld:'vINOUTENVOLVIDOSCOLETAID',pic:'ZZZZZZZ9'},{av:'AV9InOutEnvolvidosColetaNome',fld:'vINOUTENVOLVIDOSCOLETANOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E14582',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      {
         wcpOAV9InOutEnvolvidosColetaNome = "";
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H00582_A56EnvolvidosColetaAtivo = new bool[] {false} ;
         H00582_A55EnvolvidosColetaNome = new string[] {""} ;
         H00582_A54EnvolvidosColetaId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.envolvidoscoletaprompt__default(),
            new Object[][] {
                new Object[] {
               H00582_A56EnvolvidosColetaAtivo, H00582_A55EnvolvidosColetaNome, H00582_A54EnvolvidosColetaId
               }
               , new Object[] {
      ...
      private int AV8InOutEnvolvidosColetaId ;
      private int wcpOAV8InOutEnvolvidosColetaId ;
      ...
      private string AV9InOutEnvolvidosColetaNome ;
      private string wcpOAV9InOutEnvolvidosColetaNome ;
      ...
      private int aP0_InOutEnvolvidosColetaId ;
      private string aP1_InOutEnvolvidosColetaNome ;
      private GXCombobox cmbEnvolvidosColetaAtivo ;
      private IDataStoreProvider pr_default ;
      private bool[] H00582_A56EnvolvidosColetaAtivo ;
      private string[] H00582_A55EnvolvidosColetaNome ;
      private int[] H00582_A54EnvolvidosColetaId ;
   ...
   public class envolvidoscoletaprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([EnvolvidosColetaId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [EnvolvidosColetaNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and [EnvolvidosColetaAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and [EnvolvidosColetaAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00582(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
               case 1 :
                     return conditional_H00583(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
         }

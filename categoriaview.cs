...
namespace GeneXus.Programs {
   public class categoriaview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public categoriaview( IGxContext context )
      {
      ...
      public void execute( int aP0_CategoriaId ,
                           string aP1_TabCode )
      {
         this.AV10CategoriaId = aP0_CategoriaId;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "categoriaview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10CategoriaId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("categoriaview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vCATEGORIAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CategoriaId), "ZZZZZZZ9"), context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vCATEGORIAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10CategoriaId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCATEGORIAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CategoriaId), "ZZZZZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "categoriaview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10CategoriaId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("categoriaview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      protected void WB3X0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Categoria", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_CategoriaView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divCategoriageneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
      ...
      protected void START3X2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Categoria View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA3X2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "categoriaview.aspx")), "categoriaview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "categoriaview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10CategoriaId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10CategoriaId", StringUtil.LTrimStr( (decimal)(AV10CategoriaId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vCATEGORIAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CategoriaId), "ZZZZZZZ9"), context));
      ...
      protected void E113X2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("categoriaww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H003X2 */
         pr_default.execute(0, new Object[] {AV10CategoriaId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A27CategoriaId = H003X2_A27CategoriaId[0];
            A28CategoriaNome = H003X2_A28CategoriaNome[0];
            AV16GXLvl9 = 1;
            Form.Caption = A28CategoriaNome;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "CategoriaGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "categoriageneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "CategoriaGeneral";
            WebComp_Webcomponent_general_Component = "CategoriaGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10CategoriaId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10CategoriaId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10CategoriaId", StringUtil.LTrimStr( (decimal)(AV10CategoriaId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vCATEGORIAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CategoriaId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910502681", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("categoriaview.js", "?202311910502681", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divCategoriageneral_cell_Internalname = "CATEGORIAGENERAL_CELL";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10CategoriaId',fld:'vCATEGORIAID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H003X2_A27CategoriaId = new int[1] ;
         H003X2_A28CategoriaNome = new string[] {""} ;
         A28CategoriaNome = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.categoriaview__default(),
            new Object[][] {
                new Object[] {
               H003X2_A27CategoriaId, H003X2_A28CategoriaNome
               }
            }
         );
      ...
      private int AV10CategoriaId ;
      private int wcpOAV10CategoriaId ;
      ...
      private string divCategoriageneral_cell_Internalname ;
      ...
      private int[] H003X2_A27CategoriaId ;
      private string[] H003X2_A28CategoriaNome ;
   ...
   public class categoriaview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10CategoriaId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H003X2", "SELECT [CategoriaId], [CategoriaNome] FROM [Categoria] WHERE [CategoriaId] = @AV10CategoriaId ORDER BY [CategoriaId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003X2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

...
namespace GeneXus.Programs {
   public class docanexoww : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void S172( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV21ColumnsSelector,  "DocAnexoDescricao",  "",  "Descrição",  true,  "") ;
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV21ColumnsSelector,  "DocAnexoDataInclusao",  "",  "Data de Inclusão",  true,  "") ;

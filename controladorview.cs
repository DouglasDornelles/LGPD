...
namespace GeneXus.Programs {
   public class controladorview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public controladorview( IGxContext context )
      {
      ...
      public void execute( int aP0_ControladorId ,
                           string aP1_TabCode )
      {
         this.AV10ControladorId = aP0_ControladorId;
      ...
      {
         get {
            return "controladorview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "controladorview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10ControladorId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("controladorview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vCONTROLADORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10ControladorId), "ZZZZZZZ9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vCONTROLADORID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10ControladorId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCONTROLADORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10ControladorId), "ZZZZZZZ9"), context));
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Personawc == null ) )
         {
            WebComp_Personawc.componentjscripts();
         }
      }
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "controladorview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10ControladorId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("controladorview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "ControladorView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Controlador View" ;
      }
      ...
      protected void WB3B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Controlador", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_ControladorView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divControladorgeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPersona_title_Internalname, "Persona", "", "", lblPersona_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ControladorView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            context.WriteHtmlText( "Persona") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel1"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtablepersona_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0033"+"", StringUtil.RTrim( WebComp_Personawc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0033"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Personawc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldPersonawc), StringUtil.Lower( WebComp_Personawc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0033"+"");
                  }
                  WebComp_Personawc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldPersonawc), StringUtil.Lower( WebComp_Personawc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
      ...
      protected void START3B2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Controlador View", 0) ;
         }
         context.wjLoc = "";
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldPersonawc = cgiGet( "W0033");
                           if ( ( StringUtil.Len( OldPersonawc) == 0 ) || ( StringUtil.StrCmp(OldPersonawc, WebComp_Personawc_Component) != 0 ) )
                           {
                              WebComp_Personawc = getWebComponent(GetType(), "GeneXus.Programs", OldPersonawc, new Object[] {context} );
                              WebComp_Personawc.ComponentInit();
                              WebComp_Personawc.Name = "OldPersonawc";
                              WebComp_Personawc_Component = OldPersonawc;
                           }
                           if ( StringUtil.Len( WebComp_Personawc_Component) != 0 )
                           {
                              WebComp_Personawc.componentprocess("W0033", "", sEvt);
                           }
                           WebComp_Personawc_Component = OldPersonawc;
                        }
                     }
      ...
      protected void PA3B2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "controladorview.aspx")), "controladorview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "controladorview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10ControladorId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10ControladorId", StringUtil.LTrimStr( (decimal)(AV10ControladorId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vCONTROLADORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10ControladorId), "ZZZZZZZ9"), context));
      ...
      protected void RF3B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Personawc_Component) != 0 )
               {
                  WebComp_Personawc.componentstart();
               }
            }
         }
      ...
      protected void E123B2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("controladorww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H003B2 */
         pr_default.execute(0, new Object[] {AV10ControladorId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A10ControladorId = H003B2_A10ControladorId[0];
            A11ControladorNome = H003B2_A11ControladorNome[0];
            AV16GXLvl9 = 1;
            Form.Caption = A11ControladorNome;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "ControladorGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "controladorgeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "ControladorGeneral";
            WebComp_Webcomponent_general_Component = "ControladorGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10ControladorId});
      ...
      protected void S122( )
      {
         /* 'LOADTABS' Routine */
         returnInSub = false;
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "Persona") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Personawc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Personawc_Component), StringUtil.Lower( "ControladorPersonaWC")) != 0 )
            {
               WebComp_Personawc = getWebComponent(GetType(), "GeneXus.Programs", "controladorpersonawc", new Object[] {context} );
               WebComp_Personawc.ComponentInit();
               WebComp_Personawc.Name = "ControladorPersonaWC";
               WebComp_Personawc_Component = "ControladorPersonaWC";
            }
            if ( StringUtil.Len( WebComp_Personawc_Component) != 0 )
            {
               WebComp_Personawc.setjustcreated();
               WebComp_Personawc.componentprepare(new Object[] {(string)"W0033",(string)"",(int)AV10ControladorId});
               WebComp_Personawc.componentbind(new Object[] {(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Personawc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0033"+"");
               WebComp_Personawc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10ControladorId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10ControladorId", StringUtil.LTrimStr( (decimal)(AV10ControladorId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vCONTROLADORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10ControladorId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Personawc == null ) )
         {
            if ( StringUtil.Len( WebComp_Personawc_Component) != 0 )
            {
               WebComp_Personawc.componentthemes();
            }
         }
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910495258", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("controladorview.js", "?202311910495258", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divControladorgeneral_cell_Internalname = "CONTROLADORGENERAL_CELL";
         lblPersona_title_Internalname = "PERSONA_TITLE";
         divUnnamedtablepersona_Internalname = "UNNAMEDTABLEPERSONA";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10ControladorId',fld:'vCONTROLADORID',pic:'ZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E113B2',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10ControladorId',fld:'vCONTROLADORID',pic:'ZZZZZZZ9',hsh:true}]");
         setEventMetadata("TABS.TABCHANGED",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{ctrl:'PERSONAWC'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         lblPersona_title_Jsonclick = "";
         WebComp_Personawc_Component = "";
         OldPersonawc = "";
         sEvt = "";
         EvtGridId = "";
         EvtRowId = "";
         ...
         scmdbuf = "";
         H003B2_A10ControladorId = new int[1] ;
         H003B2_A11ControladorNome = new string[] {""} ;
         A11ControladorNome = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.controladorview__default(),
            new Object[][] {
                new Object[] {
               H003B2_A10ControladorId, H003B2_A11ControladorNome
               }
            }
         );
         WebComp_Webcomponent_general = new GeneXus.Http.GXNullWebComponent();
         WebComp_Personawc = new GeneXus.Http.GXNullWebComponent();
         /* GeneXus formulas. */
         context.Gx_err = 0;
      }
      ...
      private int AV10ControladorId ;
      private int wcpOAV10ControladorId ;
      ...
      private string divControladorgeneral_cell_Internalname ;
      ...
      private string lblPersona_title_Internalname ;
      private string lblPersona_title_Jsonclick ;
      private string divUnnamedtablepersona_Internalname ;
      private string WebComp_Personawc_Component ;
      private string OldPersonawc ;
      private string sEvt ;
   ...
   public class controladorview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10ControladorId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H003B2", "SELECT [ControladorId], [ControladorNome] FROM [Controlador] WHERE [ControladorId] = @AV10ControladorId ORDER BY [ControladorId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003B2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

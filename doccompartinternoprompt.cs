...
namespace GeneXus.Programs {
   public class doccompartinternoprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public doccompartinternoprompt( )
      {
      ...
      public doccompartinternoprompt( IGxContext context )
      {
      ...
      public void execute( int aP0_InCompartInternoId ,
                           ref int aP1_InOutDocumentoId )
      {
         this.AV8InCompartInternoId = aP0_InCompartInternoId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InCompartInternoId");
            ...
            {
               AV8InCompartInternoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InCompartInternoId", StringUtil.LTrimStr( (decimal)(AV8InCompartInternoId), 8, 0));
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV8InCompartInternoId = (int)(NumberUtil.Val( GetPar( "InCompartInternoId"), "."));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13FilterFullText, AV8InCompartInternoId, AV22Pgmname) ;
      ...
      {
         get {
            return "doccompartinternoprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("doccompartinternoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InCompartInternoId,8,0)),UrlEncode(StringUtil.LTrimStr(AV9InOutDocumentoId,8,0))}, new string[] {"InCompartInternoId","InOutDocumentoId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINCOMPARTINTERNOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InCompartInternoId), 8, 0, ",", "")));
      ...
      {
         return formatLink("doccompartinternoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InCompartInternoId,8,0)),UrlEncode(StringUtil.LTrimStr(AV9InOutDocumentoId,8,0))}, new string[] {"InCompartInternoId","InOutDocumentoId"})  ;
      }

      public override string GetPgmname( )
      {
         return "DocCompartInternoPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Doc Compart Interno" ;
      }
      ...
      protected void WB6G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_6G2( true) ;
         }
         else
         {
            wb_table1_14_6G2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_6G2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START6G2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Doc Compart Interno", 0) ;
         }
         context.wjLoc = "";
      ...
      {
         /* GeneXus formulas. */
         AV22Pgmname = "DocCompartInternoPrompt";
         context.Gx_err = 0;
      ...
      protected void RF6G2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV13FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV13FilterFullText), "%", "");
            /* Using cursor H006G2 */
            pr_default.execute(0, new Object[] {AV8InCompartInternoId, lV13FilterFullText, lV13FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_26_idx = 1;
            sGXsfl_26_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_26_idx), 4, 0), 4, "0");
            SubsflControlProps_262( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A75DocumentoId = H006G2_A75DocumentoId[0];
               A57CompartInternoId = H006G2_A57CompartInternoId[0];
               E176G2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV13FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV13FilterFullText), "%", "");
         /* Using cursor H006G3 */
         pr_default.execute(1, new Object[] {AV8InCompartInternoId, lV13FilterFullText, lV13FilterFullText});
      ...
      protected void E156G2( )
      {
         ...
         Form.Caption = "Consulta de Doc Compart Interno";
      ...
      protected void wb_table1_14_6G2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_DocCompartInternoPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InCompartInternoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InCompartInternoId", StringUtil.LTrimStr( (decimal)(AV8InCompartInternoId), 8, 0));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231191051216", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("doccompartinternoprompt.js", "?20231191051216", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:CompartInternoId|2:DocumentoId";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InCompartInternoId',fld:'vINCOMPARTINTERNOID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E116G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InCompartInternoId',fld:'vINCOMPARTINTERNOID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E126G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InCompartInternoId',fld:'vINCOMPARTINTERNOID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E136G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InCompartInternoId',fld:'vINCOMPARTINTERNOID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'AV11OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV12OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E176G2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E186G2',iparms:[{av:'A75DocumentoId',fld:'DOCUMENTOID',pic:'ZZZZZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV9InOutDocumentoId',fld:'vINOUTDOCUMENTOID',pic:'ZZZZZZZ9'}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E146G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InCompartInternoId',fld:'vINCOMPARTINTERNOID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H006G2_A75DocumentoId = new int[1] ;
         H006G2_A57CompartInternoId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.doccompartinternoprompt__default(),
            new Object[][] {
                new Object[] {
               H006G2_A75DocumentoId, H006G2_A57CompartInternoId
               }
               , new Object[] {
      ...
      private int AV8InCompartInternoId ;
      private int AV9InOutDocumentoId ;
      private int wcpOAV8InCompartInternoId ;
      ...
      private int[] H006G2_A75DocumentoId ;
      private int[] H006G2_A57CompartInternoId ;
   ...
   public class doccompartinternoprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int AV8InCompartInternoId )
      {
         ...
         sOrderString = "";
         AddWhere(sWhereString, "([CompartInternoId] = @AV8InCompartInternoId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13FilterFullText)) )
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([CompartInternoId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( CONVERT( char(8), CAST([DocumentoId] AS decimal(8,0))) like '%' + @lV13FilterFullText))");
         }
         else
         {
            GXv_int3[1] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H006G2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] );
               case 1 :
                     return conditional_H006G3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV8InCompartInternoId",GXType.Int32,8,0) ,

...
namespace GeneXus.Programs {
   public class operadorprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public operadorprompt( )
      {
      ...
      public operadorprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutOperadorId ,
                           ref string aP1_InOutOperadorNome )
      {
         this.AV8InOutOperadorId = aP0_InOutOperadorId;
         this.AV9InOutOperadorNome = aP1_InOutOperadorNome;
         executePrivate();
         aP0_InOutOperadorId=this.AV8InOutOperadorId;
         aP1_InOutOperadorNome=this.AV9InOutOperadorNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutOperadorId");
            ...
            {
               AV8InOutOperadorId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutOperadorId", StringUtil.LTrimStr( (decimal)(AV8InOutOperadorId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutOperadorNome = GetPar( "InOutOperadorNome");
                  AssignAttri("", false, "AV9InOutOperadorNome", AV9InOutOperadorNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("operadorprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutOperadorId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutOperadorNome))}, new string[] {"InOutOperadorId","InOutOperadorNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTOPERADORID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutOperadorId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTOPERADORNOME", AV9InOutOperadorNome);
      ...
      {
         return formatLink("operadorprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutOperadorId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutOperadorNome))}, new string[] {"InOutOperadorId","InOutOperadorNome"})  ;
      }

      public override string GetPgmname( )
      {
         return "OperadorPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Operador" ;
      }
      ...
      protected void wb_table1_14_4O2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START4O2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Operador", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_OPERADORNOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A43OperadorNome, "")), context));
         GxWebStd.gx_hidden_field( context, "OPERADORNOME", A43OperadorNome);
      }
      ...
      protected void RF4O2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A44OperadorAtivo = H004O2_A44OperadorAtivo[0];
               A43OperadorNome = H004O2_A43OperadorNome[0];
               A42OperadorId = H004O2_A42OperadorId[0];
               E174O2 ();
      ...
      protected void send_integrity_lvl_hashes4O2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_OPERADORID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A42OperadorId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_OPERADORNOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A43OperadorNome, "")), context));
      }
      ...
      protected void E154O2( )
      {
         ...
         Form.Caption = "Consulta de Operador";
      ...
      protected void E184O2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutOperadorId = A42OperadorId;
         AssignAttri("", false, "AV8InOutOperadorId", StringUtil.LTrimStr( (decimal)(AV8InOutOperadorId), 8, 0));
         AV9InOutOperadorNome = A43OperadorNome;
         AssignAttri("", false, "AV9InOutOperadorNome", AV9InOutOperadorNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutOperadorId,(string)AV9InOutOperadorNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutOperadorId","AV9InOutOperadorNome"});
      ...
      protected void wb_table1_14_4O2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_OperadorPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutOperadorId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutOperadorId", StringUtil.LTrimStr( (decimal)(AV8InOutOperadorId), 8, 0));
         AV9InOutOperadorNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutOperadorNome", AV9InOutOperadorNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231191050336", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("operadorprompt.js", "?20231191050337", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtOperadorNome_Internalname = "OPERADORNOME_"+sGXsfl_26_idx;
         cmbOperadorAtivo_Internalname = "OPERADORATIVO_"+sGXsfl_26_idx;
      }
      ...
      protected void SubsflControlProps_fel_262( )
      {
         ...
         edtOperadorNome_Internalname = "OPERADORNOME_"+sGXsfl_26_fel_idx;
         cmbOperadorAtivo_Internalname = "OPERADORATIVO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "OPERADORATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbOperadorAtivo_Internalname, "Values", (string)(cmbOperadorAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:OperadorId|2:OperadorNome|3:OperadorAtivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","{handler:'E184O2',iparms:[{av:'A42OperadorId',fld:'OPERADORID',pic:'ZZZZZZZ9',hsh:true},{av:'A43OperadorNome',fld:'OPERADORNOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutOperadorId',fld:'vINOUTOPERADORID',pic:'ZZZZZZZ9'},{av:'AV9InOutOperadorNome',fld:'vINOUTOPERADORNOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E144O2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H004O2_A44OperadorAtivo = new bool[] {false} ;
         H004O2_A43OperadorNome = new string[] {""} ;
         H004O2_A42OperadorId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.operadorprompt__default(),
            new Object[][] {
                new Object[] {
               H004O2_A44OperadorAtivo, H004O2_A43OperadorNome, H004O2_A42OperadorId
               }
               , new Object[] {
      ...
      private int AV8InOutOperadorId ;
      private int wcpOAV8InOutOperadorId ;
      ...
      private string AV9InOutOperadorNome ;
      private string wcpOAV9InOutOperadorNome ;
      ...
      private int aP0_InOutOperadorId ;
      private string aP1_InOutOperadorNome ;
      private GXCombobox cmbOperadorAtivo ;
      private IDataStoreProvider pr_default ;
      private bool[] H004O2_A44OperadorAtivo ;
      private string[] H004O2_A43OperadorNome ;
      private int[] H004O2_A42OperadorId ;
   ...
   public class operadorprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([OperadorId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [OperadorNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and [OperadorAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and [OperadorAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H004O2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
               case 1 :
                     return conditional_H004O3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
         }

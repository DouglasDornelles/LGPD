...
namespace GeneXus.Programs {
   public class setorinternoprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public setorinternoprompt( )
      {
      ...
      public setorinternoprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutSetorInternoId ,
                           ref string aP1_InOutSetorInternoNome )
      {
         this.AV8InOutSetorInternoId = aP0_InOutSetorInternoId;
         this.AV9InOutSetorInternoNome = aP1_InOutSetorInternoNome;
         executePrivate();
         aP0_InOutSetorInternoId=this.AV8InOutSetorInternoId;
         aP1_InOutSetorInternoNome=this.AV9InOutSetorInternoNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutSetorInternoId");
            ...
            {
               AV8InOutSetorInternoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutSetorInternoId", StringUtil.LTrimStr( (decimal)(AV8InOutSetorInternoId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutSetorInternoNome = GetPar( "InOutSetorInternoNome");
                  AssignAttri("", false, "AV9InOutSetorInternoNome", AV9InOutSetorInternoNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      {
         get {
            return "setorinternoprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("setorinternoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutSetorInternoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutSetorInternoNome))}, new string[] {"InOutSetorInternoId","InOutSetorInternoNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTSETORINTERNOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutSetorInternoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTSETORINTERNONOME", AV9InOutSetorInternoNome);
      ...
      {
         return formatLink("setorinternoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutSetorInternoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutSetorInternoNome))}, new string[] {"InOutSetorInternoId","InOutSetorInternoNome"})  ;
      }

      public override string GetPgmname( )
      {
         return "SetorInternoPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Setor Interno" ;
      }
      ...
      protected void WB5I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_5I2( true) ;
         }
         else
         {
            wb_table1_14_5I2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_5I2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START5I2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Setor Interno", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_SETORINTERNONOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A61SetorInternoNome, "")), context));
         GxWebStd.gx_hidden_field( context, "SETORINTERNONOME", A61SetorInternoNome);
      }
      ...
      {
         /* GeneXus formulas. */
         AV22Pgmname = "SetorInternoPrompt";
         context.Gx_err = 0;
      ...
      protected void RF5I2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A62SetorInternoAtivo = H005I2_A62SetorInternoAtivo[0];
               A61SetorInternoNome = H005I2_A61SetorInternoNome[0];
               A60SetorInternoId = H005I2_A60SetorInternoId[0];
               E175I2 ();
      ...
      protected void send_integrity_lvl_hashes5I2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_SETORINTERNOID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A60SetorInternoId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_SETORINTERNONOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A61SetorInternoNome, "")), context));
      }
      ...
      protected void E155I2( )
      {
         ...
         Form.Caption = "Consulta de Setor Interno";
      ...
      protected void E185I2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutSetorInternoId = A60SetorInternoId;
         AssignAttri("", false, "AV8InOutSetorInternoId", StringUtil.LTrimStr( (decimal)(AV8InOutSetorInternoId), 8, 0));
         AV9InOutSetorInternoNome = A61SetorInternoNome;
         AssignAttri("", false, "AV9InOutSetorInternoNome", AV9InOutSetorInternoNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutSetorInternoId,(string)AV9InOutSetorInternoNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutSetorInternoId","AV9InOutSetorInternoNome"});
      ...
      protected void wb_table1_14_5I2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_SetorInternoPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutSetorInternoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutSetorInternoId", StringUtil.LTrimStr( (decimal)(AV8InOutSetorInternoId), 8, 0));
         AV9InOutSetorInternoNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutSetorInternoNome", AV9InOutSetorInternoNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231191051174", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("setorinternoprompt.js", "?20231191051174", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtSetorInternoId_Internalname = "SETORINTERNOID_"+sGXsfl_26_idx;
         edtSetorInternoNome_Internalname = "SETORINTERNONOME_"+sGXsfl_26_idx;
         cmbSetorInternoAtivo_Internalname = "SETORINTERNOATIVO_"+sGXsfl_26_idx;
      }

      protected void SubsflControlProps_fel_262( )
      {
         edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx;
         edtSetorInternoId_Internalname = "SETORINTERNOID_"+sGXsfl_26_fel_idx;
         edtSetorInternoNome_Internalname = "SETORINTERNONOME_"+sGXsfl_26_fel_idx;
         cmbSetorInternoAtivo_Internalname = "SETORINTERNOATIVO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "SETORINTERNOATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbSetorInternoAtivo_Internalname, "Values", (string)(cmbSetorInternoAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:SetorInternoId|2:SetorInternoNome|3:SetorInternoAtivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E175I2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E185I2',iparms:[{av:'A60SetorInternoId',fld:'SETORINTERNOID',pic:'ZZZZZZZ9',hsh:true},{av:'A61SetorInternoNome',fld:'SETORINTERNONOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutSetorInternoId',fld:'vINOUTSETORINTERNOID',pic:'ZZZZZZZ9'},{av:'AV9InOutSetorInternoNome',fld:'vINOUTSETORINTERNONOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E145I2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H005I2_A62SetorInternoAtivo = new bool[] {false} ;
         H005I2_A61SetorInternoNome = new string[] {""} ;
         H005I2_A60SetorInternoId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.setorinternoprompt__default(),
            new Object[][] {
                new Object[] {
               H005I2_A62SetorInternoAtivo, H005I2_A61SetorInternoNome, H005I2_A60SetorInternoId
               }
               , new Object[] {
      ...
      private int AV8InOutSetorInternoId ;
      private int wcpOAV8InOutSetorInternoId ;
      ...
      private string AV9InOutSetorInternoNome ;
      private string wcpOAV9InOutSetorInternoNome ;
      ...
      private int aP0_InOutSetorInternoId ;
      private string aP1_InOutSetorInternoNome ;
      private GXCombobox cmbSetorInternoAtivo ;
      private IDataStoreProvider pr_default ;
      private bool[] H005I2_A62SetorInternoAtivo ;
      private string[] H005I2_A61SetorInternoNome ;
      private int[] H005I2_A60SetorInternoId ;
   ...
   public class setorinternoprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([SetorInternoId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [SetorInternoNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and [SetorInternoAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and [SetorInternoAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H005I2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
               case 1 :
                     return conditional_H005I3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
         }

...
namespace GeneXus.Programs {
   public class paiswwgetfilterdata : GXProcedure
   {
      ...
      {
         get {
            return "paisww_Services_Execute" ;
         }
      ...
      public void executeSubmit( string aP0_DDOName ,
                                 ...
                                 out string aP5_OptionIndexesJson )
      {
         paiswwgetfilterdata objpaiswwgetfilterdata;
         objpaiswwgetfilterdata = new paiswwgetfilterdata();
         objpaiswwgetfilterdata.AV20DDOName = aP0_DDOName;
         objpaiswwgetfilterdata.AV14SearchTxtParms = aP1_SearchTxtParms;
         objpaiswwgetfilterdata.AV19SearchTxtTo = aP2_SearchTxtTo;
         objpaiswwgetfilterdata.AV24OptionsJson = "" ;
         objpaiswwgetfilterdata.AV27OptionsDescJson = "" ;
         objpaiswwgetfilterdata.AV29OptionIndexesJson = "" ;
         objpaiswwgetfilterdata.context.SetSubmitInitialConfig(context);
         objpaiswwgetfilterdata.initialize();
         Submit( executePrivateCatch,objpaiswwgetfilterdata);
         aP3_OptionsJson=this.AV24OptionsJson;
         aP4_OptionsDescJson=this.AV27OptionsDescJson;
         aP5_OptionIndexesJson=this.AV29OptionIndexesJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((paiswwgetfilterdata)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Upper( AV20DDOName), "DDO_PAISNOME") == 0 )
         {
            /* Execute user subroutine: 'LOADPAISNOMEOPTIONS' */
            S121 ();
            if ( returnInSub )
            {
               this.cleanup();
      ...
      protected void S111( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV31Session.Get("PaisWWGridState"), "") == 0 )
         {
            AV33GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "PaisWWGridState"), null, "", "");
         }
         else
         {
            AV33GridState.FromXml(AV31Session.Get("PaisWWGridState"), null, "", "");
         }
         AV39GXV1 = 1;
         while ( AV39GXV1 <= AV33GridState.gxTpr_Filtervalues.Count )
         {
            ...
            else if ( StringUtil.StrCmp(AV34GridStateFilterValue.gxTpr_Name, "TFPAISNOME") == 0 )
            {
               AV11TFPaisNome = AV34GridStateFilterValue.gxTpr_Value;
            }
            else if ( StringUtil.StrCmp(AV34GridStateFilterValue.gxTpr_Name, "TFPAISNOME_SEL") == 0 )
            {
               AV12TFPaisNome_Sel = AV34GridStateFilterValue.gxTpr_Value;
            }
            else if ( StringUtil.StrCmp(AV34GridStateFilterValue.gxTpr_Name, "TFPAISATIVO_SEL") == 0 )
            {
               AV13TFPaisAtivo_Sel = (short)(NumberUtil.Val( AV34GridStateFilterValue.gxTpr_Value, "."));
            }
      ...
      protected void S121( )
      {
         /* 'LOADPAISNOMEOPTIONS' Routine */
         returnInSub = false;
         AV11TFPaisNome = AV18SearchTxt;
         AV12TFPaisNome_Sel = "";
         AV41Paiswwds_1_filterfulltext = AV36FilterFullText;
         AV42Paiswwds_2_tfpaisnome = AV11TFPaisNome;
         AV43Paiswwds_3_tfpaisnome_sel = AV12TFPaisNome_Sel;
         AV44Paiswwds_4_tfpaisativo_sel = AV13TFPaisAtivo_Sel;
         ...
         {
            BRK262 = false;
            A5PaisNome = P00262_A5PaisNome[0];
            A6PaisAtivo = P00262_A6PaisAtivo[0];
            A4PaisId = P00262_A4PaisId[0];
            AV30count = 0;
            while ( (pr_default.getStatus(0) != 101) && ( StringUtil.StrCmp(P00262_A5PaisNome[0], A5PaisNome) == 0 ) )
            {
               BRK262 = false;
               A4PaisId = P00262_A4PaisId[0];
            ...
            if ( (0==AV15SkipItems) )
            {
               AV22Option = (String.IsNullOrEmpty(StringUtil.RTrim( A5PaisNome)) ? "<#Empty#>" : A5PaisNome);
      ...
      public override void initialize( )
      {
         ...
         A5PaisNome = "";
         P00262_A5PaisNome = new string[] {""} ;
         P00262_A6PaisAtivo = new bool[] {false} ;
         P00262_A4PaisId = new int[1] ;
         AV22Option = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.paiswwgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P00262_A5PaisNome, P00262_A6PaisAtivo, P00262_A4PaisId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short AV13TFPaisAtivo_Sel ;
      ...
      private string AV11TFPaisNome ;
      private string AV12TFPaisNome_Sel ;
      ...
      private string[] P00262_A5PaisNome ;
      private bool[] P00262_A6PaisAtivo ;
      private int[] P00262_A4PaisId ;
   ...
   public class paiswwgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool A6PaisAtivo )
      {
         ...
         scmdbuf = "SELECT [PaisNome], [PaisAtivo], [PaisId] FROM [Pais]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00262(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (string)dynConstraints[4] , (bool)dynConstraints[5] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00262", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00262,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
 ...
 [ServiceContract(Namespace = "GeneXus.Programs.paiswwgetfilterdata_services")]
 [ServiceBehavior(ConcurrencyMode = ConcurrencyMode.Multiple)]
 [AspNetCompatibilityRequirements(RequirementsMode = AspNetCompatibilityRequirementsMode.Allowed)]
 public class paiswwgetfilterdata_services : GxRestService
 {
    protected override bool IntegratedSecurityEnabled
    {
       get {
    ...
    [OperationContract(Name = "PaisWWGetFilterData" )]
                         ...
                         out string OptionIndexesJson )
    {
       ...
       try
       {
          permissionPrefix = "paisww_Services_Execute";
          if ( ! IsAuthenticated() )
          {
             return  ;
          }
          if ( ! ProcessHeaders("paiswwgetfilterdata") )
          {
             return  ;
          }
          paiswwgetfilterdata worker = new paiswwgetfilterdata(context);

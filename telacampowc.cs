...
namespace GeneXus.Programs {
   public class telacampowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public telacampowc( )
      {
      ...
      public telacampowc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8TelaId = (int)(NumberUtil.Val( GetPar( "TelaId"), "."));
                  AssignAttri(sPrefix, false, "AV8TelaId", StringUtil.LTrimStr( (decimal)(AV8TelaId), 8, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(int)AV8TelaId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV31IsAuthorized_CampoNome = StringUtil.StrToBool( GetPar( "IsAuthorized_CampoNome"));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV16FilterFullText, AV8TelaId, AV20ManageFiltersExecutionStep, AV35Pgmname, AV14OrderedBy, AV15OrderedDsc, AV28IsAuthorized_Update, AV30IsAuthorized_Delete, AV31IsAuthorized_CampoNome, AV32IsAuthorized_Insert, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Tela Campo WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "telacampowc.aspx"+UrlEncode(StringUtil.LTrimStr(AV8TelaId,8,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("telacampowc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_CAMPONOME", GetSecureSignedToken( sPrefix, AV31IsAuthorized_CampoNome, context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8TelaId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV8TelaId), 8, 0, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( sPrefix, AV30IsAuthorized_Delete, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_CAMPONOME", AV31IsAuthorized_CampoNome);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_CAMPONOME", GetSecureSignedToken( sPrefix, AV31IsAuthorized_CampoNome, context));
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV32IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTELAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8TelaId), 8, 0, ",", "")));
      ...
      protected void RenderHtmlCloseForm8C2( )
      {
      ...
      protected void WB8C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "telacampowc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "Inserir", bttBtninsert_Jsonclick, 5, "Inserir", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_TelaCampoWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
            wb_table1_24_8C2( true) ;
         }
         else
         {
            wb_table1_24_8C2( false) ;
         }
         return  ;
      }

      protected void wb_table1_24_8C2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START8C2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Tela Campo WC", 0) ;
            }
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "telacampowc.aspx")), "telacampowc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "telacampowc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       bool AV31IsAuthorized_CampoNome ,
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_CAMPOID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A135CampoId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"CAMPOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A135CampoId), 8, 0, ".", "")));
      }
      ...
      protected void RF8C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            /* Using cursor H008C2 */
            pr_default.execute(0, new Object[] {AV8TelaId, lV16FilterFullText, lV16FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_39_idx = 1;
            sGXsfl_39_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_39_idx), 4, 0), 4, "0");
            SubsflControlProps_392( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A133TelaId = H008C2_A133TelaId[0];
               AssignAttri(sPrefix, false, "A133TelaId", StringUtil.LTrimStr( (decimal)(A133TelaId), 8, 0));
               A136CampoNome = H008C2_A136CampoNome[0];
               A135CampoId = H008C2_A135CampoId[0];
               E188C2 ();
      ...
      protected void send_integrity_lvl_hashes8C2( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV32IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV32IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_CAMPOID"+"_"+sGXsfl_39_idx, GetSecureSignedToken( sPrefix+sGXsfl_39_idx, context.localUtil.Format( (decimal)(A135CampoId), "ZZZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
         /* Using cursor H008C3 */
         pr_default.execute(1, new Object[] {AV8TelaId, lV16FilterFullText, lV16FilterFullText});
         GRID_nRecordCount = H008C3_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void STRUP8C0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8TelaId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8TelaId"), ",", "."));
      ...
      protected void E168C2( )
      {
         ...
         GXt_boolean1 = AV31IsAuthorized_CampoNome;
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "campoview_Execute", out  GXt_boolean1) ;
         AV31IsAuthorized_CampoNome = GXt_boolean1;
         AssignAttri(sPrefix, false, "AV31IsAuthorized_CampoNome", AV31IsAuthorized_CampoNome);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_CAMPONOME", GetSecureSignedToken( sPrefix, AV31IsAuthorized_CampoNome, context));
      ...
      protected void E118C2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("TelaCampoWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV35Pgmname+"GridState"));
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("TelaCampoWCFilters"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "TelaCampoWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "TelaCampoWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "Campo";
         AV11TrnContextAtt = new GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute(context);
         AV11TrnContextAtt.gxTpr_Attributename = "TelaId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8TelaId), 8, 0);
         AV10TrnContext.gxTpr_Attributes.Add(AV11TrnContextAtt, 0);
         AV17Session.Set("TrnContext", AV10TrnContext.ToXml(false, true, "", ""));
      }

      protected void wb_table1_24_8C2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table2_29_8C2( true) ;
         }
         else
         {
            wb_table2_29_8C2( false) ;
         }
         return  ;
      }

      protected void wb_table2_29_8C2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_24_8C2e( true) ;
         }
         else
         {
            wb_table1_24_8C2e( false) ;
         }
      }

      protected void wb_table2_29_8C2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8TelaId = Convert.ToInt32(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8TelaId", StringUtil.LTrimStr( (decimal)(AV8TelaId), 8, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8TelaId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "telacampowc", GetJustCreated( ));
         ...
         {
            AV8TelaId = Convert.ToInt32(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8TelaId", StringUtil.LTrimStr( (decimal)(AV8TelaId), 8, 0));
         }
         wcpOAV8TelaId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8TelaId"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( AV8TelaId != wcpOAV8TelaId ) ) )
         {
            setjustcreated();
         }
         wcpOAV8TelaId = AV8TelaId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8TelaId = cgiGet( sPrefix+"AV8TelaId_CTRL");
         if ( StringUtil.Len( sCtrlAV8TelaId) > 0 )
         {
            AV8TelaId = (int)(context.localUtil.CToN( cgiGet( sCtrlAV8TelaId), ",", "."));
            AssignAttri(sPrefix, false, "AV8TelaId", StringUtil.LTrimStr( (decimal)(AV8TelaId), 8, 0));
         }
         else
         {
            AV8TelaId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"AV8TelaId_PARM"), ",", "."));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8TelaId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8TelaId), 8, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8TelaId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8TelaId_CTRL", StringUtil.RTrim( sCtrlAV8TelaId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910465598", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("telacampowc.js", "?202311910465598", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_392( )
      {
         ...
         edtCampoId_Internalname = sPrefix+"CAMPOID_"+sGXsfl_39_idx;
         edtCampoNome_Internalname = sPrefix+"CAMPONOME_"+sGXsfl_39_idx;
      }
      ...
      protected void SubsflControlProps_fel_392( )
      {
         ...
         edtCampoId_Internalname = sPrefix+"CAMPOID_"+sGXsfl_39_fel_idx;
         edtCampoNome_Internalname = sPrefix+"CAMPONOME_"+sGXsfl_39_fel_idx;
      }
      ...
      protected void init_default_properties( )
      {
         ...
         edtCampoId_Internalname = sPrefix+"CAMPOID";
         edtCampoNome_Internalname = sPrefix+"CAMPONOME";
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "2:CampoId|3:CampoNome";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8TelaId',fld:'vTELAID',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_CampoNome',fld:'vISAUTHORIZED_CAMPONOME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E128C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8TelaId',fld:'vTELAID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_CampoNome',fld:'vISAUTHORIZED_CAMPONOME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E138C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8TelaId',fld:'vTELAID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_CampoNome',fld:'vISAUTHORIZED_CAMPONOME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E148C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8TelaId',fld:'vTELAID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_CampoNome',fld:'vISAUTHORIZED_CAMPONOME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E188C2',iparms:[{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A135CampoId',fld:'CAMPOID',pic:'ZZZZZZZ9',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_CampoNome',fld:'vISAUTHORIZED_CAMPONOME',pic:'',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV27Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV29Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtCampoNome_Link',ctrl:'CAMPONOME',prop:'Link'}]}");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'E118C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8TelaId',fld:'vTELAID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_CampoNome',fld:'vISAUTHORIZED_CAMPONOME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E158C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8TelaId',fld:'vTELAID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_CampoNome',fld:'vISAUTHORIZED_CAMPONOME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'A135CampoId',fld:'CAMPOID',pic:'ZZZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV25GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV26GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{av:'AV18ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]}");
         setEventMetadata("NULL","{handler:'Valid_Camponome',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV16FilterFullText = "";
         H008C2_A133TelaId = new int[1] ;
         H008C2_A136CampoNome = new string[] {""} ;
         H008C2_A135CampoId = new int[1] ;
         H008C3_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.telacampowc__default(),
            new Object[][] {
                new Object[] {
               H008C2_A133TelaId, H008C2_A136CampoNome, H008C2_A135CampoId
               }
               , new Object[] {
               H008C3_AGRID_nRecordCount
               }
            }
         );
         AV35Pgmname = "TelaCampoWC";
      ...
      private int AV8TelaId ;
      private int wcpOAV8TelaId ;
      ...
      private bool AV31IsAuthorized_CampoNome ;
      ...
      private int[] H008C2_A133TelaId ;
      private string[] H008C2_A136CampoNome ;
      private int[] H008C2_A135CampoId ;
      private long[] H008C3_AGRID_nRecordCount ;
   ...
   public class telacampowc__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H008C2( IGxContext context ,
                                             string AV16FilterFullText ,
                                             int A135CampoId ,
                                             ...
                                             int A133TelaId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [TelaId], [CampoNome], [CampoId]";
         sFromString = " FROM [Campo]";
         sOrderString = "";
         AddWhere(sWhereString, "([TelaId] = @AV8TelaId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([CampoId] AS decimal(8,0))) like '%' + @lV16FilterFullText) or ( [CampoNome] like '%' + @lV16FilterFullText))");
         }
         else
         {
            GXv_int5[1] = 1;
         ...
         {
            sOrderString += " ORDER BY [TelaId], [CampoNome]";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TelaId] DESC, [CampoNome] DESC";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [TelaId], [CampoId]";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [TelaId] DESC, [CampoId] DESC";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY [CampoId]";
         }
      ...
      protected Object[] conditional_H008C3( IGxContext context ,
                                             string AV16FilterFullText ,
                                             int A135CampoId ,
                                             string A136CampoNome ,
                                             short AV14OrderedBy ,
                                             ...
                                             int A133TelaId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM [Campo]";
         AddWhere(sWhereString, "([TelaId] = @AV8TelaId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([CampoId] AS decimal(8,0))) like '%' + @lV16FilterFullText) or ( [CampoNome] like '%' + @lV16FilterFullText))");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H008C2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] , (int)dynConstraints[6] );
               case 1 :
                     return conditional_H008C3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] , (int)dynConstraints[6] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV8TelaId",GXType.Int32,8,0) ,
          ...
          Object[] prmH008C3;
          prmH008C3 = new Object[] {
          new ParDef("@AV8TelaId",GXType.Int32,8,0) ,
          new ParDef("@lV16FilterFullText",GXType.VarChar,100,0) ,
          new ParDef("@lV16FilterFullText",GXType.NVarChar,100,0)
          };
          def= new CursorDef[] {
              new CursorDef("H008C2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008C2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H008C3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008C3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }

...
namespace GeneXus.Programs {
   public class docsetorinternoview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public docsetorinternoview( )
      {
      ...
      public docsetorinternoview( IGxContext context )
      {
      ...
      {
         get {
            return "docsetorinternoview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "docsetorinternoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10SetorInternoId,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV11DocumentoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("docsetorinternoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "docsetorinternoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10SetorInternoId,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV11DocumentoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("docsetorinternoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "DocSetorInternoView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Doc Setor Interno View" ;
      }
      ...
      protected void WB6U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Doc Setor Interno", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_DocSetorInternoView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divDocsetorinternogeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
      ...
      protected void START6U2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Doc Setor Interno View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA6U2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "docsetorinternoview.aspx")), "docsetorinternoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "docsetorinternoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      protected void E116U2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("docsetorinternoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV17GXLvl9 = 0;
         /* Using cursor H006U2 */
         pr_default.execute(0, new Object[] {AV10SetorInternoId, AV11DocumentoId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A75DocumentoId = H006U2_A75DocumentoId[0];
            A60SetorInternoId = H006U2_A60SetorInternoId[0];
            AV17GXLvl9 = 1;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "DocSetorInternoGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "docsetorinternogeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "DocSetorInternoGeneral";
            WebComp_Webcomponent_general_Component = "DocSetorInternoGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10SetorInternoId,(int)AV11DocumentoId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910512163", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("docsetorinternoview.js", "?202311910512163", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divDocsetorinternogeneral_cell_Internalname = "DOCSETORINTERNOGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Doc Setor Interno View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10SetorInternoId',fld:'vSETORINTERNOID',pic:'ZZZZZZZ9',hsh:true},{av:'AV11DocumentoId',fld:'vDOCUMENTOID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H006U2_A75DocumentoId = new int[1] ;
         H006U2_A60SetorInternoId = new int[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.docsetorinternoview__default(),
            new Object[][] {
                new Object[] {
               H006U2_A75DocumentoId, H006U2_A60SetorInternoId
               }
            }
         );
      ...
      private string divDocsetorinternogeneral_cell_Internalname ;
      ...
      private int[] H006U2_A75DocumentoId ;
      private int[] H006U2_A60SetorInternoId ;
   ...
   public class docsetorinternoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H006U2", "SELECT [DocumentoId], [SetorInternoId] FROM [DocSetorInterno] WHERE ([SetorInternoId] = @AV10SetorInternoId and [DocumentoId] = @AV11DocumentoId) AND ([SetorInternoId] = @AV10SetorInternoId and [DocumentoId] = @AV11DocumentoId) ORDER BY [SetorInternoId], [DocumentoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006U2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

...
namespace GeneXus.Programs {
   public class gamconnectionentry : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         nRC_GXsfl_81 = (int)(NumberUtil.Val( GetPar( "nRC_GXsfl_81"), "."));
         nGXsfl_81_idx = (int)(NumberUtil.Val( GetPar( "nGXsfl_81_idx"), "."));
      ...
      {
         subGridwwsysconns_Rows = (int)(NumberUtil.Val( GetPar( "subGridwwsysconns_Rows"), "."));
         Gx_mode = GetPar( "Mode");
      ...
      protected void WB1I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTblmaindata_Internalname, divTblmaindata_Visible, 0, "px", 0, "px", "", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavConnectionname_Internalname, "Nome da conexão", "col-sm-3 AttributeFLLabel", 1, true, "");
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavUserpassword_Internalname, "Senha do usuário", "col-sm-3 AttributeFLLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 DataContentCellFL", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablesplittedencryptionkey_Internalname, 1, 0, "px", 0, "px", "Table", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTextblockencryptionkey_cell_Internalname, 1, 0, "px", 0, "px", divTextblockencryptionkey_cell_Class, "left", "top", "", "", "div");
            /* Text block */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "left", "top", "", "", "div");
            wb_table1_43_1I2( true) ;
         }
         else
         {
            wb_table1_43_1I2( false) ;
         }
         return  ;
      }

      protected void wb_table1_43_1I2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTblconnkeys_Internalname, divTblconnkeys_Visible, 0, "px", 0, "px", "", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divTbladdconnkey_Internalname, 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "DataContentCellFL", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group gx-default-form-group", "left", "top", ""+" data-gx-for=\""+edtavNewconnectionkey_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavNewconnectionkey_Internalname, "Adicionar chave de conexão", "gx-form-item AttributeFLLabel", 1, true, "width: 25%;");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 CellMarginTop HasGridEmpowerer", "left", "top", "", "", "div");
            /*  Grid Control  */
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           {
                              nGXsfl_81_idx = (int)(NumberUtil.Val( sEvtType, "."));
      ...
      protected void RF1I2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            SubsflControlProps_812( ) ;
            E191I2 ();
            if ( ( GRIDWWSYSCONNS_nCurrentRecord > 0 ) && ( GRIDWWSYSCONNS_nGridOutOfScope == 0 ) && ( nGXsfl_81_idx == 1 ) )
            {
               GRIDWWSYSCONNS_nCurrentRecord = 0;
      ...
      {
         return (int)(((subGridwwsysconns_Islastpage==1) ? subGridwwsysconns_fnc_Recordcount( )/ (decimal)(subGridwwsysconns_fnc_Recordsperpage( ))+((((int)((subGridwwsysconns_fnc_Recordcount( )) % (subGridwwsysconns_fnc_Recordsperpage( ))))==0) ? 0 : 1) : (decimal)(NumberUtil.Int( (long)(GRIDWWSYSCONNS_nFirstRecordOnPage/ (decimal)(subGridwwsysconns_fnc_Recordsperpage( ))))+1))) ;
      }
      ...
      protected void STRUP1I0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            nRC_GXsfl_81 = (int)(context.localUtil.CToN( cgiGet( "nRC_GXsfl_81"), ",", "."));
            GRIDWWSYSCONNS_nFirstRecordOnPage = (long)(context.localUtil.CToN( cgiGet( "GRIDWWSYSCONNS_nFirstRecordOnPage"), ",", "."));
            GRIDWWSYSCONNS_nEOF = (short)(context.localUtil.CToN( cgiGet( "GRIDWWSYSCONNS_nEOF"), ",", "."));
            subGridwwsysconns_Rows = (int)(context.localUtil.CToN( cgiGet( "GRIDWWSYSCONNS_Rows"), ",", "."));
            GxWebStd.gx_hidden_field( context, "GRIDWWSYSCONNS_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGridwwsysconns_Rows), 6, 0, ".", "")));
      ...
      protected void E171I2( )
      {
         ...
         {
            Form.Caption = StringUtil.Format( "Lista de chave de conexão de %1", StringUtil.Upper( AV8ConnectionName), "", "", "", "", "", "", "", "");
      ...
      private void E191I2( )
      {
         ...
         AV43GXV2 = 1;
         AV42GXV1 = AV13GAMRepositoryConnection.getkeys(out  AV11Errors);
         while ( AV43GXV2 <= AV42GXV1.Count )
         {
            AV14GAMSystemConnection = ((GeneXus.Programs.genexussecurity.SdtGAMSystemConnection)AV42GXV1.Item(AV43GXV2));
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         AV44GXV3 = 1;
         while ( AV44GXV3 <= AV11Errors.Count )
         {
            AV10Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV11Errors.Item(AV44GXV3));
      ...
      protected void wb_table1_43_1I2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_43_1I2e( true) ;
         }
         else
         {
            wb_table1_43_1I2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910481849", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamconnectionentry.js", "?202311910481851", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void StartGridControl81( )
      {
         if ( GridwwsysconnsContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( "Chave de conexão") ;
         ...
         else
         {
            ...
            GridwwsysconnsColumn.AddObjectProperty("Value", StringUtil.RTrim( AV7ConnectionKey));
            ...
            GridwwsysconnsContainer.AddColumnProperties(GridwwsysconnsColumn);
            GridwwsysconnsColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridwwsysconnsColumn.AddObjectProperty("Value", StringUtil.RTrim( AV32ConnectionFile));
            GridwwsysconnsColumn.AddObjectProperty("Enabled", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtavConnectionfile_Enabled), 5, 0, ".", "")));
            GridwwsysconnsContainer.AddColumnProperties(GridwwsysconnsColumn);
            GridwwsysconnsColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridwwsysconnsColumn.AddObjectProperty("Value", StringUtil.RTrim( AV33DeleteConnection));
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_tbladdconnkey_Title = "Chave de conexão";
         Dvpanel_tbladdconnkey_Cls = "PanelCard Panel_BaseColor";
         ...
         Dvpanel_unnamedtable3_Title = "Conexão";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDWWSYSCONNS.LOAD","{handler:'E191I2',iparms:[{av:'AV23CurrentConnectionKey',fld:'vCURRENTCONNECTIONKEY',pic:'',hsh:true}]");
         ...
         setEventMetadata("'DOUACANCEL'","{handler:'E111I2',iparms:[]");
         setEventMetadata("'DOUACANCEL'",",oparms:[]}");
         setEventMetadata("'DOUSEAUTOMATICKEY'","{handler:'E121I2',iparms:[]");
         setEventMetadata("'DOUSEAUTOMATICKEY'",",oparms:[{av:'AV18NewConnectionKey',fld:'vNEWCONNECTIONKEY',pic:''}]}");
         setEventMetadata("'DOUSECURRENTKEY'","{handler:'E131I2',iparms:[{av:'AV23CurrentConnectionKey',fld:'vCURRENTCONNECTIONKEY',pic:'',hsh:true}]");
         setEventMetadata("'DOUSECURRENTKEY'",",oparms:[{av:'AV18NewConnectionKey',fld:'vNEWCONNECTIONKEY',pic:''}]}");
         setEventMetadata("'DOSAVEKEY'","{handler:'E141I2',iparms:[{av:'AV18NewConnectionKey',fld:'vNEWCONNECTIONKEY',pic:''},{av:'AV8ConnectionName',fld:'vCONNECTIONNAME',pic:''},{av:'AV19pConnectionName',fld:'vPCONNECTIONNAME',pic:''}]");
         setEventMetadata("'DOSAVEKEY'",",oparms:[{av:'AV19pConnectionName',fld:'vPCONNECTIONNAME',pic:''}]}");
         setEventMetadata("'DOGENKEY'","{handler:'E151I2',iparms:[]");
         setEventMetadata("'DOGENKEY'",",oparms:[{av:'AV9EncryptionKey',fld:'vENCRYPTIONKEY',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E161I2',iparms:[{av:'AV8ConnectionName',fld:'vCONNECTIONNAME',pic:''},{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV20UserName',fld:'vUSERNAME',pic:''},{av:'AV21UserPassword',fld:'vUSERPASSWORD',pic:''},{av:'AV9EncryptionKey',fld:'vENCRYPTIONKEY',pic:''},{av:'AV19pConnectionName',fld:'vPCONNECTIONNAME',pic:''}]");
         setEventMetadata("ENTER",",oparms:[]}");
         setEventMetadata("'WWCONNKEYS'","{handler:'E201I2',iparms:[{av:'AV19pConnectionName',fld:'vPCONNECTIONNAME',pic:''}]");
         setEventMetadata("'WWCONNKEYS'",",oparms:[{av:'AV19pConnectionName',fld:'vPCONNECTIONNAME',pic:''}]}");
         setEventMetadata("VDELETECONNECTION.CLICK","{handler:'E211I2',iparms:[{av:'AV7ConnectionKey',fld:'vCONNECTIONKEY',pic:'',hsh:true},{av:'AV8ConnectionName',fld:'vCONNECTIONNAME',pic:''},{av:'AV19pConnectionName',fld:'vPCONNECTIONNAME',pic:''}]");
         setEventMetadata("VDELETECONNECTION.CLICK",",oparms:[{av:'AV19pConnectionName',fld:'vPCONNECTIONNAME',pic:''}]}");
         setEventMetadata("VCONNECTIONFILE.CLICK","{handler:'E221I2',iparms:[{av:'AV25FileConnectionKey',fld:'vFILECONNECTIONKEY',pic:''},{av:'AV7ConnectionKey',fld:'vCONNECTIONKEY',pic:'',hsh:true},{av:'AV8ConnectionName',fld:'vCONNECTIONNAME',pic:''},{av:'AV12FileXML',fld:'vFILEXML',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         AV42GXV1 = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMSystemConnection>( context, "GeneXus.Programs.genexussecurity.SdtGAMSystemConnection", "GeneXus.Programs");
      ...
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMSystemConnection> AV42GXV1 ;

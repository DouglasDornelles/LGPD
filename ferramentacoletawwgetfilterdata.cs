...
namespace GeneXus.Programs {
   ...
   public class ferramentacoletawwgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool A35FerramentaColetaAtivo )
      {
         ...
         {
            AddWhere(sWhereString, "(( [FerramentaColetaNome] like '%' + @lV43Ferramentacoletawwds_1_filterfulltext) or ( 'sim' like '%' + LOWER(@lV43Ferramentacoletawwds_1_filterfulltext) and [FerramentaColetaAtivo] = 1) or ( 'não' like '%' + LOWER(@lV43Ferramentacoletawwds_1_filterfulltext) and [FerramentaColetaAtivo] = 0))");
         }
         else
         {
            GXv_int1[0] = 1;

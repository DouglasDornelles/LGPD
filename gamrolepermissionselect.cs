   ...
   public class gamrolepermissionselect : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void WB1N0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_16_1N2( true) ;
         }
         else
         {
            wb_table1_16_1N2( false) ;
         }
         return  ;
      }

      protected void wb_table1_16_1N2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void E111N2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            if (returnInSub) return;
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("GAMRolePermissionSelectFilters")) + "," + UrlEncode(StringUtil.RTrim(AV50Pgmname+"GridState"));
      ...
      protected void S122( )
      {
         ...
         {
            AV37GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV50Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV37GridState.FromXml(AV39Session.Get(AV50Pgmname+"GridState"), null, "", "");
         }
         /* Execute user subroutine: 'LOADREGFILTERSSTATE' */
         S152 ();
         if (returnInSub) return;
      ...
      protected void S132( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV50Pgmname+"GridState",  AV37GridState.ToXml(false, true, "", "")) ;
      }

      protected void wb_table1_16_1N2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            wb_table2_21_1N2( true) ;
         }
         else
         {
            wb_table2_21_1N2( false) ;
         }
         return  ;
      }

      protected void wb_table2_21_1N2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_16_1N2e( true) ;
         }
         else
         {
            wb_table1_16_1N2e( false) ;
         }
      }

      protected void wb_table2_21_1N2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavPermissionaccesstype, cmbavPermissionaccesstype_Internalname, StringUtil.RTrim( AV24PermissionAccessType), 1, cmbavPermissionaccesstype_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "char", "", 1, cmbavPermissionaccesstype.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,31);\"", "", true, 0, "HLP_GAMRolePermissionSelect.htm");
            cmbavPermissionaccesstype.CurrentValue = StringUtil.RTrim( AV24PermissionAccessType);
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_21_1N2e( true) ;
         }
         else
         {
            wb_table2_21_1N2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910481534", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamrolepermissionselect.js", "?202311910481535", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOADD'","{handler:'E141N2',iparms:[{av:'AV27RoleId',fld:'vROLEID',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV28Select',fld:'vSELECT',grid:45,pic:''},{av:'GRID_nFirstRecordOnPage'},{av:'nRC_GXsfl_45',ctrl:'GRID',grid:45,prop:'GridRC',grid:45},{av:'AV9AppId',fld:'vAPPID',grid:45,pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV18ID',fld:'vID',grid:45,pic:'',hsh:true},{av:'AV8Access',fld:'vACCESS',grid:45,pic:''},{av:'AV20isOK',fld:'vISOK',pic:''},{av:'AV10ApplicationId',fld:'vAPPLICATIONID',pic:'ZZZZZZZZZZZ9',hsh:true}]");

...
namespace GeneXus.Programs {
   public class envolvidoscoletaview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public envolvidoscoletaview( )
      {
      ...
      public envolvidoscoletaview( IGxContext context )
      {
      ...
      public void execute( int aP0_EnvolvidosColetaId ,
                           string aP1_TabCode )
      {
         this.AV10EnvolvidosColetaId = aP0_EnvolvidosColetaId;
      ...
      {
         get {
            return "envolvidoscoletaview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "envolvidoscoletaview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10EnvolvidosColetaId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("envolvidoscoletaview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vENVOLVIDOSCOLETAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10EnvolvidosColetaId), "ZZZZZZZ9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vENVOLVIDOSCOLETAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10EnvolvidosColetaId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vENVOLVIDOSCOLETAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10EnvolvidosColetaId), "ZZZZZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "envolvidoscoletaview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10EnvolvidosColetaId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("envolvidoscoletaview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "EnvolvidosColetaView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Envolvidos Coleta View" ;
      }
      ...
      protected void WB560( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Envolvidos Coleta", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_EnvolvidosColetaView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divEnvolvidoscoletageneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDocenvolvidoscoleta_title_Internalname, "Doc Envolvidos Coleta", "", "", lblDocenvolvidoscoleta_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_EnvolvidosColetaView.htm");
            /* Div Control */
      ...
      protected void START562( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Envolvidos Coleta View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA562( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "envolvidoscoletaview.aspx")), "envolvidoscoletaview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "envolvidoscoletaview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10EnvolvidosColetaId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10EnvolvidosColetaId", StringUtil.LTrimStr( (decimal)(AV10EnvolvidosColetaId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vENVOLVIDOSCOLETAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10EnvolvidosColetaId), "ZZZZZZZ9"), context));
      ...
      protected void E12562( )
      {
         ...
         lblWorkwithlink_Link = formatLink("envolvidoscoletaww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H00562 */
         pr_default.execute(0, new Object[] {AV10EnvolvidosColetaId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A54EnvolvidosColetaId = H00562_A54EnvolvidosColetaId[0];
            A55EnvolvidosColetaNome = H00562_A55EnvolvidosColetaNome[0];
            AV16GXLvl9 = 1;
            Form.Caption = A55EnvolvidosColetaNome;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "EnvolvidosColetaGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "envolvidoscoletageneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "EnvolvidosColetaGeneral";
            WebComp_Webcomponent_general_Component = "EnvolvidosColetaGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10EnvolvidosColetaId});
      ...
      protected void S122( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "DocEnvolvidosColeta") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Docenvolvidoscoletawc_Component), StringUtil.Lower( "EnvolvidosColetaDocEnvolvidosColetaWC")) != 0 )
            {
               WebComp_Docenvolvidoscoletawc = getWebComponent(GetType(), "GeneXus.Programs", "envolvidoscoletadocenvolvidoscoletawc", new Object[] {context} );
               WebComp_Docenvolvidoscoletawc.ComponentInit();
               WebComp_Docenvolvidoscoletawc.Name = "EnvolvidosColetaDocEnvolvidosColetaWC";
               WebComp_Docenvolvidoscoletawc_Component = "EnvolvidosColetaDocEnvolvidosColetaWC";
            }
            if ( StringUtil.Len( WebComp_Docenvolvidoscoletawc_Component) != 0 )
            {
               WebComp_Docenvolvidoscoletawc.setjustcreated();
               WebComp_Docenvolvidoscoletawc.componentprepare(new Object[] {(string)"W0033",(string)"",(int)AV10EnvolvidosColetaId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10EnvolvidosColetaId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10EnvolvidosColetaId", StringUtil.LTrimStr( (decimal)(AV10EnvolvidosColetaId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vENVOLVIDOSCOLETAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10EnvolvidosColetaId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910504584", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("envolvidoscoletaview.js", "?202311910504584", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divEnvolvidoscoletageneral_cell_Internalname = "ENVOLVIDOSCOLETAGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Envolvidos Coleta View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10EnvolvidosColetaId',fld:'vENVOLVIDOSCOLETAID',pic:'ZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E11562',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10EnvolvidosColetaId',fld:'vENVOLVIDOSCOLETAID',pic:'ZZZZZZZ9',hsh:true}]");
         setEventMetadata("TABS.TABCHANGED",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{ctrl:'DOCENVOLVIDOSCOLETAWC'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00562_A54EnvolvidosColetaId = new int[1] ;
         H00562_A55EnvolvidosColetaNome = new string[] {""} ;
         A55EnvolvidosColetaNome = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.envolvidoscoletaview__default(),
            new Object[][] {
                new Object[] {
               H00562_A54EnvolvidosColetaId, H00562_A55EnvolvidosColetaNome
               }
            }
         );
      ...
      private int AV10EnvolvidosColetaId ;
      private int wcpOAV10EnvolvidosColetaId ;
      ...
      private string divEnvolvidoscoletageneral_cell_Internalname ;
      ...
      private int[] H00562_A54EnvolvidosColetaId ;
      private string[] H00562_A55EnvolvidosColetaNome ;
   ...
   public class envolvidoscoletaview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10EnvolvidosColetaId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H00562", "SELECT [EnvolvidosColetaId], [EnvolvidosColetaNome] FROM [EnvolvidosColeta] WHERE [EnvolvidosColetaId] = @AV10EnvolvidosColetaId ORDER BY [EnvolvidosColetaId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00562,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

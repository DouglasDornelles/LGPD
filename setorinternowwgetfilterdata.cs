...
namespace GeneXus.Programs {
   public class setorinternowwgetfilterdata : GXProcedure
   {
      ...
      {
         get {
            return "setorinternoww_Services_Execute" ;
         }

      }

      public setorinternowwgetfilterdata( )
      {
      ...
      public setorinternowwgetfilterdata( IGxContext context )
      {
      ...
      public void executeSubmit( string aP0_DDOName ,
                                 ...
                                 out string aP5_OptionIndexesJson )
      {
         setorinternowwgetfilterdata objsetorinternowwgetfilterdata;
         objsetorinternowwgetfilterdata = new setorinternowwgetfilterdata();
         objsetorinternowwgetfilterdata.AV20DDOName = aP0_DDOName;
         objsetorinternowwgetfilterdata.AV14SearchTxtParms = aP1_SearchTxtParms;
         objsetorinternowwgetfilterdata.AV19SearchTxtTo = aP2_SearchTxtTo;
         objsetorinternowwgetfilterdata.AV24OptionsJson = "" ;
         objsetorinternowwgetfilterdata.AV27OptionsDescJson = "" ;
         objsetorinternowwgetfilterdata.AV29OptionIndexesJson = "" ;
         objsetorinternowwgetfilterdata.context.SetSubmitInitialConfig(context);
         objsetorinternowwgetfilterdata.initialize();
         Submit( executePrivateCatch,objsetorinternowwgetfilterdata);
         aP3_OptionsJson=this.AV24OptionsJson;
         aP4_OptionsDescJson=this.AV27OptionsDescJson;
         aP5_OptionIndexesJson=this.AV29OptionIndexesJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((setorinternowwgetfilterdata)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Upper( AV20DDOName), "DDO_SETORINTERNONOME") == 0 )
         {
            /* Execute user subroutine: 'LOADSETORINTERNONOMEOPTIONS' */
            S121 ();
            if ( returnInSub )
            {
               this.cleanup();
      ...
      protected void S111( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV31Session.Get("SetorInternoWWGridState"), "") == 0 )
         {
            AV33GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "SetorInternoWWGridState"), null, "", "");
         }
         else
         {
            AV33GridState.FromXml(AV31Session.Get("SetorInternoWWGridState"), null, "", "");
         }
         AV39GXV1 = 1;
         while ( AV39GXV1 <= AV33GridState.gxTpr_Filtervalues.Count )
         {
            ...
            else if ( StringUtil.StrCmp(AV34GridStateFilterValue.gxTpr_Name, "TFSETORINTERNONOME") == 0 )
            {
               AV11TFSetorInternoNome = AV34GridStateFilterValue.gxTpr_Value;
            }
            else if ( StringUtil.StrCmp(AV34GridStateFilterValue.gxTpr_Name, "TFSETORINTERNONOME_SEL") == 0 )
            {
               AV12TFSetorInternoNome_Sel = AV34GridStateFilterValue.gxTpr_Value;
            }
            else if ( StringUtil.StrCmp(AV34GridStateFilterValue.gxTpr_Name, "TFSETORINTERNOATIVO_SEL") == 0 )
            {
               AV13TFSetorInternoAtivo_Sel = (short)(NumberUtil.Val( AV34GridStateFilterValue.gxTpr_Value, "."));
            }
      ...
      protected void S121( )
      {
         /* 'LOADSETORINTERNONOMEOPTIONS' Routine */
         returnInSub = false;
         AV11TFSetorInternoNome = AV18SearchTxt;
         AV12TFSetorInternoNome_Sel = "";
         AV41Setorinternowwds_1_filterfulltext = AV36FilterFullText;
         AV42Setorinternowwds_2_tfsetorinternonome = AV11TFSetorInternoNome;
         AV43Setorinternowwds_3_tfsetorinternonome_sel = AV12TFSetorInternoNome_Sel;
         AV44Setorinternowwds_4_tfsetorinternoativo_sel = AV13TFSetorInternoAtivo_Sel;
         ...
         {
            BRK4H2 = false;
            A61SetorInternoNome = P004H2_A61SetorInternoNome[0];
            A62SetorInternoAtivo = P004H2_A62SetorInternoAtivo[0];
            A60SetorInternoId = P004H2_A60SetorInternoId[0];
            AV30count = 0;
            while ( (pr_default.getStatus(0) != 101) && ( StringUtil.StrCmp(P004H2_A61SetorInternoNome[0], A61SetorInternoNome) == 0 ) )
            {
               BRK4H2 = false;
               A60SetorInternoId = P004H2_A60SetorInternoId[0];
            ...
            if ( (0==AV15SkipItems) )
            {
               AV22Option = (String.IsNullOrEmpty(StringUtil.RTrim( A61SetorInternoNome)) ? "<#Empty#>" : A61SetorInternoNome);
      ...
      public override void initialize( )
      {
         ...
         A61SetorInternoNome = "";
         P004H2_A61SetorInternoNome = new string[] {""} ;
         P004H2_A62SetorInternoAtivo = new bool[] {false} ;
         P004H2_A60SetorInternoId = new int[1] ;
         AV22Option = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.setorinternowwgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P004H2_A61SetorInternoNome, P004H2_A62SetorInternoAtivo, P004H2_A60SetorInternoId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short AV13TFSetorInternoAtivo_Sel ;
      ...
      private string AV11TFSetorInternoNome ;
      private string AV12TFSetorInternoNome_Sel ;
      ...
      private string[] P004H2_A61SetorInternoNome ;
      private bool[] P004H2_A62SetorInternoAtivo ;
      private int[] P004H2_A60SetorInternoId ;
   ...
   public class setorinternowwgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool A62SetorInternoAtivo )
      {
         ...
         scmdbuf = "SELECT [SetorInternoNome], [SetorInternoAtivo], [SetorInternoId] FROM [SetorInterno]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P004H2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (string)dynConstraints[4] , (bool)dynConstraints[5] );
         }
 ...
 [ServiceContract(Namespace = "GeneXus.Programs.setorinternowwgetfilterdata_services")]
 [ServiceBehavior(ConcurrencyMode = ConcurrencyMode.Multiple)]
 [AspNetCompatibilityRequirements(RequirementsMode = AspNetCompatibilityRequirementsMode.Allowed)]
 public class setorinternowwgetfilterdata_services : GxRestService
 {
    protected override bool IntegratedSecurityEnabled
    {
       get {
    ...
    [OperationContract(Name = "SetorInternoWWGetFilterData" )]
                         ...
                         out string OptionIndexesJson )
    {
       ...
       try
       {
          permissionPrefix = "setorinternoww_Services_Execute";
          if ( ! IsAuthenticated() )
          {
             return  ;
          }
          if ( ! ProcessHeaders("setorinternowwgetfilterdata") )
          {
             return  ;
          }
          setorinternowwgetfilterdata worker = new setorinternowwgetfilterdata(context);

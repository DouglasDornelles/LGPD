...
namespace GeneXus.Programs {
   public class medidasegurancaprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public medidasegurancaprompt( )
      {
      ...
      public medidasegurancaprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutMedidaSegurancaId ,
                           ref string aP1_InOutMedidaSegurancaNome )
      {
         this.AV8InOutMedidaSegurancaId = aP0_InOutMedidaSegurancaId;
         this.AV9InOutMedidaSegurancaNome = aP1_InOutMedidaSegurancaNome;
         executePrivate();
         aP0_InOutMedidaSegurancaId=this.AV8InOutMedidaSegurancaId;
         aP1_InOutMedidaSegurancaNome=this.AV9InOutMedidaSegurancaNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutMedidaSegurancaId");
            ...
            {
               AV8InOutMedidaSegurancaId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutMedidaSegurancaId", StringUtil.LTrimStr( (decimal)(AV8InOutMedidaSegurancaId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutMedidaSegurancaNome = GetPar( "InOutMedidaSegurancaNome");
                  AssignAttri("", false, "AV9InOutMedidaSegurancaNome", AV9InOutMedidaSegurancaNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      {
         get {
            return "medidasegurancaprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("medidasegurancaprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutMedidaSegurancaId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutMedidaSegurancaNome))}, new string[] {"InOutMedidaSegurancaId","InOutMedidaSegurancaNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTMEDIDASEGURANCAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutMedidaSegurancaId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTMEDIDASEGURANCANOME", AV9InOutMedidaSegurancaNome);
      ...
      {
         return formatLink("medidasegurancaprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutMedidaSegurancaId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutMedidaSegurancaNome))}, new string[] {"InOutMedidaSegurancaId","InOutMedidaSegurancaNome"})  ;
      }

      public override string GetPgmname( )
      {
         return "MedidaSegurancaPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Medida Seguranca" ;
      }
      ...
      protected void wb_table1_14_532e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START532( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Medida Seguranca", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_MEDIDASEGURANCANOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A52MedidaSegurancaNome, "")), context));
         GxWebStd.gx_hidden_field( context, "MEDIDASEGURANCANOME", A52MedidaSegurancaNome);
      }
      ...
      {
         /* GeneXus formulas. */
         AV22Pgmname = "MedidaSegurancaPrompt";
         context.Gx_err = 0;
      ...
      protected void RF532( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A53MedidaSegurancaAtivo = H00532_A53MedidaSegurancaAtivo[0];
               A52MedidaSegurancaNome = H00532_A52MedidaSegurancaNome[0];
               A51MedidaSegurancaId = H00532_A51MedidaSegurancaId[0];
               E17532 ();
      ...
      protected void send_integrity_lvl_hashes532( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_MEDIDASEGURANCAID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A51MedidaSegurancaId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_MEDIDASEGURANCANOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A52MedidaSegurancaNome, "")), context));
      }
      ...
      protected void E15532( )
      {
         ...
         Form.Caption = "Consulta de Medida Seguranca";
      ...
      protected void E18532( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutMedidaSegurancaId = A51MedidaSegurancaId;
         AssignAttri("", false, "AV8InOutMedidaSegurancaId", StringUtil.LTrimStr( (decimal)(AV8InOutMedidaSegurancaId), 8, 0));
         AV9InOutMedidaSegurancaNome = A52MedidaSegurancaNome;
         AssignAttri("", false, "AV9InOutMedidaSegurancaNome", AV9InOutMedidaSegurancaNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutMedidaSegurancaId,(string)AV9InOutMedidaSegurancaNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutMedidaSegurancaId","AV9InOutMedidaSegurancaNome"});
      ...
      protected void wb_table1_14_532( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_MedidaSegurancaPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutMedidaSegurancaId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutMedidaSegurancaId", StringUtil.LTrimStr( (decimal)(AV8InOutMedidaSegurancaId), 8, 0));
         AV9InOutMedidaSegurancaNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutMedidaSegurancaNome", AV9InOutMedidaSegurancaNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023119105193", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("medidasegurancaprompt.js", "?2023119105193", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtMedidaSegurancaNome_Internalname = "MEDIDASEGURANCANOME_"+sGXsfl_26_idx;
         cmbMedidaSegurancaAtivo_Internalname = "MEDIDASEGURANCAATIVO_"+sGXsfl_26_idx;
      }
      ...
      protected void SubsflControlProps_fel_262( )
      {
         ...
         edtMedidaSegurancaNome_Internalname = "MEDIDASEGURANCANOME_"+sGXsfl_26_fel_idx;
         cmbMedidaSegurancaAtivo_Internalname = "MEDIDASEGURANCAATIVO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "MEDIDASEGURANCAATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbMedidaSegurancaAtivo_Internalname, "Values", (string)(cmbMedidaSegurancaAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:MedidaSegurancaId|2:MedidaSegurancaNome|3:MedidaSegurancaAtivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","{handler:'E18532',iparms:[{av:'A51MedidaSegurancaId',fld:'MEDIDASEGURANCAID',pic:'ZZZZZZZ9',hsh:true},{av:'A52MedidaSegurancaNome',fld:'MEDIDASEGURANCANOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutMedidaSegurancaId',fld:'vINOUTMEDIDASEGURANCAID',pic:'ZZZZZZZ9'},{av:'AV9InOutMedidaSegurancaNome',fld:'vINOUTMEDIDASEGURANCANOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E14532',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      {
         wcpOAV9InOutMedidaSegurancaNome = "";
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H00532_A53MedidaSegurancaAtivo = new bool[] {false} ;
         H00532_A52MedidaSegurancaNome = new string[] {""} ;
         H00532_A51MedidaSegurancaId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.medidasegurancaprompt__default(),
            new Object[][] {
                new Object[] {
               H00532_A53MedidaSegurancaAtivo, H00532_A52MedidaSegurancaNome, H00532_A51MedidaSegurancaId
               }
               , new Object[] {
      ...
      private int AV8InOutMedidaSegurancaId ;
      private int wcpOAV8InOutMedidaSegurancaId ;
      ...
      private string AV9InOutMedidaSegurancaNome ;
      private string wcpOAV9InOutMedidaSegurancaNome ;
      ...
      private int aP0_InOutMedidaSegurancaId ;
      private string aP1_InOutMedidaSegurancaNome ;
      private GXCombobox cmbMedidaSegurancaAtivo ;
      private IDataStoreProvider pr_default ;
      private bool[] H00532_A53MedidaSegurancaAtivo ;
      private string[] H00532_A52MedidaSegurancaNome ;
      private int[] H00532_A51MedidaSegurancaId ;
   ...
   public class medidasegurancaprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([MedidaSegurancaId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [MedidaSegurancaNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and [MedidaSegurancaAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and [MedidaSegurancaAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00532(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
               case 1 :
                     return conditional_H00533(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00532", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00532,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00533", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00533,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }

...
namespace GeneXus.Programs {
   ...
   public class envolvidoscoletawwexport__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV18OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( [EnvolvidosColetaNome] like '%' + @lV46Envolvidoscoletawwds_1_filterfulltext) or ( 'sim' like '%' + LOWER(@lV46Envolvidoscoletawwds_1_filterfulltext) and [EnvolvidosColetaAtivo] = 1) or ( 'não' like '%' + LOWER(@lV46Envolvidoscoletawwds_1_filterfulltext) and [EnvolvidosColetaAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;

...
namespace GeneXus.Programs {
   public class campoview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public campoview( )
      {
      ...
      public campoview( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "campoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10CampoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("campoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vCAMPOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CampoId), "ZZZZZZZ9"), context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vCAMPOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10CampoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCAMPOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CampoId), "ZZZZZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "campoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10CampoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("campoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      protected void WB8E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Campo", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_CampoView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divCampogeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
      ...
      protected void START8E2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Campo View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA8E2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "campoview.aspx")), "campoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "campoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10CampoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10CampoId", StringUtil.LTrimStr( (decimal)(AV10CampoId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vCAMPOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CampoId), "ZZZZZZZ9"), context));
      ...
      protected void E118E2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("campoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H008E2 */
         pr_default.execute(0, new Object[] {AV10CampoId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A135CampoId = H008E2_A135CampoId[0];
            A136CampoNome = H008E2_A136CampoNome[0];
            AV16GXLvl9 = 1;
            Form.Caption = A136CampoNome;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "CampoGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "campogeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "CampoGeneral";
            WebComp_Webcomponent_general_Component = "CampoGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10CampoId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10CampoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10CampoId", StringUtil.LTrimStr( (decimal)(AV10CampoId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vCAMPOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CampoId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231191051257", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("campoview.js", "?20231191051257", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divCampogeneral_cell_Internalname = "CAMPOGENERAL_CELL";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10CampoId',fld:'vCAMPOID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H008E2_A135CampoId = new int[1] ;
         H008E2_A136CampoNome = new string[] {""} ;
         A136CampoNome = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.campoview__default(),
            new Object[][] {
                new Object[] {
               H008E2_A135CampoId, H008E2_A136CampoNome
               }
            }
         );
      ...
      private int AV10CampoId ;
      private int wcpOAV10CampoId ;
      ...
      private string divCampogeneral_cell_Internalname ;
      ...
      private int[] H008E2_A135CampoId ;
      private string[] H008E2_A136CampoNome ;
   ...
   public class campoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10CampoId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H008E2", "SELECT [CampoId], [CampoNome] FROM [Campo] WHERE [CampoId] = @AV10CampoId ORDER BY [CampoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008E2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

...
namespace GeneXus.Programs {
   public class categoriawwexportreport : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void S131( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            {
               AV38CategoriaAtivoDescription = "NÃO";
            }
   ...
   public class categoriawwexportreport__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( [CategoriaNome] like '%' + @lV44Categoriawwds_1_filterfulltext) or ( 'sim' like '%' + LOWER(@lV44Categoriawwds_1_filterfulltext) and [CategoriaAtivo] = 1) or ( 'não' like '%' + LOWER(@lV44Categoriawwds_1_filterfulltext) and [CategoriaAtivo] = 0))");
         }
         else
         {
            GXv_int2[0] = 1;

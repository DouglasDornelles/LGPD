...
namespace GeneXus.Programs {
   public class arearesponsavelwwexportreport : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void S131( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            {
               AV38AreaResponsavelAtivoDescription = "NÃO";
            }
   ...
   public class arearesponsavelwwexportreport__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( [AreaResponsavelNome] like '%' + @lV44Arearesponsavelwwds_1_filterfulltext) or ( 'sim' like '%' + LOWER(@lV44Arearesponsavelwwds_1_filterfulltext) and [AreaResponsavelAtivo] = 1) or ( 'não' like '%' + LOWER(@lV44Arearesponsavelwwds_1_filterfulltext) and [AreaResponsavelAtivo] = 0))");
         }
         else
         {
            GXv_int2[0] = 1;

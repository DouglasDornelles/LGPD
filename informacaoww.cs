...
namespace GeneXus.Programs {
   public class informacaoww : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void initialize_properties( )
      {
         ...
         Dvelop_confirmpanel_btnexcluir_Confirmationtext = "Confirma a exclusão da Informação?";
   ...
   public class informacaoww__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV14OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( [InformacaoNome] like '%' + @lV55Informacaowwds_1_filterfulltext) or ( 'sim' like '%' + LOWER(@lV55Informacaowwds_1_filterfulltext) and [InformacaoAtivo] = 1) or ( 'não' like '%' + LOWER(@lV55Informacaowwds_1_filterfulltext) and [InformacaoAtivo] = 0))");
         }
         else
         {
            GXv_int5[0] = 1;

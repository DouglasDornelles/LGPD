...
namespace GeneXus.Programs {
   public class docfonteretencaoprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public docfonteretencaoprompt( )
      {
      ...
      public docfonteretencaoprompt( IGxContext context )
      {
      ...
      public void execute( int aP0_InFonteRetencaoId ,
                           ref int aP1_InOutDocumentoId )
      {
         this.AV8InFonteRetencaoId = aP0_InFonteRetencaoId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InFonteRetencaoId");
            ...
            {
               AV8InFonteRetencaoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InFonteRetencaoId", StringUtil.LTrimStr( (decimal)(AV8InFonteRetencaoId), 8, 0));
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV8InFonteRetencaoId = (int)(NumberUtil.Val( GetPar( "InFonteRetencaoId"), "."));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13FilterFullText, AV8InFonteRetencaoId, AV22Pgmname) ;
      ...
      {
         get {
            return "docfonteretencaoprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("docfonteretencaoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InFonteRetencaoId,8,0)),UrlEncode(StringUtil.LTrimStr(AV9InOutDocumentoId,8,0))}, new string[] {"InFonteRetencaoId","InOutDocumentoId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINFONTERETENCAOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InFonteRetencaoId), 8, 0, ",", "")));
      ...
      {
         return formatLink("docfonteretencaoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InFonteRetencaoId,8,0)),UrlEncode(StringUtil.LTrimStr(AV9InOutDocumentoId,8,0))}, new string[] {"InFonteRetencaoId","InOutDocumentoId"})  ;
      }

      public override string GetPgmname( )
      {
         return "DocFonteRetencaoPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Doc Fonte Retencao" ;
      }
      ...
      protected void WB6M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_6M2( true) ;
         }
         else
         {
            wb_table1_14_6M2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_6M2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START6M2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Doc Fonte Retencao", 0) ;
         }
         context.wjLoc = "";
      ...
      {
         /* GeneXus formulas. */
         AV22Pgmname = "DocFonteRetencaoPrompt";
         context.Gx_err = 0;
      ...
      protected void RF6M2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV13FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV13FilterFullText), "%", "");
            /* Using cursor H006M2 */
            pr_default.execute(0, new Object[] {AV8InFonteRetencaoId, lV13FilterFullText, lV13FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_26_idx = 1;
            sGXsfl_26_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_26_idx), 4, 0), 4, "0");
            SubsflControlProps_262( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A75DocumentoId = H006M2_A75DocumentoId[0];
               A63FonteRetencaoId = H006M2_A63FonteRetencaoId[0];
               E176M2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV13FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV13FilterFullText), "%", "");
         /* Using cursor H006M3 */
         pr_default.execute(1, new Object[] {AV8InFonteRetencaoId, lV13FilterFullText, lV13FilterFullText});
      ...
      protected void E156M2( )
      {
         ...
         Form.Caption = "Consulta de Doc Fonte Retencao";
      ...
      protected void wb_table1_14_6M2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_DocFonteRetencaoPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InFonteRetencaoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InFonteRetencaoId", StringUtil.LTrimStr( (decimal)(AV8InFonteRetencaoId), 8, 0));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910512066", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("docfonteretencaoprompt.js", "?202311910512066", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:FonteRetencaoId|2:DocumentoId";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InFonteRetencaoId',fld:'vINFONTERETENCAOID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E116M2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InFonteRetencaoId',fld:'vINFONTERETENCAOID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E126M2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InFonteRetencaoId',fld:'vINFONTERETENCAOID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E136M2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InFonteRetencaoId',fld:'vINFONTERETENCAOID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'AV11OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV12OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E176M2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E186M2',iparms:[{av:'A75DocumentoId',fld:'DOCUMENTOID',pic:'ZZZZZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV9InOutDocumentoId',fld:'vINOUTDOCUMENTOID',pic:'ZZZZZZZ9'}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E146M2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InFonteRetencaoId',fld:'vINFONTERETENCAOID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H006M2_A75DocumentoId = new int[1] ;
         H006M2_A63FonteRetencaoId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.docfonteretencaoprompt__default(),
            new Object[][] {
                new Object[] {
               H006M2_A75DocumentoId, H006M2_A63FonteRetencaoId
               }
               , new Object[] {
      ...
      private int AV8InFonteRetencaoId ;
      private int AV9InOutDocumentoId ;
      private int wcpOAV8InFonteRetencaoId ;
      ...
      private int[] H006M2_A75DocumentoId ;
      private int[] H006M2_A63FonteRetencaoId ;
   ...
   public class docfonteretencaoprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int AV8InFonteRetencaoId )
      {
         ...
         sOrderString = "";
         AddWhere(sWhereString, "([FonteRetencaoId] = @AV8InFonteRetencaoId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13FilterFullText)) )
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([FonteRetencaoId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( CONVERT( char(8), CAST([DocumentoId] AS decimal(8,0))) like '%' + @lV13FilterFullText))");
         }
         else
         {
            GXv_int3[1] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H006M2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] );
               case 1 :
                     return conditional_H006M3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV8InFonteRetencaoId",GXType.Int32,8,0) ,

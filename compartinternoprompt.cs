...
namespace GeneXus.Programs {
   public class compartinternoprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public compartinternoprompt( )
      {
      ...
      public compartinternoprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutCompartInternoId ,
                           ref string aP1_InOutCompartInternoNome )
      {
         this.AV8InOutCompartInternoId = aP0_InOutCompartInternoId;
         this.AV9InOutCompartInternoNome = aP1_InOutCompartInternoNome;
         executePrivate();
         aP0_InOutCompartInternoId=this.AV8InOutCompartInternoId;
         aP1_InOutCompartInternoNome=this.AV9InOutCompartInternoNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutCompartInternoId");
            ...
            {
               AV8InOutCompartInternoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutCompartInternoId", StringUtil.LTrimStr( (decimal)(AV8InOutCompartInternoId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutCompartInternoNome = GetPar( "InOutCompartInternoNome");
                  AssignAttri("", false, "AV9InOutCompartInternoNome", AV9InOutCompartInternoNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      {
         get {
            return "compartinternoprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("compartinternoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutCompartInternoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutCompartInternoNome))}, new string[] {"InOutCompartInternoId","InOutCompartInternoNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTCOMPARTINTERNOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutCompartInternoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTCOMPARTINTERNONOME", AV9InOutCompartInternoNome);
      ...
      {
         return formatLink("compartinternoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutCompartInternoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutCompartInternoNome))}, new string[] {"InOutCompartInternoId","InOutCompartInternoNome"})  ;
      }

      public override string GetPgmname( )
      {
         return "CompartInternoPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Compart Interno" ;
      }
      ...
      protected void WB5D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_5D2( true) ;
         }
         else
         {
            wb_table1_14_5D2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_5D2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START5D2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Compart Interno", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_COMPARTINTERNONOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A58CompartInternoNome, "")), context));
         GxWebStd.gx_hidden_field( context, "COMPARTINTERNONOME", A58CompartInternoNome);
      }
      ...
      {
         /* GeneXus formulas. */
         AV22Pgmname = "CompartInternoPrompt";
         context.Gx_err = 0;
      ...
      protected void RF5D2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A59CompartInternoAtivo = H005D2_A59CompartInternoAtivo[0];
               A58CompartInternoNome = H005D2_A58CompartInternoNome[0];
               A57CompartInternoId = H005D2_A57CompartInternoId[0];
               E175D2 ();
      ...
      protected void send_integrity_lvl_hashes5D2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_COMPARTINTERNOID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A57CompartInternoId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_COMPARTINTERNONOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A58CompartInternoNome, "")), context));
      }
      ...
      protected void E155D2( )
      {
         ...
         Form.Caption = "Consulta de Compart Interno";
      ...
      protected void E185D2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutCompartInternoId = A57CompartInternoId;
         AssignAttri("", false, "AV8InOutCompartInternoId", StringUtil.LTrimStr( (decimal)(AV8InOutCompartInternoId), 8, 0));
         AV9InOutCompartInternoNome = A58CompartInternoNome;
         AssignAttri("", false, "AV9InOutCompartInternoNome", AV9InOutCompartInternoNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutCompartInternoId,(string)AV9InOutCompartInternoNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutCompartInternoId","AV9InOutCompartInternoNome"});
      ...
      protected void wb_table1_14_5D2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_CompartInternoPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutCompartInternoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutCompartInternoId", StringUtil.LTrimStr( (decimal)(AV8InOutCompartInternoId), 8, 0));
         AV9InOutCompartInternoNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutCompartInternoNome", AV9InOutCompartInternoNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910505420", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("compartinternoprompt.js", "?202311910505421", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtCompartInternoId_Internalname = "COMPARTINTERNOID_"+sGXsfl_26_idx;
         edtCompartInternoNome_Internalname = "COMPARTINTERNONOME_"+sGXsfl_26_idx;
         cmbCompartInternoAtivo_Internalname = "COMPARTINTERNOATIVO_"+sGXsfl_26_idx;
      }

      protected void SubsflControlProps_fel_262( )
      {
         edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx;
         edtCompartInternoId_Internalname = "COMPARTINTERNOID_"+sGXsfl_26_fel_idx;
         edtCompartInternoNome_Internalname = "COMPARTINTERNONOME_"+sGXsfl_26_fel_idx;
         cmbCompartInternoAtivo_Internalname = "COMPARTINTERNOATIVO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "COMPARTINTERNOATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbCompartInternoAtivo_Internalname, "Values", (string)(cmbCompartInternoAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:CompartInternoId|2:CompartInternoNome|3:CompartInternoAtivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","{handler:'E185D2',iparms:[{av:'A57CompartInternoId',fld:'COMPARTINTERNOID',pic:'ZZZZZZZ9',hsh:true},{av:'A58CompartInternoNome',fld:'COMPARTINTERNONOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutCompartInternoId',fld:'vINOUTCOMPARTINTERNOID',pic:'ZZZZZZZ9'},{av:'AV9InOutCompartInternoNome',fld:'vINOUTCOMPARTINTERNONOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E145D2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      {
         wcpOAV9InOutCompartInternoNome = "";
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H005D2_A59CompartInternoAtivo = new bool[] {false} ;
         H005D2_A58CompartInternoNome = new string[] {""} ;
         H005D2_A57CompartInternoId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.compartinternoprompt__default(),
            new Object[][] {
                new Object[] {
               H005D2_A59CompartInternoAtivo, H005D2_A58CompartInternoNome, H005D2_A57CompartInternoId
               }
               , new Object[] {
      ...
      private int AV8InOutCompartInternoId ;
      private int wcpOAV8InOutCompartInternoId ;
      ...
      private string AV9InOutCompartInternoNome ;
      private string wcpOAV9InOutCompartInternoNome ;
      ...
      private int aP0_InOutCompartInternoId ;
      private string aP1_InOutCompartInternoNome ;
      private GXCombobox cmbCompartInternoAtivo ;
      private IDataStoreProvider pr_default ;
      private bool[] H005D2_A59CompartInternoAtivo ;
      private string[] H005D2_A58CompartInternoNome ;
      private int[] H005D2_A57CompartInternoId ;
   ...
   public class compartinternoprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([CompartInternoId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [CompartInternoNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and [CompartInternoAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and [CompartInternoAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H005D2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
               case 1 :
                     return conditional_H005D3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
         }

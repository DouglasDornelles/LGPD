...
namespace GeneXus.Programs {
   public class docmedidasegurancaview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public docmedidasegurancaview( )
      {
      ...
      public docmedidasegurancaview( IGxContext context )
      {
      ...
      {
         get {
            return "docmedidasegurancaview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "docmedidasegurancaview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10MedidaSegurancaId,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV11DocumentoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("docmedidasegurancaview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "docmedidasegurancaview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10MedidaSegurancaId,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV11DocumentoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("docmedidasegurancaview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "DocMedidaSegurancaView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Doc Medida Seguranca View" ;
      }
      ...
      protected void WB8S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Doc Medida Seguranca", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_DocMedidaSegurancaView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divDocmedidasegurancageneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
      ...
      protected void START8S2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Doc Medida Seguranca View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA8S2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "docmedidasegurancaview.aspx")), "docmedidasegurancaview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "docmedidasegurancaview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      protected void E118S2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("docmedidasegurancaww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV17GXLvl9 = 0;
         /* Using cursor H008S2 */
         pr_default.execute(0, new Object[] {AV10MedidaSegurancaId, AV11DocumentoId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A75DocumentoId = H008S2_A75DocumentoId[0];
            A51MedidaSegurancaId = H008S2_A51MedidaSegurancaId[0];
            AV17GXLvl9 = 1;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "DocMedidaSegurancaGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "docmedidasegurancageneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "DocMedidaSegurancaGeneral";
            WebComp_Webcomponent_general_Component = "DocMedidaSegurancaGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10MedidaSegurancaId,(int)AV11DocumentoId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910514390", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("docmedidasegurancaview.js", "?202311910514391", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divDocmedidasegurancageneral_cell_Internalname = "DOCMEDIDASEGURANCAGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Doc Medida Seguranca View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10MedidaSegurancaId',fld:'vMEDIDASEGURANCAID',pic:'ZZZZZZZ9',hsh:true},{av:'AV11DocumentoId',fld:'vDOCUMENTOID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H008S2_A75DocumentoId = new int[1] ;
         H008S2_A51MedidaSegurancaId = new int[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.docmedidasegurancaview__default(),
            new Object[][] {
                new Object[] {
               H008S2_A75DocumentoId, H008S2_A51MedidaSegurancaId
               }
            }
         );
      ...
      private string divDocmedidasegurancageneral_cell_Internalname ;
      ...
      private int[] H008S2_A75DocumentoId ;
      private int[] H008S2_A51MedidaSegurancaId ;
   ...
   public class docmedidasegurancaview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmH008S2;
          prmH008S2 = new Object[] {
          new ParDef("@AV10MedidaSegurancaId",GXType.Int32,8,0) ,
          new ParDef("@AV11DocumentoId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H008S2", "SELECT [DocumentoId], [MedidaSegurancaId] FROM [DocMedidaSeguranca] WHERE ([MedidaSegurancaId] = @AV10MedidaSegurancaId and [DocumentoId] = @AV11DocumentoId) AND ([MedidaSegurancaId] = @AV10MedidaSegurancaId and [DocumentoId] = @AV11DocumentoId) ORDER BY [MedidaSegurancaId], [DocumentoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008S2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

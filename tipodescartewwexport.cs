...
namespace GeneXus.Programs {
   ...
   public class tipodescartewwexport__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV18OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( [TipoDescarteNome] like '%' + @lV46Tipodescartewwds_1_filterfulltext) or ( 'sim' like '%' + LOWER(@lV46Tipodescartewwds_1_filterfulltext) and [TipoDescarteAtivo] = 1) or ( 'não' like '%' + LOWER(@lV46Tipodescartewwds_1_filterfulltext) and [TipoDescarteAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;

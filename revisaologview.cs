...
namespace GeneXus.Programs {
   public class revisaologview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public revisaologview( )
      {
      ...
      public revisaologview( IGxContext context )
      {
      ...
      public void execute( int aP0_RevisaoLogId ,
                           string aP1_TabCode )
      {
         this.AV10RevisaoLogId = aP0_RevisaoLogId;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "revisaologview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10RevisaoLogId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("revisaologview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vREVISAOLOGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10RevisaoLogId), "ZZZZZZZ9"), context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vREVISAOLOGID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10RevisaoLogId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vREVISAOLOGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10RevisaoLogId), "ZZZZZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "revisaologview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10RevisaoLogId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("revisaologview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "RevisaoLogView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Revisao Log View" ;
      }
      ...
      protected void WB8O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Revisao Log", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_RevisaoLogView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divRevisaologgeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
      ...
      protected void START8O2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Revisao Log View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA8O2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "revisaologview.aspx")), "revisaologview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "revisaologview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10RevisaoLogId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10RevisaoLogId", StringUtil.LTrimStr( (decimal)(AV10RevisaoLogId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vREVISAOLOGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10RevisaoLogId), "ZZZZZZZ9"), context));
      ...
      protected void E118O2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("revisaologww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H008O2 */
         pr_default.execute(0, new Object[] {AV10RevisaoLogId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A120RevisaoLogId = H008O2_A120RevisaoLogId[0];
            A121RevisaoLogUsuarioAlteracao = H008O2_A121RevisaoLogUsuarioAlteracao[0];
            AV16GXLvl9 = 1;
            Form.Caption = A121RevisaoLogUsuarioAlteracao;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "RevisaoLogGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "revisaologgeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "RevisaoLogGeneral";
            WebComp_Webcomponent_general_Component = "RevisaoLogGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10RevisaoLogId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10RevisaoLogId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10RevisaoLogId", StringUtil.LTrimStr( (decimal)(AV10RevisaoLogId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vREVISAOLOGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10RevisaoLogId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910513936", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("revisaologview.js", "?202311910513936", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divRevisaologgeneral_cell_Internalname = "REVISAOLOGGENERAL_CELL";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10RevisaoLogId',fld:'vREVISAOLOGID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H008O2_A120RevisaoLogId = new int[1] ;
         H008O2_A121RevisaoLogUsuarioAlteracao = new string[] {""} ;
         A121RevisaoLogUsuarioAlteracao = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.revisaologview__default(),
            new Object[][] {
                new Object[] {
               H008O2_A120RevisaoLogId, H008O2_A121RevisaoLogUsuarioAlteracao
               }
            }
         );
      ...
      private int wcpOAV10RevisaoLogId ;
      ...
      private string divRevisaologgeneral_cell_Internalname ;
      ...
      private int[] H008O2_A120RevisaoLogId ;
      private string[] H008O2_A121RevisaoLogUsuarioAlteracao ;
   ...
   public class revisaologview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10RevisaoLogId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H008O2", "SELECT [RevisaoLogId], [RevisaoLogUsuarioAlteracao] FROM [RevisaoLog] WHERE [RevisaoLogId] = @AV10RevisaoLogId ORDER BY [RevisaoLogId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008O2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

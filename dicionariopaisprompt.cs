...
namespace GeneXus.Programs {
   public class dicionariopaisprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public dicionariopaisprompt( )
      {
      ...
      public dicionariopaisprompt( IGxContext context )
      {
      ...
      public void execute( int aP0_InPaisId ,
                           ref int aP1_InOutDocDicionarioId )
      {
         this.AV8InPaisId = aP0_InPaisId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InPaisId");
            ...
            {
               AV8InPaisId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InPaisId", StringUtil.LTrimStr( (decimal)(AV8InPaisId), 8, 0));
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV8InPaisId = (int)(NumberUtil.Val( GetPar( "InPaisId"), "."));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13FilterFullText, AV8InPaisId, AV22Pgmname) ;
      ...
      {
         get {
            return "dicionariopaisprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("dicionariopaisprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InPaisId,8,0)),UrlEncode(StringUtil.LTrimStr(AV9InOutDocDicionarioId,8,0))}, new string[] {"InPaisId","InOutDocDicionarioId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINPAISID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InPaisId), 8, 0, ",", "")));
      ...
      {
         return formatLink("dicionariopaisprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InPaisId,8,0)),UrlEncode(StringUtil.LTrimStr(AV9InOutDocDicionarioId,8,0))}, new string[] {"InPaisId","InOutDocDicionarioId"})  ;
      }

      public override string GetPgmname( )
      {
         return "DicionarioPaisPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Dicionario Pais" ;
      }
      ...
      protected void WB8Z0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_8Z2( true) ;
         }
         else
         {
            wb_table1_14_8Z2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_8Z2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START8Z2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Dicionario Pais", 0) ;
         }
         context.wjLoc = "";
      ...
      {
         /* GeneXus formulas. */
         AV22Pgmname = "DicionarioPaisPrompt";
         context.Gx_err = 0;
      ...
      protected void RF8Z2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV13FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV13FilterFullText), "%", "");
            /* Using cursor H008Z2 */
            pr_default.execute(0, new Object[] {AV8InPaisId, lV13FilterFullText, lV13FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_26_idx = 1;
            sGXsfl_26_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_26_idx), 4, 0), 4, "0");
            SubsflControlProps_262( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A98DocDicionarioId = H008Z2_A98DocDicionarioId[0];
               A4PaisId = H008Z2_A4PaisId[0];
               E178Z2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV13FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV13FilterFullText), "%", "");
         /* Using cursor H008Z3 */
         pr_default.execute(1, new Object[] {AV8InPaisId, lV13FilterFullText, lV13FilterFullText});
      ...
      protected void E158Z2( )
      {
         ...
         Form.Caption = "Consulta de Dicionario Pais";
      ...
      protected void wb_table1_14_8Z2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_DicionarioPaisPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InPaisId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InPaisId", StringUtil.LTrimStr( (decimal)(AV8InPaisId), 8, 0));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910514956", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("dicionariopaisprompt.js", "?202311910514956", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:PaisId|2:DocDicionarioId";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InPaisId',fld:'vINPAISID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E118Z2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InPaisId',fld:'vINPAISID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E128Z2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InPaisId',fld:'vINPAISID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E138Z2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InPaisId',fld:'vINPAISID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'AV11OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV12OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E178Z2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E188Z2',iparms:[{av:'A98DocDicionarioId',fld:'DOCDICIONARIOID',pic:'ZZZZZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV9InOutDocDicionarioId',fld:'vINOUTDOCDICIONARIOID',pic:'ZZZZZZZ9'}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E148Z2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InPaisId',fld:'vINPAISID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H008Z2_A98DocDicionarioId = new int[1] ;
         H008Z2_A4PaisId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.dicionariopaisprompt__default(),
            new Object[][] {
                new Object[] {
               H008Z2_A98DocDicionarioId, H008Z2_A4PaisId
               }
               , new Object[] {
      ...
      private int AV8InPaisId ;
      private int AV9InOutDocDicionarioId ;
      private int wcpOAV8InPaisId ;
      ...
      private int[] H008Z2_A98DocDicionarioId ;
      private int[] H008Z2_A4PaisId ;
   ...
   public class dicionariopaisprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int AV8InPaisId )
      {
         ...
         sOrderString = "";
         AddWhere(sWhereString, "([PaisId] = @AV8InPaisId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13FilterFullText)) )
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([PaisId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( CONVERT( char(8), CAST([DocDicionarioId] AS decimal(8,0))) like '%' + @lV13FilterFullText))");
         }
         else
         {
            GXv_int3[1] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H008Z2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] );
               case 1 :
                     return conditional_H008Z3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV8InPaisId",GXType.Int32,8,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H008Z2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008Z2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H008Z3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008Z3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }

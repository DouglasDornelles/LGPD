...
namespace GeneXus.Programs {
   public class frequenciatratamentoprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public frequenciatratamentoprompt( )
      {
      ...
      public frequenciatratamentoprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutFrequenciaTratamentoId ,
                           ref string aP1_InOutFrequenciaTratamentoNome )
      {
         this.AV8InOutFrequenciaTratamentoId = aP0_InOutFrequenciaTratamentoId;
         this.AV9InOutFrequenciaTratamentoNome = aP1_InOutFrequenciaTratamentoNome;
         executePrivate();
         aP0_InOutFrequenciaTratamentoId=this.AV8InOutFrequenciaTratamentoId;
         aP1_InOutFrequenciaTratamentoNome=this.AV9InOutFrequenciaTratamentoNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutFrequenciaTratamentoId");
            ...
            {
               AV8InOutFrequenciaTratamentoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutFrequenciaTratamentoId", StringUtil.LTrimStr( (decimal)(AV8InOutFrequenciaTratamentoId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutFrequenciaTratamentoNome = GetPar( "InOutFrequenciaTratamentoNome");
                  AssignAttri("", false, "AV9InOutFrequenciaTratamentoNome", AV9InOutFrequenciaTratamentoNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      {
         get {
            return "frequenciatratamentoprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("frequenciatratamentoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutFrequenciaTratamentoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutFrequenciaTratamentoNome))}, new string[] {"InOutFrequenciaTratamentoId","InOutFrequenciaTratamentoNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTFREQUENCIATRATAMENTOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutFrequenciaTratamentoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTFREQUENCIATRATAMENTONOME", AV9InOutFrequenciaTratamentoNome);
      ...
      {
         return formatLink("frequenciatratamentoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutFrequenciaTratamentoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutFrequenciaTratamentoNome))}, new string[] {"InOutFrequenciaTratamentoId","InOutFrequenciaTratamentoNome"})  ;
      }

      public override string GetPgmname( )
      {
         return "FrequenciaTratamentoPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Frequencia Tratamento" ;
      }
      ...
      protected void WB4J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_4J2( true) ;
         }
         else
         {
            wb_table1_14_4J2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_4J2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START4J2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Frequencia Tratamento", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_FREQUENCIATRATAMENTONOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A40FrequenciaTratamentoNome, "")), context));
         GxWebStd.gx_hidden_field( context, "FREQUENCIATRATAMENTONOME", A40FrequenciaTratamentoNome);
      }
      ...
      {
         /* GeneXus formulas. */
         AV22Pgmname = "FrequenciaTratamentoPrompt";
         context.Gx_err = 0;
      ...
      protected void RF4J2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A41FrequenciaTratamentoAtivo = H004J2_A41FrequenciaTratamentoAtivo[0];
               A40FrequenciaTratamentoNome = H004J2_A40FrequenciaTratamentoNome[0];
               A39FrequenciaTratamentoId = H004J2_A39FrequenciaTratamentoId[0];
               E174J2 ();
      ...
      protected void send_integrity_lvl_hashes4J2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_FREQUENCIATRATAMENTOID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A39FrequenciaTratamentoId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_FREQUENCIATRATAMENTONOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A40FrequenciaTratamentoNome, "")), context));
      }
      ...
      protected void E154J2( )
      {
         ...
         Form.Caption = "Consulta de Frequencia Tratamento";
      ...
      protected void E184J2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutFrequenciaTratamentoId = A39FrequenciaTratamentoId;
         AssignAttri("", false, "AV8InOutFrequenciaTratamentoId", StringUtil.LTrimStr( (decimal)(AV8InOutFrequenciaTratamentoId), 8, 0));
         AV9InOutFrequenciaTratamentoNome = A40FrequenciaTratamentoNome;
         AssignAttri("", false, "AV9InOutFrequenciaTratamentoNome", AV9InOutFrequenciaTratamentoNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutFrequenciaTratamentoId,(string)AV9InOutFrequenciaTratamentoNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutFrequenciaTratamentoId","AV9InOutFrequenciaTratamentoNome"});
      ...
      protected void wb_table1_14_4J2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_FrequenciaTratamentoPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutFrequenciaTratamentoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutFrequenciaTratamentoId", StringUtil.LTrimStr( (decimal)(AV8InOutFrequenciaTratamentoId), 8, 0));
         AV9InOutFrequenciaTratamentoNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutFrequenciaTratamentoNome", AV9InOutFrequenciaTratamentoNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910502838", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("frequenciatratamentoprompt.js", "?202311910502838", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtFrequenciaTratamentoId_Internalname = "FREQUENCIATRATAMENTOID_"+sGXsfl_26_idx;
         edtFrequenciaTratamentoNome_Internalname = "FREQUENCIATRATAMENTONOME_"+sGXsfl_26_idx;
         cmbFrequenciaTratamentoAtivo_Internalname = "FREQUENCIATRATAMENTOATIVO_"+sGXsfl_26_idx;
      }

      protected void SubsflControlProps_fel_262( )
      {
         edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx;
         edtFrequenciaTratamentoId_Internalname = "FREQUENCIATRATAMENTOID_"+sGXsfl_26_fel_idx;
         edtFrequenciaTratamentoNome_Internalname = "FREQUENCIATRATAMENTONOME_"+sGXsfl_26_fel_idx;
         cmbFrequenciaTratamentoAtivo_Internalname = "FREQUENCIATRATAMENTOATIVO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "FREQUENCIATRATAMENTOATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbFrequenciaTratamentoAtivo_Internalname, "Values", (string)(cmbFrequenciaTratamentoAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:FrequenciaTratamentoId|2:FrequenciaTratamentoNome|3:FrequenciaTratamentoAtivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E174J2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E184J2',iparms:[{av:'A39FrequenciaTratamentoId',fld:'FREQUENCIATRATAMENTOID',pic:'ZZZZZZZ9',hsh:true},{av:'A40FrequenciaTratamentoNome',fld:'FREQUENCIATRATAMENTONOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutFrequenciaTratamentoId',fld:'vINOUTFREQUENCIATRATAMENTOID',pic:'ZZZZZZZ9'},{av:'AV9InOutFrequenciaTratamentoNome',fld:'vINOUTFREQUENCIATRATAMENTONOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E144J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      {
         wcpOAV9InOutFrequenciaTratamentoNome = "";
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H004J2_A41FrequenciaTratamentoAtivo = new bool[] {false} ;
         H004J2_A40FrequenciaTratamentoNome = new string[] {""} ;
         H004J2_A39FrequenciaTratamentoId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.frequenciatratamentoprompt__default(),
            new Object[][] {
                new Object[] {
               H004J2_A41FrequenciaTratamentoAtivo, H004J2_A40FrequenciaTratamentoNome, H004J2_A39FrequenciaTratamentoId
               }
               , new Object[] {
      ...
      private int AV8InOutFrequenciaTratamentoId ;
      private int wcpOAV8InOutFrequenciaTratamentoId ;
      ...
      private string AV9InOutFrequenciaTratamentoNome ;
      private string wcpOAV9InOutFrequenciaTratamentoNome ;
      ...
      private int aP0_InOutFrequenciaTratamentoId ;
      private string aP1_InOutFrequenciaTratamentoNome ;
      private GXCombobox cmbFrequenciaTratamentoAtivo ;
      private IDataStoreProvider pr_default ;
      private bool[] H004J2_A41FrequenciaTratamentoAtivo ;
      private string[] H004J2_A40FrequenciaTratamentoNome ;
      private int[] H004J2_A39FrequenciaTratamentoId ;
   ...
   public class frequenciatratamentoprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([FrequenciaTratamentoId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [FrequenciaTratamentoNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and [FrequenciaTratamentoAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and [FrequenciaTratamentoAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H004J2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
               case 1 :
                     return conditional_H004J3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
         }

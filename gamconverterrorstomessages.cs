...
namespace GeneXus.Programs {
   public class gamconverterrorstomessages : GXProcedure
   {
                                 ...
                                 out GXBaseCollection<GeneXus.Utils.SdtMessages_Message> aP1_Messages )
      {
         ...
         objgamconverterrorstomessages.AV11Messages = new GXBaseCollection<GeneXus.Utils.SdtMessages_Message>( context, "Message", "GeneXus") ;
         objgamconverterrorstomessages.context.SetSubmitInitialConfig(context);
         objgamconverterrorstomessages.initialize();
         Submit( executePrivateCatch,objgamconverterrorstomessages);
         aP1_Messages=this.AV11Messages;
      }

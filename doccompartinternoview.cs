...
namespace GeneXus.Programs {
   public class doccompartinternoview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public doccompartinternoview( )
      {
      ...
      public doccompartinternoview( IGxContext context )
      {
      ...
      {
         get {
            return "doccompartinternoview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "doccompartinternoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10CompartInternoId,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV11DocumentoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("doccompartinternoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "doccompartinternoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10CompartInternoId,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV11DocumentoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("doccompartinternoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "DocCompartInternoView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Doc Compart Interno View" ;
      }
      ...
      protected void WB6I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Doc Compart Interno", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_DocCompartInternoView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divDoccompartinternogeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
      ...
      protected void START6I2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Doc Compart Interno View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA6I2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "doccompartinternoview.aspx")), "doccompartinternoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "doccompartinternoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      protected void E116I2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("doccompartinternoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV17GXLvl9 = 0;
         /* Using cursor H006I2 */
         pr_default.execute(0, new Object[] {AV10CompartInternoId, AV11DocumentoId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A75DocumentoId = H006I2_A75DocumentoId[0];
            A57CompartInternoId = H006I2_A57CompartInternoId[0];
            AV17GXLvl9 = 1;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "DocCompartInternoGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "doccompartinternogeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "DocCompartInternoGeneral";
            WebComp_Webcomponent_general_Component = "DocCompartInternoGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10CompartInternoId,(int)AV11DocumentoId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910512174", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("doccompartinternoview.js", "?202311910512174", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divDoccompartinternogeneral_cell_Internalname = "DOCCOMPARTINTERNOGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Doc Compart Interno View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10CompartInternoId',fld:'vCOMPARTINTERNOID',pic:'ZZZZZZZ9',hsh:true},{av:'AV11DocumentoId',fld:'vDOCUMENTOID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H006I2_A75DocumentoId = new int[1] ;
         H006I2_A57CompartInternoId = new int[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.doccompartinternoview__default(),
            new Object[][] {
                new Object[] {
               H006I2_A75DocumentoId, H006I2_A57CompartInternoId
               }
            }
         );
      ...
      private string divDoccompartinternogeneral_cell_Internalname ;
      ...
      private int[] H006I2_A75DocumentoId ;
      private int[] H006I2_A57CompartInternoId ;
   ...
   public class doccompartinternoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H006I2", "SELECT [DocumentoId], [CompartInternoId] FROM [DocCompartInterno] WHERE ([CompartInternoId] = @AV10CompartInternoId and [DocumentoId] = @AV11DocumentoId) AND ([CompartInternoId] = @AV10CompartInternoId and [DocumentoId] = @AV11DocumentoId) ORDER BY [CompartInternoId], [DocumentoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006I2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

...
namespace GeneXus.Programs {
   public class frequenciatratamentowwgetfilterdata : GXProcedure
   {
      ...
      {
         get {
            return "frequenciatratamentoww_Services_Execute" ;
         }

      }

      public frequenciatratamentowwgetfilterdata( )
      {
      ...
      public frequenciatratamentowwgetfilterdata( IGxContext context )
      {
      ...
      public void executeSubmit( string aP0_DDOName ,
                                 ...
                                 out string aP5_OptionIndexesJson )
      {
         frequenciatratamentowwgetfilterdata objfrequenciatratamentowwgetfilterdata;
         objfrequenciatratamentowwgetfilterdata = new frequenciatratamentowwgetfilterdata();
         objfrequenciatratamentowwgetfilterdata.AV20DDOName = aP0_DDOName;
         objfrequenciatratamentowwgetfilterdata.AV14SearchTxtParms = aP1_SearchTxtParms;
         objfrequenciatratamentowwgetfilterdata.AV19SearchTxtTo = aP2_SearchTxtTo;
         objfrequenciatratamentowwgetfilterdata.AV24OptionsJson = "" ;
         objfrequenciatratamentowwgetfilterdata.AV27OptionsDescJson = "" ;
         objfrequenciatratamentowwgetfilterdata.AV29OptionIndexesJson = "" ;
         objfrequenciatratamentowwgetfilterdata.context.SetSubmitInitialConfig(context);
         objfrequenciatratamentowwgetfilterdata.initialize();
         Submit( executePrivateCatch,objfrequenciatratamentowwgetfilterdata);
         aP3_OptionsJson=this.AV24OptionsJson;
         aP4_OptionsDescJson=this.AV27OptionsDescJson;
         aP5_OptionIndexesJson=this.AV29OptionIndexesJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((frequenciatratamentowwgetfilterdata)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Upper( AV20DDOName), "DDO_FREQUENCIATRATAMENTONOME") == 0 )
         {
            /* Execute user subroutine: 'LOADFREQUENCIATRATAMENTONOMEOPTIONS' */
            S121 ();
            if ( returnInSub )
            {
               this.cleanup();
      ...
      protected void S111( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV31Session.Get("FrequenciaTratamentoWWGridState"), "") == 0 )
         {
            AV33GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "FrequenciaTratamentoWWGridState"), null, "", "");
         }
         else
         {
            AV33GridState.FromXml(AV31Session.Get("FrequenciaTratamentoWWGridState"), null, "", "");
         }
         AV39GXV1 = 1;
         while ( AV39GXV1 <= AV33GridState.gxTpr_Filtervalues.Count )
         {
            ...
            else if ( StringUtil.StrCmp(AV34GridStateFilterValue.gxTpr_Name, "TFFREQUENCIATRATAMENTONOME") == 0 )
            {
               AV11TFFrequenciaTratamentoNome = AV34GridStateFilterValue.gxTpr_Value;
            }
            else if ( StringUtil.StrCmp(AV34GridStateFilterValue.gxTpr_Name, "TFFREQUENCIATRATAMENTONOME_SEL") == 0 )
            {
               AV12TFFrequenciaTratamentoNome_Sel = AV34GridStateFilterValue.gxTpr_Value;
            }
            else if ( StringUtil.StrCmp(AV34GridStateFilterValue.gxTpr_Name, "TFFREQUENCIATRATAMENTOATIVO_SEL") == 0 )
            {
               AV13TFFrequenciaTratamentoAtivo_Sel = (short)(NumberUtil.Val( AV34GridStateFilterValue.gxTpr_Value, "."));
            }
      ...
      protected void S121( )
      {
         /* 'LOADFREQUENCIATRATAMENTONOMEOPTIONS' Routine */
         returnInSub = false;
         AV11TFFrequenciaTratamentoNome = AV18SearchTxt;
         AV12TFFrequenciaTratamentoNome_Sel = "";
         AV41Frequenciatratamentowwds_1_filterfulltext = AV36FilterFullText;
         AV42Frequenciatratamentowwds_2_tffrequenciatratamentonome = AV11TFFrequenciaTratamentoNome;
         AV43Frequenciatratamentowwds_3_tffrequenciatratamentonome_sel = AV12TFFrequenciaTratamentoNome_Sel;
         AV44Frequenciatratamentowwds_4_tffrequenciatratamentoativo_sel = AV13TFFrequenciaTratamentoAtivo_Sel;
         ...
         {
            BRK3W2 = false;
            A40FrequenciaTratamentoNome = P003W2_A40FrequenciaTratamentoNome[0];
            A41FrequenciaTratamentoAtivo = P003W2_A41FrequenciaTratamentoAtivo[0];
            A39FrequenciaTratamentoId = P003W2_A39FrequenciaTratamentoId[0];
            AV30count = 0;
            while ( (pr_default.getStatus(0) != 101) && ( StringUtil.StrCmp(P003W2_A40FrequenciaTratamentoNome[0], A40FrequenciaTratamentoNome) == 0 ) )
            {
               BRK3W2 = false;
               A39FrequenciaTratamentoId = P003W2_A39FrequenciaTratamentoId[0];
            ...
            if ( (0==AV15SkipItems) )
            {
               AV22Option = (String.IsNullOrEmpty(StringUtil.RTrim( A40FrequenciaTratamentoNome)) ? "<#Empty#>" : A40FrequenciaTratamentoNome);
      ...
      public override void initialize( )
      {
         ...
         AV36FilterFullText = "";
         AV11TFFrequenciaTratamentoNome = "";
         AV12TFFrequenciaTratamentoNome_Sel = "";
         AV41Frequenciatratamentowwds_1_filterfulltext = "";
         AV42Frequenciatratamentowwds_2_tffrequenciatratamentonome = "";
         AV43Frequenciatratamentowwds_3_tffrequenciatratamentonome_sel = "";
         ...
         A40FrequenciaTratamentoNome = "";
         P003W2_A40FrequenciaTratamentoNome = new string[] {""} ;
         P003W2_A41FrequenciaTratamentoAtivo = new bool[] {false} ;
         P003W2_A39FrequenciaTratamentoId = new int[1] ;
         AV22Option = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.frequenciatratamentowwgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P003W2_A40FrequenciaTratamentoNome, P003W2_A41FrequenciaTratamentoAtivo, P003W2_A39FrequenciaTratamentoId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short AV13TFFrequenciaTratamentoAtivo_Sel ;
      ...
      private string AV11TFFrequenciaTratamentoNome ;
      private string AV12TFFrequenciaTratamentoNome_Sel ;
      ...
      private string[] P003W2_A40FrequenciaTratamentoNome ;
      private bool[] P003W2_A41FrequenciaTratamentoAtivo ;
      private int[] P003W2_A39FrequenciaTratamentoId ;
   ...
   public class frequenciatratamentowwgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool A41FrequenciaTratamentoAtivo )
      {
         ...
         scmdbuf = "SELECT [FrequenciaTratamentoNome], [FrequenciaTratamentoAtivo], [FrequenciaTratamentoId] FROM [FrequenciaTratamento]";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV41Frequenciatratamentowwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( [FrequenciaTratamentoNome] like '%' + @lV41Frequenciatratamentowwds_1_filterfulltext) or ( 'sim' like '%' + LOWER(@lV41Frequenciatratamentowwds_1_filterfulltext) and [FrequenciaTratamentoAtivo] = 1) or ( 'não' like '%' + LOWER(@lV41Frequenciatratamentowwds_1_filterfulltext) and [FrequenciaTratamentoAtivo] = 0))");
         }
         else
         {
            GXv_int1[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P003W2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (string)dynConstraints[4] , (bool)dynConstraints[5] );
         }
 ...
 [ServiceContract(Namespace = "GeneXus.Programs.frequenciatratamentowwgetfilterdata_services")]
 [ServiceBehavior(ConcurrencyMode = ConcurrencyMode.Multiple)]
 [AspNetCompatibilityRequirements(RequirementsMode = AspNetCompatibilityRequirementsMode.Allowed)]
 public class frequenciatratamentowwgetfilterdata_services : GxRestService
 {
    protected override bool IntegratedSecurityEnabled
    {
       get {
    ...
    [OperationContract(Name = "FrequenciaTratamentoWWGetFilterData" )]
                         ...
                         out string OptionIndexesJson )
    {
       ...
       try
       {
          permissionPrefix = "frequenciatratamentoww_Services_Execute";
          if ( ! IsAuthenticated() )
          {
             return  ;
          }
          if ( ! ProcessHeaders("frequenciatratamentowwgetfilterdata") )
          {
             return  ;
          }
          frequenciatratamentowwgetfilterdata worker = new frequenciatratamentowwgetfilterdata(context);

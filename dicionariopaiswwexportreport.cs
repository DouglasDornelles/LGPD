   ...
   public class dicionariopaiswwexportreport : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void S111( )
      {
         ...
         if ( ! ( (0==AV18TFPaisId) && (0==AV19TFPaisId_To) ) )
         {
            H7D0( false, 20) ;
            getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 169, 169, 169, 0, 255, 255, 255) ;
            getPrinter().GxDrawText("do País", 25, Gx_line+0, 120, Gx_line+15, 0, 0, 0, 0) ;
            getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
            ...
            Gx_OldLine = Gx_line;
            Gx_line = (int)(Gx_line+20);
            AV22TFPaisId_To_Description = StringUtil.Format( "%1 (%2)", "do País", "Até", "", "", "", "", "", "", "");
            H7D0( false, 20) ;
            getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 169, 169, 169, 0, 255, 255, 255) ;
      ...
      protected void S121( )
      {
         ...
         getPrinter().GxDrawText("do País", 30, Gx_line+10, 406, Gx_line+27, 2, 0, 0, 0) ;

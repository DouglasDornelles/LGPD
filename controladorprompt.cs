...
namespace GeneXus.Programs {
   public class controladorprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public controladorprompt( )
      {
      ...
      public controladorprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutControladorId ,
                           ref string aP1_InOutControladorNome )
      {
         this.AV8InOutControladorId = aP0_InOutControladorId;
         this.AV9InOutControladorNome = aP1_InOutControladorNome;
         executePrivate();
         aP0_InOutControladorId=this.AV8InOutControladorId;
         aP1_InOutControladorNome=this.AV9InOutControladorNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutControladorId");
            ...
            {
               AV8InOutControladorId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutControladorId", StringUtil.LTrimStr( (decimal)(AV8InOutControladorId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutControladorNome = GetPar( "InOutControladorNome");
                  AssignAttri("", false, "AV9InOutControladorNome", AV9InOutControladorNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      {
         get {
            return "controladorprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("controladorprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutControladorId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutControladorNome))}, new string[] {"InOutControladorId","InOutControladorNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTCONTROLADORID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutControladorId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTCONTROLADORNOME", AV9InOutControladorNome);
      ...
      {
         return formatLink("controladorprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutControladorId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutControladorNome))}, new string[] {"InOutControladorId","InOutControladorNome"})  ;
      }

      public override string GetPgmname( )
      {
         return "ControladorPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Controlador" ;
      }
      ...
      protected void WB3D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_3D2( true) ;
         }
         else
         {
            wb_table1_14_3D2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_3D2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START3D2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Controlador", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_CONTROLADORNOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A11ControladorNome, "")), context));
         GxWebStd.gx_hidden_field( context, "CONTROLADORNOME", A11ControladorNome);
      }
      ...
      protected void RF3D2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A12ControladorAtivo = H003D2_A12ControladorAtivo[0];
               A11ControladorNome = H003D2_A11ControladorNome[0];
               A10ControladorId = H003D2_A10ControladorId[0];
               E173D2 ();
      ...
      protected void send_integrity_lvl_hashes3D2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_CONTROLADORID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A10ControladorId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_CONTROLADORNOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A11ControladorNome, "")), context));
      }
      ...
      protected void E153D2( )
      {
         ...
         Form.Caption = "Consulta de Controlador";
      ...
      protected void E183D2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutControladorId = A10ControladorId;
         AssignAttri("", false, "AV8InOutControladorId", StringUtil.LTrimStr( (decimal)(AV8InOutControladorId), 8, 0));
         AV9InOutControladorNome = A11ControladorNome;
         AssignAttri("", false, "AV9InOutControladorNome", AV9InOutControladorNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutControladorId,(string)AV9InOutControladorNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutControladorId","AV9InOutControladorNome"});
      ...
      protected void wb_table1_14_3D2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_ControladorPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutControladorId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutControladorId", StringUtil.LTrimStr( (decimal)(AV8InOutControladorId), 8, 0));
         AV9InOutControladorNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutControladorNome", AV9InOutControladorNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910505842", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("controladorprompt.js", "?202311910505842", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtControladorId_Internalname = "CONTROLADORID_"+sGXsfl_26_idx;
         edtControladorNome_Internalname = "CONTROLADORNOME_"+sGXsfl_26_idx;
         cmbControladorAtivo_Internalname = "CONTROLADORATIVO_"+sGXsfl_26_idx;
      }

      protected void SubsflControlProps_fel_262( )
      {
         edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx;
         edtControladorId_Internalname = "CONTROLADORID_"+sGXsfl_26_fel_idx;
         edtControladorNome_Internalname = "CONTROLADORNOME_"+sGXsfl_26_fel_idx;
         cmbControladorAtivo_Internalname = "CONTROLADORATIVO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "CONTROLADORATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbControladorAtivo_Internalname, "Values", (string)(cmbControladorAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
      ...
      protected void StartGridControl26( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( "do Controlador") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "") ;
            context.WriteHtmlTextNl( "</th>") ;
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:ControladorId|2:ControladorNome|3:ControladorAtivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E173D2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E183D2',iparms:[{av:'A10ControladorId',fld:'CONTROLADORID',pic:'ZZZZZZZ9',hsh:true},{av:'A11ControladorNome',fld:'CONTROLADORNOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutControladorId',fld:'vINOUTCONTROLADORID',pic:'ZZZZZZZ9'},{av:'AV9InOutControladorNome',fld:'vINOUTCONTROLADORNOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E143D2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H003D2_A12ControladorAtivo = new bool[] {false} ;
         H003D2_A11ControladorNome = new string[] {""} ;
         H003D2_A10ControladorId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.controladorprompt__default(),
            new Object[][] {
                new Object[] {
               H003D2_A12ControladorAtivo, H003D2_A11ControladorNome, H003D2_A10ControladorId
               }
               , new Object[] {
      ...
      private int AV8InOutControladorId ;
      private int wcpOAV8InOutControladorId ;
      ...
      private string AV9InOutControladorNome ;
      private string wcpOAV9InOutControladorNome ;
      ...
      private int aP0_InOutControladorId ;
      private string aP1_InOutControladorNome ;
      private GXCombobox cmbControladorAtivo ;
      private IDataStoreProvider pr_default ;
      private bool[] H003D2_A12ControladorAtivo ;
      private string[] H003D2_A11ControladorNome ;
      private int[] H003D2_A10ControladorId ;
   ...
   public class controladorprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H003D2( IGxContext context ,
                                             string AV13FilterFullText ,
                                             int A10ControladorId ,
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([ControladorId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [ControladorNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and [ControladorAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and [ControladorAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
         ...
         {
            sOrderString += " ORDER BY [ControladorId] DESC";
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H003D2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
               case 1 :
                     return conditional_H003D3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("H003D3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003D3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }

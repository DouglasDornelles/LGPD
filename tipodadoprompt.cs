...
namespace GeneXus.Programs {
   public class tipodadoprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public tipodadoprompt( )
      {
      ...
      public tipodadoprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutTipoDadoId ,
                           ref string aP1_InOutTipoDadoNome )
      {
         this.AV8InOutTipoDadoId = aP0_InOutTipoDadoId;
         this.AV9InOutTipoDadoNome = aP1_InOutTipoDadoNome;
         executePrivate();
         aP0_InOutTipoDadoId=this.AV8InOutTipoDadoId;
         aP1_InOutTipoDadoNome=this.AV9InOutTipoDadoNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutTipoDadoId");
            ...
            {
               AV8InOutTipoDadoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutTipoDadoId", StringUtil.LTrimStr( (decimal)(AV8InOutTipoDadoId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutTipoDadoNome = GetPar( "InOutTipoDadoNome");
                  AssignAttri("", false, "AV9InOutTipoDadoNome", AV9InOutTipoDadoNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("tipodadoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutTipoDadoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutTipoDadoNome))}, new string[] {"InOutTipoDadoId","InOutTipoDadoNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTTIPODADOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutTipoDadoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTTIPODADONOME", AV9InOutTipoDadoNome);
      ...
      {
         return formatLink("tipodadoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutTipoDadoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutTipoDadoNome))}, new string[] {"InOutTipoDadoId","InOutTipoDadoNome"})  ;
      }

      public override string GetPgmname( )
      {
         return "TipoDadoPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Tipo Dado" ;
      }
      ...
      protected void START442( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Tipo Dado", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_TIPODADONOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A31TipoDadoNome, "")), context));
         GxWebStd.gx_hidden_field( context, "TIPODADONOME", A31TipoDadoNome);
      }
      ...
      protected void RF442( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A32TipoDadoAtivo = H00442_A32TipoDadoAtivo[0];
               A31TipoDadoNome = H00442_A31TipoDadoNome[0];
               A30TipoDadoId = H00442_A30TipoDadoId[0];
               E17442 ();
      ...
      protected void send_integrity_lvl_hashes442( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_TIPODADOID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A30TipoDadoId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_TIPODADONOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A31TipoDadoNome, "")), context));
      }
      ...
      protected void E15442( )
      {
         ...
         Form.Caption = "Consulta de Tipo Dado";
      ...
      protected void E18442( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutTipoDadoId = A30TipoDadoId;
         AssignAttri("", false, "AV8InOutTipoDadoId", StringUtil.LTrimStr( (decimal)(AV8InOutTipoDadoId), 8, 0));
         AV9InOutTipoDadoNome = A31TipoDadoNome;
         AssignAttri("", false, "AV9InOutTipoDadoNome", AV9InOutTipoDadoNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutTipoDadoId,(string)AV9InOutTipoDadoNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutTipoDadoId","AV9InOutTipoDadoNome"});
      ...
      protected void wb_table1_14_442( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_TipoDadoPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutTipoDadoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutTipoDadoId", StringUtil.LTrimStr( (decimal)(AV8InOutTipoDadoId), 8, 0));
         AV9InOutTipoDadoNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutTipoDadoNome", AV9InOutTipoDadoNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910502296", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("tipodadoprompt.js", "?202311910502296", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtTipoDadoId_Internalname = "TIPODADOID_"+sGXsfl_26_idx;
         edtTipoDadoNome_Internalname = "TIPODADONOME_"+sGXsfl_26_idx;
         cmbTipoDadoAtivo_Internalname = "TIPODADOATIVO_"+sGXsfl_26_idx;
      }

      protected void SubsflControlProps_fel_262( )
      {
         edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx;
         edtTipoDadoId_Internalname = "TIPODADOID_"+sGXsfl_26_fel_idx;
         edtTipoDadoNome_Internalname = "TIPODADONOME_"+sGXsfl_26_fel_idx;
         cmbTipoDadoAtivo_Internalname = "TIPODADOATIVO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "TIPODADOATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbTipoDadoAtivo_Internalname, "Values", (string)(cmbTipoDadoAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:TipoDadoId|2:TipoDadoNome|3:TipoDadoAtivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E17442',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E18442',iparms:[{av:'A30TipoDadoId',fld:'TIPODADOID',pic:'ZZZZZZZ9',hsh:true},{av:'A31TipoDadoNome',fld:'TIPODADONOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutTipoDadoId',fld:'vINOUTTIPODADOID',pic:'ZZZZZZZ9'},{av:'AV9InOutTipoDadoNome',fld:'vINOUTTIPODADONOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E14442',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H00442_A32TipoDadoAtivo = new bool[] {false} ;
         H00442_A31TipoDadoNome = new string[] {""} ;
         H00442_A30TipoDadoId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tipodadoprompt__default(),
            new Object[][] {
                new Object[] {
               H00442_A32TipoDadoAtivo, H00442_A31TipoDadoNome, H00442_A30TipoDadoId
               }
               , new Object[] {
      ...
      private int AV8InOutTipoDadoId ;
      private int wcpOAV8InOutTipoDadoId ;
      ...
      private string AV9InOutTipoDadoNome ;
      private string wcpOAV9InOutTipoDadoNome ;
      ...
      private int aP0_InOutTipoDadoId ;
      private string aP1_InOutTipoDadoNome ;
      private GXCombobox cmbTipoDadoAtivo ;
      private IDataStoreProvider pr_default ;
      private bool[] H00442_A32TipoDadoAtivo ;
      private string[] H00442_A31TipoDadoNome ;
      private int[] H00442_A30TipoDadoId ;
   ...
   public class tipodadoprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([TipoDadoId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [TipoDadoNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and [TipoDadoAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and [TipoDadoAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00442(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
               case 1 :
                     return conditional_H00443(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
         }

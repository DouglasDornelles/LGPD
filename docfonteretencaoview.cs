...
namespace GeneXus.Programs {
   public class docfonteretencaoview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public docfonteretencaoview( )
      {
      ...
      public docfonteretencaoview( IGxContext context )
      {
      ...
      {
         get {
            return "docfonteretencaoview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "docfonteretencaoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10FonteRetencaoId,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV11DocumentoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("docfonteretencaoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "docfonteretencaoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10FonteRetencaoId,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV11DocumentoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("docfonteretencaoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "DocFonteRetencaoView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Doc Fonte Retencao View" ;
      }
      ...
      protected void WB6O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Doc Fonte Retencao", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_DocFonteRetencaoView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divDocfonteretencaogeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
      ...
      protected void START6O2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Doc Fonte Retencao View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA6O2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "docfonteretencaoview.aspx")), "docfonteretencaoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "docfonteretencaoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      protected void E116O2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("docfonteretencaoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV17GXLvl9 = 0;
         /* Using cursor H006O2 */
         pr_default.execute(0, new Object[] {AV10FonteRetencaoId, AV11DocumentoId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A75DocumentoId = H006O2_A75DocumentoId[0];
            A63FonteRetencaoId = H006O2_A63FonteRetencaoId[0];
            AV17GXLvl9 = 1;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "DocFonteRetencaoGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "docfonteretencaogeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "DocFonteRetencaoGeneral";
            WebComp_Webcomponent_general_Component = "DocFonteRetencaoGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10FonteRetencaoId,(int)AV11DocumentoId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910511992", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("docfonteretencaoview.js", "?202311910511992", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divDocfonteretencaogeneral_cell_Internalname = "DOCFONTERETENCAOGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Doc Fonte Retencao View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10FonteRetencaoId',fld:'vFONTERETENCAOID',pic:'ZZZZZZZ9',hsh:true},{av:'AV11DocumentoId',fld:'vDOCUMENTOID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H006O2_A75DocumentoId = new int[1] ;
         H006O2_A63FonteRetencaoId = new int[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.docfonteretencaoview__default(),
            new Object[][] {
                new Object[] {
               H006O2_A75DocumentoId, H006O2_A63FonteRetencaoId
               }
            }
         );
      ...
      private string divDocfonteretencaogeneral_cell_Internalname ;
      ...
      private int[] H006O2_A75DocumentoId ;
      private int[] H006O2_A63FonteRetencaoId ;
   ...
   public class docfonteretencaoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H006O2", "SELECT [DocumentoId], [FonteRetencaoId] FROM [DocFonteRetencao] WHERE ([FonteRetencaoId] = @AV10FonteRetencaoId and [DocumentoId] = @AV11DocumentoId) AND ([FonteRetencaoId] = @AV10FonteRetencaoId and [DocumentoId] = @AV11DocumentoId) ORDER BY [FonteRetencaoId], [DocumentoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006O2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

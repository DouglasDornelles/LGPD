...
namespace GeneXus.Programs {
   ...
   public class campoww__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV14OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( T1.[CampoNome] like '%' + @lV54Campowwds_1_filterfulltext) or ( 'sim' like '%' + LOWER(@lV54Campowwds_1_filterfulltext) and T1.[CampoAtivo] = 1) or ( 'não' like '%' + LOWER(@lV54Campowwds_1_filterfulltext) and T1.[CampoAtivo] = 0) or ( T2.[TelaNome] like '%' + @lV54Campowwds_1_filterfulltext))");
         }
         else
         {
            GXv_int6[0] = 1;

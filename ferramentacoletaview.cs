...
namespace GeneXus.Programs {
   public class ferramentacoletaview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public ferramentacoletaview( )
      {
      ...
      public ferramentacoletaview( IGxContext context )
      {
      ...
      public void execute( int aP0_FerramentaColetaId ,
                           string aP1_TabCode )
      {
         this.AV10FerramentaColetaId = aP0_FerramentaColetaId;
      ...
      {
         get {
            return "ferramentacoletaview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "ferramentacoletaview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10FerramentaColetaId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("ferramentacoletaview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vFERRAMENTACOLETAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10FerramentaColetaId), "ZZZZZZZ9"), context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vFERRAMENTACOLETAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10FerramentaColetaId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vFERRAMENTACOLETAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10FerramentaColetaId), "ZZZZZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "ferramentacoletaview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10FerramentaColetaId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("ferramentacoletaview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "FerramentaColetaView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Ferramenta Coleta View" ;
      }
      ...
      protected void WB470( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Ferramenta Coleta", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_FerramentaColetaView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divFerramentacoletageneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
      ...
      protected void START472( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Ferramenta Coleta View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA472( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "ferramentacoletaview.aspx")), "ferramentacoletaview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "ferramentacoletaview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10FerramentaColetaId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10FerramentaColetaId", StringUtil.LTrimStr( (decimal)(AV10FerramentaColetaId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vFERRAMENTACOLETAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10FerramentaColetaId), "ZZZZZZZ9"), context));
      ...
      protected void E11472( )
      {
         ...
         lblWorkwithlink_Link = formatLink("ferramentacoletaww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H00472 */
         pr_default.execute(0, new Object[] {AV10FerramentaColetaId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A33FerramentaColetaId = H00472_A33FerramentaColetaId[0];
            A34FerramentaColetaNome = H00472_A34FerramentaColetaNome[0];
            AV16GXLvl9 = 1;
            Form.Caption = A34FerramentaColetaNome;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "FerramentaColetaGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "ferramentacoletageneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "FerramentaColetaGeneral";
            WebComp_Webcomponent_general_Component = "FerramentaColetaGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10FerramentaColetaId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10FerramentaColetaId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10FerramentaColetaId", StringUtil.LTrimStr( (decimal)(AV10FerramentaColetaId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vFERRAMENTACOLETAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10FerramentaColetaId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910502186", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("ferramentacoletaview.js", "?202311910502186", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divFerramentacoletageneral_cell_Internalname = "FERRAMENTACOLETAGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Ferramenta Coleta View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10FerramentaColetaId',fld:'vFERRAMENTACOLETAID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00472_A33FerramentaColetaId = new int[1] ;
         H00472_A34FerramentaColetaNome = new string[] {""} ;
         A34FerramentaColetaNome = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.ferramentacoletaview__default(),
            new Object[][] {
                new Object[] {
               H00472_A33FerramentaColetaId, H00472_A34FerramentaColetaNome
               }
            }
         );
      ...
      private int wcpOAV10FerramentaColetaId ;
      ...
      private string divFerramentacoletageneral_cell_Internalname ;
      ...
      private int[] H00472_A33FerramentaColetaId ;
      private string[] H00472_A34FerramentaColetaNome ;
   ...
   public class ferramentacoletaview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10FerramentaColetaId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H00472", "SELECT [FerramentaColetaId], [FerramentaColetaNome] FROM [FerramentaColeta] WHERE [FerramentaColetaId] = @AV10FerramentaColetaId ORDER BY [FerramentaColetaId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00472,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

...
namespace GeneXus.Programs {
   public class rwdmasterpage : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm042( )
      {
         ...
         context.AddJavascriptSource("rwdmasterpage.js", "?20231191047032", false, true);
      ...
      protected void WB040( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "PoweredBy" + " " + ((StringUtil.StrCmp(imgImage1_gximage, "")==0) ? "GX_Image_PoweredByGeneXus_Class" : "GX_Image_"+imgImage1_gximage+"_Class");
            StyleString = "";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?20231191047040", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("rwdmasterpage.js", "?20231191047040", false, true);

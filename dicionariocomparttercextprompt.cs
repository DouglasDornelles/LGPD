...
namespace GeneXus.Programs {
   public class dicionariocomparttercextprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public dicionariocomparttercextprompt( )
      {
      ...
      public dicionariocomparttercextprompt( IGxContext context )
      {
      ...
      public void execute( int aP0_InCompartTercExternoId ,
                           ref int aP1_InOutDocDicionarioId )
      {
         this.AV8InCompartTercExternoId = aP0_InCompartTercExternoId;
         this.AV9InOutDocDicionarioId = aP1_InOutDocDicionarioId;
         executePrivate();
         aP1_InOutDocDicionarioId=this.AV9InOutDocDicionarioId;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InCompartTercExternoId");
            ...
            {
               AV8InCompartTercExternoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InCompartTercExternoId", StringUtil.LTrimStr( (decimal)(AV8InCompartTercExternoId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutDocDicionarioId = (int)(NumberUtil.Val( GetPar( "InOutDocDicionarioId"), "."));
                  AssignAttri("", false, "AV9InOutDocDicionarioId", StringUtil.LTrimStr( (decimal)(AV9InOutDocDicionarioId), 8, 0));
               }
            }
            if ( toggleJsOutput )
            {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV8InCompartTercExternoId = (int)(NumberUtil.Val( GetPar( "InCompartTercExternoId"), "."));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13FilterFullText, AV8InCompartTercExternoId, AV22Pgmname) ;
      ...
      {
         get {
            return "dicionariocomparttercextprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("dicionariocomparttercextprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InCompartTercExternoId,8,0)),UrlEncode(StringUtil.LTrimStr(AV9InOutDocDicionarioId,8,0))}, new string[] {"InCompartTercExternoId","InOutDocDicionarioId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINCOMPARTTERCEXTERNOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InCompartTercExternoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTDOCDICIONARIOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9InOutDocDicionarioId), 8, 0, ",", "")));
      ...
      {
         return formatLink("dicionariocomparttercextprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InCompartTercExternoId,8,0)),UrlEncode(StringUtil.LTrimStr(AV9InOutDocDicionarioId,8,0))}, new string[] {"InCompartTercExternoId","InOutDocDicionarioId"})  ;
      }

      public override string GetPgmname( )
      {
         return "DicionarioCompartTercExtPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Dicionario Compart Terc Ext" ;
      }
      ...
      protected void WB7L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_7L2( true) ;
         }
         else
         {
            wb_table1_14_7L2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_7L2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START7L2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Dicionario Compart Terc Ext", 0) ;
         }
         context.wjLoc = "";
      ...
      {
         /* GeneXus formulas. */
         AV22Pgmname = "DicionarioCompartTercExtPrompt";
         context.Gx_err = 0;
      ...
      protected void RF7L2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV11OrderedBy ,
                                                 AV12OrderedDsc ,
                                                 AV8InCompartTercExternoId } ,
                                                 new int[]{
                                                 TypeConstants.INT, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.INT
                                                 }
            });
            lV13FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV13FilterFullText), "%", "");
            lV13FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV13FilterFullText), "%", "");
            /* Using cursor H007L2 */
            pr_default.execute(0, new Object[] {AV8InCompartTercExternoId, lV13FilterFullText, lV13FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_26_idx = 1;
            sGXsfl_26_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_26_idx), 4, 0), 4, "0");
            SubsflControlProps_262( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A98DocDicionarioId = H007L2_A98DocDicionarioId[0];
               A66CompartTercExternoId = H007L2_A66CompartTercExternoId[0];
               E177L2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV13FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV13FilterFullText), "%", "");
         /* Using cursor H007L3 */
         pr_default.execute(1, new Object[] {AV8InCompartTercExternoId, lV13FilterFullText, lV13FilterFullText});
      ...
      protected void E157L2( )
      {
         ...
         Form.Caption = "Consulta de Dicionario Compart Terc Ext";
      ...
      protected void E187L2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV9InOutDocDicionarioId = A98DocDicionarioId;
         AssignAttri("", false, "AV9InOutDocDicionarioId", StringUtil.LTrimStr( (decimal)(AV9InOutDocDicionarioId), 8, 0));
         context.setWebReturnParms(new Object[] {(int)AV9InOutDocDicionarioId});
         context.setWebReturnParmsMetadata(new Object[] {"AV9InOutDocDicionarioId"});
      ...
      protected void wb_table1_14_7L2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_DicionarioCompartTercExtPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InCompartTercExternoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InCompartTercExternoId", StringUtil.LTrimStr( (decimal)(AV8InCompartTercExternoId), 8, 0));
         AV9InOutDocDicionarioId = Convert.ToInt32(getParm(obj,1));
         AssignAttri("", false, "AV9InOutDocDicionarioId", StringUtil.LTrimStr( (decimal)(AV9InOutDocDicionarioId), 8, 0));
      }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("dicionariocomparttercextprompt.js", "?202311910512314", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void StartGridControl26( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( "Id do Compartilhamento de Terceiros Externos") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:CompartTercExternoId|2:DocDicionarioId";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InCompartTercExternoId',fld:'vINCOMPARTTERCEXTERNOID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E117L2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InCompartTercExternoId',fld:'vINCOMPARTTERCEXTERNOID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E127L2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InCompartTercExternoId',fld:'vINCOMPARTTERCEXTERNOID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E137L2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InCompartTercExternoId',fld:'vINCOMPARTTERCEXTERNOID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'AV11OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV12OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E177L2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E187L2',iparms:[{av:'A98DocDicionarioId',fld:'DOCDICIONARIOID',pic:'ZZZZZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV9InOutDocDicionarioId',fld:'vINOUTDOCDICIONARIOID',pic:'ZZZZZZZ9'}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E147L2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InCompartTercExternoId',fld:'vINCOMPARTTERCEXTERNOID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H007L2_A98DocDicionarioId = new int[1] ;
         H007L2_A66CompartTercExternoId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.dicionariocomparttercextprompt__default(),
            new Object[][] {
                new Object[] {
               H007L2_A98DocDicionarioId, H007L2_A66CompartTercExternoId
               }
               , new Object[] {
      ...
      private int AV8InCompartTercExternoId ;
      private int AV9InOutDocDicionarioId ;
      private int wcpOAV8InCompartTercExternoId ;
      private int wcpOAV9InOutDocDicionarioId ;
      ...
      private int aP1_InOutDocDicionarioId ;
      private IDataStoreProvider pr_default ;
      private int[] H007L2_A98DocDicionarioId ;
      private int[] H007L2_A66CompartTercExternoId ;
   ...
   public class dicionariocomparttercextprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int AV8InCompartTercExternoId )
      {
         ...
         sOrderString = "";
         AddWhere(sWhereString, "([CompartTercExternoId] = @AV8InCompartTercExternoId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13FilterFullText)) )
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([CompartTercExternoId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( CONVERT( char(8), CAST([DocDicionarioId] AS decimal(8,0))) like '%' + @lV13FilterFullText))");
         }
         else
         {
            GXv_int3[1] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H007L2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] );
               case 1 :
                     return conditional_H007L3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV8InCompartTercExternoId",GXType.Int32,8,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H007L2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007L2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H007L3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007L3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }

...
namespace GeneXus.Programs {
   public class fonteretencaoview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public fonteretencaoview( )
      {
      ...
      public fonteretencaoview( IGxContext context )
      {
      ...
      public void execute( int aP0_FonteRetencaoId ,
                           string aP1_TabCode )
      {
         this.AV10FonteRetencaoId = aP0_FonteRetencaoId;
      ...
      {
         get {
            return "fonteretencaoview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "fonteretencaoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10FonteRetencaoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("fonteretencaoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vFONTERETENCAOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10FonteRetencaoId), "ZZZZZZZ9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vFONTERETENCAOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10FonteRetencaoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vFONTERETENCAOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10FonteRetencaoId), "ZZZZZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "fonteretencaoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10FonteRetencaoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("fonteretencaoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "FonteRetencaoView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Fonte Retencao View" ;
      }
      ...
      protected void WB5L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Fonte Retencao", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_FonteRetencaoView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divFonteretencaogeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDocfonteretencao_title_Internalname, "Doc Fonte Retencao", "", "", lblDocfonteretencao_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_FonteRetencaoView.htm");
            /* Div Control */
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0033"+"", StringUtil.RTrim( WebComp_Docfonteretencaowc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
      ...
      protected void START5L2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Fonte Retencao View", 0) ;
         }
         context.wjLoc = "";
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldDocfonteretencaowc = cgiGet( "W0033");
                           ...
                           if ( StringUtil.Len( WebComp_Docfonteretencaowc_Component) != 0 )
                           {
                              WebComp_Docfonteretencaowc.componentprocess("W0033", "", sEvt);
                           }
                           WebComp_Docfonteretencaowc_Component = OldDocfonteretencaowc;
                        }
                     }
      ...
      protected void PA5L2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "fonteretencaoview.aspx")), "fonteretencaoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "fonteretencaoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10FonteRetencaoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10FonteRetencaoId", StringUtil.LTrimStr( (decimal)(AV10FonteRetencaoId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vFONTERETENCAOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10FonteRetencaoId), "ZZZZZZZ9"), context));
      ...
      protected void E125L2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("fonteretencaoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H005L2 */
         pr_default.execute(0, new Object[] {AV10FonteRetencaoId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A63FonteRetencaoId = H005L2_A63FonteRetencaoId[0];
            A64FonteRetencaoNome = H005L2_A64FonteRetencaoNome[0];
            AV16GXLvl9 = 1;
            Form.Caption = A64FonteRetencaoNome;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "FonteRetencaoGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "fonteretencaogeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "FonteRetencaoGeneral";
            WebComp_Webcomponent_general_Component = "FonteRetencaoGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10FonteRetencaoId});
      ...
      protected void S122( )
      {
         /* 'LOADTABS' Routine */
         returnInSub = false;
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "DocFonteRetencao") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Docfonteretencaowc_Component), StringUtil.Lower( "FonteRetencaoDocFonteRetencaoWC")) != 0 )
            {
               WebComp_Docfonteretencaowc = getWebComponent(GetType(), "GeneXus.Programs", "fonteretencaodocfonteretencaowc", new Object[] {context} );
               WebComp_Docfonteretencaowc.ComponentInit();
               WebComp_Docfonteretencaowc.Name = "FonteRetencaoDocFonteRetencaoWC";
               WebComp_Docfonteretencaowc_Component = "FonteRetencaoDocFonteRetencaoWC";
            }
            if ( StringUtil.Len( WebComp_Docfonteretencaowc_Component) != 0 )
            {
               WebComp_Docfonteretencaowc.setjustcreated();
               WebComp_Docfonteretencaowc.componentprepare(new Object[] {(string)"W0033",(string)"",(int)AV10FonteRetencaoId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10FonteRetencaoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10FonteRetencaoId", StringUtil.LTrimStr( (decimal)(AV10FonteRetencaoId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vFONTERETENCAOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10FonteRetencaoId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231191051066", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("fonteretencaoview.js", "?20231191051066", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divFonteretencaogeneral_cell_Internalname = "FONTERETENCAOGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Fonte Retencao View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10FonteRetencaoId',fld:'vFONTERETENCAOID',pic:'ZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E115L2',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10FonteRetencaoId',fld:'vFONTERETENCAOID',pic:'ZZZZZZZ9',hsh:true}]");
         setEventMetadata("TABS.TABCHANGED",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{ctrl:'DOCFONTERETENCAOWC'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H005L2_A63FonteRetencaoId = new int[1] ;
         H005L2_A64FonteRetencaoNome = new string[] {""} ;
         A64FonteRetencaoNome = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.fonteretencaoview__default(),
            new Object[][] {
                new Object[] {
               H005L2_A63FonteRetencaoId, H005L2_A64FonteRetencaoNome
               }
            }
         );
      ...
      private int AV10FonteRetencaoId ;
      private int wcpOAV10FonteRetencaoId ;
      ...
      private string divFonteretencaogeneral_cell_Internalname ;
      ...
      private int[] H005L2_A63FonteRetencaoId ;
      private string[] H005L2_A64FonteRetencaoNome ;
   ...
   public class fonteretencaoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10FonteRetencaoId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H005L2", "SELECT [FonteRetencaoId], [FonteRetencaoNome] FROM [FonteRetencao] WHERE [FonteRetencaoId] = @AV10FonteRetencaoId ORDER BY [FonteRetencaoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005L2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

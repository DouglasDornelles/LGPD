...
namespace GeneXus.Programs {
   public class documentodocoperadorwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public documentodocoperadorwc( )
      {
      ...
      public documentodocoperadorwc( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV16FilterFullText, AV8DocumentoId, AV20ManageFiltersExecutionStep, AV35Pgmname, AV14OrderedBy, AV15OrderedDsc, AV28IsAuthorized_Update, AV30IsAuthorized_Delete, AV31IsAuthorized_Insert, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV35Pgmname = "DocumentoDocOperadorWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Documento Doc Operador WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "documentodocoperadorwc.aspx"+UrlEncode(StringUtil.LTrimStr(AV8DocumentoId,8,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("documentodocoperadorwc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         return "DocumentoDocOperadorWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Documento Doc Operador WC" ;
      }
      ...
      protected void WB6A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "documentodocoperadorwc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "Inserir", bttBtninsert_Jsonclick, 5, "Inserir", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_DocumentoDocOperadorWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
            wb_table1_24_6A2( true) ;
         }
         else
         {
            wb_table1_24_6A2( false) ;
         }
         return  ;
      }

      protected void wb_table1_24_6A2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START6A2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Documento Doc Operador WC", 0) ;
            }
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "documentodocoperadorwc.aspx")), "documentodocoperadorwc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "documentodocoperadorwc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void RF6A2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 A75DocumentoId } ,
                                                 new int[]{
                                                 TypeConstants.INT, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.INT, TypeConstants.INT
                                                 }
            });
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            /* Using cursor H006A2 */
            pr_default.execute(0, new Object[] {AV8DocumentoId, lV16FilterFullText, lV16FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_39_idx = 1;
            sGXsfl_39_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_39_idx), 4, 0), 4, "0");
            SubsflControlProps_392( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A75DocumentoId = H006A2_A75DocumentoId[0];
               AssignAttri(sPrefix, false, "A75DocumentoId", StringUtil.LTrimStr( (decimal)(A75DocumentoId), 8, 0));
               A92DocOperadorDataInclusao = H006A2_A92DocOperadorDataInclusao[0];
               A91DocOperadorProcessamento = H006A2_A91DocOperadorProcessamento[0];
               A90DocOperadorEliminacao = H006A2_A90DocOperadorEliminacao[0];
               A89DocOperadorCompartilhamento = H006A2_A89DocOperadorCompartilhamento[0];
               A88DocOperadorRetencao = H006A2_A88DocOperadorRetencao[0];
               A87DocOperadorColeta = H006A2_A87DocOperadorColeta[0];
               A42OperadorId = H006A2_A42OperadorId[0];
               A86DocOperadorId = H006A2_A86DocOperadorId[0];
               E186A2 ();
      ...
      protected void send_integrity_lvl_hashes6A2( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV31IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV31IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_DOCOPERADORID"+"_"+sGXsfl_39_idx, GetSecureSignedToken( sPrefix+sGXsfl_39_idx, context.localUtil.Format( (decimal)(A86DocOperadorId), "ZZZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
         /* Using cursor H006A3 */
         pr_default.execute(1, new Object[] {AV8DocumentoId, lV16FilterFullText, lV16FilterFullText});
      ...
      protected void E166A2( )
      {
         ...
         GXt_boolean1 = AV32IsAuthorized_DocOperadorColeta;
         ...
         AV32IsAuthorized_DocOperadorColeta = GXt_boolean1;
      ...
      protected void E116A2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("DocumentoDocOperadorWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV35Pgmname+"GridState"));
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("DocumentoDocOperadorWCFilters"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "DocumentoDocOperadorWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "DocumentoDocOperadorWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "DocOperador";
      ...
      protected void wb_table1_24_6A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table2_29_6A2( true) ;
         }
         else
         {
            wb_table2_29_6A2( false) ;
         }
         return  ;
      }

      protected void wb_table2_29_6A2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_24_6A2e( true) ;
         }
         else
         {
            wb_table1_24_6A2e( false) ;
         }
      }

      protected void wb_table2_29_6A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "documentodocoperadorwc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910445474", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("documentodocoperadorwc.js", "?202311910445474", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_392( )
      {
         ...
         edtDocOperadorId_Internalname = sPrefix+"DOCOPERADORID_"+sGXsfl_39_idx;
         edtOperadorId_Internalname = sPrefix+"OPERADORID_"+sGXsfl_39_idx;
         chkDocOperadorColeta_Internalname = sPrefix+"DOCOPERADORCOLETA_"+sGXsfl_39_idx;
         chkDocOperadorRetencao_Internalname = sPrefix+"DOCOPERADORRETENCAO_"+sGXsfl_39_idx;
         chkDocOperadorCompartilhamento_Internalname = sPrefix+"DOCOPERADORCOMPARTILHAMENTO_"+sGXsfl_39_idx;
         chkDocOperadorEliminacao_Internalname = sPrefix+"DOCOPERADORELIMINACAO_"+sGXsfl_39_idx;
         chkDocOperadorProcessamento_Internalname = sPrefix+"DOCOPERADORPROCESSAMENTO_"+sGXsfl_39_idx;
         edtDocOperadorDataInclusao_Internalname = sPrefix+"DOCOPERADORDATAINCLUSAO_"+sGXsfl_39_idx;
      }
      ...
      protected void SubsflControlProps_fel_392( )
      {
         ...
         edtDocOperadorId_Internalname = sPrefix+"DOCOPERADORID_"+sGXsfl_39_fel_idx;
         edtOperadorId_Internalname = sPrefix+"OPERADORID_"+sGXsfl_39_fel_idx;
         chkDocOperadorColeta_Internalname = sPrefix+"DOCOPERADORCOLETA_"+sGXsfl_39_fel_idx;
         chkDocOperadorRetencao_Internalname = sPrefix+"DOCOPERADORRETENCAO_"+sGXsfl_39_fel_idx;
         chkDocOperadorCompartilhamento_Internalname = sPrefix+"DOCOPERADORCOMPARTILHAMENTO_"+sGXsfl_39_fel_idx;
         chkDocOperadorEliminacao_Internalname = sPrefix+"DOCOPERADORELIMINACAO_"+sGXsfl_39_fel_idx;
         chkDocOperadorProcessamento_Internalname = sPrefix+"DOCOPERADORPROCESSAMENTO_"+sGXsfl_39_fel_idx;
         edtDocOperadorDataInclusao_Internalname = sPrefix+"DOCOPERADORDATAINCLUSAO_"+sGXsfl_39_fel_idx;
      }
      ...
      protected void sendrow_392( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_39_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            GXCCtl = "DOCOPERADORCOLETA_" + sGXsfl_39_idx;
            chkDocOperadorColeta.Name = GXCCtl;
            chkDocOperadorColeta.WebTags = "";
            chkDocOperadorColeta.Caption = "";
            AssignProp(sPrefix, false, chkDocOperadorColeta_Internalname, "TitleCaption", chkDocOperadorColeta.Caption, !bGXsfl_39_Refreshing);
            ...
            ClassString = "Attribute";
            StyleString = "";
            GXCCtl = "DOCOPERADORRETENCAO_" + sGXsfl_39_idx;
            chkDocOperadorRetencao.Name = GXCCtl;
            chkDocOperadorRetencao.WebTags = "";
            chkDocOperadorRetencao.Caption = "";
            AssignProp(sPrefix, false, chkDocOperadorRetencao_Internalname, "TitleCaption", chkDocOperadorRetencao.Caption, !bGXsfl_39_Refreshing);
            ...
            ClassString = "Attribute";
            StyleString = "";
            GXCCtl = "DOCOPERADORCOMPARTILHAMENTO_" + sGXsfl_39_idx;
            chkDocOperadorCompartilhamento.Name = GXCCtl;
            chkDocOperadorCompartilhamento.WebTags = "";
            chkDocOperadorCompartilhamento.Caption = "";
            AssignProp(sPrefix, false, chkDocOperadorCompartilhamento_Internalname, "TitleCaption", chkDocOperadorCompartilhamento.Caption, !bGXsfl_39_Refreshing);
            ...
            ClassString = "Attribute";
            StyleString = "";
            GXCCtl = "DOCOPERADORELIMINACAO_" + sGXsfl_39_idx;
            chkDocOperadorEliminacao.Name = GXCCtl;
            chkDocOperadorEliminacao.WebTags = "";
            chkDocOperadorEliminacao.Caption = "";
            AssignProp(sPrefix, false, chkDocOperadorEliminacao_Internalname, "TitleCaption", chkDocOperadorEliminacao.Caption, !bGXsfl_39_Refreshing);
            ...
            ClassString = "Attribute";
            StyleString = "";
            GXCCtl = "DOCOPERADORPROCESSAMENTO_" + sGXsfl_39_idx;
            chkDocOperadorProcessamento.Name = GXCCtl;
            chkDocOperadorProcessamento.WebTags = "";
            chkDocOperadorProcessamento.Caption = "";
            AssignProp(sPrefix, false, chkDocOperadorProcessamento_Internalname, "TitleCaption", chkDocOperadorProcessamento.Caption, !bGXsfl_39_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "2:DocOperadorId|3:OperadorId|4:DocOperadorColeta|5:DocOperadorRetencao|6:DocOperadorCompartilhamento|7:DocOperadorEliminacao|8:DocOperadorProcessamento|9:DocOperadorDataInclusao";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E186A2',iparms:[{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A86DocOperadorId',fld:'DOCOPERADORID',pic:'ZZZZZZZ9',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E156A2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8DocumentoId',fld:'vDOCUMENTOID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'A86DocOperadorId',fld:'DOCOPERADORID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV16FilterFullText = "";
         H006A2_A75DocumentoId = new int[1] ;
         H006A2_A92DocOperadorDataInclusao = new DateTime[] {DateTime.MinValue} ;
         H006A2_A91DocOperadorProcessamento = new bool[] {false} ;
         H006A2_A90DocOperadorEliminacao = new bool[] {false} ;
         H006A2_A89DocOperadorCompartilhamento = new bool[] {false} ;
         H006A2_A88DocOperadorRetencao = new bool[] {false} ;
         H006A2_A87DocOperadorColeta = new bool[] {false} ;
         H006A2_A42OperadorId = new int[1] ;
         H006A2_A86DocOperadorId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.documentodocoperadorwc__default(),
            new Object[][] {
                new Object[] {
               H006A2_A75DocumentoId, H006A2_A92DocOperadorDataInclusao, H006A2_A91DocOperadorProcessamento, H006A2_A90DocOperadorEliminacao, H006A2_A89DocOperadorCompartilhamento, H006A2_A88DocOperadorRetencao, H006A2_A87DocOperadorColeta, H006A2_A42OperadorId, H006A2_A86DocOperadorId
               }
               , new Object[] {
      ...
      private bool AV32IsAuthorized_DocOperadorColeta ;
      ...
      private int[] H006A2_A75DocumentoId ;
      private DateTime[] H006A2_A92DocOperadorDataInclusao ;
      private bool[] H006A2_A91DocOperadorProcessamento ;
      private bool[] H006A2_A90DocOperadorEliminacao ;
      private bool[] H006A2_A89DocOperadorCompartilhamento ;
      private bool[] H006A2_A88DocOperadorRetencao ;
      private bool[] H006A2_A87DocOperadorColeta ;
      private int[] H006A2_A42OperadorId ;
      private int[] H006A2_A86DocOperadorId ;
   ...
   public class documentodocoperadorwc__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H006A2( IGxContext context ,
                                             string AV16FilterFullText ,
                                             ...
                                             int A75DocumentoId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [DocumentoId], [DocOperadorDataInclusao], [DocOperadorProcessamento], [DocOperadorEliminacao], [DocOperadorCompartilhamento], [DocOperadorRetencao], [DocOperadorColeta], [OperadorId], [DocOperadorId]";
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([DocOperadorId] AS decimal(8,0))) like '%' + @lV16FilterFullText) or ( CONVERT( char(8), CAST([OperadorId] AS decimal(8,0))) like '%' + @lV16FilterFullText))");
         }
         else
         {
            GXv_int5[1] = 1;
         ...
         {
            sOrderString += " ORDER BY [DocumentoId], [DocOperadorColeta]";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [DocumentoId] DESC, [DocOperadorColeta] DESC";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [DocumentoId], [DocOperadorId]";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [DocumentoId] DESC, [DocOperadorId] DESC";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [DocumentoId], [OperadorId]";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [DocumentoId] DESC, [OperadorId] DESC";
         }
         else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [DocumentoId], [DocOperadorRetencao]";
         }
         else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [DocumentoId] DESC, [DocOperadorRetencao] DESC";
         }
         else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [DocumentoId], [DocOperadorCompartilhamento]";
         }
         else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [DocumentoId] DESC, [DocOperadorCompartilhamento] DESC";
         }
         else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [DocumentoId], [DocOperadorEliminacao]";
         }
         else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [DocumentoId] DESC, [DocOperadorEliminacao] DESC";
         }
         else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [DocumentoId], [DocOperadorProcessamento]";
         }
         else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [DocumentoId] DESC, [DocOperadorProcessamento] DESC";
         }
         else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [DocumentoId], [DocOperadorDataInclusao]";
         }
         else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [DocumentoId] DESC, [DocOperadorDataInclusao] DESC";
         }
         else if ( true )
         {
      ...
      protected Object[] conditional_H006A3( IGxContext context ,
                                             string AV16FilterFullText ,
                                             int A86DocOperadorId ,
                                             int A42OperadorId ,
                                             short AV14OrderedBy ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H006A2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] , (int)dynConstraints[6] );
               case 1 :
                     return conditional_H006A3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] , (int)dynConstraints[6] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H006A2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006A2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H006A3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006A3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }

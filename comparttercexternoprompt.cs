...
namespace GeneXus.Programs {
   public class comparttercexternoprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public comparttercexternoprompt( )
      {
      ...
      public comparttercexternoprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutCompartTercExternoId ,
                           ref string aP1_InOutCompartTercExternoNome )
      {
         this.AV8InOutCompartTercExternoId = aP0_InOutCompartTercExternoId;
         this.AV9InOutCompartTercExternoNome = aP1_InOutCompartTercExternoNome;
         executePrivate();
         aP0_InOutCompartTercExternoId=this.AV8InOutCompartTercExternoId;
         aP1_InOutCompartTercExternoNome=this.AV9InOutCompartTercExternoNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutCompartTercExternoId");
            ...
            {
               AV8InOutCompartTercExternoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutCompartTercExternoId", StringUtil.LTrimStr( (decimal)(AV8InOutCompartTercExternoId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutCompartTercExternoNome = GetPar( "InOutCompartTercExternoNome");
                  AssignAttri("", false, "AV9InOutCompartTercExternoNome", AV9InOutCompartTercExternoNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      {
         get {
            return "comparttercexternoprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("comparttercexternoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutCompartTercExternoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutCompartTercExternoNome))}, new string[] {"InOutCompartTercExternoId","InOutCompartTercExternoNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTCOMPARTTERCEXTERNOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutCompartTercExternoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTCOMPARTTERCEXTERNONOME", AV9InOutCompartTercExternoNome);
      ...
      {
         return formatLink("comparttercexternoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutCompartTercExternoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutCompartTercExternoNome))}, new string[] {"InOutCompartTercExternoId","InOutCompartTercExternoNome"})  ;
      }

      public override string GetPgmname( )
      {
         return "CompartTercExternoPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Compart Terc Externo" ;
      }
      ...
      protected void WB2V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_2V2( true) ;
         }
         else
         {
            wb_table1_14_2V2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_2V2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START2V2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Compart Terc Externo", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_COMPARTTERCEXTERNONOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A67CompartTercExternoNome, "")), context));
         GxWebStd.gx_hidden_field( context, "COMPARTTERCEXTERNONOME", A67CompartTercExternoNome);
      }
      ...
      {
         /* GeneXus formulas. */
         AV22Pgmname = "CompartTercExternoPrompt";
         context.Gx_err = 0;
      ...
      protected void RF2V2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A68CompartTercExternoAtivo = H002V2_A68CompartTercExternoAtivo[0];
               A67CompartTercExternoNome = H002V2_A67CompartTercExternoNome[0];
               A66CompartTercExternoId = H002V2_A66CompartTercExternoId[0];
               E172V2 ();
      ...
      protected void send_integrity_lvl_hashes2V2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_COMPARTTERCEXTERNOID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A66CompartTercExternoId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_COMPARTTERCEXTERNONOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A67CompartTercExternoNome, "")), context));
      }
      ...
      protected void E152V2( )
      {
         ...
         Form.Caption = "Consulta de Compart Terc Externo";
      ...
      protected void E182V2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutCompartTercExternoId = A66CompartTercExternoId;
         AssignAttri("", false, "AV8InOutCompartTercExternoId", StringUtil.LTrimStr( (decimal)(AV8InOutCompartTercExternoId), 8, 0));
         AV9InOutCompartTercExternoNome = A67CompartTercExternoNome;
         AssignAttri("", false, "AV9InOutCompartTercExternoNome", AV9InOutCompartTercExternoNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutCompartTercExternoId,(string)AV9InOutCompartTercExternoNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutCompartTercExternoId","AV9InOutCompartTercExternoNome"});
      ...
      protected void wb_table1_14_2V2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_CompartTercExternoPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutCompartTercExternoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutCompartTercExternoId", StringUtil.LTrimStr( (decimal)(AV8InOutCompartTercExternoId), 8, 0));
         AV9InOutCompartTercExternoNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutCompartTercExternoNome", AV9InOutCompartTercExternoNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910494956", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("comparttercexternoprompt.js", "?202311910494957", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtCompartTercExternoId_Internalname = "COMPARTTERCEXTERNOID_"+sGXsfl_26_idx;
         edtCompartTercExternoNome_Internalname = "COMPARTTERCEXTERNONOME_"+sGXsfl_26_idx;
         cmbCompartTercExternoAtivo_Internalname = "COMPARTTERCEXTERNOATIVO_"+sGXsfl_26_idx;
      }

      protected void SubsflControlProps_fel_262( )
      {
         edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx;
         edtCompartTercExternoId_Internalname = "COMPARTTERCEXTERNOID_"+sGXsfl_26_fel_idx;
         edtCompartTercExternoNome_Internalname = "COMPARTTERCEXTERNONOME_"+sGXsfl_26_fel_idx;
         cmbCompartTercExternoAtivo_Internalname = "COMPARTTERCEXTERNOATIVO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "COMPARTTERCEXTERNOATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbCompartTercExternoAtivo_Internalname, "Values", (string)(cmbCompartTercExternoAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:CompartTercExternoId|2:CompartTercExternoNome|3:CompartTercExternoAtivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E172V2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E182V2',iparms:[{av:'A66CompartTercExternoId',fld:'COMPARTTERCEXTERNOID',pic:'ZZZZZZZ9',hsh:true},{av:'A67CompartTercExternoNome',fld:'COMPARTTERCEXTERNONOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutCompartTercExternoId',fld:'vINOUTCOMPARTTERCEXTERNOID',pic:'ZZZZZZZ9'},{av:'AV9InOutCompartTercExternoNome',fld:'vINOUTCOMPARTTERCEXTERNONOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E142V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      {
         wcpOAV9InOutCompartTercExternoNome = "";
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H002V2_A68CompartTercExternoAtivo = new bool[] {false} ;
         H002V2_A67CompartTercExternoNome = new string[] {""} ;
         H002V2_A66CompartTercExternoId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.comparttercexternoprompt__default(),
            new Object[][] {
                new Object[] {
               H002V2_A68CompartTercExternoAtivo, H002V2_A67CompartTercExternoNome, H002V2_A66CompartTercExternoId
               }
               , new Object[] {
      ...
      private int AV8InOutCompartTercExternoId ;
      private int wcpOAV8InOutCompartTercExternoId ;
      ...
      private string AV9InOutCompartTercExternoNome ;
      private string wcpOAV9InOutCompartTercExternoNome ;
      ...
      private int aP0_InOutCompartTercExternoId ;
      private string aP1_InOutCompartTercExternoNome ;
      private GXCombobox cmbCompartTercExternoAtivo ;
      private IDataStoreProvider pr_default ;
      private bool[] H002V2_A68CompartTercExternoAtivo ;
      private string[] H002V2_A67CompartTercExternoNome ;
      private int[] H002V2_A66CompartTercExternoId ;
   ...
   public class comparttercexternoprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([CompartTercExternoId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [CompartTercExternoNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and [CompartTercExternoAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and [CompartTercExternoAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002V2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
               case 1 :
                     return conditional_H002V3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
         }

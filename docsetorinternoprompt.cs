...
namespace GeneXus.Programs {
   public class docsetorinternoprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public docsetorinternoprompt( )
      {
      ...
      public docsetorinternoprompt( IGxContext context )
      {
      ...
      public void execute( int aP0_InSetorInternoId ,
                           ref int aP1_InOutDocumentoId )
      {
         this.AV8InSetorInternoId = aP0_InSetorInternoId;
         this.AV9InOutDocumentoId = aP1_InOutDocumentoId;
         executePrivate();
         aP1_InOutDocumentoId=this.AV9InOutDocumentoId;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InSetorInternoId");
            ...
            {
               AV8InSetorInternoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InSetorInternoId", StringUtil.LTrimStr( (decimal)(AV8InSetorInternoId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutDocumentoId = (int)(NumberUtil.Val( GetPar( "InOutDocumentoId"), "."));
                  AssignAttri("", false, "AV9InOutDocumentoId", StringUtil.LTrimStr( (decimal)(AV9InOutDocumentoId), 8, 0));
               }
            }
            if ( toggleJsOutput )
            {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV8InSetorInternoId = (int)(NumberUtil.Val( GetPar( "InSetorInternoId"), "."));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13FilterFullText, AV8InSetorInternoId, AV22Pgmname) ;
      ...
      {
         get {
            return "docsetorinternoprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("docsetorinternoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InSetorInternoId,8,0)),UrlEncode(StringUtil.LTrimStr(AV9InOutDocumentoId,8,0))}, new string[] {"InSetorInternoId","InOutDocumentoId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINSETORINTERNOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InSetorInternoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTDOCUMENTOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9InOutDocumentoId), 8, 0, ",", "")));
      ...
      {
         return formatLink("docsetorinternoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InSetorInternoId,8,0)),UrlEncode(StringUtil.LTrimStr(AV9InOutDocumentoId,8,0))}, new string[] {"InSetorInternoId","InOutDocumentoId"})  ;
      }

      public override string GetPgmname( )
      {
         return "DocSetorInternoPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Doc Setor Interno" ;
      }
      ...
      protected void WB6S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_6S2( true) ;
         }
         else
         {
            wb_table1_14_6S2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_6S2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START6S2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Doc Setor Interno", 0) ;
         }
         context.wjLoc = "";
      ...
      {
         /* GeneXus formulas. */
         AV22Pgmname = "DocSetorInternoPrompt";
         context.Gx_err = 0;
      ...
      protected void RF6S2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV13FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV13FilterFullText), "%", "");
            /* Using cursor H006S2 */
            pr_default.execute(0, new Object[] {AV8InSetorInternoId, lV13FilterFullText, lV13FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_26_idx = 1;
            sGXsfl_26_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_26_idx), 4, 0), 4, "0");
            SubsflControlProps_262( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A75DocumentoId = H006S2_A75DocumentoId[0];
               A60SetorInternoId = H006S2_A60SetorInternoId[0];
               E176S2 ();
      ...
      protected void send_integrity_lvl_hashes6S2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_DOCUMENTOID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A75DocumentoId), "ZZZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV13FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV13FilterFullText), "%", "");
         /* Using cursor H006S3 */
         pr_default.execute(1, new Object[] {AV8InSetorInternoId, lV13FilterFullText, lV13FilterFullText});
         GRID_nRecordCount = H006S3_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void E156S2( )
      {
         ...
         Form.Caption = "Consulta de Doc Setor Interno";
      ...
      protected void E186S2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV9InOutDocumentoId = A75DocumentoId;
         AssignAttri("", false, "AV9InOutDocumentoId", StringUtil.LTrimStr( (decimal)(AV9InOutDocumentoId), 8, 0));
         context.setWebReturnParms(new Object[] {(int)AV9InOutDocumentoId});
         context.setWebReturnParmsMetadata(new Object[] {"AV9InOutDocumentoId"});
      ...
      protected void wb_table1_14_6S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_DocSetorInternoPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InSetorInternoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InSetorInternoId", StringUtil.LTrimStr( (decimal)(AV8InSetorInternoId), 8, 0));
         AV9InOutDocumentoId = Convert.ToInt32(getParm(obj,1));
         AssignAttri("", false, "AV9InOutDocumentoId", StringUtil.LTrimStr( (decimal)(AV9InOutDocumentoId), 8, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910512249", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("docsetorinternoprompt.js", "?202311910512249", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:SetorInternoId|2:DocumentoId";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InSetorInternoId',fld:'vINSETORINTERNOID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E116S2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InSetorInternoId',fld:'vINSETORINTERNOID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E126S2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InSetorInternoId',fld:'vINSETORINTERNOID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E136S2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InSetorInternoId',fld:'vINSETORINTERNOID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'AV11OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV12OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E176S2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E186S2',iparms:[{av:'A75DocumentoId',fld:'DOCUMENTOID',pic:'ZZZZZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV9InOutDocumentoId',fld:'vINOUTDOCUMENTOID',pic:'ZZZZZZZ9'}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E146S2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InSetorInternoId',fld:'vINSETORINTERNOID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H006S2_A75DocumentoId = new int[1] ;
         H006S2_A60SetorInternoId = new int[1] ;
         H006S3_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.docsetorinternoprompt__default(),
            new Object[][] {
                new Object[] {
               H006S2_A75DocumentoId, H006S2_A60SetorInternoId
               }
               , new Object[] {
               H006S3_AGRID_nRecordCount
               }
            }
         );
         AV22Pgmname = "DocSetorInternoPrompt";
      ...
      private int AV8InSetorInternoId ;
      private int AV9InOutDocumentoId ;
      private int wcpOAV8InSetorInternoId ;
      private int wcpOAV9InOutDocumentoId ;
      ...
      private int aP1_InOutDocumentoId ;
      private IDataStoreProvider pr_default ;
      private int[] H006S2_A75DocumentoId ;
      private int[] H006S2_A60SetorInternoId ;
      private long[] H006S3_AGRID_nRecordCount ;
   ...
   public class docsetorinternoprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H006S2( IGxContext context ,
                                             string AV13FilterFullText ,
                                             ...
                                             int AV8InSetorInternoId )
      {
         ...
         sOrderString = "";
         AddWhere(sWhereString, "([SetorInternoId] = @AV8InSetorInternoId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13FilterFullText)) )
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([SetorInternoId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( CONVERT( char(8), CAST([DocumentoId] AS decimal(8,0))) like '%' + @lV13FilterFullText))");
         }
         else
         {
            GXv_int3[1] = 1;
      ...
      protected Object[] conditional_H006S3( IGxContext context ,
                                             string AV13FilterFullText ,
                                             int A60SetorInternoId ,
                                             int A75DocumentoId ,
                                             short AV11OrderedBy ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H006S2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] );
               case 1 :
                     return conditional_H006S3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV8InSetorInternoId",GXType.Int32,8,0) ,
          ...
          Object[] prmH006S3;
          prmH006S3 = new Object[] {
          new ParDef("@AV8InSetorInternoId",GXType.Int32,8,0) ,
          new ParDef("@lV13FilterFullText",GXType.VarChar,100,0) ,
          new ParDef("@lV13FilterFullText",GXType.VarChar,100,0)
          };
          def= new CursorDef[] {
              new CursorDef("H006S2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006S2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H006S3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006S3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }

...
namespace GeneXus.Programs {
   public class frequenciatratamentoview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public frequenciatratamentoview( )
      {
      ...
      public frequenciatratamentoview( IGxContext context )
      {
      ...
      public void execute( int aP0_FrequenciaTratamentoId ,
                           string aP1_TabCode )
      {
         this.AV10FrequenciaTratamentoId = aP0_FrequenciaTratamentoId;
      ...
      {
         get {
            return "frequenciatratamentoview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "frequenciatratamentoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10FrequenciaTratamentoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("frequenciatratamentoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vFREQUENCIATRATAMENTOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10FrequenciaTratamentoId), "ZZZZZZZ9"), context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vFREQUENCIATRATAMENTOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10FrequenciaTratamentoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vFREQUENCIATRATAMENTOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10FrequenciaTratamentoId), "ZZZZZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "frequenciatratamentoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10FrequenciaTratamentoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("frequenciatratamentoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "FrequenciaTratamentoView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Frequencia Tratamento View" ;
      }
      ...
      protected void WB4H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Frequencia Tratamento", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_FrequenciaTratamentoView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divFrequenciatratamentogeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
      ...
      protected void START4H2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Frequencia Tratamento View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA4H2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "frequenciatratamentoview.aspx")), "frequenciatratamentoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "frequenciatratamentoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10FrequenciaTratamentoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10FrequenciaTratamentoId", StringUtil.LTrimStr( (decimal)(AV10FrequenciaTratamentoId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vFREQUENCIATRATAMENTOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10FrequenciaTratamentoId), "ZZZZZZZ9"), context));
      ...
      protected void E114H2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("frequenciatratamentoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H004H2 */
         pr_default.execute(0, new Object[] {AV10FrequenciaTratamentoId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A39FrequenciaTratamentoId = H004H2_A39FrequenciaTratamentoId[0];
            A40FrequenciaTratamentoNome = H004H2_A40FrequenciaTratamentoNome[0];
            AV16GXLvl9 = 1;
            Form.Caption = A40FrequenciaTratamentoNome;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "FrequenciaTratamentoGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "frequenciatratamentogeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "FrequenciaTratamentoGeneral";
            WebComp_Webcomponent_general_Component = "FrequenciaTratamentoGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10FrequenciaTratamentoId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10FrequenciaTratamentoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10FrequenciaTratamentoId", StringUtil.LTrimStr( (decimal)(AV10FrequenciaTratamentoId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vFREQUENCIATRATAMENTOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10FrequenciaTratamentoId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910502571", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("frequenciatratamentoview.js", "?202311910502572", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divFrequenciatratamentogeneral_cell_Internalname = "FREQUENCIATRATAMENTOGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Frequencia Tratamento View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10FrequenciaTratamentoId',fld:'vFREQUENCIATRATAMENTOID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H004H2_A39FrequenciaTratamentoId = new int[1] ;
         H004H2_A40FrequenciaTratamentoNome = new string[] {""} ;
         A40FrequenciaTratamentoNome = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.frequenciatratamentoview__default(),
            new Object[][] {
                new Object[] {
               H004H2_A39FrequenciaTratamentoId, H004H2_A40FrequenciaTratamentoNome
               }
            }
         );
      ...
      private int AV10FrequenciaTratamentoId ;
      private int wcpOAV10FrequenciaTratamentoId ;
      ...
      private string divFrequenciatratamentogeneral_cell_Internalname ;
      ...
      private int[] H004H2_A39FrequenciaTratamentoId ;
      private string[] H004H2_A40FrequenciaTratamentoNome ;
   ...
   public class frequenciatratamentoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10FrequenciaTratamentoId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H004H2", "SELECT [FrequenciaTratamentoId], [FrequenciaTratamentoNome] FROM [FrequenciaTratamento] WHERE [FrequenciaTratamentoId] = @AV10FrequenciaTratamentoId ORDER BY [FrequenciaTratamentoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004H2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

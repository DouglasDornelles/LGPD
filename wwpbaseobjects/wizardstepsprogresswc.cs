...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wizardstepsprogresswc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         AV8StepNumber = (short)(NumberUtil.Val( GetPar( "StepNumber"), "."));
         AV7SelectedStepNumber = (short)(NumberUtil.Val( GetPar( "SelectedStepNumber"), "."));
         sPrefix = GetPar( "sPrefix");
      ...
      protected void WB120( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablemain_Internalname, 1, 0, "px", 0, "px", "TableWizardStepsLine", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divWizardstepdescriptioncell_Internalname, divWizardstepdescriptioncell_Visible, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 FreeStyleStepsProgressCell", "left", "top", "", "", "div");
            /*  Grid Control  */
      ...
      protected void E11122( )
      {
         ...
         {
            AV5WizardStep = ((GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV9WizardSteps.Item(AV14GXV1));
      ...
      private void E12122( )
      {
         ...
         {
            AV9WizardSteps.CurrentItem = ((GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV9WizardSteps.Item(AV15GXV2));
            ...
            {
               context.DoAjaxLoad(15, GridwizardstepsRow);
            }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910444498", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wizardstepsprogresswc.js", "?202311910444498", false, true);
         }
      ...
      protected void sendrow_152( )
      {
         ...
         /* Div Control */
         GridwizardstepsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)divUnnamedtablefsgridwizardsteps_Internalname+"_"+sGXsfl_15_idx,(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)divUnnamedtablefsgridwizardsteps_Class,(string)"left",(string)"top",(string)" "+"data-gx-flex"+" ",(string)"",(string)"div"});
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDWIZARDSTEPS.LOAD","{handler:'E12122',iparms:[{av:'AV8StepNumber',fld:'vSTEPNUMBER',pic:'ZZZ9',hsh:true},{av:'AV7SelectedStepNumber',fld:'vSELECTEDSTEPNUMBER',pic:'ZZZ9',hsh:true}]");
      ...
      {
         AV9WizardSteps = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>( context, "WizardStepsItem", "LGPD_Novo");
         wcpOAV6CurrentStep = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sPrefix = "";

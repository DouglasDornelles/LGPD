...
namespace GeneXus.Programs.wwpbaseobjects {
   public class gethomemodulessample : GXProcedure
   {
      ...
      {
         this.Gxm2rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeModulesSDT_HomeModulesSDTItem>( context, "HomeModulesSDTItem", "LGPD_Novo") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeModulesSDT_HomeModulesSDTItem> aP0_Gxm2rootcol )
      {
         ...
         objgethomemodulessample.Gxm2rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeModulesSDT_HomeModulesSDTItem>( context, "HomeModulesSDTItem", "LGPD_Novo") ;
         objgethomemodulessample.context.SetSubmitInitialConfig(context);
         objgethomemodulessample.initialize();
         Submit( executePrivateCatch,objgethomemodulessample);
         aP0_Gxm2rootcol=this.Gxm2rootcol;
      }

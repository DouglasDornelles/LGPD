...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wwp_columnselector_updatecolumns : GXProcedure
   {
                                 ...
                                 ref GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector aP1_ColumnsSelector )
      {
         ...
         objwwp_columnselector_updatecolumns.AV15OldColumnsSelector = aP0_OldColumnsSelector;
         objwwp_columnselector_updatecolumns.AV11ColumnsSelector = aP1_ColumnsSelector;
         objwwp_columnselector_updatecolumns.context.SetSubmitInitialConfig(context);
         objwwp_columnselector_updatecolumns.initialize();
         Submit( executePrivateCatch,objwwp_columnselector_updatecolumns);
         aP0_OldColumnsSelector=this.AV15OldColumnsSelector;
         aP1_ColumnsSelector=this.AV11ColumnsSelector;
      }
      ...
      void executePrivate( )
      {
         ...
         AV19GXV1 = 1;
         while ( AV19GXV1 <= AV11ColumnsSelector.gxTpr_Columns.Count )
         {
            AV8Column = ((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV11ColumnsSelector.gxTpr_Columns.Item(AV19GXV1));
         ...
         AV16ColumnOrder = 0;
         AV20GXV2 = 1;
         while ( AV20GXV2 <= AV12ColumnsSelectorAux.gxTpr_Columns.Count )
         {
            AV10ColumnAux = ((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV12ColumnsSelectorAux.gxTpr_Columns.Item(AV20GXV2));
            AV21GXV3 = 1;
            while ( AV21GXV3 <= AV11ColumnsSelector.gxTpr_Columns.Count )
            {
               AV8Column = ((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV11ColumnsSelector.gxTpr_Columns.Item(AV21GXV3));
      ...
      protected void S111( )
      {
         ...
         AV13Found = false;
         AV22GXV4 = 1;
         while ( AV22GXV4 <= AV15OldColumnsSelector.gxTpr_Columns.Count )
         {
            AV10ColumnAux = ((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV15OldColumnsSelector.gxTpr_Columns.Item(AV22GXV4));
            if ( StringUtil.StrCmp(AV8Column.gxTpr_Columnname, AV10ColumnAux.gxTpr_Columnname) == 0 )
            {

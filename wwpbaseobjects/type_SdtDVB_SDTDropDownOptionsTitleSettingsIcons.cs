...
namespace GeneXus.Programs.wwpbaseobjects
{
	...
	public class SdtDVB_SDTDropDownOptionsTitleSettingsIcons : GxUserType
	{
		...
		public override void ToJSON(bool includeState)
		{
			...
			AddObjectProperty("og", gxTpr_Optiongroup_fi, false);
		...
		[SoapElement(ElementName="OptionGroup_fi")]
		[XmlElement(ElementName="OptionGroup_fi")]
		public string gxTpr_Optiongroup_fi
		{
			get {
	...
	public class SdtDVB_SDTDropDownOptionsTitleSettingsIcons_RESTInterface : GxGenericCollectionItem<SdtDVB_SDTDropDownOptionsTitleSettingsIcons>, System.Web.SessionState.IRequiresSessionState
	{
		...
		[DataMember(Name="og", Order=18)]
		public  string gxTpr_Optiongroup_fi
		{
			get { 
				return sdt.gxTpr_Optiongroup_fi;

			}
			set { 
				 sdt.gxTpr_Optiongroup_fi = value;
			}
		}

...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wwp_masterpageruntimesettings : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void gxnrFscolor_newrow_invoke( )
      {
         ...
         edtavColorname_Visible = (int)(NumberUtil.Val( GetNextPar( ), "."));
      ...
      protected void gxgrFscolor_refresh_invoke( )
      {
         ...
         gxgrFscolor_refresh( AV8ColorItemClass, AV5WWP_DesignSystemSettings, AV10ColorName, AV6BackStyle, sPrefix) ;
      ...
      protected void WB2D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablemain_Internalname, divTablemain_Visible, 0, "px", 0, "px", "TableMainDesignerSelector", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblColortxt_Internalname, "Cor", "", "", lblColortxt_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "RuntimeDesignSettingsTitle", 0, "", 1, 1, 0, 0, "HLP_WWPBaseObjects\\WWP_MasterPageRuntimeSettings.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 CellPaddingRight45", "left", "top", "", "", "div");
            /*  Grid Control  */
         ...
         if ( wbEnd == 12 )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+radavBackstyle_Internalname+"\"", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtable1_Internalname, 1, 0, "px", 0, "px", "Flex", "left", "top", " "+"data-gx-flex"+" ", "justify-content:space-around;", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divFontsizelargecell_Internalname, 1, 0, "px", 0, "px", "", "left", "top", "", "align-self:center;", "div");
            /* Text block */
                  ...
                  if ( StringUtil.Len( sEvt) > 0 )
                  {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "FSCOLOR.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 20), "TABLECOLORITEM.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              if ( ( StringUtil.Len( sPrefix) != 0 ) && ( nDoneStart == 0 ) )
                              {
                                 STRUP2D0( ) ;
      ...
      protected void gxgrFscolor_refresh( string AV8ColorItemClass ,
                                          GeneXus.Programs.wwpbaseobjects.SdtWWP_DesignSystemSettings AV5WWP_DesignSystemSettings ,
      ...
      protected void E162D2( )
      {
         ...
         S112 ();
         if (returnInSub) return;
         divTablemain_Visible = 0;
         AssignProp(sPrefix, false, divTablemain_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(divTablemain_Visible), 5, 0), true);
      }
      ...
      private void E172D2( )
      {
         ...
         {
            context.DoAjaxLoad(12, FscolorRow);
         }
         ...
         AV10ColorName = "Custom";
         AssignAttri(sPrefix, false, edtavColorname_Internalname, AV10ColorName);
         /* Execute user subroutine: 'GETCOLORCLASS' */
         S122 ();
         if (returnInSub) return;
         lblColorsquare_Caption = StringUtil.Format( AV9ColorItemDefinition, AV8ColorItemClass, "rgb(0,57,103)", "", "", "", "", "", "", "");
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 12;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910444681", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wwp_masterpageruntimesettings.js", "?202311910444681", false, true);
         }
      ...
      protected void sendrow_122( )
      {
         ...
         /* Div Control */
         FscolorRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)divTablecoloritem_Internalname+"_"+sGXsfl_12_idx,(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"",(string)"left",(string)"top",(string)"",(string)"",(string)"div"});
         /* Div Control */
         FscolorRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)"",(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"row",(string)"left",(string)"top",(string)"",(string)"",(string)"div"});
         /* Div Control */
         FscolorRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)"",(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"col-xs-12",(string)"left",(string)"top",(string)"",(string)"",(string)"div"});
         /* Text block */
         ...
         FscolorRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"left",(string)"top",(string)"div"});
         FscolorRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"left",(string)"top",(string)"div"});
         FscolorRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"left",(string)"top",(string)"div"});
         if ( FscolorContainer.GetWrapped() == 1 )
         {
         ...
         FscolorRow.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {(string)"",(string)"",(string)""});
         /* Div Control */
         FscolorRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)"",(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)" gx-attribute",(string)"left",(string)"top",(string)"",(string)"",(string)"div"});
      ...
      protected void StartGridControl12( )
      {
         ...
         else
         {
            ...
            FscolorContainer.AddColumnProperties(FscolorColumn);
            FscolorColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            FscolorColumn.AddObjectProperty("Value", AV10ColorName);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'FSCOLOR_nFirstRecordOnPage'},{av:'FSCOLOR_nEOF'},{av:'edtavColorname_Visible',ctrl:'vCOLORNAME',prop:'Visible'},{av:'AV5WWP_DesignSystemSettings',fld:'vWWP_DESIGNSYSTEMSETTINGS',pic:''},{av:'AV10ColorName',fld:'vCOLORNAME',pic:''},{av:'sPrefix'},{av:'radavBackstyle'},{av:'AV6BackStyle',fld:'vBACKSTYLE',pic:''},{av:'AV8ColorItemClass',fld:'vCOLORITEMCLASS',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("FSCOLOR.LOAD","{handler:'E172D2',iparms:[{av:'AV8ColorItemClass',fld:'vCOLORITEMCLASS',pic:'',hsh:true},{av:'AV5WWP_DesignSystemSettings',fld:'vWWP_DESIGNSYSTEMSETTINGS',pic:''},{av:'AV10ColorName',fld:'vCOLORNAME',pic:''}]");
         ...
         setEventMetadata("TABLECOLORITEM.CLICK","{handler:'E152D2',iparms:[{av:'FSCOLOR_nFirstRecordOnPage'},{av:'FSCOLOR_nEOF'},{av:'edtavColorname_Visible',ctrl:'vCOLORNAME',prop:'Visible'},{av:'AV8ColorItemClass',fld:'vCOLORITEMCLASS',pic:'',hsh:true},{av:'AV5WWP_DesignSystemSettings',fld:'vWWP_DESIGNSYSTEMSETTINGS',pic:''},{av:'AV10ColorName',fld:'vCOLORNAME',pic:''},{av:'radavBackstyle'},{av:'AV6BackStyle',fld:'vBACKSTYLE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("TABLECOLORITEM.CLICK",",oparms:[{av:'AV5WWP_DesignSystemSettings',fld:'vWWP_DESIGNSYSTEMSETTINGS',pic:''}]}");
         setEventMetadata("FONTSIZESMALL.CLICK","{handler:'E112D2',iparms:[{av:'AV11FontSizeSelected',fld:'vFONTSIZESELECTED',pic:''},{av:'AV5WWP_DesignSystemSettings',fld:'vWWP_DESIGNSYSTEMSETTINGS',pic:''}]");
         ...
         setEventMetadata("FONTSIZEMEDIUM.CLICK","{handler:'E122D2',iparms:[{av:'AV11FontSizeSelected',fld:'vFONTSIZESELECTED',pic:''},{av:'AV5WWP_DesignSystemSettings',fld:'vWWP_DESIGNSYSTEMSETTINGS',pic:''}]");
         ...
         setEventMetadata("FONTSIZELARGE.CLICK","{handler:'E132D2',iparms:[{av:'AV11FontSizeSelected',fld:'vFONTSIZESELECTED',pic:''},{av:'AV5WWP_DesignSystemSettings',fld:'vWWP_DESIGNSYSTEMSETTINGS',pic:''}]");
         ...
         setEventMetadata("VBACKSTYLE.CONTROLVALUECHANGED","{handler:'E142D2',iparms:[{av:'radavBackstyle'},{av:'AV6BackStyle',fld:'vBACKSTYLE',pic:''}]");

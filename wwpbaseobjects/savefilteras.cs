...
namespace GeneXus.Programs.wwpbaseobjects {
   public class savefilteras : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void S112( )
      {
         ...
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 é obrigatório.", "Nome", "", "", "", "", "", "", "", ""),  "error",  edtavFiltername_Internalname,  "true",  ""));
      ...
      protected void E120V2( )
      {
         ...
         if ( AV20CheckRequiredFieldsResult )
         {
            ...
            AV23GXV1 = 1;
            while ( AV23GXV1 <= AV10GridStateCollection.Count )
            {
               AV11GridStateCollectionItem = ((GeneXus.Programs.wwpbaseobjects.SdtGridStateCollection_Item)AV10GridStateCollection.Item(AV23GXV1));
      ...
      protected void wb_table2_5_0V2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table3_8_0V2( true) ;
         }
         else
         {
            wb_table3_8_0V2( false) ;
         }
         return  ;
      }

      protected void wb_table3_8_0V2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table3_8_0V2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910473140", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/savefilteras.js", "?202311910473140", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","{handler:'E120V2',iparms:[{av:'AV8FilterName',fld:'vFILTERNAME',pic:''},{av:'AV20CheckRequiredFieldsResult',fld:'vCHECKREQUIREDFIELDSRESULT',pic:''},{av:'AV15UserKey',fld:'vUSERKEY',pic:'',hsh:true},{av:'AV5GridStateKey',fld:'vGRIDSTATEKEY',pic:'',hsh:true}]");

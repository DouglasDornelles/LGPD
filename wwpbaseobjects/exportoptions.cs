   ...
   public class exportoptions : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void WB0S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_6_0S2( true) ;
         }
         else
         {
            wb_table1_6_0S2( false) ;
         }
         return  ;
      }

      protected void wb_table1_6_0S2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         {
            AV8ExportType = (short)(NumberUtil.Val( cmbavExporttype.getValidValue(StringUtil.Trim( StringUtil.Str( (decimal)(AV8ExportType), 1, 0))), "."));
      ...
      protected void STRUP0S0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV8ExportType = (short)(NumberUtil.Val( cgiGet( cmbavExporttype_Internalname), "."));
            AssignAttri("", false, "AV8ExportType", StringUtil.Str( (decimal)(AV8ExportType), 1, 0));
      ...
      protected void wb_table1_6_0S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_15_0S2( true) ;
         }
         else
         {
            wb_table2_15_0S2( false) ;
         }
         return  ;
      }

      protected void wb_table2_15_0S2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            wb_table3_52_0S2( true) ;
         }
         else
         {
            wb_table3_52_0S2( false) ;
         }
         return  ;
      }

      protected void wb_table3_52_0S2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            wb_table1_6_0S2e( true) ;
         }
         else
         {
            wb_table1_6_0S2e( false) ;
         }
      }

      protected void wb_table3_52_0S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_52_0S2e( true) ;
         }
         else
         {
            wb_table3_52_0S2e( false) ;
         }
      }

      protected void wb_table2_15_0S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_label_element( context, cmbavExporttype_Internalname, "Tipo de exportação", "col-sm-3 AttributeFLLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 25,'',false,'',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavExporttype, cmbavExporttype_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV8ExportType), 1, 0)), 1, cmbavExporttype_Jsonclick, 7, "'"+""+"'"+",false,"+"'"+"e150s1_client"+"'", "int", "", 1, cmbavExporttype.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,25);\"", "", true, 0, "HLP_WWPBaseObjects\\ExportOptions.htm");
            cmbavExporttype.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV8ExportType), 1, 0));
            ...
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td class='CellPaddingTop10 CellMarginLeft15'>") ;
            wb_table4_28_0S2( true) ;
         }
         else
         {
            wb_table4_28_0S2( false) ;
         }
         return  ;
      }

      protected void wb_table4_28_0S2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_15_0S2e( true) ;
         }
         else
         {
            wb_table2_15_0S2e( false) ;
         }
      }

      protected void wb_table4_28_0S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavUser_Internalname, "E-mail", "col-sm-3 AttributeFLLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 38,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavUser_Internalname, AV14User, StringUtil.RTrim( context.localUtil.Format( AV14User, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,38);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUser_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavUser_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "WWPBaseObjects\\WWP_Description", "left", true, "", "HLP_WWPBaseObjects\\ExportOptions.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavDoctitle_Internalname, "Título do documento", "col-sm-3 AttributeFLLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 43,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavDoctitle_Internalname, AV5DocTitle, StringUtil.RTrim( context.localUtil.Format( AV5DocTitle, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,43);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDoctitle_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavDoctitle_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "WWPBaseObjects\\WWP_Description", "left", true, "", "HLP_WWPBaseObjects\\ExportOptions.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavPassword_Internalname, AV12Password, StringUtil.RTrim( context.localUtil.Format( AV12Password, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,48);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPassword_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavPassword_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, edtavPassword_Ispassword, 0, 0, 0, -1, -1, true, "WWPBaseObjects\\WWP_Description", "left", true, "", "HLP_WWPBaseObjects\\ExportOptions.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_28_0S2e( true) ;
         }
         else
         {
            wb_table4_28_0S2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910473537", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/exportoptions.js", "?202311910473537", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_tableexport_Cls = "PanelCard Panel_BaseColor";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DODOWNLOADTOFILE'","{handler:'E120S2',iparms:[]");
         setEventMetadata("'DODOWNLOADTOFILE'",",oparms:[]}");
         setEventMetadata("'DOSAVEGOOGLEDRIVE'","{handler:'E130S2',iparms:[{av:'AV9GoogleDocResultXML',fld:'vGOOGLEDOCRESULTXML',pic:'',hsh:true}]");
         ...
         setEventMetadata("VEXPORTTYPE.CLICK","{handler:'E150S1',iparms:[{av:'cmbavExporttype'},{av:'AV8ExportType',fld:'vEXPORTTYPE',pic:'9'}]");

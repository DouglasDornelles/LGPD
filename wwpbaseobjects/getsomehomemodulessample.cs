...
namespace GeneXus.Programs.wwpbaseobjects {
   public class getsomehomemodulessample : GXProcedure
   {
      ...
      {
         this.Gxm3rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeModulesSDT_HomeModulesSDTItem>( context, "HomeModulesSDTItem", "LGPD_Novo") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeModulesSDT_HomeModulesSDTItem> aP0_Gxm3rootcol )
      {
         ...
         objgetsomehomemodulessample.Gxm3rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeModulesSDT_HomeModulesSDTItem>( context, "HomeModulesSDTItem", "LGPD_Novo") ;
         objgetsomehomemodulessample.context.SetSubmitInitialConfig(context);
         objgetsomehomemodulessample.initialize();
         Submit( executePrivateCatch,objgetsomehomemodulessample);
         aP0_Gxm3rootcol=this.Gxm3rootcol;
      }

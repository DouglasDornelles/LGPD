   ...
   public class addressdisplay : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void wb_table1_2_0R2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_5_0R2( true) ;
         }
         else
         {
            wb_table2_5_0R2( false) ;
         }
         return  ;
      }

      protected void wb_table2_5_0R2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table2_5_0R2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_5_0R2e( true) ;
         }
         else
         {
            wb_table2_5_0R2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231191047308", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwpbaseobjects/addressdisplay.js", "?20231191047308", false, true);
         }

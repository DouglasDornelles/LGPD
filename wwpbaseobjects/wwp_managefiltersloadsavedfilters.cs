...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wwp_managefiltersloadsavedfilters : GXProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         AV11ManageFiltersDataItem.gxTpr_Title = "Limpar filtros";
         ...
         AV11ManageFiltersDataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item(context);
         AV11ManageFiltersDataItem.gxTpr_Title = "Salvar filtro como...";
         ...
         {
            AV11ManageFiltersDataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item(context);
            AV11ManageFiltersDataItem.gxTpr_Title = "Mostrar filtros avançados"+"|"+"Ocultar filtros avançados";
         ...
         if ( AV13ManageFiltersItems.Count > 0 )
         {
            ...
            AV10ManageFiltersData.Add(AV11ManageFiltersDataItem, 0);
            AV18GXV1 = 1;
            while ( AV18GXV1 <= AV13ManageFiltersItems.Count )
            {
               AV12ManageFiltersItem = ((GeneXus.Programs.wwpbaseobjects.SdtGridStateCollection_Item)AV13ManageFiltersItems.Item(AV18GXV1));
               AV11ManageFiltersDataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item(context);
            ...
            AV10ManageFiltersData.Add(AV11ManageFiltersDataItem, 0);
            AV11ManageFiltersDataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item(context);
            AV11ManageFiltersDataItem.gxTpr_Title = "Gerenciar filtros";

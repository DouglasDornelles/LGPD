...
namespace GeneXus.Programs.wwpbaseobjects {
   ...
   [XmlType(TypeName =  "UserCustomizations" , Namespace = "LGPD_Novo" )]
   [Serializable]
   public class SdtUserCustomizations : GxSilentTrnSdt, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public void Load( string AV1UserCustomizationsId ,
                        string AV2UserCustomizationsKey )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(string)AV1UserCustomizationsId,(string)AV2UserCustomizationsKey});
         return  ;
      }
      ...
      public void UpdateDirties( GeneXus.Programs.wwpbaseobjects.SdtUserCustomizations sdt )
      {
         ...
         {
            gxTv_SdtUserCustomizations_N = 0;
            gxTv_SdtUserCustomizations_Usercustomizationsid = sdt.gxTv_SdtUserCustomizations_Usercustomizationsid ;
         }
      ...
      public void initialize( )
      {
         ...
         gxTv_SdtUserCustomizations_N = 1;
      ...
      private short gxTv_SdtUserCustomizations_N ;
   ...
   [DataContract(Name = @"WWPBaseObjects\UserCustomizations", Namespace = "LGPD_Novo")]
   ...
   [DataContract(Name = @"WWPBaseObjects\UserCustomizations", Namespace = "LGPD_Novo")]
   public class SdtUserCustomizations_RESTLInterface : GxGenericCollectionItem<GeneXus.Programs.wwpbaseobjects.SdtUserCustomizations>, System.Web.SessionState.IRequiresSessionState
   {

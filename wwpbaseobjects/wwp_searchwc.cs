...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wwp_searchwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public wwp_searchwc( )
      {
      ...
      protected void WB130( )
      {
         ...
         if ( wbEnd == 21 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavAdvfiltertext_Internalname, AV8AdvFilterText, StringUtil.RTrim( context.localUtil.Format( AV8AdvFilterText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,94);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavAdvfiltertext_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavAdvfiltertext_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "left", true, "", "HLP_WWPBaseObjects\\WWP_SearchWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 23), "FSRESULTCATEGORIES.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 14), "FSRESULTS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 29), "UNNAMEDTABLEFSFSRESULTS.CLICK") == 0 ) )
                           {
                              ...
                              AV32GXV1 = nGXsfl_21_idx;
                              if ( ( AV26WWP_SearchResults.Count >= AV32GXV1 ) && ( AV32GXV1 > 0 ) )
                              {
                                 AV26WWP_SearchResults.CurrentItem = ((GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV26WWP_SearchResults.Item(AV32GXV1));
                              }
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                              ...
                              else
                              {
                                 ...
                                 if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 14), "FSRESULTS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 29), "UNNAMEDTABLEFSFSRESULTS.CLICK") == 0 ) )
                                 {
                                    ...
                                    AssignProp(sPrefix, false, edtavDisplaytype4_image_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV14DisplayType4_Image)) ? AV35Displaytype4_image_GXI : context.convertURL( context.PathToRelativeUrl( AV14DisplayType4_Image))), !bGXsfl_29_Refreshing);
      ...
      private void E16132( )
      {
         ...
         returnInSub = false;
         AV32GXV1 = 1;
         while ( AV32GXV1 <= AV26WWP_SearchResults.Count )
         {
            AV26WWP_SearchResults.CurrentItem = ((GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV26WWP_SearchResults.Item(AV32GXV1));
            ...
            {
               context.DoAjaxLoad(21, FsresultcategoriesRow);
            }
      ...
      protected void S112( )
      {
         ...
         AV36GXV4 = 1;
         while ( AV36GXV4 <= AV19EntityDescriptions.Count )
         {
            AV18EntityDescription = ((string)AV19EntityDescriptions.Item(AV36GXV4));
      ...
      {
         AV32GXV1 = nGXsfl_21_idx;
         if ( ( AV32GXV1 > 0 ) && ( AV26WWP_SearchResults.Count >= AV32GXV1 ) )
         {
            AV26WWP_SearchResults.CurrentItem = ((GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV26WWP_SearchResults.Item(AV32GXV1));
         }
      ...
      {
         AV32GXV1 = nGXsfl_21_idx;
         if ( AV26WWP_SearchResults.Count < AV32GXV1 )
         {
            return  ;
         }
         ...
         returnInSub = false;
         AV34GXV3 = 1;
         while ( AV34GXV3 <= ((GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV26WWP_SearchResults.Item(AV32GXV1)).gxTpr_Result.Count )
         {
            ((GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV26WWP_SearchResults.Item(AV32GXV1)).gxTpr_Result.CurrentItem = ((GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)((GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV26WWP_SearchResults.Item(AV32GXV1)).gxTpr_Result.Item(AV34GXV3));
            ...
            else if ( StringUtil.StrCmp(((GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV26WWP_SearchResults.CurrentItem)).gxTpr_Result.CurrentItem)).gxTpr_Displaytype, "Title and image") == 0 )
            {
               ...
               else
               {
                  ...
                  AssignAttri(sPrefix, false, edtavDisplaytype4_image_Internalname, AV14DisplayType4_Image);
                  AV35Displaytype4_image_GXI = GXDbFile.PathToUrl( ((GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV26WWP_SearchResults.CurrentItem)).gxTpr_Result.CurrentItem)).gxTpr_Description2);
               }
            ...
            {
               context.DoAjaxLoad(29, FsresultsRow);
            }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910444694", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wwpbaseobjects/wwp_searchwc.js", "?202311910444695", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      ...
      protected void sendrow_29330( )
      {
         ...
         StyleString = "";
         AV14DisplayType4_Image_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV14DisplayType4_Image))&&String.IsNullOrEmpty(StringUtil.RTrim( AV35Displaytype4_image_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV14DisplayType4_Image)));
         sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV14DisplayType4_Image)) ? AV35Displaytype4_image_GXI : context.PathToRelativeUrl( AV14DisplayType4_Image));
      ...
      protected void sendrow_212( )
      {
         ...
         /* Div Control */
         FsresultcategoriesRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)divUnnamedtablefsfsresultcategories_Internalname+"_"+sGXsfl_21_idx,(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"Table",(string)"left",(string)"top",(string)"",(string)"",(string)"div"});
         /* Div Control */
         ...
         /* Div Control */
         FsresultcategoriesRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)"",(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"col-xs-12 SearchResultMPCategoryCell",(string)"left",(string)"top",(string)"",(string)"",(string)"div"});
         /* Div Control */
         ...
         FsresultcategoriesRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)"",(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"row",(string)"left",(string)"top",(string)"",(string)"",(string)"div"});
         /* Div Control */
         FsresultcategoriesRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)divShowingonlycell_Internalname+"_"+sGXsfl_21_idx,(int)divShowingonlycell_Visible,(short)0,(string)"px",(short)0,(string)"px",(string)"col-xs-12",(string)"left",(string)"top",(string)"",(string)"",(string)"div"});
         /* Text block */
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("FSRESULTCATEGORIES.LOAD","{handler:'E16132',iparms:[{av:'AV26WWP_SearchResults',fld:'vWWP_SEARCHRESULTS',grid:21,pic:'',hsh:true},{av:'nGXsfl_21_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:21},{av:'FSRESULTCATEGORIES_nFirstRecordOnPage'},{av:'nRC_GXsfl_21',ctrl:'FSRESULTCATEGORIES',prop:'GridRC',grid:21}]");
         ...
         setEventMetadata("FSRESULTS.LOAD","{handler:'E17133',iparms:[{av:'AV26WWP_SearchResults',fld:'vWWP_SEARCHRESULTS',grid:21,pic:'',hsh:true},{av:'nGXsfl_21_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:21},{av:'FSRESULTCATEGORIES_nFirstRecordOnPage'},{av:'nRC_GXsfl_21',ctrl:'FSRESULTCATEGORIES',prop:'GridRC',grid:21}]");
         ...
         setEventMetadata("'DOCLOSESEARCH'","{handler:'E11132',iparms:[]");
         setEventMetadata("'DOCLOSESEARCH'",",oparms:[]}");
         setEventMetadata("'DOSHOWALL'","{handler:'E12132',iparms:[{av:'AV22SearchText',fld:'vSEARCHTEXT',pic:''}]");
         setEventMetadata("'DOSHOWALL'",",oparms:[]}");
         setEventMetadata("'DOBTNADVSEARCH'","{handler:'E13132',iparms:[{av:'AV8AdvFilterText',fld:'vADVFILTERTEXT',pic:''},{av:'AV5AdvFilterEntities',fld:'vADVFILTERENTITIES',pic:''}]");
         setEventMetadata("'DOBTNADVSEARCH'",",oparms:[]}");
         setEventMetadata("UNNAMEDTABLEFSFSRESULTS.CLICK","{handler:'E14132',iparms:[{av:'AV26WWP_SearchResults',fld:'vWWP_SEARCHRESULTS',grid:21,pic:'',hsh:true},{av:'nGXsfl_21_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:21},{av:'FSRESULTCATEGORIES_nFirstRecordOnPage'},{av:'nRC_GXsfl_21',ctrl:'FSRESULTCATEGORIES',prop:'GridRC',grid:21},{av:'AV24Url',fld:'vURL',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         gxfirstwebparm_bkp = "";
         sPrefix = "";
         AV26WWP_SearchResults = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem>( context, "WWP_SearchResultsItem", "LGPD_Novo");
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXKey = "";
         ...
         AV25WWP_SearchResultAux = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem>( context, "WWP_SearchResultsItem", "LGPD_Novo");

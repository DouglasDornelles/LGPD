...
namespace GeneXus.Programs {
   public class dicionariocomparttercextview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public dicionariocomparttercextview( )
      {
      ...
      public dicionariocomparttercextview( IGxContext context )
      {
      ...
      public void execute( int aP0_CompartTercExternoId ,
                           ...
                           string aP2_TabCode )
      {
         this.AV10CompartTercExternoId = aP0_CompartTercExternoId;
         this.AV11DocDicionarioId = aP1_DocDicionarioId;
      ...
      {
         get {
            return "dicionariocomparttercextview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "dicionariocomparttercextview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10CompartTercExternoId,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV11DocDicionarioId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("dicionariocomparttercextview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vCOMPARTTERCEXTERNOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CompartTercExternoId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_vDOCDICIONARIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV11DocDicionarioId), "ZZZZZZZ9"), context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vCOMPARTTERCEXTERNOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10CompartTercExternoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCOMPARTTERCEXTERNOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CompartTercExternoId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vDOCDICIONARIOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11DocDicionarioId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vDOCDICIONARIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV11DocDicionarioId), "ZZZZZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "dicionariocomparttercextview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10CompartTercExternoId,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV11DocDicionarioId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("dicionariocomparttercextview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "DicionarioCompartTercExtView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Dicionario Compart Terc Ext View" ;
      }
      ...
      protected void WB7J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Dicionario Compart Terc Ext", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_DicionarioCompartTercExtView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divDicionariocomparttercextgeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
      ...
      protected void START7J2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Dicionario Compart Terc Ext View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA7J2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "dicionariocomparttercextview.aspx")), "dicionariocomparttercextview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "dicionariocomparttercextview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10CompartTercExternoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10CompartTercExternoId", StringUtil.LTrimStr( (decimal)(AV10CompartTercExternoId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vCOMPARTTERCEXTERNOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CompartTercExternoId), "ZZZZZZZ9"), context));
                     if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
                     {
                        AV11DocDicionarioId = (int)(NumberUtil.Val( GetPar( "DocDicionarioId"), "."));
                        AssignAttri("", false, "AV11DocDicionarioId", StringUtil.LTrimStr( (decimal)(AV11DocDicionarioId), 8, 0));
                        GxWebStd.gx_hidden_field( context, "gxhash_vDOCDICIONARIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV11DocDicionarioId), "ZZZZZZZ9"), context));
      ...
      protected void E117J2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("dicionariocomparttercextww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV17GXLvl9 = 0;
         /* Using cursor H007J2 */
         pr_default.execute(0, new Object[] {AV10CompartTercExternoId, AV11DocDicionarioId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A98DocDicionarioId = H007J2_A98DocDicionarioId[0];
            A66CompartTercExternoId = H007J2_A66CompartTercExternoId[0];
            AV17GXLvl9 = 1;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "DicionarioCompartTercExtGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "dicionariocomparttercextgeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "DicionarioCompartTercExtGeneral";
            WebComp_Webcomponent_general_Component = "DicionarioCompartTercExtGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10CompartTercExternoId,(int)AV11DocDicionarioId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10CompartTercExternoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10CompartTercExternoId", StringUtil.LTrimStr( (decimal)(AV10CompartTercExternoId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vCOMPARTTERCEXTERNOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CompartTercExternoId), "ZZZZZZZ9"), context));
         AV11DocDicionarioId = Convert.ToInt32(getParm(obj,1));
         AssignAttri("", false, "AV11DocDicionarioId", StringUtil.LTrimStr( (decimal)(AV11DocDicionarioId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vDOCDICIONARIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV11DocDicionarioId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231191051227", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("dicionariocomparttercextview.js", "?20231191051227", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divDicionariocomparttercextgeneral_cell_Internalname = "DICIONARIOCOMPARTTERCEXTGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Dicionario Compart Terc Ext View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10CompartTercExternoId',fld:'vCOMPARTTERCEXTERNOID',pic:'ZZZZZZZ9',hsh:true},{av:'AV11DocDicionarioId',fld:'vDOCDICIONARIOID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H007J2_A98DocDicionarioId = new int[1] ;
         H007J2_A66CompartTercExternoId = new int[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.dicionariocomparttercextview__default(),
            new Object[][] {
                new Object[] {
               H007J2_A98DocDicionarioId, H007J2_A66CompartTercExternoId
               }
            }
         );
      ...
      private int AV10CompartTercExternoId ;
      private int AV11DocDicionarioId ;
      private int wcpOAV10CompartTercExternoId ;
      private int wcpOAV11DocDicionarioId ;
      ...
      private string divDicionariocomparttercextgeneral_cell_Internalname ;
      ...
      private int[] H007J2_A98DocDicionarioId ;
      private int[] H007J2_A66CompartTercExternoId ;
   ...
   public class dicionariocomparttercextview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10CompartTercExternoId",GXType.Int32,8,0) ,
          new ParDef("@AV11DocDicionarioId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H007J2", "SELECT [DocDicionarioId], [CompartTercExternoId] FROM [DicionarioCompartTercExt] WHERE ([CompartTercExternoId] = @AV10CompartTercExternoId and [DocDicionarioId] = @AV11DocDicionarioId) AND ([CompartTercExternoId] = @AV10CompartTercExternoId and [DocDicionarioId] = @AV11DocDicionarioId) ORDER BY [CompartTercExternoId], [DocDicionarioId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007J2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

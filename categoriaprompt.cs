...
namespace GeneXus.Programs {
   public class categoriaprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public categoriaprompt( )
      {
      ...
      public categoriaprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutCategoriaId ,
                           ref string aP1_InOutCategoriaNome )
      {
         this.AV8InOutCategoriaId = aP0_InOutCategoriaId;
         this.AV9InOutCategoriaNome = aP1_InOutCategoriaNome;
         executePrivate();
         aP0_InOutCategoriaId=this.AV8InOutCategoriaId;
         aP1_InOutCategoriaNome=this.AV9InOutCategoriaNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutCategoriaId");
            ...
            {
               AV8InOutCategoriaId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutCategoriaId", StringUtil.LTrimStr( (decimal)(AV8InOutCategoriaId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutCategoriaNome = GetPar( "InOutCategoriaNome");
                  AssignAttri("", false, "AV9InOutCategoriaNome", AV9InOutCategoriaNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      {
         get {
            return "categoriaprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("categoriaprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutCategoriaId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutCategoriaNome))}, new string[] {"InOutCategoriaId","InOutCategoriaNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTCATEGORIAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutCategoriaId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTCATEGORIANOME", AV9InOutCategoriaNome);
      ...
      {
         return formatLink("categoriaprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutCategoriaId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutCategoriaNome))}, new string[] {"InOutCategoriaId","InOutCategoriaNome"})  ;
      }

      public override string GetPgmname( )
      {
         return "CategoriaPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Categoria" ;
      }
      ...
      protected void WB3Z0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_3Z2( true) ;
         }
         else
         {
            wb_table1_14_3Z2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_3Z2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START3Z2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Categoria", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_CATEGORIANOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A28CategoriaNome, "")), context));
         GxWebStd.gx_hidden_field( context, "CATEGORIANOME", A28CategoriaNome);
      }
      ...
      protected void RF3Z2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A29CategoriaAtivo = H003Z2_A29CategoriaAtivo[0];
               A28CategoriaNome = H003Z2_A28CategoriaNome[0];
               A27CategoriaId = H003Z2_A27CategoriaId[0];
               E173Z2 ();
      ...
      protected void send_integrity_lvl_hashes3Z2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_CATEGORIAID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A27CategoriaId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_CATEGORIANOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A28CategoriaNome, "")), context));
      }
      ...
      protected void E153Z2( )
      {
         ...
         Form.Caption = "Consulta de Categoria";
      ...
      protected void E183Z2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutCategoriaId = A27CategoriaId;
         AssignAttri("", false, "AV8InOutCategoriaId", StringUtil.LTrimStr( (decimal)(AV8InOutCategoriaId), 8, 0));
         AV9InOutCategoriaNome = A28CategoriaNome;
         AssignAttri("", false, "AV9InOutCategoriaNome", AV9InOutCategoriaNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutCategoriaId,(string)AV9InOutCategoriaNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutCategoriaId","AV9InOutCategoriaNome"});
      ...
      protected void wb_table1_14_3Z2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_CategoriaPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutCategoriaId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutCategoriaId", StringUtil.LTrimStr( (decimal)(AV8InOutCategoriaId), 8, 0));
         AV9InOutCategoriaNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutCategoriaNome", AV9InOutCategoriaNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910501689", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("categoriaprompt.js", "?202311910501690", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtCategoriaId_Internalname = "CATEGORIAID_"+sGXsfl_26_idx;
         edtCategoriaNome_Internalname = "CATEGORIANOME_"+sGXsfl_26_idx;
         cmbCategoriaAtivo_Internalname = "CATEGORIAATIVO_"+sGXsfl_26_idx;
      }

      protected void SubsflControlProps_fel_262( )
      {
         edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx;
         edtCategoriaId_Internalname = "CATEGORIAID_"+sGXsfl_26_fel_idx;
         edtCategoriaNome_Internalname = "CATEGORIANOME_"+sGXsfl_26_fel_idx;
         cmbCategoriaAtivo_Internalname = "CATEGORIAATIVO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "CATEGORIAATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbCategoriaAtivo_Internalname, "Values", (string)(cmbCategoriaAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:CategoriaId|2:CategoriaNome|3:CategoriaAtivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E173Z2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E183Z2',iparms:[{av:'A27CategoriaId',fld:'CATEGORIAID',pic:'ZZZZZZZ9',hsh:true},{av:'A28CategoriaNome',fld:'CATEGORIANOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutCategoriaId',fld:'vINOUTCATEGORIAID',pic:'ZZZZZZZ9'},{av:'AV9InOutCategoriaNome',fld:'vINOUTCATEGORIANOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E143Z2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H003Z2_A29CategoriaAtivo = new bool[] {false} ;
         H003Z2_A28CategoriaNome = new string[] {""} ;
         H003Z2_A27CategoriaId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.categoriaprompt__default(),
            new Object[][] {
                new Object[] {
               H003Z2_A29CategoriaAtivo, H003Z2_A28CategoriaNome, H003Z2_A27CategoriaId
               }
               , new Object[] {
      ...
      private int AV8InOutCategoriaId ;
      private int wcpOAV8InOutCategoriaId ;
      ...
      private string AV9InOutCategoriaNome ;
      private string wcpOAV9InOutCategoriaNome ;
      ...
      private int aP0_InOutCategoriaId ;
      private string aP1_InOutCategoriaNome ;
      private GXCombobox cmbCategoriaAtivo ;
      private IDataStoreProvider pr_default ;
      private bool[] H003Z2_A29CategoriaAtivo ;
      private string[] H003Z2_A28CategoriaNome ;
      private int[] H003Z2_A27CategoriaId ;
   ...
   public class categoriaprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([CategoriaId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [CategoriaNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and [CategoriaAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and [CategoriaAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
      ...
      protected Object[] conditional_H003Z3( IGxContext context ,
                                             string AV13FilterFullText ,
                                             int A27CategoriaId ,
                                             string A28CategoriaNome ,
                                             bool A29CategoriaAtivo ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H003Z2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
               case 1 :
                     return conditional_H003Z3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H003Z2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003Z2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H003Z3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003Z3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }

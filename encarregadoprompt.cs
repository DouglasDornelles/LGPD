...
namespace GeneXus.Programs {
   public class encarregadoprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public encarregadoprompt( )
      {
      ...
      public encarregadoprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutEncarregadoId ,
                           ref string aP1_InOutEncarregadoNome )
      {
         this.AV8InOutEncarregadoId = aP0_InOutEncarregadoId;
         this.AV9InOutEncarregadoNome = aP1_InOutEncarregadoNome;
         executePrivate();
         aP0_InOutEncarregadoId=this.AV8InOutEncarregadoId;
         aP1_InOutEncarregadoNome=this.AV9InOutEncarregadoNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutEncarregadoId");
            ...
            {
               AV8InOutEncarregadoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutEncarregadoId", StringUtil.LTrimStr( (decimal)(AV8InOutEncarregadoId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutEncarregadoNome = GetPar( "InOutEncarregadoNome");
                  AssignAttri("", false, "AV9InOutEncarregadoNome", AV9InOutEncarregadoNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      {
         get {
            return "encarregadoprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("encarregadoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutEncarregadoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutEncarregadoNome))}, new string[] {"InOutEncarregadoId","InOutEncarregadoNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTENCARREGADOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutEncarregadoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTENCARREGADONOME", AV9InOutEncarregadoNome);
      ...
      {
         return formatLink("encarregadoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutEncarregadoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutEncarregadoNome))}, new string[] {"InOutEncarregadoId","InOutEncarregadoNome"})  ;
      }

      public override string GetPgmname( )
      {
         return "EncarregadoPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Encarregado" ;
      }
      ...
      protected void WB3J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_3J2( true) ;
         }
         else
         {
            wb_table1_14_3J2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_3J2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START3J2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Encarregado", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_ENCARREGADONOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A8EncarregadoNome, "")), context));
         GxWebStd.gx_hidden_field( context, "ENCARREGADONOME", A8EncarregadoNome);
      }
      ...
      protected void RF3J2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A9EncarregadoAtivo = H003J2_A9EncarregadoAtivo[0];
               A8EncarregadoNome = H003J2_A8EncarregadoNome[0];
               A7EncarregadoId = H003J2_A7EncarregadoId[0];
               E173J2 ();
      ...
      protected void send_integrity_lvl_hashes3J2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_ENCARREGADOID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A7EncarregadoId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_ENCARREGADONOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A8EncarregadoNome, "")), context));
      }
      ...
      protected void E153J2( )
      {
         ...
         Form.Caption = "Consulta de Encarregado";
      ...
      protected void E183J2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutEncarregadoId = A7EncarregadoId;
         AssignAttri("", false, "AV8InOutEncarregadoId", StringUtil.LTrimStr( (decimal)(AV8InOutEncarregadoId), 8, 0));
         AV9InOutEncarregadoNome = A8EncarregadoNome;
         AssignAttri("", false, "AV9InOutEncarregadoNome", AV9InOutEncarregadoNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutEncarregadoId,(string)AV9InOutEncarregadoNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutEncarregadoId","AV9InOutEncarregadoNome"});
      ...
      protected void wb_table1_14_3J2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_EncarregadoPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutEncarregadoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutEncarregadoId", StringUtil.LTrimStr( (decimal)(AV8InOutEncarregadoId), 8, 0));
         AV9InOutEncarregadoNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutEncarregadoNome", AV9InOutEncarregadoNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910501866", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("encarregadoprompt.js", "?202311910501866", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtEncarregadoId_Internalname = "ENCARREGADOID_"+sGXsfl_26_idx;
         edtEncarregadoNome_Internalname = "ENCARREGADONOME_"+sGXsfl_26_idx;
         cmbEncarregadoAtivo_Internalname = "ENCARREGADOATIVO_"+sGXsfl_26_idx;
      }

      protected void SubsflControlProps_fel_262( )
      {
         edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx;
         edtEncarregadoId_Internalname = "ENCARREGADOID_"+sGXsfl_26_fel_idx;
         edtEncarregadoNome_Internalname = "ENCARREGADONOME_"+sGXsfl_26_fel_idx;
         cmbEncarregadoAtivo_Internalname = "ENCARREGADOATIVO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "ENCARREGADOATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbEncarregadoAtivo_Internalname, "Values", (string)(cmbEncarregadoAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:EncarregadoId|2:EncarregadoNome|3:EncarregadoAtivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E173J2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E183J2',iparms:[{av:'A7EncarregadoId',fld:'ENCARREGADOID',pic:'ZZZZZZZ9',hsh:true},{av:'A8EncarregadoNome',fld:'ENCARREGADONOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutEncarregadoId',fld:'vINOUTENCARREGADOID',pic:'ZZZZZZZ9'},{av:'AV9InOutEncarregadoNome',fld:'vINOUTENCARREGADONOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E143J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H003J2_A9EncarregadoAtivo = new bool[] {false} ;
         H003J2_A8EncarregadoNome = new string[] {""} ;
         H003J2_A7EncarregadoId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.encarregadoprompt__default(),
            new Object[][] {
                new Object[] {
               H003J2_A9EncarregadoAtivo, H003J2_A8EncarregadoNome, H003J2_A7EncarregadoId
               }
               , new Object[] {
      ...
      private int AV8InOutEncarregadoId ;
      private int wcpOAV8InOutEncarregadoId ;
      ...
      private string AV9InOutEncarregadoNome ;
      private string wcpOAV9InOutEncarregadoNome ;
      ...
      private int aP0_InOutEncarregadoId ;
      private string aP1_InOutEncarregadoNome ;
      private GXCombobox cmbEncarregadoAtivo ;
      private IDataStoreProvider pr_default ;
      private bool[] H003J2_A9EncarregadoAtivo ;
      private string[] H003J2_A8EncarregadoNome ;
      private int[] H003J2_A7EncarregadoId ;
   ...
   public class encarregadoprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([EncarregadoId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [EncarregadoNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and [EncarregadoAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and [EncarregadoAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H003J2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (bool)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] );
               case 1 :
                     return conditional_H003J3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (bool)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] );
         }

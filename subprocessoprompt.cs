...
namespace GeneXus.Programs {
   public class subprocessoprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public subprocessoprompt( )
      {
      ...
      public subprocessoprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutSubprocessoId ,
                           ref string aP1_InOutSubprocessoNome )
      {
         this.AV8InOutSubprocessoId = aP0_InOutSubprocessoId;
         this.AV9InOutSubprocessoNome = aP1_InOutSubprocessoNome;
         executePrivate();
         aP0_InOutSubprocessoId=this.AV8InOutSubprocessoId;
         aP1_InOutSubprocessoNome=this.AV9InOutSubprocessoNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutSubprocessoId");
            ...
            {
               AV8InOutSubprocessoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutSubprocessoId", StringUtil.LTrimStr( (decimal)(AV8InOutSubprocessoId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutSubprocessoNome = GetPar( "InOutSubprocessoNome");
                  AssignAttri("", false, "AV9InOutSubprocessoNome", AV9InOutSubprocessoNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      {
         get {
            return "subprocessoprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("subprocessoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutSubprocessoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutSubprocessoNome))}, new string[] {"InOutSubprocessoId","InOutSubprocessoNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTSUBPROCESSOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutSubprocessoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTSUBPROCESSONOME", AV9InOutSubprocessoNome);
      ...
      {
         return formatLink("subprocessoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutSubprocessoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutSubprocessoNome))}, new string[] {"InOutSubprocessoId","InOutSubprocessoNome"})  ;
      }

      public override string GetPgmname( )
      {
         return "SubProcessoPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Sub Processo" ;
      }
      ...
      protected void WB740( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_742( true) ;
         }
         else
         {
            wb_table1_14_742( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_742e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START742( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Sub Processo", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_SUBPROCESSONOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A21SubprocessoNome, "")), context));
         GxWebStd.gx_hidden_field( context, "SUBPROCESSONOME", A21SubprocessoNome);
      }
      ...
      protected void RF742( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV12OrderedDsc } ,
                                                 new int[]{
                                                 TypeConstants.INT, TypeConstants.INT, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.BOOLEAN
                                                 }
            });
            ...
            {
               A23SubprocessoAtivo = H00742_A23SubprocessoAtivo[0];
               A21SubprocessoNome = H00742_A21SubprocessoNome[0];
               A17ProcessoNome = H00742_A17ProcessoNome[0];
               A16ProcessoId = H00742_A16ProcessoId[0];
               n16ProcessoId = H00742_n16ProcessoId[0];
               A20SubprocessoId = H00742_A20SubprocessoId[0];
               A17ProcessoNome = H00742_A17ProcessoNome[0];
               E17742 ();
      ...
      protected void send_integrity_lvl_hashes742( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_SUBPROCESSOID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A20SubprocessoId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_SUBPROCESSONOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A21SubprocessoNome, "")), context));
      }
      ...
      protected void E15742( )
      {
         ...
         Form.Caption = "Consulta de Sub Processo";
      ...
      protected void E18742( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutSubprocessoId = A20SubprocessoId;
         AssignAttri("", false, "AV8InOutSubprocessoId", StringUtil.LTrimStr( (decimal)(AV8InOutSubprocessoId), 8, 0));
         AV9InOutSubprocessoNome = A21SubprocessoNome;
         AssignAttri("", false, "AV9InOutSubprocessoNome", AV9InOutSubprocessoNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutSubprocessoId,(string)AV9InOutSubprocessoNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutSubprocessoId","AV9InOutSubprocessoNome"});
      ...
      protected void wb_table1_14_742( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_SubProcessoPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutSubprocessoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutSubprocessoId", StringUtil.LTrimStr( (decimal)(AV8InOutSubprocessoId), 8, 0));
         AV9InOutSubprocessoNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutSubprocessoNome", AV9InOutSubprocessoNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910512285", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("subprocessoprompt.js", "?202311910512285", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtSubprocessoId_Internalname = "SUBPROCESSOID_"+sGXsfl_26_idx;
         edtProcessoId_Internalname = "PROCESSOID_"+sGXsfl_26_idx;
         edtProcessoNome_Internalname = "PROCESSONOME_"+sGXsfl_26_idx;
         edtSubprocessoNome_Internalname = "SUBPROCESSONOME_"+sGXsfl_26_idx;
         cmbSubprocessoAtivo_Internalname = "SUBPROCESSOATIVO_"+sGXsfl_26_idx;
      }

      protected void SubsflControlProps_fel_262( )
      {
         edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx;
         edtSubprocessoId_Internalname = "SUBPROCESSOID_"+sGXsfl_26_fel_idx;
         edtProcessoId_Internalname = "PROCESSOID_"+sGXsfl_26_fel_idx;
         edtProcessoNome_Internalname = "PROCESSONOME_"+sGXsfl_26_fel_idx;
         edtSubprocessoNome_Internalname = "SUBPROCESSONOME_"+sGXsfl_26_fel_idx;
         cmbSubprocessoAtivo_Internalname = "SUBPROCESSOATIVO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "SUBPROCESSOATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbSubprocessoAtivo_Internalname, "Values", (string)(cmbSubprocessoAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
            send_integrity_lvl_hashes742( ) ;
      ...
      protected void StartGridControl26( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Nome do Processo") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:SubprocessoId|2:ProcessoId|3:ProcessoNome|4:SubprocessoNome|5:SubprocessoAtivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E17742',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E18742',iparms:[{av:'A20SubprocessoId',fld:'SUBPROCESSOID',pic:'ZZZZZZZ9',hsh:true},{av:'A21SubprocessoNome',fld:'SUBPROCESSONOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutSubprocessoId',fld:'vINOUTSUBPROCESSOID',pic:'ZZZZZZZ9'},{av:'AV9InOutSubprocessoNome',fld:'vINOUTSUBPROCESSONOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E14742',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H00742_A23SubprocessoAtivo = new bool[] {false} ;
         H00742_A21SubprocessoNome = new string[] {""} ;
         H00742_A17ProcessoNome = new string[] {""} ;
         H00742_A16ProcessoId = new int[1] ;
         H00742_n16ProcessoId = new bool[] {false} ;
         H00742_A20SubprocessoId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.subprocessoprompt__default(),
            new Object[][] {
                new Object[] {
               H00742_A23SubprocessoAtivo, H00742_A21SubprocessoNome, H00742_A17ProcessoNome, H00742_A16ProcessoId, H00742_n16ProcessoId, H00742_A20SubprocessoId
               }
               , new Object[] {
      ...
      private int AV8InOutSubprocessoId ;
      private int wcpOAV8InOutSubprocessoId ;
      ...
      private string AV9InOutSubprocessoNome ;
      private string wcpOAV9InOutSubprocessoNome ;
      ...
      private int aP0_InOutSubprocessoId ;
      private string aP1_InOutSubprocessoNome ;
      private GXCombobox cmbSubprocessoAtivo ;
      private IDataStoreProvider pr_default ;
      private bool[] H00742_A23SubprocessoAtivo ;
      private string[] H00742_A21SubprocessoNome ;
      private string[] H00742_A17ProcessoNome ;
      private int[] H00742_A16ProcessoId ;
      private bool[] H00742_n16ProcessoId ;
      private int[] H00742_A20SubprocessoId ;
   ...
   public class subprocessoprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.[SubprocessoAtivo], T1.[SubprocessoNome], T2.[ProcessoNome], T1.[ProcessoId], T1.[SubprocessoId]";
         sFromString = " FROM ([SubProcesso] T1 LEFT JOIN [Processo] T2 ON T2.[ProcessoId] = T1.[ProcessoId])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13FilterFullText)) )
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST(T1.[SubprocessoId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( CONVERT( char(8), CAST(T1.[ProcessoId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( T2.[ProcessoNome] like '%' + @lV13FilterFullText) or ( T1.[SubprocessoNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and T1.[SubprocessoAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and T1.[SubprocessoAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
         ...
         {
            sOrderString += " ORDER BY T1.[SubprocessoNome]";
         }
         else if ( ( AV11OrderedBy == 1 ) && ( AV12OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[SubprocessoNome] DESC";
         }
         else if ( ( AV11OrderedBy == 2 ) && ! AV12OrderedDsc )
         {
            sOrderString += " ORDER BY T1.[SubprocessoId]";
         }
         else if ( ( AV11OrderedBy == 2 ) && ( AV12OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[SubprocessoId] DESC";
         }
         else if ( ( AV11OrderedBy == 3 ) && ! AV12OrderedDsc )
         {
            sOrderString += " ORDER BY T1.[ProcessoId]";
         }
         else if ( ( AV11OrderedBy == 3 ) && ( AV12OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[ProcessoId] DESC";
         }
         else if ( ( AV11OrderedBy == 4 ) && ! AV12OrderedDsc )
         {
            sOrderString += " ORDER BY T2.[ProcessoNome]";
         }
         else if ( ( AV11OrderedBy == 4 ) && ( AV12OrderedDsc ) )
         {
            sOrderString += " ORDER BY T2.[ProcessoNome] DESC";
         }
         else if ( ( AV11OrderedBy == 5 ) && ! AV12OrderedDsc )
         {
            sOrderString += " ORDER BY T1.[SubprocessoAtivo]";
         }
         else if ( ( AV11OrderedBy == 5 ) && ( AV12OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[SubprocessoAtivo] DESC";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY T1.[SubprocessoId]";
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ([SubProcesso] T1 LEFT JOIN [Processo] T2 ON T2.[ProcessoId] = T1.[ProcessoId])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13FilterFullText)) )
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST(T1.[SubprocessoId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( CONVERT( char(8), CAST(T1.[ProcessoId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( T2.[ProcessoNome] like '%' + @lV13FilterFullText) or ( T1.[SubprocessoNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and T1.[SubprocessoAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and T1.[SubprocessoAtivo] = 0))");
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00742(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (bool)dynConstraints[5] , (short)dynConstraints[6] , (bool)dynConstraints[7] );
               case 1 :
                     return conditional_H00743(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (bool)dynConstraints[5] , (short)dynConstraints[6] , (bool)dynConstraints[7] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00742", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00742,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00743", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00743,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }

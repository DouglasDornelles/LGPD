...
namespace GeneXus.Programs {
   public class documentodoccompartinternowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public documentodoccompartinternowc( )
      {
      ...
      public documentodoccompartinternowc( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV33Pgmname = "DocumentoDocCompartInternoWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Documento Doc Compart Interno WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "documentodoccompartinternowc.aspx"+UrlEncode(StringUtil.LTrimStr(AV8DocumentoId,8,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("documentodoccompartinternowc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", sPrefix+"hsh"+"DocumentoDocCompartInternoWC");
         forbiddenHiddens.Add("DocumentoId", context.localUtil.Format( (decimal)(A75DocumentoId), "ZZZZZZZ9"));
         GxWebStd.gx_hidden_field( context, sPrefix+"hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("documentodoccompartinternowc:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return "DocumentoDocCompartInternoWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Documento Doc Compart Interno WC" ;
      }
      ...
      protected void WB660( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "documentodoccompartinternowc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "Inserir", bttBtninsert_Jsonclick, 5, "Inserir", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_DocumentoDocCompartInternoWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START662( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Documento Doc Compart Interno WC", 0) ;
            }
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "documentodoccompartinternowc.aspx")), "documentodoccompartinternowc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "documentodoccompartinternowc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_COMPARTINTERNOID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A57CompartInternoId), "ZZZZZZZ9"), context));
      ...
      protected void send_integrity_lvl_hashes662( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV30IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV30IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_COMPARTINTERNOID"+"_"+sGXsfl_39_idx, GetSecureSignedToken( sPrefix+sGXsfl_39_idx, context.localUtil.Format( (decimal)(A57CompartInternoId), "ZZZZZZZ9"), context));
      }
      ...
      protected void STRUP660( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            {
               GXUtil.WriteLogError("documentodoccompartinternowc:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
               context.HttpContext.Response.StatusDescription = 403.ToString();
               context.HttpContext.Response.StatusCode = 403;
               context.WriteHtmlText( "<title>403 Forbidden</title>") ;
      ...
      protected void E11662( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("DocumentoDocCompartInternoWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV33Pgmname+"GridState"));
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("DocumentoDocCompartInternoWCFilters"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "DocumentoDocCompartInternoWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
      ...
      protected void E15662( )
      {
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "doccompartinterno.aspx"+UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode(StringUtil.LTrimStr(0,1,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV8DocumentoId,8,0));
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "DocumentoDocCompartInternoWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void wb_table1_24_662( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table2_29_662( true) ;
         }
         else
         {
            wb_table2_29_662( false) ;
         }
         return  ;
      }

      protected void wb_table2_29_662e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table2_29_662( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "documentodoccompartinternowc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231191046170", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("documentodoccompartinternowc.js", "?20231191046170", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_392( )
      {
         ...
         edtCompartInternoId_Internalname = sPrefix+"COMPARTINTERNOID_"+sGXsfl_39_idx;
      }
      ...
      protected void SubsflControlProps_fel_392( )
      {
         ...
         edtCompartInternoId_Internalname = sPrefix+"COMPARTINTERNOID_"+sGXsfl_39_fel_idx;
      }
      ...
      protected void StartGridControl39( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( "Id da Forma de Compartilhamento Interno") ;
            context.WriteHtmlTextNl( "</th>") ;
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "2:CompartInternoId";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E18662',iparms:[{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A57CompartInternoId',fld:'COMPARTINTERNOID',pic:'ZZZZZZZ9',hsh:true},{av:'A75DocumentoId',fld:'DOCUMENTOID',pic:'ZZZZZZZ9'},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E15662',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8DocumentoId',fld:'vDOCUMENTOID',pic:'ZZZZZZZ9'},{av:'AV19ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV29IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV30IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A75DocumentoId',fld:'DOCUMENTOID',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'A57CompartInternoId',fld:'COMPARTINTERNOID',pic:'ZZZZZZZ9',hsh:true}]");
         ...
         setEventMetadata("NULL","{handler:'Valid_Compartinternoid',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV15FilterFullText = "";
         H00662_A75DocumentoId = new int[1] ;
         H00662_A57CompartInternoId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.documentodoccompartinternowc__default(),
            new Object[][] {
                new Object[] {
               H00662_A75DocumentoId, H00662_A57CompartInternoId
               }
               , new Object[] {
      ...
      private int[] H00662_A75DocumentoId ;
      private int[] H00662_A57CompartInternoId ;
   ...
   public class documentodoccompartinternowc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int A75DocumentoId )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([CompartInternoId] AS decimal(8,0))) like '%' + @lV15FilterFullText))");
         }
         else
         {
            GXv_int5[1] = 1;
         ...
         if ( ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY [DocumentoId], [CompartInternoId]";
         }
         else if ( AV14OrderedDsc )
         {
            sOrderString += " ORDER BY [DocumentoId] DESC, [CompartInternoId] DESC";
         }
         else if ( true )
         {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00662(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (bool)dynConstraints[2] , (int)dynConstraints[3] , (int)dynConstraints[4] );
               case 1 :
                     return conditional_H00663(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (bool)dynConstraints[2] , (int)dynConstraints[3] , (int)dynConstraints[4] );
         }

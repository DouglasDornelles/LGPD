...
namespace GeneXus.Programs {
   public class informacaodocdicionariowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public informacaodocdicionariowc( )
      {
      ...
      public informacaodocdicionariowc( IGxContext context )
      {
      ...
      {
         this.AV8InformacaoId = aP0_InformacaoId;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8InformacaoId = (int)(NumberUtil.Val( GetPar( "InformacaoId"), "."));
                  AssignAttri(sPrefix, false, "AV8InformacaoId", StringUtil.LTrimStr( (decimal)(AV8InformacaoId), 8, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(int)AV8InformacaoId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV8InformacaoId, AV20ManageFiltersExecutionStep, AV37Pgmname, AV14OrderedBy, AV15OrderedDsc, AV16FilterFullText, AV28IsAuthorized_Update, AV30IsAuthorized_Delete, AV33IsAuthorized_HipoteseTratamentoNome, AV34IsAuthorized_PaisNome, A4PaisId, AV31IsAuthorized_Insert, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV37Pgmname = "InformacaoDocDicionarioWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Informacao Doc Dicionario WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "informacaodocdicionariowc.aspx"+UrlEncode(StringUtil.LTrimStr(AV8InformacaoId,8,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("informacaodocdicionariowc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8InformacaoId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV8InformacaoId), 8, 0, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV31IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vINFORMACAOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InformacaoId), 8, 0, ",", "")));
      ...
      {
         return "InformacaoDocDicionarioWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Informacao Doc Dicionario WC" ;
      }
      ...
      protected void WB2N0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "informacaodocdicionariowc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "Inserir", bttBtninsert_Jsonclick, 5, "Inserir", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_InformacaoDocDicionarioWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void wb_table1_24_2N2e( bool wbgen )
      {
         ...
         if ( wbEnd == 39 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtInformacaoId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A69InformacaoId), 8, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A69InformacaoId), "ZZZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtInformacaoId_Jsonclick, 0, "Attribute", "", "", "", "", edtInformacaoId_Visible, 0, 0, "text", "1", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "Id", "right", false, "", "HLP_InformacaoDocDicionarioWC.htm");
            /* User Defined Control */
      ...
      protected void START2N2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Informacao Doc Dicionario WC", 0) ;
            }
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "informacaodocdicionariowc.aspx")), "informacaodocdicionariowc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "informacaodocdicionariowc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void RF2N2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H002N2 */
            pr_default.execute(0, new Object[] {AV8InformacaoId, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_39_idx = 1;
            sGXsfl_39_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_39_idx), 4, 0), 4, "0");
            SubsflControlProps_392( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A69InformacaoId = H002N2_A69InformacaoId[0];
               AssignAttri(sPrefix, false, "A69InformacaoId", StringUtil.LTrimStr( (decimal)(A69InformacaoId), 8, 0));
               A73HipoteseTratamentoNome = H002N2_A73HipoteseTratamentoNome[0];
               A103DocDicionarioDataInclusao = H002N2_A103DocDicionarioDataInclusao[0];
               A102DocDicionarioFinalidade = H002N2_A102DocDicionarioFinalidade[0];
               A101DocDicionarioTransfInter = H002N2_A101DocDicionarioTransfInter[0];
               A100DocDicionarioPodeEliminar = H002N2_A100DocDicionarioPodeEliminar[0];
               A99DocDicionarioSensivel = H002N2_A99DocDicionarioSensivel[0];
               A72HipoteseTratamentoId = H002N2_A72HipoteseTratamentoId[0];
               A98DocDicionarioId = H002N2_A98DocDicionarioId[0];
               A73HipoteseTratamentoNome = H002N2_A73HipoteseTratamentoNome[0];
               E182N2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         /* Using cursor H002N3 */
         pr_default.execute(1, new Object[] {AV8InformacaoId});
      ...
      protected void STRUP2N0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8InformacaoId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8InformacaoId"), ",", "."));
      ...
      protected void E162N2( )
      {
         ...
         AssignProp(sPrefix, false, edtInformacaoId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtInformacaoId_Visible), 5, 0), true);
      ...
      protected void E112N2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("InformacaoDocDicionarioWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV37Pgmname+"GridState"));
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("InformacaoDocDicionarioWCFilters"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "InformacaoDocDicionarioWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "InformacaoDocDicionarioWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "InformacaoId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8InformacaoId), 8, 0);
      ...
      protected void wb_table2_29_2N2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table2_29_2N2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InformacaoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8InformacaoId", StringUtil.LTrimStr( (decimal)(AV8InformacaoId), 8, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8InformacaoId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "informacaodocdicionariowc", GetJustCreated( ));
         ...
         {
            AV8InformacaoId = Convert.ToInt32(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8InformacaoId", StringUtil.LTrimStr( (decimal)(AV8InformacaoId), 8, 0));
         }
         wcpOAV8InformacaoId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8InformacaoId"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( AV8InformacaoId != wcpOAV8InformacaoId ) ) )
         {
            setjustcreated();
         }
         wcpOAV8InformacaoId = AV8InformacaoId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8InformacaoId = cgiGet( sPrefix+"AV8InformacaoId_CTRL");
         if ( StringUtil.Len( sCtrlAV8InformacaoId) > 0 )
         {
            AV8InformacaoId = (int)(context.localUtil.CToN( cgiGet( sCtrlAV8InformacaoId), ",", "."));
            AssignAttri(sPrefix, false, "AV8InformacaoId", StringUtil.LTrimStr( (decimal)(AV8InformacaoId), 8, 0));
         }
         else
         {
            AV8InformacaoId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"AV8InformacaoId_PARM"), ",", "."));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8InformacaoId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InformacaoId), 8, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8InformacaoId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8InformacaoId_CTRL", StringUtil.RTrim( sCtrlAV8InformacaoId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910445763", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("informacaodocdicionariowc.js", "?202311910445763", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "2:DocDicionarioId|3:HipoteseTratamentoId|4:PaisId|5:DocDicionarioSensivel|6:DocDicionarioPodeEliminar|7:DocDicionarioTransfInter|8:DocDicionarioFinalidade|9:DocDicionarioDataInclusao|10:HipoteseTratamentoNome|11:PaisNome";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8InformacaoId',fld:'vINFORMACAOID',pic:'ZZZZZZZ9'},{av:'A4PaisId',fld:'PAISID',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV37Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_HipoteseTratamentoNome',fld:'vISAUTHORIZED_HIPOTESETRATAMENTONOME',pic:'',hsh:true},{av:'AV34IsAuthorized_PaisNome',fld:'vISAUTHORIZED_PAISNOME',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E122N2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8InformacaoId',fld:'vINFORMACAOID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV37Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_HipoteseTratamentoNome',fld:'vISAUTHORIZED_HIPOTESETRATAMENTONOME',pic:'',hsh:true},{av:'AV34IsAuthorized_PaisNome',fld:'vISAUTHORIZED_PAISNOME',pic:'',hsh:true},{av:'A4PaisId',fld:'PAISID',pic:'ZZZZZZZ9'},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E132N2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8InformacaoId',fld:'vINFORMACAOID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV37Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_HipoteseTratamentoNome',fld:'vISAUTHORIZED_HIPOTESETRATAMENTONOME',pic:'',hsh:true},{av:'AV34IsAuthorized_PaisNome',fld:'vISAUTHORIZED_PAISNOME',pic:'',hsh:true},{av:'A4PaisId',fld:'PAISID',pic:'ZZZZZZZ9'},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E142N2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8InformacaoId',fld:'vINFORMACAOID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV37Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_HipoteseTratamentoNome',fld:'vISAUTHORIZED_HIPOTESETRATAMENTONOME',pic:'',hsh:true},{av:'AV34IsAuthorized_PaisNome',fld:'vISAUTHORIZED_PAISNOME',pic:'',hsh:true},{av:'A4PaisId',fld:'PAISID',pic:'ZZZZZZZ9'},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E182N2',iparms:[{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A98DocDicionarioId',fld:'DOCDICIONARIOID',pic:'ZZZZZZZ9',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_HipoteseTratamentoNome',fld:'vISAUTHORIZED_HIPOTESETRATAMENTONOME',pic:'',hsh:true},{av:'A72HipoteseTratamentoId',fld:'HIPOTESETRATAMENTOID',pic:'ZZZZZZZ9'},{av:'AV34IsAuthorized_PaisNome',fld:'vISAUTHORIZED_PAISNOME',pic:'',hsh:true},{av:'A4PaisId',fld:'PAISID',pic:'ZZZZZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV27Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV29Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtHipoteseTratamentoNome_Link',ctrl:'HIPOTESETRATAMENTONOME',prop:'Link'},{av:'edtPaisNome_Link',ctrl:'PAISNOME',prop:'Link'}]}");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'E112N2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8InformacaoId',fld:'vINFORMACAOID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV37Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_HipoteseTratamentoNome',fld:'vISAUTHORIZED_HIPOTESETRATAMENTONOME',pic:'',hsh:true},{av:'AV34IsAuthorized_PaisNome',fld:'vISAUTHORIZED_PAISNOME',pic:'',hsh:true},{av:'A4PaisId',fld:'PAISID',pic:'ZZZZZZZ9'},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E152N2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8InformacaoId',fld:'vINFORMACAOID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV37Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV33IsAuthorized_HipoteseTratamentoNome',fld:'vISAUTHORIZED_HIPOTESETRATAMENTONOME',pic:'',hsh:true},{av:'AV34IsAuthorized_PaisNome',fld:'vISAUTHORIZED_PAISNOME',pic:'',hsh:true},{av:'A4PaisId',fld:'PAISID',pic:'ZZZZZZZ9'},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'A98DocDicionarioId',fld:'DOCDICIONARIOID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         scmdbuf = "";
         H002N2_A69InformacaoId = new int[1] ;
         H002N2_A73HipoteseTratamentoNome = new string[] {""} ;
         H002N2_A103DocDicionarioDataInclusao = new DateTime[] {DateTime.MinValue} ;
         H002N2_A102DocDicionarioFinalidade = new string[] {""} ;
         H002N2_A101DocDicionarioTransfInter = new bool[] {false} ;
         H002N2_A100DocDicionarioPodeEliminar = new bool[] {false} ;
         H002N2_A99DocDicionarioSensivel = new bool[] {false} ;
         H002N2_A72HipoteseTratamentoId = new int[1] ;
         H002N2_A98DocDicionarioId = new int[1] ;
         ...
         sCtrlAV8InformacaoId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         GXCCtl = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.informacaodocdicionariowc__default(),
            new Object[][] {
                new Object[] {
               H002N2_A69InformacaoId, H002N2_A73HipoteseTratamentoNome, H002N2_A103DocDicionarioDataInclusao, H002N2_A102DocDicionarioFinalidade, H002N2_A101DocDicionarioTransfInter, H002N2_A100DocDicionarioPodeEliminar, H002N2_A99DocDicionarioSensivel, H002N2_A72HipoteseTratamentoId, H002N2_A98DocDicionarioId
               }
               , new Object[] {
      ...
      private int AV8InformacaoId ;
      private int wcpOAV8InformacaoId ;
      ...
      private string sCtrlAV8InformacaoId ;
      ...
      private int[] H002N2_A69InformacaoId ;
      private string[] H002N2_A73HipoteseTratamentoNome ;
      private DateTime[] H002N2_A103DocDicionarioDataInclusao ;
      private string[] H002N2_A102DocDicionarioFinalidade ;
      private bool[] H002N2_A101DocDicionarioTransfInter ;
      private bool[] H002N2_A100DocDicionarioPodeEliminar ;
      private bool[] H002N2_A99DocDicionarioSensivel ;
      private int[] H002N2_A72HipoteseTratamentoId ;
      private int[] H002N2_A98DocDicionarioId ;
   ...
   public class informacaodocdicionariowc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int A69InformacaoId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.[InformacaoId], T2.[HipoteseTratamentoNome], T1.[DocDicionarioDataInclusao], T1.[DocDicionarioFinalidade], T1.[DocDicionarioTransfInter], T1.[DocDicionarioPodeEliminar], T1.[DocDicionarioSensivel], T1.[HipoteseTratamentoId], T1.[DocDicionarioId]";
         sFromString = " FROM ([DocDicionario] T1 INNER JOIN [HipoteseTratamento] T2 ON T2.[HipoteseTratamentoId] = T1.[HipoteseTratamentoId])";
         sOrderString = "";
         AddWhere(sWhereString, "(T1.[InformacaoId] = @AV8InformacaoId)");
         if ( ( AV14OrderedBy == 1 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.[InformacaoId], T1.[DocDicionarioSensivel]";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[InformacaoId] DESC, T1.[DocDicionarioSensivel] DESC";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.[InformacaoId], T1.[DocDicionarioId]";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[InformacaoId] DESC, T1.[DocDicionarioId] DESC";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.[InformacaoId], T1.[HipoteseTratamentoId]";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[InformacaoId] DESC, T1.[HipoteseTratamentoId] DESC";
         }
         ...
         {
            sOrderString += " ORDER BY T1.[InformacaoId], T1.[DocDicionarioPodeEliminar]";
         }
         else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[InformacaoId] DESC, T1.[DocDicionarioPodeEliminar] DESC";
         }
         else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.[InformacaoId], T1.[DocDicionarioTransfInter]";
         }
         else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[InformacaoId] DESC, T1.[DocDicionarioTransfInter] DESC";
         }
         else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.[InformacaoId], T1.[DocDicionarioFinalidade]";
         }
         else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[InformacaoId] DESC, T1.[DocDicionarioFinalidade] DESC";
         }
         else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.[InformacaoId], T1.[DocDicionarioDataInclusao]";
         }
         else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[InformacaoId] DESC, T1.[DocDicionarioDataInclusao] DESC";
         }
         else if ( ( AV14OrderedBy == 9 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.[InformacaoId], T2.[HipoteseTratamentoNome]";
         }
         else if ( ( AV14OrderedBy == 9 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.[InformacaoId] DESC, T2.[HipoteseTratamentoNome] DESC";
         }
                                             ...
                                             int A69InformacaoId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ([DocDicionario] T1 INNER JOIN [HipoteseTratamento] T2 ON T2.[HipoteseTratamentoId] = T1.[HipoteseTratamentoId])";
         AddWhere(sWhereString, "(T1.[InformacaoId] = @AV8InformacaoId)");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002N2(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (int)dynConstraints[2] , (int)dynConstraints[3] );
               case 1 :
                     return conditional_H002N3(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (int)dynConstraints[2] , (int)dynConstraints[3] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV8InformacaoId",GXType.Int32,8,0) ,

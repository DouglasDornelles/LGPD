...
namespace GeneXus.Programs {
   ...
   public class tipodescartewwgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool A47TipoDescarteAtivo )
      {
         ...
         {
            AddWhere(sWhereString, "(( [TipoDescarteNome] like '%' + @lV43Tipodescartewwds_1_filterfulltext) or ( 'sim' like '%' + LOWER(@lV43Tipodescartewwds_1_filterfulltext) and [TipoDescarteAtivo] = 1) or ( 'não' like '%' + LOWER(@lV43Tipodescartewwds_1_filterfulltext) and [TipoDescarteAtivo] = 0))");
         }
         else
         {
            GXv_int1[0] = 1;

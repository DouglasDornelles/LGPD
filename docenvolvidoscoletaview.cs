...
namespace GeneXus.Programs {
   public class docenvolvidoscoletaview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public docenvolvidoscoletaview( )
      {
      ...
      public docenvolvidoscoletaview( IGxContext context )
      {
      ...
      {
         get {
            return "docenvolvidoscoletaview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "docenvolvidoscoletaview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10EnvolvidosColetaId,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV11DocumentoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("docenvolvidoscoletaview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vDOCUMENTOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV11DocumentoId), "ZZZZZZZ9"), context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vENVOLVIDOSCOLETAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10EnvolvidosColetaId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vDOCUMENTOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11DocumentoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vDOCUMENTOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV11DocumentoId), "ZZZZZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "docenvolvidoscoletaview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10EnvolvidosColetaId,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV11DocumentoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("docenvolvidoscoletaview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "DocEnvolvidosColetaView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Doc Envolvidos Coleta View" ;
      }
      ...
      protected void WB6L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Doc Envolvidos Coleta", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_DocEnvolvidosColetaView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divDocenvolvidoscoletageneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
      ...
      protected void START6L2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Doc Envolvidos Coleta View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA6L2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "docenvolvidoscoletaview.aspx")), "docenvolvidoscoletaview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "docenvolvidoscoletaview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
               ...
               if ( nGotPars == 0 )
               {
                  ...
                  if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
                  {
                     ...
                     if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
                     {
                        ...
                        AssignAttri("", false, "AV11DocumentoId", StringUtil.LTrimStr( (decimal)(AV11DocumentoId), 8, 0));
                        GxWebStd.gx_hidden_field( context, "gxhash_vDOCUMENTOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV11DocumentoId), "ZZZZZZZ9"), context));
      ...
      protected void E116L2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("docenvolvidoscoletaww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV17GXLvl9 = 0;
         /* Using cursor H006L2 */
         pr_default.execute(0, new Object[] {AV10EnvolvidosColetaId, AV11DocumentoId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A75DocumentoId = H006L2_A75DocumentoId[0];
            A54EnvolvidosColetaId = H006L2_A54EnvolvidosColetaId[0];
            AV17GXLvl9 = 1;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "DocEnvolvidosColetaGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "docenvolvidoscoletageneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "DocEnvolvidosColetaGeneral";
            WebComp_Webcomponent_general_Component = "DocEnvolvidosColetaGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10EnvolvidosColetaId,(int)AV11DocumentoId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910511964", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("docenvolvidoscoletaview.js", "?202311910511964", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divDocenvolvidoscoletageneral_cell_Internalname = "DOCENVOLVIDOSCOLETAGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Doc Envolvidos Coleta View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10EnvolvidosColetaId',fld:'vENVOLVIDOSCOLETAID',pic:'ZZZZZZZ9',hsh:true},{av:'AV11DocumentoId',fld:'vDOCUMENTOID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H006L2_A75DocumentoId = new int[1] ;
         H006L2_A54EnvolvidosColetaId = new int[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.docenvolvidoscoletaview__default(),
            new Object[][] {
                new Object[] {
               H006L2_A75DocumentoId, H006L2_A54EnvolvidosColetaId
               }
            }
         );
      ...
      private string divDocenvolvidoscoletageneral_cell_Internalname ;
      ...
      private int[] H006L2_A75DocumentoId ;
      private int[] H006L2_A54EnvolvidosColetaId ;
   ...
   public class docenvolvidoscoletaview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H006L2", "SELECT [DocumentoId], [EnvolvidosColetaId] FROM [DocEnvolvidosColeta] WHERE ([EnvolvidosColetaId] = @AV10EnvolvidosColetaId and [DocumentoId] = @AV11DocumentoId) AND ([EnvolvidosColetaId] = @AV10EnvolvidosColetaId and [DocumentoId] = @AV11DocumentoId) ORDER BY [EnvolvidosColetaId], [DocumentoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006L2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

...
namespace GeneXus.Programs {
   public class docmedidasegurancaprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public docmedidasegurancaprompt( )
      {
      ...
      public docmedidasegurancaprompt( IGxContext context )
      {
      ...
      public void execute( int aP0_InMedidaSegurancaId ,
                           ref int aP1_InOutDocumentoId )
      {
         this.AV8InMedidaSegurancaId = aP0_InMedidaSegurancaId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InMedidaSegurancaId");
            ...
            {
               AV8InMedidaSegurancaId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InMedidaSegurancaId", StringUtil.LTrimStr( (decimal)(AV8InMedidaSegurancaId), 8, 0));
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV8InMedidaSegurancaId = (int)(NumberUtil.Val( GetPar( "InMedidaSegurancaId"), "."));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13FilterFullText, AV8InMedidaSegurancaId, AV22Pgmname) ;
      ...
      {
         get {
            return "docmedidasegurancaprompt_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("docmedidasegurancaprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InMedidaSegurancaId,8,0)),UrlEncode(StringUtil.LTrimStr(AV9InOutDocumentoId,8,0))}, new string[] {"InMedidaSegurancaId","InOutDocumentoId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINMEDIDASEGURANCAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InMedidaSegurancaId), 8, 0, ",", "")));
      ...
      {
         return formatLink("docmedidasegurancaprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InMedidaSegurancaId,8,0)),UrlEncode(StringUtil.LTrimStr(AV9InOutDocumentoId,8,0))}, new string[] {"InMedidaSegurancaId","InOutDocumentoId"})  ;
      }

      public override string GetPgmname( )
      {
         return "DocMedidaSegurancaPrompt" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consulta de Doc Medida Seguranca" ;
      }
      ...
      protected void WB8Y0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_8Y2( true) ;
         }
         else
         {
            wb_table1_14_8Y2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_8Y2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START8Y2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Doc Medida Seguranca", 0) ;
         }
         context.wjLoc = "";
      ...
      {
         /* GeneXus formulas. */
         AV22Pgmname = "DocMedidaSegurancaPrompt";
         context.Gx_err = 0;
      ...
      protected void RF8Y2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV13FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV13FilterFullText), "%", "");
            /* Using cursor H008Y2 */
            pr_default.execute(0, new Object[] {AV8InMedidaSegurancaId, lV13FilterFullText, lV13FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_26_idx = 1;
            sGXsfl_26_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_26_idx), 4, 0), 4, "0");
            SubsflControlProps_262( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A75DocumentoId = H008Y2_A75DocumentoId[0];
               A51MedidaSegurancaId = H008Y2_A51MedidaSegurancaId[0];
               E178Y2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV13FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV13FilterFullText), "%", "");
         /* Using cursor H008Y3 */
         pr_default.execute(1, new Object[] {AV8InMedidaSegurancaId, lV13FilterFullText, lV13FilterFullText});
      ...
      protected void E158Y2( )
      {
         ...
         Form.Caption = "Consulta de Doc Medida Seguranca";
      ...
      protected void wb_table1_14_8Y2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_DocMedidaSegurancaPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InMedidaSegurancaId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InMedidaSegurancaId", StringUtil.LTrimStr( (decimal)(AV8InMedidaSegurancaId), 8, 0));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910514535", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("docmedidasegurancaprompt.js", "?202311910514535", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtMedidaSegurancaId_Internalname = "MEDIDASEGURANCAID_"+sGXsfl_26_idx;
      ...
      protected void SubsflControlProps_fel_262( )
      {
         ...
         edtMedidaSegurancaId_Internalname = "MEDIDASEGURANCAID_"+sGXsfl_26_fel_idx;
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:MedidaSegurancaId|2:DocumentoId";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InMedidaSegurancaId',fld:'vINMEDIDASEGURANCAID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E178Y2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E188Y2',iparms:[{av:'A75DocumentoId',fld:'DOCUMENTOID',pic:'ZZZZZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV9InOutDocumentoId',fld:'vINOUTDOCUMENTOID',pic:'ZZZZZZZ9'}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E148Y2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8InMedidaSegurancaId',fld:'vINMEDIDASEGURANCAID',pic:'ZZZZZZZ9'},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H008Y2_A75DocumentoId = new int[1] ;
         H008Y2_A51MedidaSegurancaId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.docmedidasegurancaprompt__default(),
            new Object[][] {
                new Object[] {
               H008Y2_A75DocumentoId, H008Y2_A51MedidaSegurancaId
               }
               , new Object[] {
      ...
      private int AV8InMedidaSegurancaId ;
      private int AV9InOutDocumentoId ;
      private int wcpOAV8InMedidaSegurancaId ;
      ...
      private int[] H008Y2_A75DocumentoId ;
      private int[] H008Y2_A51MedidaSegurancaId ;
   ...
   public class docmedidasegurancaprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int AV8InMedidaSegurancaId )
      {
         ...
         sOrderString = "";
         AddWhere(sWhereString, "([MedidaSegurancaId] = @AV8InMedidaSegurancaId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13FilterFullText)) )
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([MedidaSegurancaId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( CONVERT( char(8), CAST([DocumentoId] AS decimal(8,0))) like '%' + @lV13FilterFullText))");
         }
         else
         {
            GXv_int3[1] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H008Y2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] );
               case 1 :
                     return conditional_H008Y3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV8InMedidaSegurancaId",GXType.Int32,8,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H008Y2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008Y2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H008Y3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008Y3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }

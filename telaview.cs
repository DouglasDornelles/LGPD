...
namespace GeneXus.Programs {
   public class telaview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public telaview( )
      {
      ...
      public telaview( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "telaview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10TelaId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("telaview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vTELAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10TelaId), "ZZZZZZZ9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vTELAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10TelaId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vTELAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10TelaId), "ZZZZZZZ9"), context));
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Campowc == null ) )
         {
            WebComp_Campowc.componentjscripts();
         }
      }
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "telaview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10TelaId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("telaview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      protected void WB8A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Tela", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_TelaView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTelageneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCampo_title_Internalname, "Campo", "", "", lblCampo_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_TelaView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            context.WriteHtmlText( "Campo") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel1"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtablecampo_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0033"+"", StringUtil.RTrim( WebComp_Campowc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0033"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Campowc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldCampowc), StringUtil.Lower( WebComp_Campowc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0033"+"");
                  }
                  WebComp_Campowc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldCampowc), StringUtil.Lower( WebComp_Campowc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
      ...
      protected void START8A2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Tela View", 0) ;
         }
         context.wjLoc = "";
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldCampowc = cgiGet( "W0033");
                           if ( ( StringUtil.Len( OldCampowc) == 0 ) || ( StringUtil.StrCmp(OldCampowc, WebComp_Campowc_Component) != 0 ) )
                           {
                              WebComp_Campowc = getWebComponent(GetType(), "GeneXus.Programs", OldCampowc, new Object[] {context} );
                              WebComp_Campowc.ComponentInit();
                              WebComp_Campowc.Name = "OldCampowc";
                              WebComp_Campowc_Component = OldCampowc;
                           }
                           if ( StringUtil.Len( WebComp_Campowc_Component) != 0 )
                           {
                              WebComp_Campowc.componentprocess("W0033", "", sEvt);
                           }
                           WebComp_Campowc_Component = OldCampowc;
                        }
                     }
      ...
      protected void PA8A2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "telaview.aspx")), "telaview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "telaview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10TelaId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10TelaId", StringUtil.LTrimStr( (decimal)(AV10TelaId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vTELAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10TelaId), "ZZZZZZZ9"), context));
      ...
      protected void RF8A2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Campowc_Component) != 0 )
               {
                  WebComp_Campowc.componentstart();
               }
            }
         }
      ...
      protected void E128A2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("telaww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H008A2 */
         pr_default.execute(0, new Object[] {AV10TelaId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A133TelaId = H008A2_A133TelaId[0];
            A134TelaNome = H008A2_A134TelaNome[0];
            AV16GXLvl9 = 1;
            Form.Caption = A134TelaNome;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "TelaGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "telageneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "TelaGeneral";
            WebComp_Webcomponent_general_Component = "TelaGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10TelaId});
      ...
      protected void S122( )
      {
         /* 'LOADTABS' Routine */
         returnInSub = false;
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "Campo") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Campowc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Campowc_Component), StringUtil.Lower( "TelaCampoWC")) != 0 )
            {
               WebComp_Campowc = getWebComponent(GetType(), "GeneXus.Programs", "telacampowc", new Object[] {context} );
               WebComp_Campowc.ComponentInit();
               WebComp_Campowc.Name = "TelaCampoWC";
               WebComp_Campowc_Component = "TelaCampoWC";
            }
            if ( StringUtil.Len( WebComp_Campowc_Component) != 0 )
            {
               WebComp_Campowc.setjustcreated();
               WebComp_Campowc.componentprepare(new Object[] {(string)"W0033",(string)"",(int)AV10TelaId});
               WebComp_Campowc.componentbind(new Object[] {(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Campowc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0033"+"");
               WebComp_Campowc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10TelaId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10TelaId", StringUtil.LTrimStr( (decimal)(AV10TelaId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vTELAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10TelaId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Campowc == null ) )
         {
            if ( StringUtil.Len( WebComp_Campowc_Component) != 0 )
            {
               WebComp_Campowc.componentthemes();
            }
         }
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910512464", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("telaview.js", "?202311910512464", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTelageneral_cell_Internalname = "TELAGENERAL_CELL";
         lblCampo_title_Internalname = "CAMPO_TITLE";
         divUnnamedtablecampo_Internalname = "UNNAMEDTABLECAMPO";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10TelaId',fld:'vTELAID',pic:'ZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E118A2',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10TelaId',fld:'vTELAID',pic:'ZZZZZZZ9',hsh:true}]");
         setEventMetadata("TABS.TABCHANGED",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{ctrl:'CAMPOWC'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         lblCampo_title_Jsonclick = "";
         WebComp_Campowc_Component = "";
         OldCampowc = "";
         sEvt = "";
         EvtGridId = "";
         EvtRowId = "";
         ...
         scmdbuf = "";
         H008A2_A133TelaId = new int[1] ;
         H008A2_A134TelaNome = new string[] {""} ;
         A134TelaNome = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.telaview__default(),
            new Object[][] {
                new Object[] {
               H008A2_A133TelaId, H008A2_A134TelaNome
               }
            }
         );
         WebComp_Webcomponent_general = new GeneXus.Http.GXNullWebComponent();
         WebComp_Campowc = new GeneXus.Http.GXNullWebComponent();
         /* GeneXus formulas. */
         context.Gx_err = 0;
      }
      ...
      private int AV10TelaId ;
      private int wcpOAV10TelaId ;
      ...
      private string divTelageneral_cell_Internalname ;
      ...
      private string lblCampo_title_Internalname ;
      private string lblCampo_title_Jsonclick ;
      private string divUnnamedtablecampo_Internalname ;
      private string WebComp_Campowc_Component ;
      private string OldCampowc ;
      private string sEvt ;
   ...
   public class telaview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10TelaId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H008A2", "SELECT [TelaId], [TelaNome] FROM [Tela] WHERE [TelaId] = @AV10TelaId ORDER BY [TelaId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008A2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

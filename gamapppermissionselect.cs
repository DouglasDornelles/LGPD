   ...
   public class gamapppermissionselect : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void WB1A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_16_1A2( true) ;
         }
         else
         {
            wb_table1_16_1A2( false) ;
         }
         return  ;
      }

      protected void wb_table1_16_1A2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      private void E171A2( )
      {
         ...
         AV49GXV1 = 1;
         while ( AV49GXV1 <= AV25GAMAppPermissions.Count )
         {
            AV10AppPermission = ((GeneXus.Programs.genexussecurity.SdtGAMApplicationPermission)AV25GAMAppPermissions.Item(AV49GXV1));
            AV24Select = false;
            AssignAttri("", false, chkavSelect_Internalname, AV24Select);
      ...
      protected void E111A2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            if (returnInSub) return;
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("GAMAppPermissionSelectFilters")) + "," + UrlEncode(StringUtil.RTrim(AV48Pgmname+"GridState"));
         ...
         else
         {
            ...
            else
            {
               ...
               S142 ();
               if (returnInSub) return;
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV48Pgmname+"GridState",  AV37ManageFiltersXml) ;
      ...
      protected void E141A2( )
      {
         ...
         while ( nGXsfl_35_fel_idx < nRC_GXsfl_35 )
         {
            ...
            if ( AV24Select )
            {
               ...
               {
                  AV51GXV2 = 1;
                  while ( AV51GXV2 <= AV14Errors.Count )
                  {
                     AV13Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV14Errors.Item(AV51GXV2));
         ...
         {
            AV52GXV3 = 1;
            while ( AV52GXV3 <= AV14Errors.Count )
            {
               AV13Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV14Errors.Item(AV52GXV3));
               GX_msglist.addItem(StringUtil.Format( "%1 (GAM%2)", AV13Error.gxTpr_Message, StringUtil.LTrimStr( (decimal)(AV13Error.gxTpr_Code), 12, 0), "", "", "", "", "", "", ""));
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV35Session.Get(AV48Pgmname+"GridState"), "") == 0 )
         {
            AV33GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV48Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV33GridState.FromXml(AV35Session.Get(AV48Pgmname+"GridState"), null, "", "");
         }
         /* Execute user subroutine: 'LOADREGFILTERSSTATE' */
         S152 ();
         if (returnInSub) return;
      ...
      protected void S152( )
      {
         ...
         returnInSub = false;
         AV53GXV4 = 1;
         while ( AV53GXV4 <= AV33GridState.gxTpr_Filtervalues.Count )
         {
            AV34GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV33GridState.gxTpr_Filtervalues.Item(AV53GXV4));
      ...
      protected void S132( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV48Pgmname+"GridState",  AV33GridState.ToXml(false, true, "", "")) ;
      }

      protected void wb_table1_16_1A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            wb_table2_21_1A2( true) ;
         }
         else
         {
            wb_table2_21_1A2( false) ;
         }
         return  ;
      }

      protected void wb_table2_21_1A2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_16_1A2e( true) ;
         }
         else
         {
            wb_table1_16_1A2e( false) ;
         }
      }

      protected void wb_table2_21_1A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_21_1A2e( true) ;
         }
         else
         {
            wb_table2_21_1A2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910475671", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamapppermissionselect.js", "?202311910475672", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E171A2',iparms:[{av:'AV9ApplicationId',fld:'vAPPLICATIONID',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV15FilName',fld:'vFILNAME',pic:''},{av:'AV23PermissionId',fld:'vPERMISSIONID',pic:'',hsh:true},{av:'AV19IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true}]");

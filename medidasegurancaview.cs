...
namespace GeneXus.Programs {
   public class medidasegurancaview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public medidasegurancaview( )
      {
      ...
      public medidasegurancaview( IGxContext context )
      {
      ...
      public void execute( int aP0_MedidaSegurancaId ,
                           string aP1_TabCode )
      {
         this.AV10MedidaSegurancaId = aP0_MedidaSegurancaId;
      ...
      {
         get {
            return "medidasegurancaview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "medidasegurancaview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10MedidaSegurancaId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("medidasegurancaview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vMEDIDASEGURANCAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10MedidaSegurancaId), "ZZZZZZZ9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vMEDIDASEGURANCAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10MedidaSegurancaId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vMEDIDASEGURANCAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10MedidaSegurancaId), "ZZZZZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "medidasegurancaview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10MedidaSegurancaId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("medidasegurancaview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "MedidaSegurancaView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Medida Seguranca View" ;
      }
      ...
      protected void WB510( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Medida Seguranca", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_MedidaSegurancaView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divMedidasegurancageneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDocumento_title_Internalname, "Documento", "", "", lblDocumento_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_MedidaSegurancaView.htm");
            /* Div Control */
      ...
      protected void START512( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Medida Seguranca View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA512( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "medidasegurancaview.aspx")), "medidasegurancaview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "medidasegurancaview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10MedidaSegurancaId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10MedidaSegurancaId", StringUtil.LTrimStr( (decimal)(AV10MedidaSegurancaId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vMEDIDASEGURANCAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10MedidaSegurancaId), "ZZZZZZZ9"), context));
      ...
      protected void E12512( )
      {
         ...
         lblWorkwithlink_Link = formatLink("medidasegurancaww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H00512 */
         pr_default.execute(0, new Object[] {AV10MedidaSegurancaId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A51MedidaSegurancaId = H00512_A51MedidaSegurancaId[0];
            A52MedidaSegurancaNome = H00512_A52MedidaSegurancaNome[0];
            AV16GXLvl9 = 1;
            Form.Caption = A52MedidaSegurancaNome;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "MedidaSegurancaGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "medidasegurancageneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "MedidaSegurancaGeneral";
            WebComp_Webcomponent_general_Component = "MedidaSegurancaGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10MedidaSegurancaId});
      ...
      protected void S122( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "Documento") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Documentowc_Component), StringUtil.Lower( "MedidaSegurancaDocumentoWC")) != 0 )
            {
               WebComp_Documentowc = getWebComponent(GetType(), "GeneXus.Programs", "medidasegurancadocumentowc", new Object[] {context} );
               WebComp_Documentowc.ComponentInit();
               WebComp_Documentowc.Name = "MedidaSegurancaDocumentoWC";
               WebComp_Documentowc_Component = "MedidaSegurancaDocumentoWC";
            }
            if ( StringUtil.Len( WebComp_Documentowc_Component) != 0 )
            {
               WebComp_Documentowc.setjustcreated();
               WebComp_Documentowc.componentprepare(new Object[] {(string)"W0033",(string)"",(int)AV10MedidaSegurancaId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10MedidaSegurancaId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10MedidaSegurancaId", StringUtil.LTrimStr( (decimal)(AV10MedidaSegurancaId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vMEDIDASEGURANCAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10MedidaSegurancaId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910504430", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("medidasegurancaview.js", "?202311910504430", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divMedidasegurancageneral_cell_Internalname = "MEDIDASEGURANCAGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Medida Seguranca View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10MedidaSegurancaId',fld:'vMEDIDASEGURANCAID',pic:'ZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E11512',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10MedidaSegurancaId',fld:'vMEDIDASEGURANCAID',pic:'ZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00512_A51MedidaSegurancaId = new int[1] ;
         H00512_A52MedidaSegurancaNome = new string[] {""} ;
         A52MedidaSegurancaNome = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.medidasegurancaview__default(),
            new Object[][] {
                new Object[] {
               H00512_A51MedidaSegurancaId, H00512_A52MedidaSegurancaNome
               }
            }
         );
      ...
      private int AV10MedidaSegurancaId ;
      private int wcpOAV10MedidaSegurancaId ;
      ...
      private string divMedidasegurancageneral_cell_Internalname ;
      ...
      private int[] H00512_A51MedidaSegurancaId ;
      private string[] H00512_A52MedidaSegurancaNome ;
   ...
   public class medidasegurancaview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10MedidaSegurancaId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H00512", "SELECT [MedidaSegurancaId], [MedidaSegurancaNome] FROM [MedidaSeguranca] WHERE [MedidaSegurancaId] = @AV10MedidaSegurancaId ORDER BY [MedidaSegurancaId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00512,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

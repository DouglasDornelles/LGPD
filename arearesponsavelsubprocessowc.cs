...
namespace GeneXus.Programs {
   public class arearesponsavelsubprocessowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public arearesponsavelsubprocessowc( )
      {
      ...
      public arearesponsavelsubprocessowc( IGxContext context )
      {
      ...
      public void execute( int aP0_AreaResponsavelId )
      {
         this.AV8AreaResponsavelId = aP0_AreaResponsavelId;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "AreaResponsavelId");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8AreaResponsavelId = (int)(NumberUtil.Val( GetPar( "AreaResponsavelId"), "."));
                  AssignAttri(sPrefix, false, "AV8AreaResponsavelId", StringUtil.LTrimStr( (decimal)(AV8AreaResponsavelId), 8, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(int)AV8AreaResponsavelId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV38Insert_ProcessoId = (int)(NumberUtil.Val( GetPar( "Insert_ProcessoId"), "."));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV20ManageFiltersExecutionStep, AV41Pgmname, AV14OrderedBy, AV15OrderedDsc, AV16FilterFullText, AV28IsAuthorized_Update, AV38Insert_ProcessoId, AV34IsSubProcesso, AV35SubProcessoId_Out, AV36ProcessoId_Out, AV30IsAuthorized_Delete, AV32IsAuthorized_Insert, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV41Pgmname = "AreaResponsavelSubProcessoWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Area Responsavel Sub Processo WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "arearesponsavelsubprocessowc.aspx"+UrlEncode(StringUtil.LTrimStr(AV8AreaResponsavelId,8,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("arearesponsavelsubprocessowc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8AreaResponsavelId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV8AreaResponsavelId), 8, 0, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_UPDATE", GetSecureSignedToken( sPrefix, AV28IsAuthorized_Update, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vINSERT_PROCESSOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV38Insert_ProcessoId), 8, 0, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV32IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vAREARESPONSAVELID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8AreaResponsavelId), 8, 0, ",", "")));
      ...
      {
         return "AreaResponsavelSubProcessoWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Area Responsavel Sub Processo WC" ;
      }
      ...
      protected void WB7T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "arearesponsavelsubprocessowc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "Inserir", bttBtninsert_Jsonclick, 5, "Inserir", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_AreaResponsavelSubProcessoWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
            wb_table1_24_7T2( true) ;
         }
         else
         {
            wb_table1_24_7T2( false) ;
         }
         return  ;
      }

      protected void wb_table1_24_7T2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         if ( wbEnd == 39 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtAreaResponsavelId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A24AreaResponsavelId), 8, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A24AreaResponsavelId), "ZZZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAreaResponsavelId_Jsonclick, 0, "Attribute", "", "", "", "", edtAreaResponsavelId_Visible, 0, 0, "text", "1", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "Id", "right", false, "", "HLP_AreaResponsavelSubProcessoWC.htm");
            /* User Defined Control */
      ...
      protected void START7T2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Area Responsavel Sub Processo WC", 0) ;
            }
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "arearesponsavelsubprocessowc.aspx")), "arearesponsavelsubprocessowc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "arearesponsavelsubprocessowc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void RF7T2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A23SubprocessoAtivo = H007T2_A23SubprocessoAtivo[0];
               A21SubprocessoNome = H007T2_A21SubprocessoNome[0];
               A17ProcessoNome = H007T2_A17ProcessoNome[0];
               A16ProcessoId = H007T2_A16ProcessoId[0];
               n16ProcessoId = H007T2_n16ProcessoId[0];
               A20SubprocessoId = H007T2_A20SubprocessoId[0];
               A17ProcessoNome = H007T2_A17ProcessoNome[0];
               E187T2 ();
      ...
      protected void STRUP7T0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8AreaResponsavelId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8AreaResponsavelId"), ",", "."));
      ...
      protected void E167T2( )
      {
         ...
         AssignProp(sPrefix, false, edtAreaResponsavelId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtAreaResponsavelId_Visible), 5, 0), true);
      ...
      private void E187T2( )
      {
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "subprocesso.aspx"+UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode(StringUtil.LTrimStr(A20SubprocessoId,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV38Insert_ProcessoId,8,0)) + "," + UrlEncode(StringUtil.BoolToStr(AV34IsSubProcesso)) + "," + UrlEncode(StringUtil.LTrimStr(AV35SubProcessoId_Out,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV36ProcessoId_Out,8,0));
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "subprocesso.aspx"+UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode(StringUtil.LTrimStr(A20SubprocessoId,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV38Insert_ProcessoId,8,0)) + "," + UrlEncode(StringUtil.BoolToStr(AV34IsSubProcesso)) + "," + UrlEncode(StringUtil.LTrimStr(AV35SubProcessoId_Out,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV36ProcessoId_Out,8,0));
      ...
      protected void E117T2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("AreaResponsavelSubProcessoWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV41Pgmname+"GridState"));
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("AreaResponsavelSubProcessoWCFilters"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "AreaResponsavelSubProcessoWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
      ...
      protected void E157T2( )
      {
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "subprocesso.aspx"+UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode(StringUtil.LTrimStr(0,1,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV38Insert_ProcessoId,8,0)) + "," + UrlEncode(StringUtil.BoolToStr(AV34IsSubProcesso)) + "," + UrlEncode(StringUtil.LTrimStr(AV35SubProcessoId_Out,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV36ProcessoId_Out,8,0));
      ...
      protected void S152( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "subprocesso_Delete", out  GXt_boolean3) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "AreaResponsavelSubProcessoWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "AreaResponsavelId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8AreaResponsavelId), 8, 0);
         AV10TrnContext.gxTpr_Attributes.Add(AV11TrnContextAtt, 0);
         AV17Session.Set("TrnContext", AV10TrnContext.ToXml(false, true, "", ""));
      }

      protected void wb_table1_24_7T2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table2_29_7T2( true) ;
         }
         else
         {
            wb_table2_29_7T2( false) ;
         }
         return  ;
      }

      protected void wb_table2_29_7T2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_24_7T2e( true) ;
         }
         else
         {
            wb_table1_24_7T2e( false) ;
         }
      }

      protected void wb_table2_29_7T2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8AreaResponsavelId = Convert.ToInt32(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8AreaResponsavelId", StringUtil.LTrimStr( (decimal)(AV8AreaResponsavelId), 8, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8AreaResponsavelId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "arearesponsavelsubprocessowc", GetJustCreated( ));
         ...
         {
            AV8AreaResponsavelId = Convert.ToInt32(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8AreaResponsavelId", StringUtil.LTrimStr( (decimal)(AV8AreaResponsavelId), 8, 0));
         }
         wcpOAV8AreaResponsavelId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8AreaResponsavelId"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( AV8AreaResponsavelId != wcpOAV8AreaResponsavelId ) ) )
         {
            setjustcreated();
         }
         wcpOAV8AreaResponsavelId = AV8AreaResponsavelId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8AreaResponsavelId = cgiGet( sPrefix+"AV8AreaResponsavelId_CTRL");
         if ( StringUtil.Len( sCtrlAV8AreaResponsavelId) > 0 )
         {
            AV8AreaResponsavelId = (int)(context.localUtil.CToN( cgiGet( sCtrlAV8AreaResponsavelId), ",", "."));
            AssignAttri(sPrefix, false, "AV8AreaResponsavelId", StringUtil.LTrimStr( (decimal)(AV8AreaResponsavelId), 8, 0));
         }
         else
         {
            AV8AreaResponsavelId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"AV8AreaResponsavelId_PARM"), ",", "."));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8AreaResponsavelId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8AreaResponsavelId), 8, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8AreaResponsavelId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8AreaResponsavelId_CTRL", StringUtil.RTrim( sCtrlAV8AreaResponsavelId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910454065", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("arearesponsavelsubprocessowc.js", "?202311910454065", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_392( )
      {
         ...
         edtProcessoId_Internalname = sPrefix+"PROCESSOID_"+sGXsfl_39_idx;
         edtProcessoNome_Internalname = sPrefix+"PROCESSONOME_"+sGXsfl_39_idx;
         ...
         edtAreaResponsavelNome_Internalname = sPrefix+"AREARESPONSAVELNOME_"+sGXsfl_39_idx;
      }
      ...
      protected void SubsflControlProps_fel_392( )
      {
         ...
         edtProcessoId_Internalname = sPrefix+"PROCESSOID_"+sGXsfl_39_fel_idx;
         edtProcessoNome_Internalname = sPrefix+"PROCESSONOME_"+sGXsfl_39_fel_idx;
         ...
         edtAreaResponsavelNome_Internalname = sPrefix+"AREARESPONSAVELNOME_"+sGXsfl_39_fel_idx;
      }
      ...
      protected void sendrow_392( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_39_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtProcessoId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A16ProcessoId), 8, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A16ProcessoId), "ZZZZZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtProcessoId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)39,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtAreaResponsavelNome_Internalname,(string)A25AreaResponsavelNome,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtAreaResponsavelNome_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)100,(short)0,(short)0,(short)39,(short)0,(short)-1,(short)-1,(bool)true,(string)"Nome",(string)"left",(bool)true,(string)""});
      ...
      protected void init_default_properties( )
      {
         ...
         edtProcessoNome_Internalname = sPrefix+"PROCESSONOME";
         edtSubprocessoNome_Internalname = sPrefix+"SUBPROCESSONOME";
         cmbSubprocessoAtivo_Internalname = sPrefix+"SUBPROCESSOATIVO";
         edtAreaResponsavelNome_Internalname = sPrefix+"AREARESPONSAVELNOME";
         Gridpaginationbar_Internalname = sPrefix+"GRIDPAGINATIONBAR";
         divGridtablewithpaginationbar_Internalname = sPrefix+"GRIDTABLEWITHPAGINATIONBAR";
         divTablegridheader_Internalname = sPrefix+"TABLEGRIDHEADER";
         Ddo_grid_Internalname = sPrefix+"DDO_GRID";
         edtAreaResponsavelId_Internalname = sPrefix+"AREARESPONSAVELID";
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "2:SubprocessoId|3:ProcessoId|4:ProcessoNome|5:SubprocessoNome|6:SubprocessoAtivo|7:AreaResponsavelNome";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV38Insert_ProcessoId',fld:'vINSERT_PROCESSOID',pic:'ZZZZZZZ9'},{av:'AV34IsSubProcesso',fld:'vISSUBPROCESSO',pic:''},{av:'AV35SubProcessoId_Out',fld:'vSUBPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV36ProcessoId_Out',fld:'vPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E127T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV38Insert_ProcessoId',fld:'vINSERT_PROCESSOID',pic:'ZZZZZZZ9'},{av:'AV34IsSubProcesso',fld:'vISSUBPROCESSO',pic:''},{av:'AV35SubProcessoId_Out',fld:'vSUBPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV36ProcessoId_Out',fld:'vPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E137T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV38Insert_ProcessoId',fld:'vINSERT_PROCESSOID',pic:'ZZZZZZZ9'},{av:'AV34IsSubProcesso',fld:'vISSUBPROCESSO',pic:''},{av:'AV35SubProcessoId_Out',fld:'vSUBPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV36ProcessoId_Out',fld:'vPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E147T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV38Insert_ProcessoId',fld:'vINSERT_PROCESSOID',pic:'ZZZZZZZ9'},{av:'AV34IsSubProcesso',fld:'vISSUBPROCESSO',pic:''},{av:'AV35SubProcessoId_Out',fld:'vSUBPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV36ProcessoId_Out',fld:'vPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E187T2',iparms:[{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A20SubprocessoId',fld:'SUBPROCESSOID',pic:'ZZZZZZZ9'},{av:'AV38Insert_ProcessoId',fld:'vINSERT_PROCESSOID',pic:'ZZZZZZZ9'},{av:'AV34IsSubProcesso',fld:'vISSUBPROCESSO',pic:''},{av:'AV35SubProcessoId_Out',fld:'vSUBPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV36ProcessoId_Out',fld:'vPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
         ...
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'E117T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV38Insert_ProcessoId',fld:'vINSERT_PROCESSOID',pic:'ZZZZZZZ9'},{av:'AV34IsSubProcesso',fld:'vISSUBPROCESSO',pic:''},{av:'AV35SubProcessoId_Out',fld:'vSUBPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV36ProcessoId_Out',fld:'vPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E157T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV38Insert_ProcessoId',fld:'vINSERT_PROCESSOID',pic:'ZZZZZZZ9'},{av:'AV34IsSubProcesso',fld:'vISSUBPROCESSO',pic:''},{av:'AV35SubProcessoId_Out',fld:'vSUBPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV36ProcessoId_Out',fld:'vPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'A20SubprocessoId',fld:'SUBPROCESSOID',pic:'ZZZZZZZ9'}]");
         setEventMetadata("'DOINSERT'",",oparms:[{av:'AV36ProcessoId_Out',fld:'vPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV35SubProcessoId_Out',fld:'vSUBPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV34IsSubProcesso',fld:'vISSUBPROCESSO',pic:''},{av:'AV38Insert_ProcessoId',fld:'vINSERT_PROCESSOID',pic:'ZZZZZZZ9'},{av:'A20SubprocessoId',fld:'SUBPROCESSOID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV25GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV26GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{av:'AV18ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]}");
         setEventMetadata("VALID_PROCESSOID","{handler:'Valid_Processoid',iparms:[]");
         setEventMetadata("VALID_PROCESSOID",",oparms:[]}");
         setEventMetadata("NULL","{handler:'Valid_Arearesponsavelnome',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         scmdbuf = "";
         H007T2_A23SubprocessoAtivo = new bool[] {false} ;
         H007T2_A21SubprocessoNome = new string[] {""} ;
         H007T2_A17ProcessoNome = new string[] {""} ;
         H007T2_A16ProcessoId = new int[1] ;
         H007T2_n16ProcessoId = new bool[] {false} ;
         H007T2_A20SubprocessoId = new int[1] ;
         ...
         sCtrlAV8AreaResponsavelId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         GXCCtl = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.arearesponsavelsubprocessowc__default(),
            new Object[][] {
                new Object[] {
               H007T2_A23SubprocessoAtivo, H007T2_A21SubprocessoNome, H007T2_A17ProcessoNome, H007T2_A16ProcessoId, H007T2_n16ProcessoId, H007T2_A20SubprocessoId
               }
               , new Object[] {
      ...
      private int AV8AreaResponsavelId ;
      private int wcpOAV8AreaResponsavelId ;
      private int subGrid_Rows ;
      private int Gridpaginationbar_Rowsperpageselectedvalue ;
      private int nRC_GXsfl_39 ;
      private int nGXsfl_39_idx=1 ;
      private int AV38Insert_ProcessoId ;
      ...
      private string sCtrlAV8AreaResponsavelId ;
      ...
      private bool[] H007T2_A23SubprocessoAtivo ;
      private string[] H007T2_A21SubprocessoNome ;
      private string[] H007T2_A17ProcessoNome ;
      private int[] H007T2_A16ProcessoId ;
      private bool[] H007T2_n16ProcessoId ;
      private int[] H007T2_A20SubprocessoId ;
   ...
   public class arearesponsavelsubprocessowc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H007T2(context, (short)dynConstraints[0] , (bool)dynConstraints[1] );
               case 1 :
                     return conditional_H007T3(context, (short)dynConstraints[0] , (bool)dynConstraints[1] );
         }

...
namespace GeneXus.Programs {
   public class compartinternoview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public compartinternoview( )
      {
      ...
      public compartinternoview( IGxContext context )
      {
      ...
      public void execute( int aP0_CompartInternoId ,
                           string aP1_TabCode )
      {
         this.AV10CompartInternoId = aP0_CompartInternoId;
      ...
      {
         get {
            return "compartinternoview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "compartinternoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10CompartInternoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("compartinternoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vCOMPARTINTERNOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CompartInternoId), "ZZZZZZZ9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vCOMPARTINTERNOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10CompartInternoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCOMPARTINTERNOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CompartInternoId), "ZZZZZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "compartinternoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10CompartInternoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("compartinternoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "CompartInternoView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Compart Interno View" ;
      }
      ...
      protected void WB5B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Compart Interno", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_CompartInternoView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divCompartinternogeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDoccompartinterno_title_Internalname, "Doc Compart Interno", "", "", lblDoccompartinterno_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_CompartInternoView.htm");
            /* Div Control */
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0033"+"", StringUtil.RTrim( WebComp_Doccompartinternowc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
      ...
      protected void START5B2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Compart Interno View", 0) ;
         }
         context.wjLoc = "";
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldDoccompartinternowc = cgiGet( "W0033");
                           ...
                           if ( StringUtil.Len( WebComp_Doccompartinternowc_Component) != 0 )
                           {
                              WebComp_Doccompartinternowc.componentprocess("W0033", "", sEvt);
                           }
                           WebComp_Doccompartinternowc_Component = OldDoccompartinternowc;
                        }
                     }
      ...
      protected void PA5B2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "compartinternoview.aspx")), "compartinternoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "compartinternoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10CompartInternoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
                     AssignAttri("", false, "AV10CompartInternoId", StringUtil.LTrimStr( (decimal)(AV10CompartInternoId), 8, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vCOMPARTINTERNOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CompartInternoId), "ZZZZZZZ9"), context));
      ...
      protected void E125B2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("compartinternoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H005B2 */
         pr_default.execute(0, new Object[] {AV10CompartInternoId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A57CompartInternoId = H005B2_A57CompartInternoId[0];
            A58CompartInternoNome = H005B2_A58CompartInternoNome[0];
            AV16GXLvl9 = 1;
            Form.Caption = A58CompartInternoNome;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "CompartInternoGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "compartinternogeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "CompartInternoGeneral";
            WebComp_Webcomponent_general_Component = "CompartInternoGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(int)AV10CompartInternoId});
      ...
      protected void S122( )
      {
         /* 'LOADTABS' Routine */
         returnInSub = false;
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "DocCompartInterno") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Doccompartinternowc_Component), StringUtil.Lower( "CompartInternoDocCompartInternoWC")) != 0 )
            {
               WebComp_Doccompartinternowc = getWebComponent(GetType(), "GeneXus.Programs", "compartinternodoccompartinternowc", new Object[] {context} );
               WebComp_Doccompartinternowc.ComponentInit();
               WebComp_Doccompartinternowc.Name = "CompartInternoDocCompartInternoWC";
               WebComp_Doccompartinternowc_Component = "CompartInternoDocCompartInternoWC";
            }
            if ( StringUtil.Len( WebComp_Doccompartinternowc_Component) != 0 )
            {
               WebComp_Doccompartinternowc.setjustcreated();
               WebComp_Doccompartinternowc.componentprepare(new Object[] {(string)"W0033",(string)"",(int)AV10CompartInternoId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10CompartInternoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10CompartInternoId", StringUtil.LTrimStr( (decimal)(AV10CompartInternoId), 8, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vCOMPARTINTERNOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CompartInternoId), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910505538", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("compartinternoview.js", "?202311910505539", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divCompartinternogeneral_cell_Internalname = "COMPARTINTERNOGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Compart Interno View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10CompartInternoId',fld:'vCOMPARTINTERNOID',pic:'ZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E115B2',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10CompartInternoId',fld:'vCOMPARTINTERNOID',pic:'ZZZZZZZ9',hsh:true}]");
         setEventMetadata("TABS.TABCHANGED",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{ctrl:'DOCCOMPARTINTERNOWC'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H005B2_A57CompartInternoId = new int[1] ;
         H005B2_A58CompartInternoNome = new string[] {""} ;
         A58CompartInternoNome = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.compartinternoview__default(),
            new Object[][] {
                new Object[] {
               H005B2_A57CompartInternoId, H005B2_A58CompartInternoNome
               }
            }
         );
      ...
      private int AV10CompartInternoId ;
      private int wcpOAV10CompartInternoId ;
      ...
      private string divCompartinternogeneral_cell_Internalname ;
      ...
      private int[] H005B2_A57CompartInternoId ;
      private string[] H005B2_A58CompartInternoNome ;
   ...
   public class compartinternoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV10CompartInternoId",GXType.Int32,8,0)
          };
          def= new CursorDef[] {
              new CursorDef("H005B2", "SELECT [CompartInternoId], [CompartInternoNome] FROM [CompartInterno] WHERE [CompartInternoId] = @AV10CompartInternoId ORDER BY [CompartInternoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005B2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

...
namespace GeneXus.Programs {
   public class processosubprocessowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public processosubprocessowc( )
      {
      ...
      public processosubprocessowc( IGxContext context )
      {
      ...
      public void execute( int aP0_ProcessoId )
      {
         this.AV8ProcessoId = aP0_ProcessoId;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "ProcessoId");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8ProcessoId = (int)(NumberUtil.Val( GetPar( "ProcessoId"), "."));
                  AssignAttri(sPrefix, false, "AV8ProcessoId", StringUtil.LTrimStr( (decimal)(AV8ProcessoId), 8, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(int)AV8ProcessoId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV33ProcessoId_In = (int)(NumberUtil.Val( GetPar( "ProcessoId_In"), "."));
         AV34IsSubProcesso = StringUtil.StrToBool( GetPar( "IsSubProcesso"));
         AV35SubProcessoId_Out = (int)(NumberUtil.Val( GetPar( "SubProcessoId_Out"), "."));
         AV36ProcessoId_Out = (int)(NumberUtil.Val( GetPar( "ProcessoId_Out"), "."));
         AV30IsAuthorized_Delete = StringUtil.StrToBool( GetPar( "IsAuthorized_Delete"));
         AV32IsAuthorized_SubprocessoNome = StringUtil.StrToBool( GetPar( "IsAuthorized_SubprocessoNome"));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV16FilterFullText, AV8ProcessoId, AV20ManageFiltersExecutionStep, AV39Pgmname, AV14OrderedBy, AV15OrderedDsc, AV28IsAuthorized_Update, AV33ProcessoId_In, AV34IsSubProcesso, AV35SubProcessoId_Out, AV36ProcessoId_Out, AV30IsAuthorized_Delete, AV32IsAuthorized_SubprocessoNome, AV31IsAuthorized_Insert, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV39Pgmname = "ProcessoSubProcessoWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Processo Sub Processo WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "processosubprocessowc.aspx"+UrlEncode(StringUtil.LTrimStr(AV8ProcessoId,8,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("processosubprocessowc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_SUBPROCESSONOME", GetSecureSignedToken( sPrefix, AV32IsAuthorized_SubprocessoNome, context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8ProcessoId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV8ProcessoId), 8, 0, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_UPDATE", GetSecureSignedToken( sPrefix, AV28IsAuthorized_Update, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vPROCESSOID_IN", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV33ProcessoId_In), 8, 0, ",", "")));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISSUBPROCESSO", AV34IsSubProcesso);
         GxWebStd.gx_hidden_field( context, sPrefix+"vSUBPROCESSOID_OUT", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV35SubProcessoId_Out), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vPROCESSOID_OUT", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV36ProcessoId_Out), 8, 0, ",", "")));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_DELETE", AV30IsAuthorized_Delete);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( sPrefix, AV30IsAuthorized_Delete, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_SUBPROCESSONOME", AV32IsAuthorized_SubprocessoNome);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_SUBPROCESSONOME", GetSecureSignedToken( sPrefix, AV32IsAuthorized_SubprocessoNome, context));
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV31IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vPROCESSOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8ProcessoId), 8, 0, ",", "")));
      ...
      {
         return "ProcessoSubProcessoWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Processo Sub Processo WC" ;
      }
      ...
      protected void WB3V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "processosubprocessowc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "Inserir", bttBtninsert_Jsonclick, 5, "Inserir", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_ProcessoSubProcessoWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", "", "", "div");
            wb_table1_24_3V2( true) ;
         }
         else
         {
            wb_table1_24_3V2( false) ;
         }
         return  ;
      }

      protected void wb_table1_24_3V2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         if ( wbEnd == 39 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtProcessoId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A16ProcessoId), 8, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A16ProcessoId), "ZZZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProcessoId_Jsonclick, 0, "Attribute", "", "", "", "", edtProcessoId_Visible, 0, 0, "text", "1", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "Id", "right", false, "", "HLP_ProcessoSubProcessoWC.htm");
            /* User Defined Control */
      ...
      protected void START3V2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Processo Sub Processo WC", 0) ;
            }
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "processosubprocessowc.aspx")), "processosubprocessowc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "processosubprocessowc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       int AV33ProcessoId_In ,
                                       bool AV34IsSubProcesso ,
                                       int AV35SubProcessoId_Out ,
                                       int AV36ProcessoId_Out ,
                                       bool AV30IsAuthorized_Delete ,
                                       bool AV32IsAuthorized_SubprocessoNome ,
      ...
      protected void RF3V2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 A16ProcessoId } ,
                                                 new int[]{
                                                 TypeConstants.INT, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.INT, TypeConstants.INT, TypeConstants.BOOLEAN
                                                 }
            });
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            /* Using cursor H003V2 */
            pr_default.execute(0, new Object[] {AV8ProcessoId, lV16FilterFullText, lV16FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_39_idx = 1;
            sGXsfl_39_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_39_idx), 4, 0), 4, "0");
            SubsflControlProps_392( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A16ProcessoId = H003V2_A16ProcessoId[0];
               n16ProcessoId = H003V2_n16ProcessoId[0];
               AssignAttri(sPrefix, false, "A16ProcessoId", StringUtil.LTrimStr( (decimal)(A16ProcessoId), 8, 0));
               A23SubprocessoAtivo = H003V2_A23SubprocessoAtivo[0];
               A21SubprocessoNome = H003V2_A21SubprocessoNome[0];
               A20SubprocessoId = H003V2_A20SubprocessoId[0];
               E183V2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
         /* Using cursor H003V3 */
         pr_default.execute(1, new Object[] {AV8ProcessoId, lV16FilterFullText, lV16FilterFullText});
      ...
      protected void STRUP3V0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8ProcessoId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8ProcessoId"), ",", "."));
      ...
      protected void E163V2( )
      {
         ...
         GXt_boolean1 = AV32IsAuthorized_SubprocessoNome;
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "subprocessoview_Execute", out  GXt_boolean1) ;
         AV32IsAuthorized_SubprocessoNome = GXt_boolean1;
         AssignAttri(sPrefix, false, "AV32IsAuthorized_SubprocessoNome", AV32IsAuthorized_SubprocessoNome);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_SUBPROCESSONOME", GetSecureSignedToken( sPrefix, AV32IsAuthorized_SubprocessoNome, context));
         Ddo_grid_Gridinternalname = subGrid_Internalname;
         ucDdo_grid.SendProperty(context, sPrefix, false, Ddo_grid_Internalname, "GridInternalName", Ddo_grid_Gridinternalname);
         edtProcessoId_Visible = 0;
         AssignProp(sPrefix, false, edtProcessoId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtProcessoId_Visible), 5, 0), true);
      ...
      private void E183V2( )
      {
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "subprocesso.aspx"+UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode(StringUtil.LTrimStr(A20SubprocessoId,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV33ProcessoId_In,8,0)) + "," + UrlEncode(StringUtil.BoolToStr(AV34IsSubProcesso)) + "," + UrlEncode(StringUtil.LTrimStr(AV35SubProcessoId_Out,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV36ProcessoId_Out,8,0));
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "subprocesso.aspx"+UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode(StringUtil.LTrimStr(A20SubprocessoId,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV33ProcessoId_In,8,0)) + "," + UrlEncode(StringUtil.BoolToStr(AV34IsSubProcesso)) + "," + UrlEncode(StringUtil.LTrimStr(AV35SubProcessoId_Out,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV36ProcessoId_Out,8,0));
            edtavDelete_Link = formatLink("subprocesso.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
         }
         if ( AV32IsAuthorized_SubprocessoNome )
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "subprocessoview.aspx"+UrlEncode(StringUtil.LTrimStr(A20SubprocessoId,8,0)) + "," + UrlEncode(StringUtil.RTrim(""));
            edtSubprocessoNome_Link = formatLink("subprocessoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
         }
         /* Load Method */
         if ( wbStart != -1 )
         {
      ...
      protected void E113V2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("ProcessoSubProcessoWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV39Pgmname+"GridState"));
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("ProcessoSubProcessoWCFilters"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "ProcessoSubProcessoWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void E153V2( )
      {
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "subprocesso.aspx"+UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode(StringUtil.LTrimStr(0,1,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV33ProcessoId_In,8,0)) + "," + UrlEncode(StringUtil.BoolToStr(AV34IsSubProcesso)) + "," + UrlEncode(StringUtil.LTrimStr(AV35SubProcessoId_Out,8,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV36ProcessoId_Out,8,0));
      ...
      protected void S152( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "subprocesso_Update", out  GXt_boolean1) ;
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "subprocesso_Delete", out  GXt_boolean1) ;
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "subprocesso_Insert", out  GXt_boolean1) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "ProcessoSubProcessoWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "SubProcesso";
         AV11TrnContextAtt = new GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute(context);
         AV11TrnContextAtt.gxTpr_Attributename = "ProcessoId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8ProcessoId), 8, 0);
         AV10TrnContext.gxTpr_Attributes.Add(AV11TrnContextAtt, 0);
         AV17Session.Set("TrnContext", AV10TrnContext.ToXml(false, true, "", ""));
      }

      protected void wb_table1_24_3V2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table2_29_3V2( true) ;
         }
         else
         {
            wb_table2_29_3V2( false) ;
         }
         return  ;
      }

      protected void wb_table2_29_3V2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_24_3V2e( true) ;
         }
         else
         {
            wb_table1_24_3V2e( false) ;
         }
      }

      protected void wb_table2_29_3V2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8ProcessoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8ProcessoId", StringUtil.LTrimStr( (decimal)(AV8ProcessoId), 8, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8ProcessoId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "processosubprocessowc", GetJustCreated( ));
         ...
         {
            AV8ProcessoId = Convert.ToInt32(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8ProcessoId", StringUtil.LTrimStr( (decimal)(AV8ProcessoId), 8, 0));
         }
         wcpOAV8ProcessoId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8ProcessoId"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( AV8ProcessoId != wcpOAV8ProcessoId ) ) )
         {
            setjustcreated();
         }
         wcpOAV8ProcessoId = AV8ProcessoId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8ProcessoId = cgiGet( sPrefix+"AV8ProcessoId_CTRL");
         if ( StringUtil.Len( sCtrlAV8ProcessoId) > 0 )
         {
            AV8ProcessoId = (int)(context.localUtil.CToN( cgiGet( sCtrlAV8ProcessoId), ",", "."));
            AssignAttri(sPrefix, false, "AV8ProcessoId", StringUtil.LTrimStr( (decimal)(AV8ProcessoId), 8, 0));
         }
         else
         {
            AV8ProcessoId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"AV8ProcessoId_PARM"), ",", "."));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8ProcessoId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8ProcessoId), 8, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8ProcessoId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8ProcessoId_CTRL", StringUtil.RTrim( sCtrlAV8ProcessoId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910453979", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("processosubprocessowc.js", "?202311910453979", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_392( )
      {
         ...
         edtSubprocessoNome_Internalname = sPrefix+"SUBPROCESSONOME_"+sGXsfl_39_idx;
         cmbSubprocessoAtivo_Internalname = sPrefix+"SUBPROCESSOATIVO_"+sGXsfl_39_idx;
      }
      ...
      protected void SubsflControlProps_fel_392( )
      {
         ...
         edtSubprocessoNome_Internalname = sPrefix+"SUBPROCESSONOME_"+sGXsfl_39_fel_idx;
         cmbSubprocessoAtivo_Internalname = sPrefix+"SUBPROCESSOATIVO_"+sGXsfl_39_fel_idx;
      }
      ...
      protected void sendrow_392( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_39_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSubprocessoNome_Internalname,(string)A21SubprocessoNome,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)edtSubprocessoNome_Link,(string)"",(string)"",(string)"",(string)edtSubprocessoNome_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)100,(short)0,(short)0,(short)39,(short)0,(short)-1,(short)-1,(bool)true,(string)"Nome",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            {
               GXCCtl = "SUBPROCESSOATIVO_" + sGXsfl_39_idx;
            ...
            AssignProp(sPrefix, false, cmbSubprocessoAtivo_Internalname, "Values", (string)(cmbSubprocessoAtivo.ToJavascriptSource()), !bGXsfl_39_Refreshing);
      ...
      protected void StartGridControl39( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( "do Subprocesso") ;
            context.WriteHtmlTextNl( "</th>") ;
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtSubprocessoNome_Link));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void init_default_properties( )
      {
         ...
         edtSubprocessoNome_Internalname = sPrefix+"SUBPROCESSONOME";
         cmbSubprocessoAtivo_Internalname = sPrefix+"SUBPROCESSOATIVO";
         Gridpaginationbar_Internalname = sPrefix+"GRIDPAGINATIONBAR";
         divGridtablewithpaginationbar_Internalname = sPrefix+"GRIDTABLEWITHPAGINATIONBAR";
         divTablegridheader_Internalname = sPrefix+"TABLEGRIDHEADER";
         Ddo_grid_Internalname = sPrefix+"DDO_GRID";
         edtProcessoId_Internalname = sPrefix+"PROCESSOID";
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "2:SubprocessoId|3:SubprocessoNome|4:SubprocessoAtivo";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8ProcessoId',fld:'vPROCESSOID',pic:'ZZZZZZZ9'},{av:'AV33ProcessoId_In',fld:'vPROCESSOID_IN',pic:'ZZZZZZZ9'},{av:'AV34IsSubProcesso',fld:'vISSUBPROCESSO',pic:''},{av:'AV35SubProcessoId_Out',fld:'vSUBPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV36ProcessoId_Out',fld:'vPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'sPrefix'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_SubprocessoNome',fld:'vISAUTHORIZED_SUBPROCESSONOME',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E123V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProcessoId',fld:'vPROCESSOID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV33ProcessoId_In',fld:'vPROCESSOID_IN',pic:'ZZZZZZZ9'},{av:'AV34IsSubProcesso',fld:'vISSUBPROCESSO',pic:''},{av:'AV35SubProcessoId_Out',fld:'vSUBPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV36ProcessoId_Out',fld:'vPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_SubprocessoNome',fld:'vISAUTHORIZED_SUBPROCESSONOME',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E133V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProcessoId',fld:'vPROCESSOID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV33ProcessoId_In',fld:'vPROCESSOID_IN',pic:'ZZZZZZZ9'},{av:'AV34IsSubProcesso',fld:'vISSUBPROCESSO',pic:''},{av:'AV35SubProcessoId_Out',fld:'vSUBPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV36ProcessoId_Out',fld:'vPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_SubprocessoNome',fld:'vISAUTHORIZED_SUBPROCESSONOME',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E143V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProcessoId',fld:'vPROCESSOID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV33ProcessoId_In',fld:'vPROCESSOID_IN',pic:'ZZZZZZZ9'},{av:'AV34IsSubProcesso',fld:'vISSUBPROCESSO',pic:''},{av:'AV35SubProcessoId_Out',fld:'vSUBPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV36ProcessoId_Out',fld:'vPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_SubprocessoNome',fld:'vISAUTHORIZED_SUBPROCESSONOME',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E183V2',iparms:[{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A20SubprocessoId',fld:'SUBPROCESSOID',pic:'ZZZZZZZ9'},{av:'AV33ProcessoId_In',fld:'vPROCESSOID_IN',pic:'ZZZZZZZ9'},{av:'AV34IsSubProcesso',fld:'vISSUBPROCESSO',pic:''},{av:'AV35SubProcessoId_Out',fld:'vSUBPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV36ProcessoId_Out',fld:'vPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_SubprocessoNome',fld:'vISAUTHORIZED_SUBPROCESSONOME',pic:'',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV27Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV29Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtSubprocessoNome_Link',ctrl:'SUBPROCESSONOME',prop:'Link'}]}");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'E113V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProcessoId',fld:'vPROCESSOID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV33ProcessoId_In',fld:'vPROCESSOID_IN',pic:'ZZZZZZZ9'},{av:'AV34IsSubProcesso',fld:'vISSUBPROCESSO',pic:''},{av:'AV35SubProcessoId_Out',fld:'vSUBPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV36ProcessoId_Out',fld:'vPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_SubprocessoNome',fld:'vISAUTHORIZED_SUBPROCESSONOME',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E153V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProcessoId',fld:'vPROCESSOID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV33ProcessoId_In',fld:'vPROCESSOID_IN',pic:'ZZZZZZZ9'},{av:'AV34IsSubProcesso',fld:'vISSUBPROCESSO',pic:''},{av:'AV35SubProcessoId_Out',fld:'vSUBPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV36ProcessoId_Out',fld:'vPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_SubprocessoNome',fld:'vISAUTHORIZED_SUBPROCESSONOME',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'A20SubprocessoId',fld:'SUBPROCESSOID',pic:'ZZZZZZZ9'}]");
         setEventMetadata("'DOINSERT'",",oparms:[{av:'AV36ProcessoId_Out',fld:'vPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV35SubProcessoId_Out',fld:'vSUBPROCESSOID_OUT',pic:'ZZZZZZZ9'},{av:'AV34IsSubProcesso',fld:'vISSUBPROCESSO',pic:''},{av:'AV33ProcessoId_In',fld:'vPROCESSOID_IN',pic:'ZZZZZZZ9'},{av:'A20SubprocessoId',fld:'SUBPROCESSOID',pic:'ZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV25GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV26GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{av:'AV18ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]}");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV16FilterFullText = "";
         H003V2_A16ProcessoId = new int[1] ;
         H003V2_n16ProcessoId = new bool[] {false} ;
         H003V2_A23SubprocessoAtivo = new bool[] {false} ;
         H003V2_A21SubprocessoNome = new string[] {""} ;
         H003V2_A20SubprocessoId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.processosubprocessowc__default(),
            new Object[][] {
                new Object[] {
               H003V2_A16ProcessoId, H003V2_n16ProcessoId, H003V2_A23SubprocessoAtivo, H003V2_A21SubprocessoNome, H003V2_A20SubprocessoId
               }
               , new Object[] {
      ...
      private int AV8ProcessoId ;
      private int wcpOAV8ProcessoId ;
      private int subGrid_Rows ;
      private int Gridpaginationbar_Rowsperpageselectedvalue ;
      private int nRC_GXsfl_39 ;
      private int nGXsfl_39_idx=1 ;
      private int AV33ProcessoId_In ;
      private int AV35SubProcessoId_Out ;
      private int AV36ProcessoId_Out ;
      ...
      private string edtSubprocessoNome_Link ;
      ...
      private string sCtrlAV8ProcessoId ;
      ...
      private bool AV34IsSubProcesso ;
      private bool AV30IsAuthorized_Delete ;
      private bool AV32IsAuthorized_SubprocessoNome ;
      ...
      private int[] H003V2_A16ProcessoId ;
      private bool[] H003V2_n16ProcessoId ;
      private bool[] H003V2_A23SubprocessoAtivo ;
      private string[] H003V2_A21SubprocessoNome ;
      private int[] H003V2_A20SubprocessoId ;
   ...
   public class processosubprocessowc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int A16ProcessoId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [ProcessoId], [SubprocessoAtivo], [SubprocessoNome], [SubprocessoId]";
         sFromString = " FROM [SubProcesso]";
         sOrderString = "";
         AddWhere(sWhereString, "([ProcessoId] = @AV8ProcessoId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([SubprocessoId] AS decimal(8,0))) like '%' + @lV16FilterFullText) or ( [SubprocessoNome] like '%' + @lV16FilterFullText))");
         }
         else
         {
            GXv_int5[1] = 1;
         ...
         {
            sOrderString += " ORDER BY [ProcessoId], [SubprocessoNome]";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [ProcessoId] DESC, [SubprocessoNome] DESC";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [ProcessoId], [SubprocessoId]";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [ProcessoId] DESC, [SubprocessoId] DESC";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY [ProcessoId], [SubprocessoAtivo]";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY [ProcessoId] DESC, [SubprocessoAtivo] DESC";
         }
         else if ( true )
         {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H003V2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] , (int)dynConstraints[6] );
               case 1 :
                     return conditional_H003V3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] , (int)dynConstraints[6] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV8ProcessoId",GXType.Int32,8,0) ,
          new ParDef("@lV16FilterFullText",GXType.VarChar,100,0) ,
          new ParDef("@lV16FilterFullText",GXType.NVarChar,100,0) ,

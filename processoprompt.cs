...
namespace GeneXus.Programs {
   public class processoprompt : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public processoprompt( )
      {
      ...
      public processoprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutProcessoId ,
                           ref string aP1_InOutProcessoNome )
      {
         this.AV8InOutProcessoId = aP0_InOutProcessoId;
         this.AV9InOutProcessoNome = aP1_InOutProcessoNome;
         executePrivate();
         aP0_InOutProcessoId=this.AV8InOutProcessoId;
         aP1_InOutProcessoNome=this.AV9InOutProcessoNome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutProcessoId");
            ...
            {
               AV8InOutProcessoId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8InOutProcessoId", StringUtil.LTrimStr( (decimal)(AV8InOutProcessoId), 8, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9InOutProcessoNome = GetPar( "InOutProcessoNome");
                  AssignAttri("", false, "AV9InOutProcessoNome", AV9InOutProcessoNome);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("processoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutProcessoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutProcessoNome))}, new string[] {"InOutProcessoId","InOutProcessoNome"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTPROCESSOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8InOutProcessoId), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTPROCESSONOME", AV9InOutProcessoNome);
      ...
      {
         return formatLink("processoprompt.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8InOutProcessoId,8,0)),UrlEncode(StringUtil.RTrim(AV9InOutProcessoNome))}, new string[] {"InOutProcessoId","InOutProcessoNome"})  ;
      }

      public override string GetPgmname( )
      {
         return "ProcessoPrompt" ;
      }
      ...
      protected void START3T2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Consulta de Processo", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_PROCESSONOME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A17ProcessoNome, "")), context));
      ...
      protected void RF3T2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A19ProcessoAtivo = H003T2_A19ProcessoAtivo[0];
               A17ProcessoNome = H003T2_A17ProcessoNome[0];
               A16ProcessoId = H003T2_A16ProcessoId[0];
               E173T2 ();
      ...
      protected void send_integrity_lvl_hashes3T2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV22Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV22Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_PROCESSOID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A16ProcessoId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_PROCESSONOME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A17ProcessoNome, "")), context));
      }
      ...
      protected void E153T2( )
      {
         ...
         Form.Caption = "Consulta de Processo";
      ...
      protected void E183T2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8InOutProcessoId = A16ProcessoId;
         AssignAttri("", false, "AV8InOutProcessoId", StringUtil.LTrimStr( (decimal)(AV8InOutProcessoId), 8, 0));
         AV9InOutProcessoNome = A17ProcessoNome;
         AssignAttri("", false, "AV9InOutProcessoNome", AV9InOutProcessoNome);
         context.setWebReturnParms(new Object[] {(int)AV8InOutProcessoId,(string)AV9InOutProcessoNome});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutProcessoId","AV9InOutProcessoNome"});
      ...
      protected void wb_table1_14_3T2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"fas fa-filter CleanFiltersIcon\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_ProcessoPrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8InOutProcessoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8InOutProcessoId", StringUtil.LTrimStr( (decimal)(AV8InOutProcessoId), 8, 0));
         AV9InOutProcessoNome = (string)getParm(obj,1);
         AssignAttri("", false, "AV9InOutProcessoNome", AV9InOutProcessoNome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311910501525", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("processoprompt.js", "?202311910501526", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         cmbProcessoAtivo_Internalname = "PROCESSOATIVO_"+sGXsfl_26_idx;
      }
      ...
      protected void SubsflControlProps_fel_262( )
      {
         ...
         cmbProcessoAtivo_Internalname = "PROCESSOATIVO_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "PROCESSOATIVO_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbProcessoAtivo_Internalname, "Values", (string)(cmbProcessoAtivo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
      ...
      protected void StartGridControl26( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( "do Processo") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "do Processo") ;
            context.WriteHtmlTextNl( "</th>") ;
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:ProcessoId|2:ProcessoNome|3:ProcessoAtivo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E173T2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV19Select',fld:'vSELECT',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E183T2',iparms:[{av:'A16ProcessoId',fld:'PROCESSOID',pic:'ZZZZZZZ9',hsh:true},{av:'A17ProcessoNome',fld:'PROCESSONOME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8InOutProcessoId',fld:'vINOUTPROCESSOID',pic:'ZZZZZZZ9'},{av:'AV9InOutProcessoNome',fld:'vINOUTPROCESSONOME',pic:''}]}");
         setEventMetadata("'DOCLEANFILTERS'","{handler:'E143T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV22Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13FilterFullText = "";
         H003T2_A19ProcessoAtivo = new bool[] {false} ;
         H003T2_A17ProcessoNome = new string[] {""} ;
         H003T2_A16ProcessoId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.processoprompt__default(),
            new Object[][] {
                new Object[] {
               H003T2_A19ProcessoAtivo, H003T2_A17ProcessoNome, H003T2_A16ProcessoId
               }
               , new Object[] {
      ...
      private int AV8InOutProcessoId ;
      private int wcpOAV8InOutProcessoId ;
      ...
      private string AV9InOutProcessoNome ;
      private string wcpOAV9InOutProcessoNome ;
      ...
      private int aP0_InOutProcessoId ;
      private string aP1_InOutProcessoNome ;
      private GXCombobox cmbProcessoAtivo ;
      private IDataStoreProvider pr_default ;
      private bool[] H003T2_A19ProcessoAtivo ;
      private string[] H003T2_A17ProcessoNome ;
      private int[] H003T2_A16ProcessoId ;
   ...
   public class processoprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H003T2( IGxContext context ,
                                             string AV13FilterFullText ,
                                             int A16ProcessoId ,
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([ProcessoId] AS decimal(8,0))) like '%' + @lV13FilterFullText) or ( [ProcessoNome] like '%' + @lV13FilterFullText) or ( 'sim' like '%' + LOWER(@lV13FilterFullText) and [ProcessoAtivo] = 1) or ( 'não' like '%' + LOWER(@lV13FilterFullText) and [ProcessoAtivo] = 0))");
         }
         else
         {
            GXv_int3[0] = 1;
         ...
         {
            sOrderString += " ORDER BY [ProcessoId] DESC";
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H003T2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
               case 1 :
                     return conditional_H003T3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H003T2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003T2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H003T3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003T3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
